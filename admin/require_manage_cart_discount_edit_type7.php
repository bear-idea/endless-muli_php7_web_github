...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Discount")) {
  $updateSQL = sprintf("UPDATE demo_productdiscount SET name=%s, discountFullamount=%s, discountNowfold=%s, startdate=%s, enddate=%s, limitdate=%s, skeyword=%s, sdescription=%s, content=%s, indicate=%s, notes1=%s, lang=%s WHERE id=%s",
                       GetSQLValueString($_POST['name'], "text"),
					   GetSQLValueString($_POST['discountFullamount'], "int"),
					   GetSQLValueString($_POST['discountNowfold'], "int"),
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 滿額多重減價(-) <small>修改</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post">
        ...
        <label class="col-md-2 col-form-label">折扣方式<span class="text-red">*</span> <i class="fa fa-info-circle text-orange" data-original-title="例如:80代表8折/10代表1折。" data-toggle="tooltip" data-placement="top"></i></label>
          <div class="col-md-2">
                  <div class="input-group p-0">
                    ...
                    <input name="discountFullamount" type="number" required="" class="form-control col-md-12" id="discountFullamount" step="1" value="<?php echo $row_RecordDiscount['discountFullamount']; ?>" maxlength="11" data-parsley-min="0" data-parsley-max="9999999" data-parsley-type="number" data-parsley-trigger="blur" data-parsley-errors-container="#error_discountFullamount"/>
          ...
          <div class="col-md-2">
                  <div class="input-group p-0">
                    <div class="input-group-prepend"><span class="input-group-text">減</span></div>
                    <input name="discountNowfold" type="number" required="" class="form-control col-md-12" id="discountNowfold" step="1" value="<?php echo $row_RecordDiscount['discountNowfold']; ?>" maxlength="11" data-parsley-min="0" data-parsley-max="9999999" data-parsley-type="number" data-parsley-trigger="blur" data-parsley-errors-container="#error_discountNowfold"/>
                    <div class="input-group-append"><span class="input-group-text">元</span></div> 
                  </div>
                  <div id="error_discountNowfold"></div>
          </div>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
            ...
            <input name="type" type="hidden" id="type" value="7" />
          </div>
      </div>
