...
if (isset($_POST['pid'])) {
  $colname_RecordProducSptFormat = $_POST['pid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordProducSptFormat = sprintf("SELECT * FROM demo_productspformat WHERE pid = %s ORDER BY sortid ASC, pid DESC", GetSQLValueString($colname_RecordProducSptFormat, "text"));
...
<?php
echo $row_RecordProducSptFormat['formatname'];
?>