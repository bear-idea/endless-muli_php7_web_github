...
<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>sqldatatable/js/scaleorder_split_datatable.js?<?php echo time(); ?>"></script>
<!-- ================== END Datatables JS ================== -->
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 拆分紀錄 <small>總覽</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
    ...
    <div class="row justify-content-end">
      ...
      <div class="col-md-3 col-sm-12 m-b-10">
          <div class="input-group" data-column="2">  
              <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 拆分日期</span></span>
              <input name="startdate" type="text" class="form-control search_filter" placeholder="" id="col2_filter" autocomplete="off"/>		
          </div>
      </div>
      
      <div class="col-md-2 col-sm-12 m-b-10">
        <div class="input-group" data-column="4"> <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 車號</span></span>
            <select name="carnumber" class="form-control search_filter" id="col4_filter">
    ...
    <table id="data-table-default" class="table table-striped table-bordered table-hover table-condensed">
      <thead>
        <tr>
          ...
          <th width="-1" data-priority="1"><strong>拆分單號</strong></th>
          <th width="150" data-priority="1"><strong>拆分日期</strong></th>
          <th width="70" data-priority="1"><strong>預估天數</strong></th>
          <th width="100" data-priority="1"><strong>車號</strong></th>
          <th width="100" data-priority="1"><strong>重量</strong></th>
          <th width="150" data-priority="1"><strong>完工日期</strong></th>
...
$(document).ready(function() {
  ...
  /*$('input[name="postdate"], input[name="enddate"]').val('');
