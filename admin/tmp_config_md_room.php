...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Tmp")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmproomboard=%s, tmproomboardicon=%s, tmproomboardfontcolor=%s, tmproomviewcolumn=%s WHERE id=%s",
                       GetSQLValueString($_POST['tmproomboard'], "text"),
                       GetSQLValueString($_POST['tmproomboardicon'], "text"),
                       GetSQLValueString($_POST['tmproomboardfontcolor'], "text"),
                       GetSQLValueString($_POST['tmproomviewcolumn'], "int"),
...
<div style="padding:10px; margin:10px; position:relative;" id="wrapper_config">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="TB_General_style01">
    <tr>
      <td colspan="2"><i class="fa fa-chevron-right" style="color:#F00"></i> <strong><?php echo $ModuleName['Room']; ?>：</strong></td>
      </tr>
       <tr>
      <td align="right">版面顯示方式：</td>
      <td><table width="600">
          <tr>
            <td width="65" style="border-bottom-width:0px;"><img src="images/col4.jpg" width="60" height="60" /></td>
            <td width="65" style="border-bottom-width:0px;"><img src="images/col3.jpg" width="60" height="60" /></td>
            <td width="65" style="border-bottom-width:0px;"><img src="images/col2.jpg" alt="" width="60" height="60" /></td>
            <td width="65" style="border-bottom-width:0px;">&nbsp;</td>
            <td style="border-bottom-width:0px;">&nbsp;</td>
          </tr>
          <tr>
            <td style="border-bottom-width:0px;"><label>
              <input <?php if (!(strcmp($row_RecordTmp['tmproomviewcolumn'],"4"))) {echo "checked=\"checked\"";} ?> name="tmproomviewcolumn" type="radio" id="RadioGroup1_1" value="4" checked="checked" />
              風格1</label></td>
            <td style="border-bottom-width:0px;"><input <?php if (!(strcmp($row_RecordTmp['tmproomviewcolumn'],"3"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmproomviewcolumn" value="3" id="RadioGroup1_2" />
風格2</td>
            <td style="border-bottom-width:0px;"><input <?php if (!(strcmp($row_RecordTmp['tmproomviewcolumn'],"2"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmproomviewcolumn" value="2" id="RadioGroup1_3" />
風格3</td>
            <td style="border-bottom-width:0px;">&nbsp;</td>
            <td style="border-bottom-width:0px;">&nbsp;</td>
          </tr>
    ...
    <tr>
      ...
      <label for="tmproomboard"></label>
      <select name="tmproomboard" id="tmproomboard">
        <option value="base" <?php if (!(strcmp("base", $row_RecordTmp['tmproomboard']))) {echo "selected=\"selected\"";} ?>>基本</option>
        <option value="corner" <?php if (!(strcmp("corner", $row_RecordTmp['tmproomboard']))) {echo "selected=\"selected\"";} ?>>圓角</option>
        <option value="glass01" <?php if (!(strcmp("glass01", $row_RecordTmp['tmproomboard']))) {echo "selected=\"selected\"";} ?>>玻璃圓角</option>
        <option value="glass02" <?php if (!(strcmp("glass02", $row_RecordTmp['tmproomboard']))) {echo "selected=\"selected\"";} ?>>玻璃方角</option>
        <option value="pick" <?php if (!(strcmp("pick", $row_RecordTmp['tmproomboard']))) {echo "selected=\"selected\"";} ?>>切角</option>
        <option value="stamp" <?php if (!(strcmp("stamp", $row_RecordTmp['tmproomboard']))) {echo "selected=\"selected\"";} ?>>郵票</option>
        <option value="photographic" <?php if (!(strcmp("photographic", $row_RecordTmp['tmproomboard']))) {echo "selected=\"selected\"";} ?>>相紙A</option>
        <option value="photographic01" <?php if (!(strcmp("photographic01", $row_RecordTmp['tmproomboard']))) {echo "selected=\"selected\"";} ?>>相紙B</option>
        <option value="photographic02" <?php if (!(strcmp("photographic02", $row_RecordTmp['tmproomboard']))) {echo "selected=\"selected\"";} ?>>相紙C</option>
        <option value="photographic03" <?php if (!(strcmp("photographic03", $row_RecordTmp['tmproomboard']))) {echo "selected=\"selected\"";} ?>>相紙D</option>
        <option value="photographic04" <?php if (!(strcmp("photographic04", $row_RecordTmp['tmproomboard']))) {echo "selected=\"selected\"";} ?>>相紙E</option>
        <option value="photographic05" <?php if (!(strcmp("photographic05", $row_RecordTmp['tmproomboard']))) {echo "selected=\"selected\"";} ?>>相紙F</option>
        <option value="photographic06" <?php if (!(strcmp("photographic06", $row_RecordTmp['tmproomboard']))) {echo "selected=\"selected\"";} ?>>相紙G</option>
        <option value="photographic07" <?php if (!(strcmp("photographic07", $row_RecordTmp['tmproomboard']))) {echo "selected=\"selected\"";} ?>>相紙H</option>
        <option value="photographic08" <?php if (!(strcmp("photographic08", $row_RecordTmp['tmproomboard']))) {echo "selected=\"selected\"";} ?>>相紙I</option>
        <option value="photographic09" <?php if (!(strcmp("photographic09", $row_RecordTmp['tmproomboard']))) {echo "selected=\"selected\"";} ?>>相紙J</option>
      </select>
      </span><br /></td>
    </tr>
    <tr>
      ...
      <label for="tmproomboardicon"></label>
      <select name="tmproomboardicon" id="tmproomboardicon">
        <option value="" <?php if (!(strcmp("", $row_RecordTmp['tmproomboardicon']))) {echo "selected=\"selected\"";} ?>>-- 選擇圖示 --</option>
        <option value="photoFram_Block_glossy" <?php if (!(strcmp("photoFram_Block_glossy", $row_RecordTmp['tmproomboardicon']))) {echo "selected=\"selected\"";} ?>>仿玻璃</option>
        <option value="photoFram_Block_floral-corner" <?php if (!(strcmp("photoFram_Block_floral-corner", $row_RecordTmp['tmproomboardicon']))) {echo "selected=\"selected\"";} ?>>花紋A</option>
        <option value="photoFram_Block_heraldry" <?php if (!(strcmp("photoFram_Block_heraldry", $row_RecordTmp['tmproomboardicon']))) {echo "selected=\"selected\"";} ?>>花紋B</option>
        <option value="photoFram_Block_paper-clip" <?php if (!(strcmp("photoFram_Block_paper-clip", $row_RecordTmp['tmproomboardicon']))) {echo "selected=\"selected\"";} ?>>迴紋針</option>
        <option value="photoFram_Block_pin" <?php if (!(strcmp("photoFram_Block_pin", $row_RecordTmp['tmproomboardicon']))) {echo "selected=\"selected\"";} ?>>圖釘</option>
        <option value="photoFram_Block_tape" <?php if (!(strcmp("photoFram_Block_tape", $row_RecordTmp['tmproomboardicon']))) {echo "selected=\"selected\"";} ?>>膠帶</option>
        <option value="photoFram_Block_flower" <?php if (!(strcmp("photoFram_Block_flower", $row_RecordTmp['tmproomboardicon']))) {echo "selected=\"selected\"";} ?>>花和蝴蝶</option>
        <option value="photoFram_Block_leaf" <?php if (!(strcmp("photoFram_Block_leaf", $row_RecordTmp['tmproomboardicon']))) {echo "selected=\"selected\"";} ?>>葉子</option>
        <option value="photoFram_Block_clip" <?php if (!(strcmp("photoFram_Block_clip", $row_RecordTmp['tmproomboardicon']))) {echo "selected=\"selected\"";} ?>>夾子</option>
      </select>
      </span></td>
    </tr>
    <tr>
      <td align="right">標題文字顏色：</td>
      <td><span id="sprytextfield43">
      <label for="tmproomboardfontcolor"></label>
      <input name="tmproomboardfontcolor" type="text" class="color-picker" id="tmproomboardfontcolor" value="<?php echo $row_RecordTmp['tmproomboardfontcolor']; ?>" size="20"/>
      </span></td>
    </tr>
     <tr>
      <td align="right">&nbsp;</td>
