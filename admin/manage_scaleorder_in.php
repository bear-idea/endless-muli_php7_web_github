...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_scaleorder_in.php"); ?>
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include("require_manage_scaleorder_in_index.php");			
					break;
				case "viewpage2":
				...
				case "viewpage3":
					...
					break;
				case "outpage":
					include("require_manage_scaleorder_index_out.php");			
					break;
				case "addpage":
					include("require_manage_scaleorder_in_add.php");
					break;
				case "outaddpage":
					include("require_manage_scaleorder_add_out.php");
					break;
				case "outaddpage_old":
					include("require_manage_scaleorder_add_out_old_page.php");
					break;
				case "outeditpage":
					include("require_manage_scaleorder_edit_out.php");
					break;
				case "outaddnewpage":
					include("require_manage_scaleorder_add_out_new.php");
					break;
				case "outaddoldpage":
					include("require_manage_scaleorder_add_out_old.php");
					break;
				case "outaddoddpage":
					include("require_manage_scaleorder_add_out_old.php");
					break;
				...
				case "Sticker_qr":
					...
					break;	
				case "editpage":
					include("require_manage_scaleorder_in_edit.php"); 
					break;
				case "notes":
				...
				case "invoice":
					...
					break;
				case "export":
					include_once("require_manage_scaleorder_in_export.php");
					break;
				case "exportout":
