...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_careers.php"); ?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include_once("require_manage_careers_index.php");			
					break;
				case "addpage":
					include_once("require_manage_careers_add.php");
					break;
				case "editpage":
					include_once("require_manage_careers_edit.php"); 
					break;
				case "deletepage":
					include_once("require_manage_careers_delete.php");
					break;
				case "listpage":
					include_once("require_manage_careers_list.php");
					break;
				case "listitempage":
					include_once("require_manage_careers_listitem.php");
					break;
				case "configpage":
					include_once("require_manage_careers_config.php");
					break;
				default:
					include_once("require_manage_careers_index.php");
					break;
