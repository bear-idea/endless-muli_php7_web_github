...
$query_RecordForumListItem = sprintf("SELECT demo_forumitem.item_id, demo_forumlist.list_id, demo_forumlist.listname, demo_forumitem.itemname, demo_forumitem.itemvalue, demo_forumitem.lang FROM demo_forumlist LEFT OUTER JOIN demo_forumitem ON demo_forumlist.list_id = demo_forumitem.list_id WHERE demo_forumlist.list_id = %s && demo_forumitem.lang=%s && demo_forumitem.userid=%s ORDER BY demo_forumitem. sortid ASC", GetSQLValueString($collistid_RecordForumListItem, "int"),GetSQLValueString($collang_RecordForumListItem, "text"),GetSQLValueString($coluserid_RecordForumListItem, "int"));
...
<?php do { ?>
  <?php $data[$row_RecordForumListItem['itemvalue']] = $row_RecordForumListItem['itemname']; ?>
