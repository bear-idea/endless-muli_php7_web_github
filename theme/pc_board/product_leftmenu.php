...
<img src="<?php echo $SiteImgUrl; ?><?php echo $TmpLeftMenuWebName ?>/image/tmpleftmenu/<?php echo $TmpLeftMenuTitlePic ?>" style="display:block; margin:auto"/>
<?php } ?>
          ...
          <ul>
            ...
            <?php do { ?>
              <li class="<?php echo $row_RecordMultiLeftMenu_l2['endnode']; ?>">
                ...
                <a href="<?php echo $SiteBaseUrl . url_rewrite("product",array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'subpage','type1'=>$row_RecordMultiLeftMenu_l1['item_id'],'type2'=>$row_RecordMultiLeftMenu_l2['item_id']),'',$UrlWriteEnable);?>"><strong><?php echo $row_RecordMultiLeftMenu_l2['itemname']; ?></strong></a>
                <?php } else { ?>
