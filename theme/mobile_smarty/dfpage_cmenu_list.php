...
<?php //require("require_sharelink.php"); ?>
  <select name="jumpMenu" id="jumpMenu" onchange="MM_jumpMenu('parent',this,0)">
    ...
    <option value="<?php echo $SiteBaseUrl . url_rewrite('dfpage',array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'detailed','aid'=>$row_RecordDfPageCMenu['aid'],'type1'=>$row_RecordDfPageCMenu['type1'],'type2'=>$row_RecordDfPageCMenu['type2'],'type3'=>$row_RecordDfPageCMenu['type3']),'',$UrlWriteEnable);?><?php echo $id_params . $row_RecordDfPageCMenu['id']; ?>" <?php if (isset($_GET['id']) && $row_RecordDfPageCMenu['id'] == $_GET['id']){echo "selected=\"selected\"";} ?>><?php echo $row_RecordDfPageCMenu['title']; ?></option>
    <?php } else if ($row_RecordDfPageCMenu['type2'] != "-1") { ?>
    <option value="<?php echo $SiteBaseUrl . url_rewrite('dfpage',array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'detailed','aid'=>$row_RecordDfPageCMenu['aid'],'type1'=>$row_RecordDfPageCMenu['type1'],'type2'=>$row_RecordDfPageCMenu['type2']),'',$UrlWriteEnable);?><?php echo $id_params . $row_RecordDfPageCMenu['id']; ?>" <?php if (isset($_GET['id']) && $row_RecordDfPageCMenu['id'] == $_GET['id']){echo "selected=\"selected\"";} ?>><?php echo $row_RecordDfPageCMenu['title']; ?></option>
