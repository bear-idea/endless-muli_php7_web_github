  ...
  <?php 
    ...
    <?php if ($TmpWrpViewLineLocate == '2') { ?>               
        ...
        <section class="page-header page-header-xxs">
			...
			<?php echo $ModuleName['News']; ?>
			<!-- InstanceEndEditable --></h1>
            <!-- InstanceBeginEditable name="導覽列" -->
                                    <?php require("require_news_viewline_mobile.php"); ?>
                    <!-- InstanceEndEditable -->
        </section>
	...
	<?php } ?>
      ...
      <div class="row">      
        ...
        <?php
			...
			{
				case "viewpage":
					include_once("require_news.php");				
					break;
				case "search":
					include_once("require_news_search.php");				
					break;
				case "detailed":
					switch($MSNews)
					{	
						case '0':
							//include_once("require_news_detailed_base.php");
							//break;
						case '1':
							//include_once("require_news_detailed.php");
							//break;
						default:
							include_once("require_news_detailed.php");
							break;
