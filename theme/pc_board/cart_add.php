...
<div class="columns on-1">
        <div class="container">
            <div class="column">
                ...
                <h1 style="font-size:large"><?php if($TmpTitleBgImage != ''){ ?><span class="titlesicon" data-scroll-reveal="enter top"><img src="<?php if($SiteBaseUrlOuter != "" && $TmpTitleBgWebName == 'playweb') { echo $SiteImgUrlOuter; } else { echo $SiteImgUrl; } ?><?php echo $TmpTitleBgWebName; ?>/image/tmpbackground/<?php echo $TmpTitleBgImage; ?>" /></span><?php } ?> <span class="titlesicon" data-scroll-reveal="enter right"><?php echo $Lang_Title_Cart_Show; ?></span></h1>
                </div>
            </div>
        </div>        
</div>
          ...
          <tr>
            <td align="center"><table width="250" border="0" cellspacing="0" cellpadding="0">
              <tr>
                  ...
                  <td width="189"><?php echo $Lang_Classify_Exist_In_Shopping_List ?></td>
                </tr>
            </table></td>
          </tr>
          <tr>
