...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_about.php"); ?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "areapage":
					include_once("require_manage_about_area_index.php");			
					break;
				case "viewpage":
					include_once("require_manage_about_index.php");			
					break;
				case "viewpage_sub":
					include_once("require_manage_about_index_sub.php");			
					break;
				case "searchpage":
					include_once("require_manage_about_index_search.php");			
					break;
				case "viewpage_sl1":
					include_once("require_manage_about_index_sl1.php");			
					break;
				case "viewpage_sl2":
					include_once("require_manage_about_index_sl2.php");			
					break;
				case "viewpage_sl3":
					include_once("require_manage_about_index_sl3.php");			
					break;
				case "addpage":
				...
				case "editpage":
					...
					break;
				case "deletepage":
					include_once("require_manage_about_delete.php");
					break;
				case "listpage":
