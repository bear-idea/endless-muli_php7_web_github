...
div .product_inner_board_detailed{padding:2px;background-color:#FFFAF7;border:1px solid #DDD;height:100%}
.product_inner_board_detailed_title{padding:5px;background-color:#FEEFD1;background-repeat:repeat;font-weight:700; color:#000}
.Product_Detailed_Right_Board{border:0 solid #DDD}
.Product_Detailed_Right_Board tr td{padding:5px;border-bottom-style:dotted;border-color:#FFD5BF;border-width:1px}
.div_table-cell{overflow:hidden;height:380px;width:380px;text-align:center;vertical-align:middle;background-color:#FFF;border:1px solid #DDD}
...
.number_g{font-size:1.67em;height:18px;width:32px}
...
<div class="row">
                    ...
                    <table width="99%" border="0" cellspacing="0" cellpadding="0">
                      <?php if ($row_RecordProduct['pdseries'] !='') { ?>
                          ...
                          <?php } else { /* 判斷是否有折扣活動 */ ?>
                              ...
                              <?php } elseif ($row_RecordProduct['spprice'] !='') { ?>
                              <span id="Cg_SpPrice" style="color: #FF0000;"><?php echo $Lang_Classify_Context_Currency_units; ?><?php echo doFormatMoney($row_RecordProduct['spprice']); ?></span>
                              <?php } elseif ($row_RecordProduct['price'] !='') { ?>
                              <span id="Cg_SpPrice" style="color: #FF0000;"><?php echo $Lang_Classify_Context_Currency_units; ?><?php echo doFormatMoney($row_RecordProduct['price']); ?></span>
                              <?php } ?>
                          <?php } /* \判斷是否有折扣活動 */ ?>
                          </td>
                  ...
                  <div class="product_inner_board_detailed">
                  	<table width="99%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <?php if ($row_RecordProduct['inventoryshow'] == "1" && $row_RecordProduct['inventory'] != "" && $row_RecordProduct['inventory'] <= 50) {
                                    $invcount = $row_RecordProduct['inventory'];
                                } else {
                                    $invcount=50;
                                }?>
                    <script>
                    ...
                    <table width="99%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <a href="#" class="btn btn-3d btn-warning btn-lg" id="Cart_Add" onclick="AddtoCart('<?php echo $row_RecordProduct['id']; ?>','<?php if (isset($fmtpid)) {
                                    echo $fmtpid;
                                } ?>','0')" style="color:#FFF;"><i class="fa fa-cart-plus" aria-hidden="true"></i><?php echo $Lang_Classify_Context_Mail_Send_Add; ?></a>
                            ...
                            ?>
                            <a href="#" class="btn btn-3d btn-danger btn-lg" onclick="AddtoCart('<?php echo $row_RecordProduct['id']; ?>','<?php if (isset($fmtpid)) {
                                echo $fmtpid;
                            } ?>','<?php echo $gotoshowcart; ?>')" style="color:#FFF;"><i class="fa fa-cart-plus" aria-hidden="true"></i><?php echo $Lang_Classify_Context_Mail_Send_Pay; ?></a>
                  ...
                  <div class="product_inner_board_detailed">
                    <div class="product_inner_board_detailed_title">
                        ...
                        <table width="99%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            <td valign="top">
                            <span class="label label-light" style="color:#337ab7;font-weight:bolder;">
                            指定商品
                            </span>
                  ...
                  <div class="product_inner_board_detailed">
                    <!-- 右方詳細內容區塊標題 -->
                        <div class="product_inner_board_detailed_title acc_trigger">
                            付款與運送 <div style="float:right; "><?php if (($row_RecordSystemConfigOtr['sevenshopenable'] == '1' || $row_RecordSystemConfigOtr['sevenshopnopayenable'] == '1' || $row_RecordSystemConfigOtr['familyshopenable'] == '1' || $row_RecordSystemConfigOtr['familyshopnopayenable'] == '1') && $row_RecordSystemConfigOtr['allpaypaymentnumber'] != "") { ?><a data-toggle="tooltip" data-placement="top" title="便利超商"></a><?php } ?><?php if ($row_RecordSystemConfigOtr['allpaypaymentenable_Credit'] == '1' || $row_RecordSystemConfigOtr['allpaypaymentenable'] == '1' || $row_RecordSystemConfigOtr['pchomepaypaymentenable'] == '1' || $row_RecordSystemConfigOtr['paypalpaymentenable'] == '1') { ?><a data-toggle="tooltip" data-placement="top" title="信用卡"></a><?php } ?><?php if ($row_RecordSystemConfigOtr['atmpaymentenable'] == '1') { ?><a data-toggle="tooltip" data-placement="top" title="<?php echo $Lang_Classify_Context_Cart_ATM_Transfers; //ATM轉帳?>"></a><?php } ?><?php if ($row_RecordSystemConfigOtr['postofficepaymentenable'] == '1') { ?><a data-toggle="tooltip" data-placement="top" title="<?php echo $Lang_Classify_Context_Cart_Postal_Allocation; //郵政劃撥?>"></a><?php } ?><?php if ($row_RecordSystemConfigOtr['linguipaymentenable'] == '1') { ?><a data-toggle="tooltip" data-placement="top" title="<?php echo $Lang_Classify_Context_Cart_Financial_Remittance; //金融匯款?>"></a><?php } ?></div>
                      	</div>
                    <!-- 右方詳細內容區塊標題 END -->
                    <div class="acc_container">
                  ...
                  <?php if ($row_RecordProduct['skeyword'] != "" && $row_RecordProduct['skeywordindicate'] == 1) { ?>
                        ...
                        for ($i = 0; $i < count($arr_tag); $i++) {
                            echo "<a href=\"".$SiteBaseUrl . url_rewrite("product", array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'search'), '', $UrlWriteEnable).$tag_params.$arr_tag[$i] ."\">".$arr_tag[$i]."</a>";
                        }
...
<ul id="myTab" class="nav nav-tabs nav-top-border margin-top-10" role="tablist">
  ...
  <li role="presentation"><a href="#tabs-4" style="color:#000" role="tab" data-toggle="tab"><?php echo $Lang_Tab_FAQ_Product //問答紀錄 ?></a></li>
  <?php } ?>
</ul>
<div class="tab-content padding-top-20">
  ...
  <div id="tabs-4" class="tab-pane">
    <div>
      <?php require("require_productpost.php"); ?>
    </div>
    <div style=" clear:both; display:block"></div>
  </div>
  <?php } ?>
