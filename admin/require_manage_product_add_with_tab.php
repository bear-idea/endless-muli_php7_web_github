...
setcookie("Ck_Product_name", $_POST['name'],time()+3600); 
setcookie("Ck_Product_pdseries", $_POST['pdseries'],time()+3600); 
setcookie("Ck_Product_model", $_POST['model'],time()+3600); 
setcookie("Ck_Product_price", $_POST['price'],time()+3600); 
setcookie("Ck_Product_spprice", $_POST['spprice'],time()+3600);  
setcookie("Ck_Product_skeyword", $_POST['skeyword'],time()+3600);  
setcookie("Ck_Product_sdescription", $_POST['sdescription'],time()+3600);
setcookie("Ck_Product_content", $_POST['content'],time()+3600);
setcookie("Ck_Product_notes1", $_POST['notes1'],time()+3600);
}
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_Product")) {
  $insertSQL = sprintf("INSERT INTO demo_product (name, type1, type2, type3, pdseries, model, price, spprice, pricecheck, pic, skeyword, sdescription, skeywordindicate, content, indicate, plot, homeshow, notes1, lang, postdate, userid) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  setcookie("Ck_Product_name", "",time()-3600); 
  setcookie("Ck_Product_pdseries", "",time()-3600); 
  setcookie("Ck_Product_model", "",time()-3600); 
  setcookie("Ck_Product_price", "",time()-3600); 
  setcookie("Ck_Product_spprice", "",time()-3600);  
  setcookie("Ck_Product_skeyword", "",time()-3600);  
  setcookie("Ck_Product_sdescription", "",time()-3600);
  setcookie("Ck_Product_content", "",time()-3600);
  setcookie("Ck_Product_notes1", "",time()-3600);
...
<div class="panel panel-inverse panel-with-tabs"> 
  ...
  <div class="panel-heading p-0">
      ...
      <div class="tab-overflow">
          <ul class="nav nav-tabs nav-tabs-inverse">
              ...
              <li class="nav-item"><a href="#nav-tab-1" data-toggle="tab" class="nav-link active"><i class="fa fa-plus"></i> 基本資料</a></li>
  ...
  <div class="tab-content">
      ...
      <div class="tab-pane fade active show" id="nav-tab-1">
          ...
          <div class="col-md-10">
                      <input name="name" type="text" required class="form-control" id="name" value="<?php echo $_COOKIE['Ck_Product_name']; ?>" maxlength="200"/>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                    ...
                    <select name="type1" id="type1" class="form-control col-md-4" style="display:inline-block" required>
...
?>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      <input name="price" type="number" id="price" value="<?php echo $_COOKIE['Ck_Product_price']; ?>" maxlength="11" class="form-control col-md-4" min="0" max="9999999" /><?php if ($OptionCartSelect == '1') {?><small class="f-s-12 text-grey-darker">若不想啟用此商品購物功能，請將價格留空。</small><?php } ?>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      <input name="spprice" type="number" id="spprice" value="<?php echo $_COOKIE['Ck_Product_spprice']; ?>" maxlength="11" class="form-control col-md-4" min="0" max="9999999"/><?php if ($OptionCartSelect == '1') {?><small class="f-s-12 text-grey-darker">若不想啟用此商品購物功能，請將價格留空。</small><?php } ?>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
               <input id="pic" name="pic" type="file" size="50" maxlength="50" class="file" data-parsley-trigger="blur" required=""/>
