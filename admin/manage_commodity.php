...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_commodity.php"); ?>
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include_once("require_manage_commodity_index.php");			
					break;
				case "seo":
					include_once("require_manage_commodity_index_seo.php");			
					break;
				case "export":
					include_once("require_manage_commodity_export.php");			
					break;
				case "copypage":
					include_once("require_manage_commodity_copy.php");			
					break;
				case "inventory":
					include_once("require_manage_commodity_inventory.php");			
					break;
				case "viewpage_sub":
					include_once("require_manage_commodity_index_sub.php");			
					break;
				case "searchpage":
					include_once("require_manage_commodity_index_search.php");			
					break;
				case "photoviewpage":
					include_once("require_manage_commodity_photo_index.php");			
					break;
				case "photoaddpage":
					include_once("require_manage_commodity_photo_multi_add.php");			
					break;
				case "photoeditpage":
					include_once("require_manage_commodity_photo_edit.php");			
					break;
				case "postpage":
					include_once("require_manage_commodity_post_index.php");			
					break;
				case "postaddpage":
					include_once("require_manage_commodity_post_add.php");			
					break;
				case "posteditpage":
					include_once("require_manage_commodity_post_edit.php");			
					break;
				case "replypage":
					include_once("require_manage_commodity_reply_index.php");			
					break;
				case "replyaddpage":
					include_once("require_manage_commodity_reply_add.php");			
					break;
				case "replyeditpage":
					include_once("require_manage_commodity_reply_edit.php");			
					break;
				case "pluspage":
					include_once("require_manage_commodity_plus_index.php");			
					break;
				case "plusaddpage":
					include_once("require_manage_commodity_plus_add.php");			
					break;
				case "pluseditpage":
					include_once("require_manage_commodity_plus_edit.php");			
					break;
				case "formatpage":
					include_once("require_manage_commodity_formatlistitem.php");
					break;
				case "spformatpage":
					include_once("require_manage_commodity_spformatlistitem.php");
					break;
				case "postsearchpage":
					include_once("require_manage_commodity_post_search.php");			
					break;
				case "addpage":
					include_once("require_manage_commodity_add.php");
					break;
				case "editpage":
					include_once("require_manage_commodity_edit.php"); 
					break;
				case "edittabpage":
					include_once("require_manage_commodity_tab_edit.php"); 
					break;
				case "listpage":
					include_once("require_manage_commodity_list.php");
					break;
				case "listitempage":
					include_once("require_manage_commodity_listitem.php");
					break;
				case "mulilistitempage":
					include_once("require_manage_commodity_mulilistitem.php");
					break;
				case "mulilistitempage_adv":
					include_once("require_manage_commodity_mulilistitem_adv.php");
					break;
				case "advlistitempage":
					include_once("require_manage_commodity_advlilistitem.php");
					break;
				case "adminlistitempage":
					include_once("require_manage_commodity_adminlilistitem.php");
					break;
				case "sub_mulilistitempage":
					include_once("require_manage_commodity_mulilistitem_sub.php");
					break;
				case "sub_mulilistitempage_adv":
					include_once("require_manage_commodity_mulilistitem_sub_adv.php");
					break;
				case "configpage":
					include_once("require_manage_commodity_config.php");
					break;
				case "pricecheck":
					include_once("require_manage_commodity_pricecheck.php");
					break;
				case "pricecheck_st":
					include_once("require_manage_commodity_pricecheck_config.php");
					break;
				case "editpricecheck":
					include_once("require_manage_commodity_pricecheck_edit.php");
					break;
				case "editinventory":
					include_once("require_manage_commodity_inventory_edit.php");			
					break;
				case "datachange":
					include_once("require_manage_commodity_datachange.php");
					break;
				default:
					include_once("require_manage_commodity_index.php");
					break;
