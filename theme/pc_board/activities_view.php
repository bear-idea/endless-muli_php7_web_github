      ...
      ?>
          ...
          ?>
           <tr class= "<?php echo $chahgecolorcount; ?>">       
              <td width="<?php echo floor(($TmpWebWidth-200-$Tmp_Middle_L_M_Width-$Tmp_Middle_R_M_Width)/4); ?>" valign="middle" class="activities_down_board">
              <?php 
			  #
              # ============== [if] ============== #
			  #
			  ...
			  ?>
                ...
                <div class='<?php echo $TmpActivitiesBoardIcon; ?>'></div>
                  <div class="nailthumb-container"> <a href="<?php echo $SiteBaseUrl . url_rewrite("activities",array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'detailed','id'=>$row_RecordActivities['act_id']),'',$UrlWriteEnable);?>"><img src="<?php echo $SiteImgUrl; ?><?php echo $_GET['wshop']; ?>/image/activities/thumb/small_<?php echo  GetFileThumbExtend($row_RecordActivities['pic']);?>" /></a><span></span>
                    </div> 
                </div>  
                </div>
			  ...
			  ?>
              <div class="activities_inner_board" data-scroll-reveal="enter top after <?php echo $m_count/100; ?>s">
                <div class="photoFrame_<?php echo $TmpActivitiesBoard; ?>">
                <div class="activities_inner_board_relative">
                <div class='<?php echo $TmpActivitiesBoardIcon; ?>'></div>
                  <div class="nailthumb-container">	 
                        <a><img src="<?php echo $TplImagePath ?>/act_noimage.jpg"/></a><span></span>
                  </div> 
                </div>  
                </div>
                </div>
             ...
             <td align="left" valign="middle"  class="activities_down_board">
              ...
              ?>
                <span class="TipTypeStyle" data-scroll-reveal="enter top after 0.5s">[<?php echo highLight($row_RecordActivities['type'], @$_GET['searchkey'], $HighlightSelect); ?>]</span> 
              <?php 
              } 
              # 
			  # ============== [/if] ============== #
              ...
              if ($row_RecordActivities['photonum'] > 0 && $row_RecordActivities['pic'] != "") { 
			  ?>
              <span data-scroll-reveal="enter left after 0.2s"><a href="<?php echo $SiteBaseUrl . url_rewrite("activities",array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'detailed','id'=>$row_RecordActivities['act_id']),'',$UrlWriteEnable);?>"><?php echo $row_RecordActivities['title']; ?></a></span><br />
              <?php
			  #
			  # ============== [/if] ============== # 
			  #
			  ...
			  ?>
              <span data-scroll-reveal="enter left after 0.2s"><?php echo $row_RecordActivities['title']; ?></span><br />
              <?php 
              } 
              # 
			  # ============== [/else] ============== #
             ...
             <td valign="middle"  class="activities_down_board">
              ...
              if($row_RecordActivities['photonum'] != "") {
		  		...
		  		echo $row_RecordActivities['photonum'] . $Lang_Classify_Context_PhotoNum_Activities /*張相片*/ ;
				echo "</span>"; 
			  }
			  # 
			  # ============== [/if] ============== #
