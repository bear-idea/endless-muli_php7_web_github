...
<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>sqldatatable/js/scaleorder_price_datatable.js?<?php echo time(); ?>"></script>
<!-- ================== END Datatables JS ================== -->
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 資收日明細 <small>總覽</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
    ...
    <table id="data-table-default" class="table table-striped table-bordered table-hover table-condensed">
      <thead>
        <tr>
          ...
          <th width="150" data-priority="1"><strong>代碼</strong></th>
          <th width="100" data-priority="1"><strong>品項</strong></th>
          <th width="100" data-priority="1"><strong>聯單編號</strong></th>
          <th width="70" data-priority="1"><strong>淨重</strong></th>
          <th width="70" data-priority="1"><strong>單價</strong></th>
          <th width="70" data-priority="1"><strong>金額</strong></th>
...
$(document).ready(function() {
  $('input[name="postdate"]').daterangepicker({
	...
	startDate: "<?php $dt = new DateTime(); $dt->modify('first day of -2 month'); echo $dt->format('Y-m-d'); ?>",
    //endDate: "2016-11-28",
