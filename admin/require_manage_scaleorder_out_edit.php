...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Scaleorder_in")) {
  ...
  $updateGoTo = "manage_scaleorder_out.php?Opt=viewpage&lang=" . $_POST['lang'];
  /*if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 出庫物料 <small>修改</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
