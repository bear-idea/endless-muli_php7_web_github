...
<?php } ?>
      ...
      <?php $m_count=1; ?>
          <?php do { ?> 
                ...
                <div class="photoFrame_<?php echo $TmpProjectBoard; ?>">
                            ...
                            <?php } ?>
                                ...
                                <div class="partner_inner_board_context"><div class="shop-item-summary text-center"><?php echo $row_RecordPartner['name']; ?></div></div>
          ...
          <div style="height:10px;"></div>
                    <?php if($totalPages_RecordPartner > 0) { ?>
 				    <div class="col-md-7 col-xs-12">
                        <div style="text-align:center;">
                        <?php //if ($page > 0) { // Show if not first page ?>
                        <div class="col-md-3 col-xs-12">
                            <a href="<?php printf("%s?page=%d%s", $currentPage, 0, $queryString_RecordPartner); ?>" class="btn btn-reveal btn-white" style="width:100%; margin:2px;">
                        ...
                        <div class="col-md-3 col-xs-12">
                            <a href="<?php printf("%s?page=%d%s", $currentPage, max(0, $page-1), $queryString_RecordPartner); ?>" class="btn  btn-reveal btn-white" style="width:100%; margin:2px;">
                            <i class="fa fa-angle-left"></i>
                            <span><?php echo $Lang_Prev; ?></span>
                            </a> 
                        </div>
                        <div class="col-md-3 col-xs-12">
                            <a href="<?php printf("%s?page=%d%s", $currentPage, min($totalPages_RecordPartner, $page+1), $queryString_RecordPartner); ?>" class="btn  btn-reveal btn-white" style="width:100%; margin:2px;">
                        ...
                        <div class="col-md-3 col-xs-12">
                            <a href="<?php printf("%s?page=%d%s", $currentPage, $totalPages_RecordPartner, $queryString_RecordPartner); ?>" class="btn btn-reveal btn-white" style="width:100%; margin:2px;">
                        ...
                        <div> 
                            ...
                            <div style="margin:2px 0px 2px 0px;">
                                <select class="form-control" onchange="location = this.options[this.selectedIndex].value;">
                                    <?php for($i=0; $i<ceil($totalRows_RecordPartner/$maxRows_RecordPartner); $i++) { ?>
                                    <option value="<?php printf("%s?page=%d%s", $currentPage, $i,  $queryString_RecordPartner); ?>" <?php if($_GET['page'] == $i) { ?>selected="selected"<?php } ?>><?php echo $i+1; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            </div>
                            ...
                            <a href="#" class="btn btn-white" style="width:100%; margin:2px 0px 2px 0px;">
                                <span><?php echo $Lang_Content_Count_Total; ?><?php echo $totalRows_RecordPartner; ?><?php echo $Lang_Content_Count_Lots; ?></span>
                            </a>
                            </div>
                        </div>
                    </div>
