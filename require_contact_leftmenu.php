...
<div id="menu1" class="menuTree">
        ...
        <?php do { ?>
            ...
            <a href="contact.php?Opt=typepage&navi=<?php echo $_GET['navi']; ?>&lang=<?php echo $_SESSION['lang']; ?>&mtype=Contact&level=<?php echo $row_RecordMultiLeftMenu_l1['level']; ?>&type1=<?php echo $row_RecordMultiLeftMenu_l1['item_id']; ?>&subitem_id=<?php echo $row_RecordMultiLeftMenu_l1['subitem_id']; ?>"><?php echo $row_RecordMultiLeftMenu_l1['itemname']; ?>
            </a>
...
if (isset($_SESSON['userid'])) {
  $coluserid_RecordMultiLeftMenu_l2 = $_SESSON['userid'];
}
...
$totalRows_RecordMultiLeftMenu_l2 = mysqli_num_rows($RecordMultiLeftMenu_l2);
                    ...
                    <a href="contact.php?Opt=typepage&navi=<?php echo $_GET['navi']; ?>&lang=<?php echo $_SESSION['lang']; ?>&mtype=Contact&level=<?php echo $row_RecordMultiLeftMenu_l2['level']; ?>&type1=<?php echo $row_RecordMultiLeftMenu_l1['item_id']; ?>&type2=<?php echo $row_RecordMultiLeftMenu_l2['item_id']; ?>&subitem_id=<?php echo $row_RecordMultiLeftMenu_l2['subitem_id']; ?>"><?php echo $row_RecordMultiLeftMenu_l2['itemname']; ?>
                    </a>
...
$totalRows_RecordMultiLeftMenu_l3 = mysqli_num_rows($RecordMultiLeftMenu_l3);
						...
						<?php do { ?>
                          <li class="<?php echo $row_RecordMultiLeftMenu_l3['endnode']; ?>">
                            <a href="contact.php?Opt=typepage&navi=<?php echo $_GET['navi']; ?>&lang=<?php echo $_SESSION['lang']; ?>&mtype=Contact&level=<?php echo $row_RecordMultiLeftMenu_l3['level']; ?>&type1=<?php echo $row_RecordMultiLeftMenu_l1['item_id']; ?>&type2=<?php echo $row_RecordMultiLeftMenu_l2['item_id']; ?>&type3=<?php echo $row_RecordMultiLeftMenu_l3['item_id']; ?>&subitem_id=<?php echo $row_RecordMultiLeftMenu_l3['subitem_id']; ?>"><?php echo $row_RecordMultiLeftMenu_l3['itemname']; ?>
                              </a>
                          </li>
