...
$.ajax({
		type: "POST",
		url: "sqlgettmp/mainmenu_get_rwd.php?id=<?php echo $row_RecordTmpMainMenuShow['id']; ?>&userid=<?php echo $w_userid; ?>&TmpDftMenu_Y=<?php echo $TmpDftMenu_Y; ?>&TmpDftMenu_X=<?php echo $TmpDftMenu_X; ?>&TmpPicMenu_X=<?php echo $TmpPicMenu_X; ?>&TmpPicMenu_Y=<?php echo $TmpPicMenu_Y; ?>&TmpW=<?php echo ($TmpWebWidth+$Tmp_Wrp_R_M_Width+$Tmp_Wrp_L_M_Width).$TmpWebWidthUnit; ?>",
