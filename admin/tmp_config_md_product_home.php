...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Tmp")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmphomeproductmod=%s, tmphomeproductshowtype=%s WHERE id=%s",
                       GetSQLValueString($_POST['tmphomeproductmod'], "int"),
					   GetSQLValueString($_POST['tmphomeproductshowtype'], "int"),
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post" id="form_Tmp" name="form_Tmp">
       ...
       <div class="form-group row">
          <label class="col-md-2 col-form-label ">顯示模式<span class="text-red">*</span></label>
          <div class="col-md-10">
              <select name="tmphomeproductmod" id="tmphomeproductmod" class="form-control" data-parsley-trigger="blur" required="">
                  <option value="0" <?php if (!(strcmp(0, $row_RecordTmp['tmphomeproductmod']))) {echo "selected=\"selected\"";} ?>>隨機顯示</option>
                  <option value="1" <?php if (!(strcmp(1, $row_RecordTmp['tmphomeproductmod']))) {echo "selected=\"selected\"";} ?>>自訂顯示</option>
                </select>  
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
              <select name="tmphomeproductshowtype" id="tmphomeproductshowtype" class="form-control" data-parsley-trigger="blur" required="">
                  <option value="0" <?php if (!(strcmp(0, $row_RecordTmp['tmphomeproductshowtype']))) {echo "selected=\"selected\"";} ?>>全部產品</option>
                  <option value="1" <?php if (!(strcmp(1, $row_RecordTmp['tmphomeproductshowtype']))) {echo "selected=\"selected\"";} ?>>分類顯示</option>
                </select>  
