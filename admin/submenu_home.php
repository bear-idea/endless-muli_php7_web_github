...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE demo_setting_fr SET subnamereplaceenable=%s WHERE id=%s",
                       GetSQLValueString($_POST['subnamereplaceenable'], "int"),
...
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordSettingFr = "SELECT id, userid, lang, subnamereplaceenable FROM demo_setting_fr WHERE userid = $w_userid";
...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-without-sidebar p-0">
  ...
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 欄位 <small>設定</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post" id="form_Tmp" name="form_Tmp">
       <div class="form-group row">
        ...
        <div class="col-md-12"><span class="badge badge-primary"><i class="fa fa-paper-plane"></i> 標題名稱</span></div>
      </div>
      <div class="form-group row">
          <label class="col-md-2 col-form-label">初始值<span class="text-red">*</span><i class="fa fa-info-circle text-orange" data-original-title="是否使用選單名稱。" data-toggle="tooltip" data-placement="top"></i></label>                       	
          <div class="col-md-10">
          
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordSettingFr['subnamereplaceenable'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="subnamereplaceenable" id="subnamereplaceenable_0" value="0" />
                <label for="subnamereplaceenable_0">統一使用自訂欄位標題</label>
            </div>
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordSettingFr['subnamereplaceenable'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="subnamereplaceenable" id="subnamereplaceenable_1" value="1" />
                <label for="subnamereplaceenable_1">依主選單名稱來做改變</label>
            </div>
