...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Tmp")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmpbannerpicwidth=%s, tmpbannerpicheight=%s, tmpbanner=%s, tmpbannerselect=%s, tmpbannerpaddingtop=%s, tmpbannerpaddingbttom=%s, tmpbannerpaddingleft=%s, tmpbannerpaddingright=%s WHERE id=%s",
                       ...
                       GetSQLValueString($_POST['tmpbannerselect'], "int"),
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-heading">
    ...
    <div class="btn-group pull-right"><a href="javascript:void(0);" onclick="startIntro();" data-original-title="教學導引 Step By Step" data-toggle="tooltip" data-placement="top" id="startButton" class="btn btn-default btn-sm"><i class="far fa-comment-alt fa-fw"></i> 導覽</a><a href="tmp_config_<?php echo $row_RecordTmp['name']; // 為版型風格?>.php?lang=<?php echo $_SESSION['lang']; ?>&amp;id_edit=<?php echo $row_RecordTmp['id']; ?>" data-original-title="" data-toggle="tooltip" data-placement="top" class="btn btn-default btn-sm"><i class="fa fa-reply fa-fw"></i> 上一頁</a></div>
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post" id="form_Tmp" name="form_Tmp">
      <div class="form-group row">
        ...
        <div class="col-md-12"><span class="badge badge-primary"><i class="fa fa-paper-plane"></i> 橫幅區塊 <i class="fa fa-info-circle text-white" data-original-title="您必須先選擇要使用的橫幅模式送出您的填寫資料，之後可依照您所選取的模式，點選《橫幅設定》按鈕後可上傳您的圖片。" data-toggle="tooltip" data-placement="top"></i></span></div>
      </div>
      
      <div class="form-group row" id="Step_Select">
          <label class="col-md-2 col-form-label">橫幅模式<span class="text-red">*</span></label>
          <div class="col-md-10">
                      <div class="radio radio-css radio-inline" id="Step_None">
                <input <?php if (!(strcmp($row_RecordTmp['tmpbanner'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpbanner" id="tmpbanner_2" value="0" />
                <label for="tmpbanner_2">不顯示</label>
            </div>
            <br>
            <div class="radio radio-css radio-inline" id="Step_All">
                <input <?php if (!(strcmp($row_RecordTmp['tmpbanner'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpbanner" id="tmpbanner_1" value="1" />
                <label for="tmpbanner_1">使用公版橫幅(多圖輪播、僅支援JPG) <i class="fa fa-info-circle text-orange" data-original-title="此選項代表選擇此項目的樣板皆使用一個統一的橫幅，而此橫幅之圖片可在在後台首頁的《輪播系統》中修改，並且可在其功能中設定各圖片的轉場特效。" data-toggle="tooltip" data-placement="top"></i> <a href="manage_ads.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>" target="_top" class="btn btn-primary btn-xs" id="Step_Add">前往內頁輪播橫幅設定 <i class="fa fa-chevron-circle-right"></i></a></label>
            </div>
            <br>
            <div class="radio radio-css radio-inline" id="Step_Tmp">
                <input <?php if (!(strcmp($row_RecordTmp['tmpbanner'],"2"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpbanner" id="tmpbanner_3" value="2" />
                <label for="tmpbanner_3">使用樣版橫幅(多圖輪播、僅支援JPG) <i class="fa fa-info-circle text-orange" data-original-title="此選項代表目前此樣板使用之橫幅，其他的樣版並不會套用，並且可在其功能中設定各圖片的轉場特效且不限制您的上傳圖片數量，但不建議上傳過多，過多圖片可能會導致網頁載入過慢。" data-toggle="tooltip" data-placement="top"></i> <a href="" class="btn btn-primary btn-xs">設定目前版型輪播橫幅 <i class="fa fa-chevron-circle-right"></i></a></label>
            </div>
            <br>
            <div class="radio radio-css radio-inline" id="Step_Only">
                <input <?php if (!(strcmp($row_RecordTmp['tmpbanner'],"3"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpbanner" id="tmpbanner_4" value="3" />
                <label for="tmpbanner_4">使用單圖橫幅</label>
            </div>
            
            <div class="alert alert-secondary fade show m-t-10 m-l-25">
              <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmpbannerselect'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpbannerselect" id="tmpbannerselect_1" value="1" />
                <label for="tmpbannerselect_1">預設圖片 <a href="bannershow_home.php?lang=<?php echo $_SESSION['lang']; ?>&amp;id_edit=<?php echo $row_RecordTmp['id']; ?>" class="btn btn-primary btn-xs">選擇圖片 <i class="fa fa-chevron-circle-right"></i></a></label>
              </div>
              <br>
              <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmpbannerselect'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpbannerselect" id="tmpbannerselect_2" value="0" />

                <label for="tmpbannerselect_2">自訂圖片(支援Gif / Flash / Jpg，僅能上傳單張/個) <i class="fa fa-info-circle text-orange" data-original-title="當您使用Flash及圖片時不要忘了填寫寬高，某些版本瀏覽器並無法自動判斷寬高(例如:IE)，建議填寫。" data-toggle="tooltip" data-placement="top"></i></label>
              </div>
                    ...
                    <div class="col-md-2">
                        <div class="input-group p-0">
                          ...
                          <div class="input-group-prepend"><span class="input-group-text">寬度</span></div>
                              <input name="tmpbannerpicwidth" class="form-control" id="tmpbannerpicwidth" value="<?php echo $row_RecordTmp['tmpbannerpicwidth']; ?>" maxlength="5" data-parsley-min="800" data-parsley-max="2000" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                     ...
                     <div class="col-md-2">
                        <div class="input-group p-0">
                          ...
                          <div class="input-group-prepend"><span class="input-group-text">高度</span></div>
                              <input name="tmpbannerpicheight" class="form-control" id="tmpbannerpicheight" value="<?php echo $row_RecordTmp['tmpbannerpicheight']; ?>" maxlength="5" data-parsley-min="0" data-parsley-max="500" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                                  <div class="input-group-append"><span class="input-group-text">px</span></div>                
                          </div>
                      ...
                      <div class="col-md-2">
                      <a href="uplod_tmpbannerpic.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;lang=<?php echo $_GET['lang']; ?>" class="btn btn-primary">選擇圖片 <i class="fa fa-chevron-circle-right"></i></a>
                      </div>
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">內距</label>
          <div class="col-md-2">
            <div class="input-group p-0">
            
              <div class="input-group-prepend"><span class="input-group-text">上</span></div>
                  <input name="tmpbannerpaddingtop" class="form-control" id="tmpbannerpaddingtop" value="<?php echo $row_RecordTmp['tmpbannerpaddingtop']; ?>" maxlength="3" data-parsley-min="0" data-parsley-max="50" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                      <div class="input-group-append"><span class="input-group-text">px</span></div>                
              </div>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">下</span></div>
                  <input name="tmpbannerpaddingbttom" class="form-control" id="tmpbannerpaddingbttom" value="<?php echo $row_RecordTmp['tmpbannerpaddingbttom']; ?>" maxlength="3" data-parsley-min="0" data-parsley-max="50" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                     <div class="input-group-append"><span class="input-group-text">px</span></div>                 
              </div>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">左</span></div>
                  <input name="tmpbannerpaddingleft" class="form-control" id="tmpbannerpaddingleft" value="<?php echo $row_RecordTmp['tmpbannerpaddingleft']; ?>" maxlength="3" data-parsley-min="0" data-parsley-max="50" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                  <div class="input-group-append"><span class="input-group-text">px</span></div>                    
              </div>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">右</span></div>
                  <input name="tmpbannerpaddingright" class="form-control" id="tmpbannerpaddingright" value="<?php echo $row_RecordTmp['tmpbannerpaddingright']; ?>" maxlength="3" data-parsley-min="0" data-parsley-max="50" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                    <div class="input-group-append"><span class="input-group-text">px</span></div>                  
              </div>
        ...
        var intro = introJs();
          intro.setOptions({
            steps: [
			  ...
			  {
                element: '#Step_All',
                intro: '<img src="images/tip/tip077.jpg" width="500" height="232" /><br /><br />可上傳多張圖片作播放，設定完橫幅後，所有版型選擇此項目皆會套用，一般皆建議選擇此項目設定。'
              },
			  {
                element: '#Step_Tmp',
                intro: '<img src="images/tip/tip078.jpg" width="500" height="164" /><br /><br />可上傳多張圖片作播放，設定完橫幅後，僅會對目前的版型作套用。'
              },
			  {
                element: '#Step_Only',
                intro: '單張圖片上傳，但支援多種圖片格式及Flash。'
              },
			  {
                element: '#Step_Send',
                intro: '送出修改。'
