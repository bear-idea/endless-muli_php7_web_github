...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Knowledge") && $_POST['sdescription'] == "") { 
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Knowledge")) {
  $updateSQL = sprintf("UPDATE demo_knowledge SET name=%s, type1=%s, type2=%s, type3=%s, content=%s, indicate=%s, skeyword=%s, sdescription=%s, notes1=%s, lang=%s, userid=%s WHERE id=%s",
  ...
  $updateGoTo = "manage_knowledge.php?Opt=viewpage&lang=" . $_POST['lang'];
  /*if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> <?php echo $ModuleName['Knowledge']; ?> <small>修改</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post">
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="name" type="text" class="form-control" id="name" value="<?php echo $row_RecordKnowledge['name']; ?>" maxlength="200" data-parsley-trigger="blur" required=""/>
...
?>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">      
          <a href="uplod_knowledge.php?id_edit=<?php echo $row_RecordKnowledge['id']; ?>&amp;lang=<?php echo $_GET['lang']; ?>" class="btn btn-warning colorbox_iframe_cd"><i class="fa fa-image"></i> 圖片修改</a>                    
        </div>
      </div>
