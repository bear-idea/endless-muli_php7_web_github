...
?>
                     ...
                     <td><div class="QapTcha"></div></td>
                      ...
                      <tr>
                        ...
                        <input name="author" type="hidden" id="author" value="<?php echo $_SESSION['MM_Username_' . $_GET['wshop']]; ?>" /></td>
                      </tr>
  ...
  <tr>
    <td align="center"><table width="300" border="0" cellspacing="0" cellpadding="0">
      <tr>
          ...
          <td>您必須<a href="<?php echo $SiteBaseUrl . url_rewrite('member',array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'log'),'',$UrlWriteEnable);?>">登入會員</a>才可發表主題<br />
若您尚未加入會員，請<a href="<?php echo $SiteBaseUrl . url_rewrite('member',array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'reg'),'',$UrlWriteEnable);?>">點此註冊 </a></td>
        </tr>
    </table></td>
  </tr>
  <tr>
