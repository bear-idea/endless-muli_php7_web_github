...
<!-- ================== BEGIN Chart CSS ================== -->
<link href="<?php if($SiteBaseUrlOuter != "") { echo $SiteBaseUrlOuter . $SiteBaseAdminPath; } else { echo $SiteBaseUrl . $SiteBaseAdminPath; } ?>assets/plugins/nvd3/build/nv.d3.min.css" rel="stylesheet" />
<!-- ================== END Chart CSS ================== -->
...
<script src="<?php if($SiteBaseUrlOuter != "") { echo $SiteBaseUrlOuter . $SiteBaseAdminPath; } else { echo $SiteBaseUrl . $SiteBaseAdminPath; } ?>assets/plugins/nvd3/build/nv.d3.min.js"></script>
<!-- ================== END Chart JS ================== -->

<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 月統計圖 <small>總覽</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-body">
    <form id="form" name="form" method="get" action="<?php echo $editFormAction; ?>">
    <div class="row justify-content-end">
      <div class="col-md-3 col-sm-12 m-b-10">
          <div class="input-group" data-column="11">
              ...
              <input name="postdate" type="text" class="form-control search_filter" placeholder="" id="postdate" autocomplete="off"/>		
          </div>
      </div>
      
      <div class="col-md-2 col-sm-12 m-b-10">
        <div class="input-group" data-column="8"> <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 供應商</span></span>
            <select name="manufacturer" class="form-control search_filter" id="col8_filter">
            <option value="" selected="selected">全部</option>
              <?php
do {  
?>
                  <option value="<?php echo $row_RecordManufacturer['name']?>"><?php echo $row_RecordManufacturer['name']?></option>
                  <?php
...
?>
      ...
      <div class="col-md-2 col-sm-12 m-b-10">
        <div class="input-group" data-column="9"> <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 車號</span></span>
            <select name="carnumber" class="form-control search_filter" id="col9_filter">
            <option value="" selected="selected">全部</option>
              <?php
do {  
?>
...
$(document).ready(function() {
  ...
  $('#postdate').datetimepicker({
	   defaultDate: "<?php $dt = new DateTime(); echo $dt->format('Y'); ?>",
...
var handleBarChart = function() {
    ...
    var barChartData = [{
        ...
        values: [
			 ...
			 for($i_month=1; $i_month<=12; $i_month++){
			 	require("require_manage_scaleorder_clearance_chart_month_weight.php"); 
			 }
			 ?>
        ]
    }];
    ...
    nv.addGraph(function() {
        ...
        barChart.yAxis.axisLabel("重量(kg)");
        barChart.xAxis.axisLabel('月份');
