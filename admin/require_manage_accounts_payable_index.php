...
<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>sqldatatable/js/accounts_payabledetail_datatable.js"></script>
<!-- ================== END Datatables JS ================== -->
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 應付帳款 <small>總覽</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
  ...
  <div class="panel-body">
    ...
    <div class="col-md-3 col-sm-12 m-b-10">
      ...
      <div class="col-md-2 col-sm-12 m-b-10">
        <div class="input-group" data-column="2"> <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 付款廠商</span></span>
            <select name="suppliercode" class="form-control search_filter" id="col2_filter">
    ...
    <table id="data-table-default" class="table table-striped table-bordered table-hover table-condensed">
      <thead>
        <tr>
          ...
          <th width="-1" data-priority="1"><strong>付款廠商</strong></th>
          <th width="100" data-priority="1"><strong>廠商代碼</strong></th>
