...
<div class="columns on-1">
    ...
    <div class="column">
      <div class="container ct_board">
		...
		?>
              <?php if ($totalRows_RecordCartListFreight > 0 || $row_RecordSystemConfigOtr['sevenshopenable'] == '1' || $row_RecordSystemConfigOtr['sevenshopnopayenable'] == '1' || $row_RecordSystemConfigOtr['familyshopenable'] == '1' || $row_RecordSystemConfigOtr['familyshopnopayenable'] == '1') { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 padding-10" style="border:#EEE solid 1px; background-color:#FFF;">
                   ...
                   <?php if ($row_RecordSystemConfigOtr['pchomepaypaymentenable'] == '1') { ?>
                    ...
                    <?php do { ?>
                      ...
                      <label class="radio" style="line-height:37px; ">
                          ...
                          <?php echo $row_RecordCartListPayment['itemname']; ?></label>
                      </div>    
                          <?php 
					  /*****************************************************************************************/
					  // \自訂付款方式
              ...
              <div class="form-group text-center" >
                    ...
                    <input type="reset" name="button" id="button" value="<?php echo $Lang_Classify_Refill ?>" class="btn btn-3d btn-white btn-block"/>
                  
                    <input type="button" name="button3" id="button3" value="<?php echo $Lang_Classify_Prev ?>" onclick="history.back(-1)" class="btn btn-3d btn-white btn-block"/>
                  
                    <input type="submit" name="button2" id="button2" value="<?php echo $Lang_Classify_Next ?>" onclick="return CheckFields();" class="btn btn-3d btn-white btn-block"/>
