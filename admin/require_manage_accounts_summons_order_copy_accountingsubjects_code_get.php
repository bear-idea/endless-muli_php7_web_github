...
<?php
	...
	for($i=$row_RecordAccounts_summonsListType['level']-1; $i>=0; $i--){
		...
		if($row_RecordAccounts_summonsListType['item_id'] == '' || $row_RecordAccounts_summonsListType['item_id'] == NULL) { $row_RecordAccounts_summonsListType['item_id'] = '-1';}
		$accountingsubjects[$row_RecordAccounts_summonsListType['level']] = $row_RecordAccounts_summonsListType['item_id'];
	}
	
	//$accountingsubjects[0];
	//$accountingsubjects[1];
	//$accountingsubjects[2];
	//$accountingsubjects[3];
	//echo $_GET['itemvalue'];
