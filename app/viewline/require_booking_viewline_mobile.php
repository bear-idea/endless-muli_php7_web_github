<ol class="breadcrumb hidden-xs" data-scroll-reveal='enter top after 0.8s'>
  ...
  <li>
  <a href="<?php echo $SiteBaseUrl . url_rewrite('contact',array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'viewpage'),'',$UrlWriteEnable);?>"><?php echo $ModuleName['Booking']; //聯絡我們 ?></a></li>
</ol>