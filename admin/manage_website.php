...
?>
<?php require("require_manage_reserve_room_del.php"); // 刪除2個月前資料?>
...
<script type="text/javascript" src="js/Highcharts-4.2.1/js/modules/exporting.js"></script>
<script src="js/Highcharts-4.2.1/js/highcharts-3d.js"></script>
<script>
jQuery(function($){
  ...
  $(function() {
	...
	$( "#spacedate, #dpaydate, #payenddate" ).datepicker({
      defaultDate: "+1w",
      changeMonth: true,
      changeYear: true,
      numberOfMonths: 1,
...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_website.php"); ?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include_once("require_manage_website_index.php");			
					break;
				case "chartpage":
					include_once("require_manage_website_chart.php");
					break;
				case "chartpage_sitenum":
					include_once("require_manage_website_chart_show_sitenum.php");
					break;
				case "addpage":
					include_once("require_manage_website_add.php");
					break;
				case "editpage":
					include_once("require_manage_website_edit.php"); 
					break;
				case "deletepage":
					include_once("require_manage_website_delete.php");
					break;
				case "listpage":
					include_once("require_manage_website_list.php");
					break;
				case "listitempage":
					include_once("require_manage_website_listitem.php");
					break;
				case "configpage":
					include_once("require_manage_website_config.php");
					break;
				case "paypage":
					include_once("require_manage_website_paydetail_index.php");			
					break;
				case "payaddpage":
					include_once("require_manage_website_paydetail_add.php");			
					break;
				case "payeditpage":
					include_once("require_manage_website_paydetail_edit.php");			
					break;
				case "payviewpage":
					include_once("require_manage_website_paydetail_view.php");			
					break;
				default:
					include_once("require_manage_website_index.php");
					break;
