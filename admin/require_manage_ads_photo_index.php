...
<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>sqldatatable/js/adtype_datatable_photo.js"></script>
<!-- ================== END Datatables JS ================== -->
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 輪播圖片 <small>總覽</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-heading">
    ...
    <div class="btn-group pull-right"><a href="inner_ads.php?wshop=<?php echo $wshop; ?>&amp;Opt=photoaddpage&amp;lang=<?php echo $_SESSION['lang']; ?>&amp;act_id=<?php echo $_GET['act_id']; ?>" class="btn btn-default btn-sm"><i class="fa fa-plus"></i> 新增</a></div>
    <h4 class="panel-title"><i class="fa fa-database"></i> 圖片一覽</h4>
  </div>
  <!-- end panel-heading --> 
  <!-- begin panel-body -->
    ...
    <table id="data-table-default" class="table table-striped table-bordered" style="width:100%">
      <thead>
        <tr>
          ...
          <th width="120" data-priority="1">圖片</th>
          <th><strong>描述</strong></th>
          <th width="1%">放置位置</th>
          <th width="100"><strong>動畫效果</strong></th>
...
<script>
	...
	$(document).ready(function() {
		TableManageDefault.init(<?php echo $_GET['act_id']?>);		
	});
</script>
