...
window.onload = function()
{
	...
	CKEDITOR.replace( 'content',{width : '700px', toolbar : 'Full'} );
};
</script>
...
<div style="padding:10px; margin:10px; position:relative; min-width:1000px;" id="wrapper_config">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="TB_General_style01">
      ...
      <td><?php echo $row_RecordTmpColumn['dftname']; ?> <span class = "InnerPage" style="float:none;"><a href="#" data-original-title="注意此區塊寬度為700px，您在填寫內容必須以此寬度為基準。" data-toggle="tooltip" data-placement="right">?</a></span></td>
    </tr>
    <tr>
