...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_tickets.php"); ?>
    	<!-- InstanceEndEditable -->
  ...
  <div id="content_full" class="content" style="padding:15px">
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			switch($_GET['Opt_Tickets'])
			{
				case "viewpage":
					include_once("require_manage_tickets_index.php");			
					break;
				case "addpage":
					include_once("require_manage_tickets_add.php");
					break;
				case "multiaddpage":
					include_once("require_manage_tickets_multiadd.php");
					break;
				case "editpage":
					include_once("require_manage_tickets_edit.php"); 
					break;
				case "tbviewpage":
					include_once("require_manage_tickets_tb_index.php");			
					break;
				case "ctbviewpage":
					include_once("require_manage_tickets_tb_view.php");			
					break;
				case "tbaddpage":
					include_once("require_manage_tickets_tb_add.php");
					break;
				case "tbeditpage":
					include_once("require_manage_tickets_tb_edit.php");
					break;
				case "deletepage":
					include_once("require_manage_tickets_delete.php");
					break;
				case "listpage":
					include_once("require_manage_tickets_list.php");
					break;
				case "listitempage":
					include_once("require_manage_tickets_listitem.php");
					break;
				default:
					include_once("require_manage_tickets_index.php");
					break;
