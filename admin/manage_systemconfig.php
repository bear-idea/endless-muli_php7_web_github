...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_systemconfig.php"); ?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "settingpage":
					include_once("require_manage_systemconfig_index.php");			
					break;
				case "settingpage_fr":
					include_once("require_manage_systemconfig_fr_index.php");
					break;
				case "ms":
					include_once("require_manage_systemconfig_ms_index.php");
					break;
				case "settingpage_otr":
					include_once("require_manage_systemconfig_otr_index.php"); 
					break;
				case "deletepage":
					include_once("require_manage_systemconfig_delete.php");
					break;
				case "listpage":
					include_once("require_manage_systemconfig_list.php");
					break;
				case "listitempage":
					include_once("require_manage_systemconfig_listitem.php");
					break;
				default:
					include_once("require_manage_systemconfig_index.php");
					break;
