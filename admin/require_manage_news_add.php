...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> <?php echo $ModuleName['News']; ?> <small>新增</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
          ...
          <div class="col-md-10">
                    <select name="author" id="author" class="form-control" data-parsley-trigger="blur" required="">
                      ...
                      <?php
						do {
						?>
											  <option value="<?php echo $row_RecordNewsListAuthor['itemname']?>"><?php echo $row_RecordNewsListAuthor['itemname']?></option>
											  <?php
