var handleDataTableDefault = function(aid) {
    ...
    if ($('#data-table-default').length !== 0) {
        ...
        var otable = $('#data-table-default').DataTable({       
            ...
            "autoWidth": false,
            "ajax": {
                "url": "sqldatatable/accounts_summonsbook_detailledger_view.php?aid=" + aid,
                "type": "post",
				"data": function ( d ) {
            ...
            "fnDrawCallback": function(oSettings) {
                ...
                $('#data-table-default').editable({
                    selector: ".ed_notes1",
                    url: 'sqledit/accounts_summonsbook_detailledger_jedit.php',
                    type: 'text',
                    name: 'notes1',
                    //title: '輸入標題',
    ...
    swal({
        ...
        preConfirm: function() {
            return new Promise(function(resolve) {
                ...
                $.ajax({
                    url: "sqldatatable/accounts_summonsbook_detailledger_del.php?id_del=" + id,
                    type: "GET"
        ...
        swal({
            ...
            preConfirm: function() {
                return new Promise(function(resolve) {
                    ...
                    $.ajax({
                        url: "sqldatatable/accounts_summonsbook_detailledger_del_muti.php",
                        data: {
                            id: list_id
                        },
                        type: "POST"
