...
#v_wrp{width:600px; margin-left:auto; margin-right:auto; margin-top:10px; border:#CCC dotted 1px; position:relative; padding-right:20px; padding-bottom:20px; padding-top:20px; padding-left:20px; background-position:center center; background-repeat:no-repeat}
...
#v_wrp_l_column{border:#CCC dotted 1px; margin:5px; float:right; width:200px; position:relative; min-height:700px}
...
#v_wrp_middle{border:#CCC dotted 1px; margin:5px; margin-right:215px; position:relative; min-height:700px}
    ...
    <tr>
      <td>
       ...
       <div id="v_out_wrp">
        ...
        <div id="v_wrp_header">
        <span style="position: absolute; top: -80px; left: -160px; border: #CCC dotted 1px; padding: 5px;"><img src="images/sty05.jpg" width="100" height="100" /><br />
        ...
        <span style="position: absolute; top: 57px; right: -259px;">
        ...
        <a href="tmpwrpbackground_home.php?id=<?php echo $row_RecordTmp['id']; ?>&amp;type=拼貼材質" data-original-title="選擇您要更換的背景" data-toggle="tooltip" data-placement="right" class="btn btn-primary btn-xs btn-block">背景選擇</a>
            ...
            <div id="v_wrp_banner">
            <span style="position: absolute; top: 65px; right: -31px;">
        	<img src="images/z_line_c.png" width="36" height="1" /> 
        </span>
            <span style="margin-right: 5px; margin-top: 35px; padding: 5px; border: #CCC dotted 1px;  position: absolute; top: 3px; right: -150px;">
        ...
        <a href="tmpleftbackground_home.php?id=<?php echo $row_RecordTmp['id']; ?>&amp;type=拼貼材質" data-original-title="選擇您要更換的背景" data-toggle="tooltip" data-placement="right" class="btn btn-primary btn-xs btn-block">背景選擇</a>
            ...
            <span style="position: absolute; top: 10px; left: -72px;">
        	<img src="images/z_line_c.png" width="82" height="1" /> 
        </span>
        <span style="margin-right: 5px; margin-top: 5px; padding: 5px; border: #CCC dotted 1px; position: absolute; top: -50px; left: -185px;" id="Step_ViewLine">
            ...
            <div id="v_wrp_middle_title">
            	<div id="v_wrp_middle_title_sicon"><span style="color: #CCC; font-size:20px; font-weight:bolder; padding:2px; position: absolute; right: 5px; top: 5px;">
            	  小圖示</span></div>
                <!--獨立背景-->
                <span style="margin-left: 5px; margin-top: 150px; padding: 5px; border: #CCC dotted 1px;  position: absolute; top: 57px; left: -189px;">
        ...
        <a href="tmptitlebackground_home.php?id=<?php echo $row_RecordTmp['id']; ?>&amp;type=標題圖示" data-original-title="選擇您要更換的圖示" data-toggle="tooltip" data-placement="right" class="btn btn-primary btn-xs btn-block">圖示選擇</a>
            	...
            	<!--獨立外框-->
                <span style="position: absolute; top: 115px; left: -120px;">
        	<img src="images/z_line_f-l.png" width="130" height="123" /> 
        </span>
                <span style="margin-right: 5px; margin-top: 5px; padding: 5px; border: #CCC dotted 1px; position: absolute; top: 53px; left: -185px;" id="Step_Title">
