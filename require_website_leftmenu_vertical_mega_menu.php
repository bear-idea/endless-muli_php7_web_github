...
$query_RecordMultiLeftMenu_l1 = sprintf("SELECT * FROM demo_websiteitem WHERE list_id = 1 && lang = %s ORDER BY item_id DESC", GetSQLValueString($collang_RecordMultiLeftMenu_l1, "text"));
...
<div class="dcjq-vertical-mega-menu">
        ...
        <?php do { ?>
             <li class="child">
            <a href="website.php?Opt=typepage&lang=<?php echo $_SESSION['lang']; ?>&tp=WebSite&searchkey=<?php echo urlencode($row_RecordMultiLeftMenu_l1['itemname']); ?>"><?php echo $row_RecordMultiLeftMenu_l1['itemname']; ?>
            </a>
            </li>
