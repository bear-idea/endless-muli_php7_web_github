...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require("require_leftmainmenu_attendance.php");?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include("require_manage_attendance_index.php");			
					break;
				case "gen":
					include("require_manage_attendance_gen.php");
					break;
				case "add":
					include("require_manage_attendance_add.php");
					break;
				case "edit":
					include("require_manage_attendance_edit.php");
					break;
				case "listpage":
					include("require_manage_attendance_list.php");
					break;
				case "listitempage":
					include("require_manage_attendance_listitem.php");
					break;
				default:
					include("require_manage_attendance_index.php");
					break;
