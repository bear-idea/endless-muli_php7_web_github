...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_accounts_receivable.php"); ?>
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include("require_manage_accounts_receivable_index.php");			
					break;
				case "addpage":
					include("require_manage_accounts_receivable_add.php");
					break;
				case "editpage":
					include("require_manage_accounts_receivable_edit.php"); 
					break;
				default:
					include("require_manage_accounts_receivable_index.php");
					break;
