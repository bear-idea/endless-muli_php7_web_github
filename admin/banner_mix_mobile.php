...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE demo_tmphomeblockcolumn SET content=%s WHERE id =%s",
...
<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>sqldatatable/js/tmpblockbanner_datatable_get.js"></script>
<!-- ================== END Datatables JS ================== -->
...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-without-sidebar p-0">
  ...
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 區塊橫幅 <small>選擇</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-heading">
    ...
    <div class="btn-group pull-right"><a href="tmp_config_<?php echo $_GET['board']; ?>_block_cn.php?lang=<?php echo $_SESSION['lang']; ?>&amp;id_edit=<?php echo $_GET['id_tmp']; ?>&amp;board=<?php echo $_GET['board']; ?>" data-original-title="" data-toggle="tooltip" data-placement="top" class="btn btn-default btn-sm"><i class="fa fa-reply fa-fw"></i> 上一頁</a></div>
    <?php } else if($_GET['lang'] == 'en') { ?>
    <div class="btn-group pull-right"><a href="tmp_config_<?php echo $_GET['board']; ?>_block_en.php?lang=<?php echo $_SESSION['lang']; ?>&amp;id_edit=<?php echo $_GET['id_tmp']; ?>&amp;board=<?php echo $_GET['board']; ?>" data-original-title="" data-toggle="tooltip" data-placement="top" class="btn btn-default btn-sm"><i class="fa fa-reply fa-fw"></i> 上一頁</a></div>
    <?php } else if($_GET['lang'] == 'jp') { ?>
    <div class="btn-group pull-right"><a href="tmp_config_<?php echo $_GET['board']; ?>_block_jp.php?lang=<?php echo $_SESSION['lang']; ?>&amp;id_edit=<?php echo $_GET['id_tmp']; ?>&amp;board=<?php echo $_GET['board']; ?>" data-original-title="" data-toggle="tooltip" data-placement="top" class="btn btn-default btn-sm"><i class="fa fa-reply fa-fw"></i> 上一頁</a></div>
    <?php } else if($_GET['lang'] == 'kr') { ?>
    <div class="btn-group pull-right"><a href="tmp_config_<?php echo $_GET['board']; ?>_block_kr.php?lang=<?php echo $_SESSION['lang']; ?>&amp;id_edit=<?php echo $_GET['id_tmp']; ?>&amp;board=<?php echo $_GET['board']; ?>" data-original-title="" data-toggle="tooltip" data-placement="top" class="btn btn-default btn-sm"><i class="fa fa-reply fa-fw"></i> 上一頁</a></div>
    <?php } else if($_GET['lang'] == 'sp') { ?>
    <div class="btn-group pull-right"><a href="tmp_config_<?php echo $_GET['board']; ?>_block_sp.php?lang=<?php echo $_SESSION['lang']; ?>&amp;id_edit=<?php echo $_GET['id_tmp']; ?>&amp;board=<?php echo $_GET['board']; ?>" data-original-title="" data-toggle="tooltip" data-placement="top" class="btn btn-default btn-sm"><i class="fa fa-reply fa-fw"></i> 上一頁</a></div>
    <?php } else { ?>
    <div class="btn-group pull-right"><a href="tmp_config_<?php echo $_GET['board']; ?>_block.php?lang=<?php echo $_SESSION['lang']; ?>&amp;id_edit=<?php echo $_GET['id_tmp']; ?>&amp;board=<?php echo $_GET['board']; ?>" data-original-title="" data-toggle="tooltip" data-placement="top" class="btn btn-default btn-sm"><i class="fa fa-reply fa-fw"></i> 上一頁</a></div>
    <?php } ?>
  ...
  <div class="row">
      <div class="col-md-12">
        <div class="card bg-grey-transparent-1">
          <div class="card-block">
            <?php if($totalRows_RecordAds > 0) { ?><?php //echo $row_RecordAds['webname']; ?>
            <span class="label label-purple" data-original-title="編號" data-toggle="tooltip" data-placement="right">#No.<?php echo $row_RecordAds['act_id']; ?></span>
            <div class="pull-left m-r-10" style="width:100%">
              <div class="img-thumbnail m-b-5 m-t-5"><div class="imgLiquidFill" style="min-width:100%; height:100px; background-image:url('<?php echo $SiteImgUrlAdmin; ?><?php echo $wshop; ?>/image/banner/<?php echo $row_RecordAds['pic']; ?>'); background-repeat:no-repeat; background-position:<?php echo $row_RecordAds['bgposition'];?>; background-color:<?php echo $row_RecordAds['bgcolor'];?>; bgsize:<?php echo $row_RecordAds['bgsize'];?>"></div></div>
        
            </div>
            <span class="label label-success"><?php echo $row_RecordAds['photonum']; ?>張圖片</span>
            <div style="clear:both;"></div>
            <?php } else { ?>
            <div class="alert alert-danger m-t-5 m-b-0"><i class="fa fa-info-circle"></i> <b>目前尚未套用任何橫幅。</b></div>
            <?php } ?>
          </div>
        </div>
      </div>
  ...
  <form action="<?php echo $editFormAction; ?>" method="POST" name="Form_Choose" id="Form_Choose" data-parsley-validate=""> 
    ...
    <table id="data-table-default" class="table table-bordered table-hover cards" style="width:100%">
      <thead>
        <tr>
          <th data-priority="1"><strong>可選擇橫幅</strong></th>
          </tr>
      </thead>
      <tfoot>
        <tr>
          <td align="left">
          <span class="label label-danger p-10"><div class='radio radio-css radio-inline'><input type='radio' name='TmpBgSelect' value='' id='TmpBgSelect_none' data-parsley-trigger='blur' data-parsley-errors-container='#error_action'><label for='TmpBgSelect_none' class='text-white'>不使用任何橫幅</label></div></span>
    ...
    <input name="id" type="hidden" id="id" value="<?php echo $row_RecordTmpColumn['id']; ?>" />
