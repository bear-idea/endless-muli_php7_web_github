...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Activities")) {
  $updateSQL = sprintf("UPDATE demo_actalbum SET title=%s, author=%s, type=%s, location=%s, sdescription=%s, skeyword=%s, content=%s, startdate=%s, enddate=%s, indicate=%s, postdate=%s, notes1=%s, lang=%s WHERE act_id=%s",
  ...
  $updateGoTo = "manage_activities.php?Opt=viewpage&lang=" . $_POST['lang'];
  /*if (isset($_SERVER['QUERY_STRING'])) {
...
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordActivitiesListAuthor = sprintf("SELECT * FROM demo_actitem WHERE list_id = 2 && lang = %s && userid=%s", GetSQLValueString($collang_RecordActivitiesListAuthor, "text"),GetSQLValueString($coluserid_RecordActivitiesListAuthor, "int"));
...
$colname_RecordActivities = "-1";
if (isset($_GET['act_id'])) {
  $colname_RecordActivities = $_GET['act_id'];
}
...
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordActivities = sprintf("SELECT * FROM demo_actalbum WHERE act_id = %s && userid=%s", GetSQLValueString($colname_RecordActivities, "int"),GetSQLValueString($coluserid_RecordActivities, "int"));
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> <?php echo $ModuleName['Activities']; ?> <small>修改</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post">
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="title" type="text" class="form-control" id="title" value="<?php echo $row_RecordActivities['title']; ?>" maxlength="200" data-parsley-trigger="blur" required="" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
              <select name="type" id="type" class="form-control" data-parsley-trigger="blur" required="">
                  <option value="" <?php if (!(strcmp(-1, $row_RecordActivities['type']))) {echo "selected=\"selected\"";} ?>>-- 選擇類別 --</option>
                  <?php
do {  
?>
                  <option value="<?php echo $row_RecordActivitiesListType['itemname']?>"<?php if (!(strcmp($row_RecordActivitiesListType['itemname'], $row_RecordActivities['type']))) {echo "selected=\"selected\"";} ?>><?php echo $row_RecordActivitiesListType['itemname']?></option>
                  <?php
      ...
      <div class="form-group row">
        <label class="col-md-2 col-form-label">發佈者<span class="text-red">*</span></label>
          <div class="col-md-10">
                  ...
                  <option value="" <?php if (!(strcmp(-1, $row_RecordActivities['author']))) {echo "selected=\"selected\"";} ?>>-- 選擇發佈者 --</option>
                  <?php
do {  
?>
                  <option value="<?php echo $row_RecordActivitiesListAuthor['itemname']?>"<?php if (!(strcmp($row_RecordActivitiesListAuthor['itemname'], $row_RecordActivities['author']))) {echo "selected=\"selected\"";} ?>><?php echo $row_RecordActivitiesListAuthor['itemname']?></option>
<?php
...
?>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="location" type="text" class="form-control" id="location" value="<?php echo $row_RecordActivities['location']; ?>" maxlength="30" data-parsley-trigger="blur"/>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-5">
                      ...
                      <div class="input-group m-b-10">
								...
								<input name="startdate" type="text" class="form-control" id="startdate" value="<?php echo $row_RecordActivities['startdate']; ?>" maxlength="10" data-provide="datepicker" data-date-format="yyyy-mm-dd" data-parsley-trigger="blur" data-date-language="zh-TW">
							</div>
          ...
          <div class="col-md-5">
            ...
            <div class="input-group m-b-10">
			  <div class="input-group-prepend"><span class="input-group-text">結束</span></div>
					  <input name="enddate" type="text" class="form-control" id="enddate" value="<?php echo $row_RecordActivities['enddate']; ?>" maxlength="10" data-provide="datepicker" data-date-format="yyyy-mm-dd" data-parsley-trigger="blur" data-date-language="zh-TW">
				  </div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
            ...
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordActivities['indicate'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="indicate" id="indicate_1" value="1" />
                <label for="indicate_1">公佈</label>
            </div>
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordActivities['indicate'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="indicate" id="indicate_2" value="0" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
               <input name="skeyword" type="text" class="form-control" id="skeyword" value="<?php echo $row_RecordActivities['skeyword']; ?>" maxlength="300" data-role="tagsinput" />
          </div>
      </div>
      <div class="form-group row">
          ...
          <div class="col-md-10">
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordActivities['skeywordindicate'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="skeywordindicate" id="skeywordindicate_1" value="1" />
                <label for="skeywordindicate_1">顯示</label>
            </div>
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordActivities['skeywordindicate'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="skeywordindicate" id="skeywordindicate_2" value="0" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                 <input name="sdescription" type="text" class="form-control" id="sdescription" value="<?php echo $row_RecordActivities['sdescription']; ?>" size="100" maxlength="150"/> 
          </div>
      </div>
      <div class="form-group row">
          ...
          <div class="col-md-10">
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordActivities['pushtop'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="pushtop" id="pushtop_1" value="1" />
                <label for="pushtop_1">是</label>
            </div>
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordActivities['pushtop'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="pushtop" id="pushtop_2" value="0" />
      ...
      <div class="form-group row">
          ...
          <div class="table-responsive">
                <textarea name="content" id="content" cols="100%" rows="35" class="form-control"><?php echo $row_RecordActivities['content']; ?></textarea>  
          </div>
          </div>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
              <input name="postdate" type="text" class="form-control" id="postdate" value="<?php $dt = new DateTime($row_RecordActivities['postdate']); echo $dt->format('Y-m-d'); ?>" maxlength="10" data-provide="datepicker" data-date-format="yyyy-mm-dd" data-date-language="zh-TW" data-parsley-trigger="blur" required=""/> 
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
              <input name="notes1" type="text" class="form-control" id="notes1" value="<?php echo $row_RecordActivities['notes1']; ?>" size="50" maxlength="50"/>    
          </div>
      </div>
      <div class="form-group row">
        ...
        <div class="col-md-10">
          <button type="submit" class="btn btn btn-primary btn-block">送出</button>
            <input name="id" type="hidden" id="id" value="<?php echo $row_RecordActivities['id']; ?>" />
            <input name="lang" type="hidden" id="lang" value="<?php echo $row_RecordActivities['lang']; ?>" />
            <input name="editdate" type="hidden" id="editdate" value="<?php echo date("Y-m-d H-i-s"); ?>" />
          </div>
      </div>
      <input type="hidden" name="MM_update" value="form_Activities" />
  </form>
  </div>
  <!-- end panel-body --> 
</div>
