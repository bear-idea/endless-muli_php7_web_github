...
<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>sqldatatable/js/project_datatable_photo.js"></script>
<!-- ================== END Datatables JS ================== -->
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-heading">
    ...
    <div class="btn-group pull-right"><a href="inner_project.php?wshop=<?php echo $wshop; ?>&amp;Opt=photoaddpage&amp;lang=<?php echo $_SESSION['lang']; ?>&amp;act_id=<?php echo $_GET['act_id']; ?>" class="btn btn-default btn-sm"><i class="fa fa-plus"></i> 新增</a></div>
