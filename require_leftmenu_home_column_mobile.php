...
<div class="side-nav BlockWrp <?php if ($row_RecordLeftMenuColumn['type'] != 'alltypelist' && $row_RecordLeftMenuColumn['type'] != 'productlist') { echo "hidden-xs"; } ?>">
  <?php if (/*$row_RecordLeftMenuColumn['indicatetitle'] == '1' && */$row_RecordLeftMenuColumn['type'] != 'bline') { ?>
      ...
      <h4 class="sb-menu-icon BlockTitle"> <?php if($SubMenuName != "" && $row_RecordSystemConfigFr['subnamereplaceenable'] == "1" && $row_RecordLeftMenuColumn['type'] == 'alltypelist') {echo $SubMenuName;}else{echo $row_RecordLeftMenuColumn['customname'];}?></h4>
  ...
  <?php if($row_RecordLeftMenuColumn['type'] == 'productlist') {include_once("require_product_leftmenu_vertical_mega_menu.php");} ?>
