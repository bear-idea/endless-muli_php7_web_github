...
<div class="card bg-silver-lighter mb-10px" style="overflow:hidden">
  <div class="card-body">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 網站狀態 <small>設定</small> <?php require($page_view_path_vendor."require_lang_show.php"); ?></h4>
  </div>
</div>
  ...
  <form action="<?php echo $request->getRequestUri(); ?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post">
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
            <div class="form-check form-check-inline">
                <input <?php if (!(strcmp($row_RecordWebState['urlonly'],"1"))) {echo "checked=\"checked\"";} ?> class="form-check-input"  type="radio" name="urlonly" id="urlonly_1" value="1" />
                <label for="urlonly_1">是</label>
            </div>
            <div class="form-check form-check-inline">
                <input <?php if (!(strcmp($row_RecordWebState['urlonly'],"0"))) {echo "checked=\"checked\"";} ?> class="form-check-input"  type="radio" name="urlonly" id="urlonly_2" value="0" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
            ...
            <div class="form-check form-check-inline">
                <input <?php if (!(strcmp($row_RecordWebState['urlenable'],"1"))) {echo "checked=\"checked\"";} ?> class="form-check-input"  type="radio" name="urlenable" id="urlenable_1" value="1" />
                <label for="urlenable_1">否</label>
            </div>
            <div class="form-check form-check-inline">
                <input <?php if (!(strcmp($row_RecordWebState['urlenable'],"0"))) {echo "checked=\"checked\"";} ?> class="form-check-input"  type="radio" name="urlenable" id="urlenable_2" value="0" />
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">E-mail <i class="fa fa-info-circle text-orange" data-bs-original-title="通知信件信箱。" data-bs-toggle="tooltip" data-bs-placement="top"></i></label>
          <div class="col-md-10">
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">網址啟用日 <i class="fa fa-info-circle text-orange" data-bs-original-title="僅首次使用需填寫及修改紀錄首次啟用時間。" data-bs-toggle="tooltip" data-bs-placement="top"></i></label>
          <div class="col-md-10">
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">網站最後續約日 <i class="fa fa-info-circle text-orange" data-bs-original-title="續約之日期，此欄若需限定客戶使用時間必填。" data-bs-toggle="tooltip" data-bs-placement="top"></i></label>
          <div class="col-md-10">
