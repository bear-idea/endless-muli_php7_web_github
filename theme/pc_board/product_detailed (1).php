...
$("#Cart_Add").click(function(){
	...
	var pic = $('#pic').val();
	<?php if ($totalRows_RecordProducSptFormat > 0) { ?>
    ...
    $.ajax({ //make ajax request to cart_process.php
        ...
        data: "id=<?php echo $row_RecordProduct['id']; ?>&qu=" + qu + "&pr=" + pr + "&prsp=" + prsp + "&pic=" + pic + <?php if ($totalRows_RecordProducSptFormat > 0) { ?>"&spfmt=" + arr[2] + <?php } ?><?php if ($totalRows_RecordProductAjaxFormat > 0) { ?><?php echo $fmt; ?><?php } ?>"&wshop=<?php echo $_GET['wshop']; ?>&time()",
