...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_CommodityItemAdd")) {
  $insertSQL = sprintf("INSERT INTO invoicing_commodityitem (list_id, itemname, itemvalue, subitem_id, lang, userid) VALUES (%s, %s, %s, %s, %s, %s)",
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_CommodityItemEdit")) {
	foreach($_POST['item_id'] as $key => $val){
	  $updateSQL = sprintf("UPDATE invoicing_commodityitem SET list_id=%s, sortid=%s, indicate=%s, itemname=%s, itemvalue=%s, lang=%s WHERE item_id=%s",
