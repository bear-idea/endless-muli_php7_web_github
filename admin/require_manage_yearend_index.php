...
<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>sqldatatable/js/yearend_datatable.js?<?php echo time(); ?>"></script>
<!-- ================== END Datatables JS ================== -->
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 年終獎金 <small>總覽</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-body">
    ...
    <div class="alert alert-warning m-t-0"><i class="fa fa-info-circle"></i> <b>員工服務未滿三3個月者不發與年終獎金。</b></div>
    
    
    
    <div class="row justify-content-end">
      <div class="col-md-2 m-b-10">
        <div class="input-group" data-column="6"> <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 年份</span></span>
            <select name="particularyear" class="form-control search_filter" id="col6_filter">
      ...
      <div class="col-md-2 col-sm-12 m-b-10">
        <div class="input-group" data-column="2"> <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 部門</span></span>
            <select name="department" class="form-control search_filter" id="col2_filter">
...
?>
      ...
      <div class="col-md-2 col-sm-12 m-b-10">
        <div class="input-group" data-column="3"> <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 職位</span></span>
            <select name="job" class="form-control search_filter" id="col3_filter">
            <option value="" selected="selected">全部</option>
              <?php
do {  
?>
...
?>
      ...
      <div class="col-md-3 m-b-10">
        <div class="input-group"> <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 姓名</span></span>
    ...
    <table id="data-table-default" class="table table-striped table-bordered table-hover table-condensed">
      <thead>
        <tr>
          <th width="16"></th>
          <th width="-1" data-priority="1"><strong>姓名</strong></th>
          <th width="100" data-priority="1"><strong>部門</strong></th>
          <th width="100" data-priority="1"><strong>職位</strong></th>
          <th width="100" data-priority="1"><strong>到職日</strong></th>
          <th width="100" data-priority="1"><strong>離職日</strong></th>
          <th width="70" data-priority="1"><strong>年份</strong></th>
          <th width="100" data-priority="1"><strong>年資</strong></th>
          <th width="100" data-priority="1"><strong>年終</strong></th>
          <th width="80" class="none"><strong>公殤</strong></th>
          <th width="80" class="none">事假</th>
          <th width="80" class="none">病假</th>
          <th width="80" class="none">遲到早退</th>
          <th width="80">總休息</th>
          <th width="80">主管考核</th>
          <th width="80">加給金額	</th>
          <th width="80">實領年終</th>
        ...
        var intro = introJs();
          intro.setOptions({
            steps: [
			  {
                element: '#Step_List',
                intro: '您可以點選按鈕設置清單或點選下一步繼續導覽。<div style="text-align:center;margin-top:10px;"><span class = "InnerPage" style="float:none"><a href="manage_yearend.php?wshop=<?php echo $wshop;?>&Opt=listpage&lang=<?php echo $_SESSION['lang']; ?>" target="_blank"><i class="fa fa-arrow-circle-right"></i> 前往設置清單</a></span></div>'
              },
			  {
                element: '#Step_Add',
                intro: '您可以點選按鈕新增資料或點選下一步繼續導覽。<div style="text-align:center;margin-top:10px;"><span class = "InnerPage" style="float:none"><a href="manage_yearend.php?wshop=<?php echo $wshop;?>&Opt=addpage&lang=<?php echo $_SESSION['lang']; ?>" target="_blank"><i class="fa fa-arrow-circle-right"></i> 前往新增資料</a></span></div>'
              },
              {
                element: '#Step_View',
