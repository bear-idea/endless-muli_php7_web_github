...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_Tmp")) {
  $insertSQL = sprintf("INSERT INTO demo_tmp_source (title, name, homeselect, tmpwebwidth, tmpwebwidthunit, type, pic, indicate, sdescription, tmpmenulimit, notes1, lang, userid, webname) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
 ...
 // //mysqli_select_db($database_DB_Conn, $DB_Conn);
  ...
  $insertGoTo = "manage_tmp.php?Operate=addSuccess&Opt=sourceviewpage&lang=" . $_POST['lang'];
  if (isset($_SERVER['QUERY_STRING'])) {
...
<form action="require_manage_tmp_source_add.php?GP_upload=true" method="post" enctype="multipart/form-data" name="form_Tmp" id="form_Tmp" onsubmit="checkFileUpload(this,'GIF,JPG,JPEG,BMP,PNG',false,500,'','',1500,1500,'','');showProgressWindow('fileCopyProgress.htm',300,100);return document.MM_returnValue">
...
<br />
    ...
    <tr >
      ...
      <td><span id="sprytextfield3">
        <input name="tmpwebwidth" type="text" id="tmpwebwidth" value="960" size="4" maxlength="4" readonly="readonly" <?php if ($_SESSION['MM_UserGroup'] != 'superadmin') {?>readonly="readonly"<?php } ?> />
    ...
    <tr>
      ...
      <td><p>
        <label for="pic"></label>
        <input name="pic" type="file" id="pic" onchange="checkOneFileUpload(this,'GIF,JPG,JPEG,BMP,PNG',false,500,'','',1500,1500,'','')" size="50" maxlength="50" />
      </p></td>
    </tr>
    <tr>
