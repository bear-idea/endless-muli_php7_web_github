...
<link rel="stylesheet" href="<?php echo $TplCssPath; ?>/webslidemenu.css">
...
<script type="text/javascript" src="<?php echo $TplJsPath; ?>/webslidemenu.js"></script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <?php if ($wrp_full == "0") { ?>
  <div id="header" _height="none" style="display:none">
    <div id="context">
    <?php if ($MSTMP == 'default') { ?>
    <br>
    <div style="position:absolute;"><a href="index.php"><img src="../images/logo.png" alt="logo" width="150" height="58"></a>
