...
{
	case "News":
	    if($_SESSION['lang'] == 'en') {$MD_Name = $row_RecordMDName['customname_en'];} else if ($_SESSION['lang'] == 'cn'){$MD_Name = $row_RecordMDName['customname_cn'];} else if ($_SESSION['lang'] == 'jp'){$MD_Name = $row_RecordMDName['customname_jp'];} else if ($_SESSION['lang'] == 'kr'){$MD_Name = $row_RecordMDName['customname_kr'];} else if ($_SESSION['lang'] == 'sp'){$MD_Name = $row_RecordMDName['customname_sp'];}else {$MD_Name = $row_RecordMDName['customname'];} $ModuleName['News'] = $MD_Name;
		break;
    case "Coupons":
	    if($_SESSION['lang'] == 'en') {$MD_Name = $row_RecordMDName['customname_en'];} else if ($_SESSION['lang'] == 'cn'){$MD_Name = $row_RecordMDName['customname_cn'];} else if ($_SESSION['lang'] == 'jp'){$MD_Name = $row_RecordMDName['customname_jp'];} else if ($_SESSION['lang'] == 'kr'){$MD_Name = $row_RecordMDName['customname_kr'];} else if ($_SESSION['lang'] == 'sp'){$MD_Name = $row_RecordMDName['customname_sp'];}else {$MD_Name = $row_RecordMDName['customname'];}$ModuleName['Coupons'] = $MD_Name;
		break;
	case "Timeline":
	...
	case "Dealer":
		...
		break;
	case "Booking":
	    if($_SESSION['lang'] == 'en') {$MD_Name = $row_RecordMDName['customname_en'];} else if ($_SESSION['lang'] == 'cn'){$MD_Name = $row_RecordMDName['customname_cn'];} else if ($_SESSION['lang'] == 'jp'){$MD_Name = $row_RecordMDName['customname_jp'];} else if ($_SESSION['lang'] == 'kr'){$MD_Name = $row_RecordMDName['customname_kr'];} else if ($_SESSION['lang'] == 'sp'){$MD_Name = $row_RecordMDName['customname_sp'];}else {$MD_Name = $row_RecordMDName['customname'];}$ModuleName['Booking'] = $MD_Name;
		break;
	default:
		break;
}
