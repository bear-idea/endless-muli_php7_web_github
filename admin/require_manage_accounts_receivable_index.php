...
<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>sqldatatable/js/accounts_receivabledetail_datatable.js"></script>
<!-- ================== END Datatables JS ================== -->
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 應收帳款 <small>總覽</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-body">
    ...
    <div class="col-md-3 col-sm-12 m-b-10">
          <div class="input-group" data-column="8">
              <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 時間</span></span>
              <input name="postdate" type="text" class="form-control search_filter" placeholder="" id="col8_filter" autocomplete="off"/>		
          </div>
      </div>
      <div class="col-md-2 col-sm-12 m-b-10">
        <div class="input-group" data-column="2"> <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 請款客戶</span></span>
            <select name="clientelecode" class="form-control search_filter" id="col2_filter">
...
?>
      ...
      <div class="col-md-2 col-sm-12 m-b-10">
        <div class="input-group" data-column="3"> <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 收款公司</span></span>
            <select name="company" class="form-control search_filter" id="col3_filter">
    ...
    <table id="data-table-default" class="table table-striped table-bordered table-hover table-condensed">
      <thead>
        <tr>
          ...
          <th width="-1" data-priority="1"><strong>請款客戶</strong></th>
          <th width="100" data-priority="1"><strong>客戶代碼</strong></th>
          <th width="100" data-priority="1"><strong>收款公司</strong></th>
          <th width="70"><strong>應收金額</strong></th>
          <th width="70"><strong>預收金額</strong></th>
		  <th width="70"><strong>折讓</strong></th>
		  <th width="70"><strong>實收金額</strong></th>
