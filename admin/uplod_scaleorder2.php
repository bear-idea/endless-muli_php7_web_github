...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Scaleorder")) {
  $updateSQL = sprintf("UPDATE erp_scaleorderindetail SET pic2=IFNULL(%s,pic2) WHERE id=%s",
  ...
  $updateGoTo = "uplod_scaleorder2.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$(document).ready(function() {
	$("#pic2").fileinput({
		...
		initialPreviewConfig: [<?php echo "{url: 'sqldatatable/scaleorder_scaleorder2_photo_del.php?id_del=".$row_RecordScaleorder['id']."', key: ".$row_RecordScaleorder['id'].", extra: {id:".$row_RecordScaleorder['id']."} }"; ?>],
		<?php } ?>
