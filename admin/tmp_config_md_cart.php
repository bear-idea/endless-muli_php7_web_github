...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Tmp")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmpcartbuttonbgcolor=%s, tmpcartbuttonfontcolor=%s WHERE id=%s",
                       GetSQLValueString($_POST['tmpcartbuttonbgcolor'], "text"),
					   GetSQLValueString($_POST['tmpcartbuttonfontcolor'], "text"),
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post" id="form_Tmp" name="form_Tmp">
       <div class="form-group row">
        ...
        <div class="col-md-12"><span class="badge badge-primary"><i class="fa fa-paper-plane"></i> <?php echo $ModuleName['Cart']; ?></span></div>
      </div>
  	  <div class="form-group row">
          <label class="col-md-2 col-form-label">購物鈕背景顏色<span class="text-red">*</span></label>
          <div class="col-md-10">
          		<div class="input-group colorpicker-component colorpicker-element">				
                   <input name="tmpcartbuttonbgcolor" type="text" required class="form-control colorpicker-element" id="tmpcartbuttonbgcolor" value="<?php echo $row_RecordTmp['tmpcartbuttonbgcolor']; ?>" maxlength="20" data-parsley-errors-container="#error_tmpcartbuttonbgcolor" data-parsley-trigger="blur"/>
                   <span class="input-group-addon"><i style="background-color: rgb(64, 18, 18);"></i></span>
              </div>
              <div id="error_tmpcartbuttonbgcolor"></div>
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">購物鈕文字顏色<span class="text-red">*</span></label>
          <div class="col-md-10">
          		<div class="input-group colorpicker-component colorpicker-element">				
                   <input name="tmpcartbuttonfontcolor" type="text" required class="form-control colorpicker-element" id="tmpcartbuttonfontcolor" value="<?php echo $row_RecordTmp['tmpcartbuttonfontcolor']; ?>" maxlength="20" data-parsley-errors-container="#error_tmpcartbuttonfontcolor" data-parsley-trigger="blur"/>
                   <span class="input-group-addon"><i style="background-color: rgb(64, 18, 18);"></i></span>
              </div>
              <div id="error_tmpcartbuttonfontcolor"></div>
