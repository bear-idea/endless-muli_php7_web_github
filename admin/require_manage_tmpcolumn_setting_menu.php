...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_TmpColumn")) {
  $updateSQL = sprintf("UPDATE demo_tmpcolumn SET customname=%s, sortid=%s, indicatetitle=%s, indicatemiddle=%s, indicatewrp=%s, indicatetopmenu=%s, indicatebottommenu=%s, lang=%s WHERE id=%s",
