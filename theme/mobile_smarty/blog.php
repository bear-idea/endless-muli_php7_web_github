  ...
  <?php 
    ...
    <?php if ($TmpWrpViewLineLocate == '2') { ?>               
        ...
        <section class="page-header page-header-xxs">
			...
			<?php echo $ModuleName['Blog']; ?>
			<!-- InstanceEndEditable --></h1>
            <!-- InstanceBeginEditable name="導覽列" -->
                                    <?php require("require_blog_viewline_mobile.php"); ?>
                    <!-- InstanceEndEditable -->
        </section>
	...
	<?php } ?>
      ...
      <div class="row">      
        ...
        <?php
			...
			{
				case "viewpage":
					include_once("require_blog.php");				
					break;
				case "typepage":
					include_once("require_blog_type.php");				
					break;
				case "maintypepage":
					include_once("require_blog_type_main.php");				
					break;
				case "detailed":
					include_once("require_blog_detailed.php");				
					break;
				default:   
					include_once("require_blog.php");	
					break;  
