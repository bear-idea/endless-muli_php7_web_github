var handleDataTableDefault = function() {
    ...
    if ($('#data-table-default').length !== 0) {
		...
		//"dom":"lBfrtip",buttons:[{extend:"copy",className:"btn-sm"},{extend:"csv",className:"btn-sm"},{extend:"excel",className:"btn-sm"},{extend:"pdf",className:"btn-sm"},{extend:"print",className:"btn-sm"},{extend:"colvis",className:"btn-sm"}],
			"dom":"lBprtip",buttons:[{extend:"copy",className:"btn-sm",title:"清運明細月報表"},{extend:"csv",className:"btn-sm",title:"清運明細月報表"},{extend:"excel",className:"btn-sm",title:"清運明細月報表",footer:true},{extend:"pdf",className:"btn-sm",title:"清運明細月報表"},{extend:"print",className:"btn-sm",title:"清運明細月報表"},{extend:"colvis",className:"btn-sm",title:"清運明細月報表"}],
			//"dom": "lprtip",
            ...
            "autoWidth": false,
            "ajax": {
                "url": "sqldatatable/scaleorder_clearance_view_month.php",
                "type": "post",
				"data": function ( d ) {
					...
					d.search_postdate = $('#col9_filter').val();
					d.search_mode = $('#col7_filter').val();
					//console.log($('#col7_filter').val());
			...
			"footerCallback": function ( row, data, start, end, display ) {
                ...
                $(api.column(4).footer()).html( this.api().column(4).data().reduce( function (a, b) { return intVal(a) + intVal(b);}, 0 ) );
				$(api.column(5).footer()).html( this.api().column(5).data().reduce( function (a, b) { return intVal(a) + intVal(b);}, 0 ) );
