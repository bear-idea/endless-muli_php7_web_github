...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Discount")) {
  $updateSQL = sprintf("UPDATE demo_productdiscount SET name=%s, discountPieces=%s, discountNowfold=%s, startdate=%s, enddate=%s, limitdate=%s, skeyword=%s, sdescription=%s, content=%s, menuname=%s, menuindicate=%s, indicate=%s, notes1=%s, lang=%s WHERE id=%s",
  ...
  $updateGoTo = "manage_cart.php?Operate=editSuccess&Opt_Cart=discount&lang=" . $_POST['lang'] . "&type=" . $_POST['type'];
  /*if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 任選優惠(+) <small>修改</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
        ...
        <label class="col-md-2 col-form-label">折扣方式<span class="text-red">*</span> <i class="fa fa-info-circle text-orange" data-original-title="例如:80代表8折/10代表1折。" data-toggle="tooltip" data-placement="top"></i></label>
          <div class="col-md-2">
                  <div class="input-group p-0">
                    <div class="input-group-prepend"><span class="input-group-text">任選</span></div>
