...
<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>sqldatatable/js/cart_datatable.js?<?php echo time(); ?>"></script>
<!-- ================== END Datatables JS ================== -->
  ...
  <div class="alert alert-warning"><i class="fa fa-info-circle"></i> <b><?php if($row_RecordSystemConfigOtr['inventorycorrection'] == "1") { ?>目前<span style="color:#900">【已開啟】</span>庫存校正功能，<span style="color:#900">【刪除訂單】</span>時會<span style="color:#900">【自動修正】</span>商品庫存量。<?php } else { ?>目前<span style="color:#900">【未開啟】</span>庫存校正功能，<span style="color:#900">【刪除訂單】</span>時會<span style="color:#900">【保留】</span>目前商品庫存量。<?php } ?><a href="manage_cart.php?wshop=<?php echo $wshop;?>&amp;Opt=ivcpage&amp;lang=<?php echo $_SESSION['lang']; ?>" class="btn btn-primary btn-xs" data-original-title="前往更改設定" data-toggle="tooltip" data-placement="top"><i class="fa fa-chevron-right"></i> 選擇模式</a></b></div>
    ...
    <div class="row justify-content-end">
      <div class="col-md-3 col-sm-12 m-b-10">
          <div class="input-group" data-column="4">
              <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 訂購日期</span></span>
              <input name="postdate" type="text" class="form-control search_filter" placeholder="" id="col14_filter" autocomplete="off"/><?php /* 加上autocomplete="off"后，自动提示就没有了 */ ?>
              
          </div>
      </div>
      <div class="col-md-2 col-sm-12 m-b-10">
        <div class="input-group" data-column="7"> <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 出貨狀態</span></span>
            <select name="state" class="form-control search_filter" id="col7_filter">
    ...
    <table id="data-table-default" class="table table-striped table-bordered table-hover table-condensed">
      <thead>
        <tr>
          ...
          <th width="-1" data-priority="1"><strong>訂單編號</strong></th>
          <th width="50" data-priority="1"><strong>訂購人</strong></th>
          <th width="300" data-priority="1"><strong>聯絡電話/收貨地址</strong></th>
          <th width="70" data-priority="1"><strong>訂購日期</strong></th>
          <th width="70" data-priority="1"><strong>付款方式</strong></th>
          <th width="70" data-priority="1"><strong>付款狀態</strong></th>
          <th width="70" data-priority="1"><strong>貨運方式</strong></th>
          <th width="70" data-priority="1"><strong>出貨狀態</strong></th>
          <th width="70"><strong>總金額</strong></th>
