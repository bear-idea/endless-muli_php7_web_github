...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_knowledge.php"); ?>
        <?php //require_once("require_leftmainmenu_knowledge_list.php"); ?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include_once("require_manage_knowledge_index.php");			
					break;
				case "viewpage_sub":
					include_once("require_manage_knowledge_index_sub.php");			
					break;
				case "searchpage":
					include_once("require_manage_knowledge_index_search.php");			
					break;
				case "addpage":
					include_once("require_manage_knowledge_add.php");
					break;
				case "editpage":
					include_once("require_manage_knowledge_edit.php"); 
					break;
				case "listpage":
					include_once("require_manage_knowledge_list.php");
					break;
				case "listitempage":
					include_once("require_manage_knowledge_listitem.php");
					break;
				case "mulilistitempage":
					include_once("require_manage_knowledge_mulilistitem.php");
					break;
				case "advlistitempage":
					include_once("require_manage_knowledge_advlilistitem.php");
					break;
				case "adminlistitempage":
					include_once("require_manage_knowledge_adminlilistitem.php");
					break;
				case "sub_mulilistitempage":
					include_once("require_manage_knowledge_mulilistitem_sub.php");
					break;
				case "configpage":
					include_once("require_manage_knowledge_config.php");
					break;
				default:
					include_once("require_manage_knowledge_index.php");
					break;
