...
<div class="Menu_ListView_Icon_Board cl_blue4" style="background-image:url(images/mt_color_010.png); color:#4d5258; font-weight:bolder;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="100" align="center">郵件<br/>抓取
        </td>
    </tr>
  </table>
</div>
<a href="manage_searchdata.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_005.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">Mail搜尋</td>
    </tr>
  </table>
</div>
</a>
<a href="manage_blacklist.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_108.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">黑名單</td>
    </tr>
  </table>
</div>
</a>
<?php if ($_SESSION['MM_UserGroup'] == 'superadmin') { ?>
<a href="manage_nationalmail.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_006.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">各國Mail</td>
    </tr>
  </table>
</div>
</a>
