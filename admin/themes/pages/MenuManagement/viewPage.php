...
$tableConfig = [
    ...
    'ajaxUrl' => ADMINURL . '/sqldatatable/menu-management_view.php',
    'editUrl' => ADMINURL . '/sqledit/menu-management_jedit.php',
    'editListUrl' => ADMINURL . '/sqledit/menu-management_get_list.php?list_id=1',
    ...
    'columns' => [
        ...
        [ 'title' => '次標題', 'data' => 'subtitle', 'orderable' => true, 'className' => 'ed_subtitle', 'width' => '100px' ],
        [ 'title' => '路由/模組資訊', 'data' => 'url', 'orderable' => true, 'className' => 'ed_url', 'width' => '-1' ],
        [ 'title' => '選單類型', 'data' => 'type', 'orderable' => true, 'className' => 'ed_type', 'width' => '100px', 'inputclass' => 'form-select', 'sourceUrl' => "[{ value: 'MainMenu', text: '主選單' }, { value: 'SubMenu', text: '次選單' }, { value: 'FooterMenu', text: '頁尾選單' }]" ],
    ...
    'searchColumns' => ['module_class', 'indicate', 'type'],
    ...
    <div class="panel-body">
        <div class="row justify-content-end">
            ...
            <div class="col-md-2 col-sm-12 m-b-10">
                <div class="input-group" data-column="4"> <span class="input-group-text"><i class="fas fa-search fa-fw"></i> 類別</span>
                    <select name="type" class="form-control form-select search_filter" id="filter-type">
                        <option value="%">全部</option>
                        <option value="MainMenu">主選單 [MainMenu]</option>
                        <option value="SubMenu">次選單 [SubMenu]</option>
                        <option value="FooterMenu">頁尾選單 [FooterMenu]</option>
                    </select>
                </div>
            </div>
            <div class="col-md-2 col-sm-12 m-b-10">
