...
// 導覽
if($.cookie("intro_frilink") == null){
	jQuery(window).load(function() {startIntro();})
	$.cookie('intro_frilink', '1', { path:'/', expires: 365 });
}
</script>
<!-- InstanceEndEditable -->
</head>
...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_frilink.php"); ?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include_once("require_manage_frilink_index.php");			
					break;
				case "addpage_s":
					include_once("require_manage_frilink_add_select.php");
					break;
				case "addpage_d":
					include_once("require_manage_frilink_add_default.php");
					break;
				case "addpage_c":
					include_once("require_manage_frilink_add_custom.php");
					break;
				case "copypage_d":
					include_once("require_manage_frilink_copy_default.php"); 
					break;
				case "copypage_c":
					include_once("require_manage_frilink_copy_custom.php"); 
					break;
				case "editpage_d":
					include_once("require_manage_frilink_edit_default.php"); 
					break;
				case "editpage_c":
					include_once("require_manage_frilink_edit_custom.php"); 
					break;
				case "listpage":
					include_once("require_manage_frilink_list.php");
					break;
				case "listitempage":
					include_once("require_manage_frilink_listitem.php");
					break;
				case "configpage":
					include_once("require_manage_frilink_config.php");
					break;
				case "tmp_step_map":
					include_once("require_manage_frilink_step_map.php");
					break;
				default:
					include_once("require_manage_frilink_index.php");
					break;
