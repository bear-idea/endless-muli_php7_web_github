...
<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>sqldatatable/js/employees_datatable_seo.js"></script>
<!-- ================== END Datatables JS ================== -->
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-body">
    ...
    <div class="alert alert-warning m-t-0 m-b-10"><i class="fa fa-info-circle"></i> <b>填寫關鍵字及頁面描述請注意內容必須和項目內容有所關連。</b></div>
    
    <div class="alert alert-warning m-t-0 m-b-15"><i class="fa fa-info-circle"></i> <b>填寫關鍵字及頁頁描述請務必每個項目皆略為有所不同。</b></div>
