			  ...
			  <script>
                ...
                <div id="tabs">
                    <ul>
                        ...
                        <li><a href="#tabs-1"><?php echo $Lang_Tab_Content_Org //詳細資料 ?></a></li>
                        <?php } ?> 
                        <?php if ($row_RecordOrg['content1'] != '') { ?>
                        <li><a href="#tabs-2"><?php echo $Lang_Tab_Content1_Org //經驗歷程 ?></a></li>
                        <?php } ?> 
                        <?php if ($row_RecordOrg['content2'] != '') { ?>
                        <li><a href="#tabs-3"><?php echo $Lang_Tab_Content2_Org //專長領域 ?></a></li>
                        <?php } ?>
                        <?php if ($row_RecordOrg['content3'] != '') { ?>
                        <li><a href="#tabs-4"><?php echo $Lang_Tab_Content3_Org //榮譽事蹟 ?></a></li>
                        <?php } ?>
                        <?php if ($row_RecordOrg['content4'] != '') { ?>
                        <li><a href="#tabs-5"><?php echo $Lang_Tab_Content4_Org //補充說明 ?></a></li>
                        <?php } ?>
