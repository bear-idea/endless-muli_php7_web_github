...
<form action="require_manage_tmp_add.php?GP_upload=true" method="post" enctype="multipart/form-data" name="form_Tmp" id="form_Tmp" onsubmit="checkFileUpload(this,'GIF,JPG,JPEG,BMP,PNG',false,1500,'','',1500,1500,'','');showProgressWindow('fileCopyProgress.htm',300,100);return document.MM_returnValue">
    ...
    <tr>
     ...
     <tr>
      ...
      <td><div id="TmpName">
        <table width="500">
          <tr>
            <td width="100" style="border-bottom-width:0px;"><a href="#" data-original-title="" data-toggle="tooltip" data-placement="right"><img src="images/sty01.jpg" width="100" height="100"/></a></td>
            <td width="100" style="border-bottom-width:0px;"><!--<a href="#" data-original-title="" data-toggle="tooltip" data-placement="right"><img src="images/sty02.jpg" width="100" height="100" /></a>--></td>
...
風格2--></td>
        ...
        <span class="Form_Caption_Word">(此項目選擇後則不可修改。)</span>        <span class="radioRequiredMsg">請進行選取。</span></div></td>
    </tr>
    <tr <?php if ($OptionTmpHomeSelect == '0') { ?>style="display:none;"<?php } ?>>
      <td align="right"><span class="Form_Required_Item">*</span>首頁頁面：</td>
    ...
    <tr>
      ...
      <td><span id="TmpMenuLimit">
        <?php if ($_SESSION['MM_UserGroup'] == 'superadmin') {?><label>
          <input type="radio" name="tmpmenulimit" value="0" id="tmpmenulimit_0" />
          預設選單</label>
          <br /><?php } ?>
        <label>
          <input name="tmpmenulimit" type="radio" id="tmpmenulimit_1" value="1" checked="checked" />
          預設/自訂選單</label>
...
<br />
    ...
    <tr >
      ...
      <td><span id="sprytextfield3">
        <input name="tmpwebwidth" type="text" id="tmpwebwidth" value="960" size="4" maxlength="4" readonly <?php if ($_SESSION['MM_UserGroup'] != 'superadmin') {?>readonly="readonly"<?php } ?> />
    ...
    <tr>
      ...
      <td><p>
        <label for="pic"></label>
        <input name="pic" type="file" id="pic" onchange="checkOneFileUpload(this,'GIF,JPG,JPEG,BMP,PNG',false,1500,'','',1500,1500,'','')" size="50" maxlength="50" />
      </p></td>
    </tr>
    <tr>
