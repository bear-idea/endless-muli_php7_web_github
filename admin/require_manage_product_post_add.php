...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_ProductPost")) {
  $insertSQL = sprintf("INSERT INTO demo_productpost (pid, author, content, notes1, lang, userid) VALUES (%s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "manage_product.php?Operate=addSuccess&Opt=postpage&lang=" . $_POST['lang'] . "&id=" . $_POST['pid'] . "&pdname=" . $_POST['pdname'];
  if (isset($_SERVER['QUERY_STRING'])) {
...
<?php } else { ?>
	<?php if ($ManageProductPostEditorSelect == '1') {?>
	<?php $CKEtoolbar = 'Full' ?>
    <?php } else if ($ManageProductPostEditorSelect == '2') {?>
...
<div>
    <div>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="TB_General_style02">
        ...
        <form id="form_ProductPost" name="form_ProductPost" method="post" action="require_manage_product_post_add.php">    
...
<input type="hidden" name="pid" id="pid" value="<?php echo $_GET['pd_id']; ?>" />
              ...
              <input type="hidden" name="MM_insert" value="form_ProductPost" />
        </form>
      <script type="text/javascript">
        <!--
        var sprytextarea1 = new Spry.Widget.ValidationTextarea("ProductPostContent", {validateOn:["blur"], isRequired:false});
        var sprytextfield4 = new Spry.Widget.ValidationTextField("ProductPostNotes1", "none", {validateOn:["blur"], isRequired:false});
