...
<?php do { ?>
  <?php 
	...
	if($row_RecordStaff["worksheet"] != ""){
		$dvalue['worksheet'] = "<span id=worksheet_".$row_RecordStaff["id"]."' class='ed_worksheet' data-type='select' data-pk='".$row_RecordStaff["id"]."' data-placement='top'>".$row_RecordStaff["worksheet"]."</span>";
	}else{
		$dvalue['worksheet'] = "<span id=worksheet_".$row_RecordStaff["id"]."' class='ed_worksheet editable-click editable-empty' data-type='select' data-pk='".$row_RecordStaff["id"]."' data-placement='top'>".'Empty'."</span>";
	}
