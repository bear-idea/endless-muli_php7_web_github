...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require("require_leftmainmenu_socialchat.php");?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include("require_manage_socialchat_index.php");			
					break;
				case "addpage_s":
					include("require_manage_socialchat_add_select.php");
					break;
				case "addpage_skype":
					include_once("require_manage_socialchat_add_skype.php");
					break;
				case "addpage_message":
					include_once("require_manage_socialchat_add_message.php");
					break;
				case "addpage_line":
					include_once("require_manage_socialchat_add_line.php");
					break;
				case "addpage_whatsapp":
					include_once("require_manage_socialchat_add_whatsapp.php");
					break;
				case "addpage_phone":
					include_once("require_manage_socialchat_add_phone.php");
					break;
				case "addpage_mail":
					include_once("require_manage_socialchat_add_mail.php");
					break;
				case "eiitpage_skype":
					include_once("require_manage_socialchat_edit_skype.php");
					break;
				case "editpage_message":
					include_once("require_manage_socialchat_edit_message.php");
					break;
				case "editpage_line":
					include_once("require_manage_socialchat_edit_line.php");
					break;
				case "editpage_whatsapp":
					include_once("require_manage_socialchat_edit_whatsapp.php");
					break;
				case "editpage_phone":
					include_once("require_manage_socialchat_edit_phone.php");
					break;
				case "editpage_mail":
					include_once("require_manage_socialchat_edit_mail.php");
					break;
				default:
					include("require_manage_socialchat_index.php");
					break;
