...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE demo_setting_fr SET SiteDecsHome_en=%s, SiteMail_en=%s, SiteAuthor_en=%s, SiteSName_en=%s, SitePhone_en=%s, SiteCell_en=%s, SiteFax_en=%s, SiteAddr_en=%s, SiteAddrX=%s, SiteAddrY=%s, contacttitle_en=%s, contacttitleindicate=%s, contactcontent_en=%s, googlemapindicate=%s, formindicate=%s WHERE id=%s",
  ...
  <?php if ($row_RecordSystemConfigFr['GoogleMapAPICode1'] == "") { ?>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="contacttitle" type="text" class="form-control" id="contacttitle" value="<?php echo $row_RecordSystemConfigFr['contacttitle_en']; ?>" maxlength="200" data-parsley-trigger="blur" required="" />
      ...
      <div class="form-group row" id="Step_Content">
          ...
          <div class="table-responsive">
                <textarea name="contactcontent" id="contactcontent" cols="100%" rows="35" class="form-control"><?php echo $row_RecordSystemConfigFr['contactcontent_en']; ?></textarea>  
          </div>
          </div>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SiteSName" type="text" class="form-control" id="SiteSName" value="<?php echo $row_RecordSystemConfigFr['SiteSName_en']; ?>" maxlength="100" data-parsley-trigger="blur" required="" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SiteDecsHome" type="text" class="form-control" id="SiteDecsHome" value="<?php echo $row_RecordSystemConfigFr['SiteDecsHome_en']; ?>" maxlength="200" data-parsley-trigger="blur" required="" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SitePhone" type="text" class="form-control" id="SitePhone" value="<?php echo $row_RecordSystemConfigFr['SitePhone_en']; ?>" maxlength="30" data-parsley-trigger="blur" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SiteCell" type="text" class="form-control" id="SiteCell" value="<?php echo $row_RecordSystemConfigFr['SiteCell_en']; ?>" maxlength="15" data-parsley-trigger="blur" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SiteFax" type="text" class="form-control" id="SiteFax" value="<?php echo $row_RecordSystemConfigFr['SiteFax_en']; ?>" maxlength="15" data-parsley-trigger="blur" />
      ...
      <div class="form-group row" id="Step_MapMove">
          ...
          <div class="col-md-8">
                      ...
                      <input name="SiteAddr" type="text" class="form-control" id="SiteAddr" value="<?php echo $row_RecordSystemConfigFr['SiteAddr_en']; ?>" maxlength="250" data-parsley-trigger="blur" />
...
<div style="position:relative"><div id="out" style="position:absolute;"><div id="map_canvas"></div></div></div>
          ...
          <div class="col-md-2">
                     ...
                     <a href="http://www.post.gov.tw/post/internet/f_searchzone/index.jsp?ID=190103" class="btn btn-warning btn-sm" data-original-title="中華郵政全球資訊網_查詢專區_郵件業務_中文地址英譯" target="_blank" data-toggle="tooltip" data-placement="top">中文地址英譯 <i class="fa fa-chevron-circle-right"></i></a>     
      ...
      <div class="form-group row" id="Step_Mail">
          ...
          <div class="col-md-10">
                      ...
                      <input name="sitemail" type="email" class="form-control" id="sitemail" value="<?php echo $row_RecordSystemConfigFr['SiteMail_en']; ?>" maxlength="150" data-parsley-trigger="blur" required="" />
      ...
      <div class="form-group row" id="Step_MailTitle">
          ...
          <div class="col-md-10">
                      ...
                      <input name="siteauthor" type="text" class="form-control" id="siteauthor" value="<?php echo $row_RecordSystemConfigFr['SiteAuthor_en']; ?>" maxlength="150" data-parsley-trigger="blur" required="" />
