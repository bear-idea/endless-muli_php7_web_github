...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Tmp")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmpmainmenuindicate=%s, tmpsubmainmenuindicate=%s, tmpheaderminheight=%s, tmpheaderpaddingtop=%s, tmpheaderpaddingbttom=%s, tmpheaderpaddingleft=%s, tmpheaderpaddingright=%s, tmpheadermodselect=%s WHERE id=%s",
					   ...
					   GetSQLValueString($_POST['tmpheadermodselect'], "int"),
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post" id="form_Tmp" name="form_Tmp">
      <div class="form-group row">
        ...
        <div class="col-md-12"><span class="badge badge-primary"><i class="fa fa-paper-plane"></i> 頁首區塊</span></div>
      </div>
      
      <div class="form-group row">
          <label class="col-md-2 col-form-label">最小高度</label>
          <div class="col-md-10">
                      <input name="tmpheaderminheight" class="form-control" id="tmpheaderminheight" value="<?php echo $row_RecordTmp['tmpheaderminheight']; ?>" maxlength="5" data-parsley-min="0" data-parsley-max="9999" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">上</span></div>
                  <input name="tmpheaderpaddingtop" class="form-control" id="tmpheaderpaddingtop" value="<?php echo $row_RecordTmp['tmpheaderpaddingtop']; ?>" maxlength="3" data-parsley-min="-50" data-parsley-max="50" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">下</span></div>
                  <input name="tmpheaderpaddingbttom" class="form-control" id="tmpheaderpaddingbttom" value="<?php echo $row_RecordTmp['tmpheaderpaddingbttom']; ?>" maxlength="3" data-parsley-min="-50" data-parsley-max="50" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                     <div class="input-group-append"><span class="input-group-text">px</span></div>                 
              </div>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">左</span></div>
                  <input name="tmpheaderpaddingleft" class="form-control" id="tmpheaderpaddingleft" value="<?php echo $row_RecordTmp['tmpheaderpaddingleft']; ?>" maxlength="3" data-parsley-min="-50" data-parsley-max="50" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                  <div class="input-group-append"><span class="input-group-text">px</span></div>                    
              </div>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">右</span></div>
                  <input name="tmpheaderpaddingright" class="form-control" id="tmpheaderpaddingright" value="<?php echo $row_RecordTmp['tmpheaderpaddingright']; ?>" maxlength="3" data-parsley-min="-50" data-parsley-max="50" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                    <div class="input-group-append"><span class="input-group-text">px</span></div>                  
              </div>
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">選單區塊<span class="text-red">*</span><i class="fa fa-info-circle text-orange" data-original-title="此選項會將主選單做隱藏，您可在《自訂欄位》中加入《選單總覽》的區塊，並將您的選單區塊作隱藏，如此可將您的選單移至左邊。" data-toggle="tooltip" data-placement="top"></i></label>                       	
          <div class="col-md-10">
          
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmpmainmenuindicate'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpmainmenuindicate" id="tmpmainmenuindicate_2" value="0" />
                <label for="tmpmainmenuindicate_2">不顯示</label>
            </div>
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmpmainmenuindicate'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpmainmenuindicate" id="tmpmainmenuindicate_1" value="1" />
                <label for="tmpmainmenuindicate_1">顯示</label>
            </div>
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">子選單區塊<span class="text-red">*</span><i class="fa fa-info-circle text-orange" data-original-title="此選項會將主選單中的子選單做隱藏，您可在《自訂欄位》中加入《分類選單》的區塊來做配合使用。" data-toggle="tooltip" data-placement="top"></i></label>                       	
          <div class="col-md-10">
          
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmpsubmainmenuindicate'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpsubmainmenuindicate" id="tmpsubmainmenuindicate_2" value="1" />
                <label for="tmpsubmainmenuindicate_2">僅自訂頁面顯示多層分類</label>
            </div>
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmpsubmainmenuindicate'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpsubmainmenuindicate" id="tmpsubmainmenuindicate_1" value="0" />
                <label for="tmpsubmainmenuindicate_1">隱藏</label>
            </div>
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmpsubmainmenuindicate'],"2"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpsubmainmenuindicate" id="tmpsubmainmenuindicate_3" value="2" />
                <label for="tmpsubmainmenuindicate_3">全部模組顯示多層分類</label>
            </div>
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmpsubmainmenuindicate'],"3"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpsubmainmenuindicate" id="tmpsubmainmenuindicate_4" value="3" />
                <label for="tmpsubmainmenuindicate_4">全部模組顯示多層分類 / 產品選單以多層分類顯示</label>
            </div>
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmpsubmainmenuindicate'],"4"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpsubmainmenuindicate" id="tmpsubmainmenuindicate_5" value="4" />
                <label for="tmpsubmainmenuindicate_5">全部模組顯示多層分類 / 產品選單以分類顯示</label>
            </div>
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">頁首模式<span class="text-red">*</span><i class="fa fa-info-circle text-orange" data-original-title="此選項可設定頁首的顯示模式。" data-toggle="tooltip" data-placement="top"></i></label>                       	
          <div class="col-md-10">
          
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmpheadermodselect'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpheadermodselect" id="tmpheadermodselect_2" value="0" />
                <label for="tmpheadermodselect_2">預設</label>
            </div>
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmpheadermodselect'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpheadermodselect" id="tmpheadermodselect_1" value="1" />
                <label for="tmpheadermodselect_1">自訂</label>  <a href="inner_tmp.php?Opt=header&amp;id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;lang=<?php echo $_SESSION['lang'] ?>" target="" class="btn btn-primary btn-xs"> 前往設定 <i class="fa fa-chevron-circle-right"></i></a>
            </div>
