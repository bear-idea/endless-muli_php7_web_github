...
$updateSQL = sprintf("UPDATE demo_setting_fr SET SiteName_jp=%s, SiteDecsHome_jp=%s, SiteIndicate=%s, SiteIndicateDesc=%s, SiteCopyLock=%s, SiteAnimeCheck=%s, SiteType=%s, SiteFBFan=%s, SiteUrl=%s, SiteMail_jp=%s, SiteAuthor_jp=%s, SiteSName_jp=%s, SitePhone_jp=%s, SiteCell_jp=%s, SiteFax_jp=%s, SiteLINE=%s, SiteAddr_jp=%s, SiteAddrX_jp=%s, SiteAddrY_jp=%s, SiteIndustryType1=%s, SiteIndustryType2=%s, SiteIndustryType3=%s, googlemaparea1=%s, googlemaparea2=%s, googlemaparea3=%s, SiteFontSize=%s, urlwriteenable=%s WHERE id=%s",
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post">
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="sitename" type="text" class="form-control" id="sitename" value="<?php echo $row_RecordSettingFr['SiteName_jp']; ?>" maxlength="200" data-parsley-trigger="blur" required="" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SiteDecsHome" type="text" class="form-control" id="SiteDecsHome" value="<?php echo $row_RecordSettingFr['SiteDecsHome_jp']; ?>" maxlength="300" data-parsley-trigger="blur" required="" />
...
?>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SiteSName" type="text" class="form-control" id="SiteSName" value="<?php echo $row_RecordSettingFr['SiteSName_jp']; ?>" maxlength="100" data-parsley-trigger="blur" required="" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SitePhone" type="text" id="SitePhone" value="<?php echo $row_RecordSettingFr['SitePhone_jp']; ?>" maxlength="30" data-parsley-trigger="blur" class="form-control"/>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SiteCell" type="text" id="SitePhone" value="<?php echo $row_RecordSettingFr['SiteCell_jp']; ?>" maxlength="15" data-parsley-trigger="blur" class="form-control"/>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SiteFax" type="text" id="SiteFax" value="<?php echo $row_RecordSettingFr['SiteFax_jp']; ?>" maxlength="20" data-parsley-trigger="blur" class="form-control"/>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SiteAddr" type="text" id="SiteAddr" value="<?php echo $row_RecordSettingFr['SiteAddr_jp']; ?>" size="50" maxlength="250" data-parsley-trigger="blur" class="form-control"/>
...
<div style="position:relative"><div class="" id="out" style="position:absolute;"><div id="map_canvas"></div></div></div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="sitemail" type="email" id="sitemail" value="<?php echo $row_RecordSettingFr['SiteMail_jp']; ?>" size="50" maxlength="150" data-parsley-trigger="blur" class="form-control" required=""/>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="siteauthor" type="text" id="siteauthor" value="<?php echo $row_RecordSettingFr['SiteAuthor_jp']; ?>" size="50" maxlength="150"  data-parsley-trigger="blur" class="form-control" required=""/>
