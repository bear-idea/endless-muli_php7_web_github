...
?>
<script type='text/javascript' src='<?php echo $SiteBaseUrl ?>assets/plugins/unitegallery/js/unitegallery.min.js'></script>	
<link rel='stylesheet' href='<?php echo $SiteBaseUrl ?>assets/plugins/unitegallery/css/unite-gallery.css' type='text/css' />
<script src='<?php echo $SiteBaseUrl ?>assets/plugins/unitegallery/themes/compact/ug-theme-compact.js' type='text/javascript'></script>
...
<div id="gallery" style="display:none;">
		...
		<?php do { ?>
        <img alt="<?php echo $row_RecordRoomPhotoAlbum['sdescription']; ?>"
			 src="<?php echo $SiteImgUrl; ?><?php echo $_GET['wshop']; ?>/image/room/<?php echo $row_RecordRoomPhotoAlbum['pic']; ?>"
			 data-image="<?php echo $SiteImgUrl; ?><?php echo $_GET['wshop']; ?>/image/room/<?php echo $row_RecordRoomPhotoAlbum['pic']; ?>"
			 data-description="">	
...
<div id="gallery" style="display:none;">
        ...
        <img alt="<?php echo $row_RecordRoom['sdescription']; ?>"
			 src="<?php echo $SiteImgUrl; ?><?php echo $_GET['wshop']; ?>/image/room/<?php echo $row_RecordRoom['pic']; ?>"
			 data-image="<?php echo $SiteImgUrl; ?><?php echo $_GET['wshop']; ?>/image/room/<?php echo $row_RecordRoom['pic']; ?>"
			 data-description="">	
