...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require("require_leftmainmenu_absence.php");?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include("require_manage_absence_index.php");			
					break;
				case "addpage":
					include("require_manage_absence_add.php");
					break;
				case "editpage":
					include("require_manage_absence_edit.php"); 
					break;
				case "genpage":
					include("require_manage_absence_gen.php"); 
					break;
				case "listpage":
					include("require_manage_absence_list.php");
					break;
				case "listitempage":
					include("require_manage_absence_listitem.php");
					break;
				default:
					include("require_manage_absence_index.php");
					break;
