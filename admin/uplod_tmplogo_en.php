...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Tmplogo")) {
  echo $updateSQL = sprintf("UPDATE demo_tmplogo SET logoimage_en=IFNULL(%s,logoimage_en), width=%s, height=%s WHERE id=%s",
  ...
  <form action="<?php echo $editFormAction;?>" class="form-horizontal form-bordered" data-parsley-validate="" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
            ...
            <input name="oldpic" type="hidden" id="oldpic" value="<?php echo $row_RecordTmplogo['logoimage_en']; ?>" />
...
$(document).ready(function() {
	$("#logoimage").fileinput({
		...
		maxFileSize: 2000,  
		<?php if ($row_RecordTmplogo['logoimage_en'] != "") { ?>
		initialPreview: ["<?php echo $SiteImgUrlAdmin; ?><?php echo $wshop; ?>/logo/<?php echo $row_RecordTmplogo['logoimage_en']; ?>"],
		<?php } ?>
