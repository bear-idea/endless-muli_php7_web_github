  ...
  <ul>
    <?php do { ?>
     <?php // 判斷商品所在之層級
                            ...
                            ?>
      <li><div class="Img_Center" style="float:left; width:50px; height:50px;"><img src="<?php echo $SiteImgUrl; ?><?php echo $_GET['wshop']; ?>/image/product/thumb/small_<?php echo GetFileThumbExtend($row_RecordProductNewsList['pic']); ?>" alt="<?php echo $row_RecordProductNewsList['sdescription']; ?>"/></div><div style="float:left; width:135px; margin-left:5px;">
	  <?php if ($level == '2') { ?>
      <a href="<?php echo $SiteBaseUrl . url_rewrite("product",array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'detailed','type1'=>$row_RecordProductNewsList['type1'],'type2'=>$row_RecordProductNewsList['type2'],'type3'=>$row_RecordProductNewsList['type3']),'',$UrlWriteEnable);?><?php echo $id_params; ?><?php echo $row_RecordProductNewsList['id']; ?>"><?php echo $row_RecordProductNewsList['name']; ?></a>
      <?php } else if ($level == '1') { ?>
      <a href="<?php echo $SiteBaseUrl . url_rewrite("product",array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'detailed','type1'=>$row_RecordProductNewsList['type1'],'type2'=>$row_RecordProductNewsList['type2']),'',$UrlWriteEnable);?><?php echo $id_params; ?><?php echo $row_RecordProductNewsList['id']; ?>"><?php echo $row_RecordProductNewsList['name']; ?></a>
      <?php } else if ($level == '0') { ?>
      <a href="<?php echo $SiteBaseUrl . url_rewrite("product",array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'detailed','type1'=>$row_RecordProductNewsList['type1']),'',$UrlWriteEnable);?><?php echo $id_params; ?><?php echo $row_RecordProductNewsList['id']; ?>"><?php echo $row_RecordProductNewsList['name']; ?></a>
      <?php } else { ?>
      <a href="<?php echo $SiteBaseUrl . url_rewrite("product",array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'detailed'),'',$UrlWriteEnable);?><?php echo $id_params; ?><?php echo $row_RecordProductNewsList['id']; ?>"><?php echo $row_RecordProductNewsList['name']; ?></a>
      <?php } ?>
      </div></li>
