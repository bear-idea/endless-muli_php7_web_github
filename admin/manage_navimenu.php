...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require("require_leftmainmenu_navimenu.php");?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include("require_manage_navimenu_index.php");			
					break;
				case "viewpage_sl1":
					include("require_manage_navimenu_sl1_index.php");			
					break;
				case "addpage_L1":
					include("require_manage_navimenu_L1_add.php");
					break;
				case "addpage_L2":
					include("require_manage_navimenu_L2_add.php");
					break;
				case "addpage_L3":
					include("require_manage_navimenu_L3_add.php");
					break;
				case "editpage":
					include("require_manage_navimenu_edit.php"); 
					break;
				case "deletepage":
					include("require_manage_navimenu_delete.php");
					break;
				case "listpage":
					include("require_manage_navimenu_list.php");
					break;
				case "listitempage":
					include("require_manage_navimenu_listitem.php");
					break;
				default:
					include("require_manage_navimenu_index.php");
					break;
