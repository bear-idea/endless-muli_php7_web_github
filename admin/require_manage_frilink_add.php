...
if (isset($wuserid)) {
  $coluserid_RecordFrilinkListType = $wuserid;
}
...
$totalRows_RecordFrilinkListType = mysqli_num_rows($RecordFrilinkListType);$colname_RecordFrilinkListType = "zh-tw";
if (isset($_GET['lang'])) {
  $colname_RecordFrilinkListType = $_GET['lang'];
}
$coluserid_RecordFrilinkListType = "-1";
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_Frilink")) {
  ...
  $insertGoTo = "manage_frilink.php?Operate=addSuccess&Opt=viewpage&lang=" . $_POST['lang'];
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div>
    <div>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="TB_General_style02">
          <tr>
            <td><h5><strong><font color="#756b5b">新增<?php echo $ModuleName['Frilink']; ?> [<?php echo $langname; ?>
...
<form action="require_manage_frilink_add.php?GP_upload=true" method="post" enctype="multipart/form-data" name="form_Frilink" id="form_Frilink" onsubmit="checkFileUpload(this,'GIF,JPG,JPEG,BMP,PNG',false,500,'','',300,300,'','');showProgressWindow('fileCopyProgress.htm',300,100);return document.MM_returnValue">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="TB_General_style01">
    <tr>
      <td width="100" align="right"><span class="Form_Required_Item">*</span>名稱：</td>
      <td><span id="FrilinkName">
        <label>
          <input name="name" type="text" id="name" size="50" maxlength="50" />
        </label>
        <span class="textfieldRequiredMsg">欄位不可為空。</span></span>
        <input name="button3" type="button" id="button3" onclick="MM_openBrWindow('frilink_link_photo.php','範例圖片','resizable=yes,width=500,height=500')" value="範例圖片" /></td>
    </tr>
    <tr>
      <td align="right"><span class="Form_Required_Item">*</span>分類：</td>
      <td><span id="FrilinkType">
...
註：若您有快速連結<a class="tip_img_frilink" style=" background-color:#C60; color:#FFF"> ? </a>的區塊，請注意只會顯示10個在您的頁面上，但您可在該模組主頁面中調整排列順序<a class="tip_img_sort" style=" background-color:#C60; color:#FFF"> ? </a>來作顯示。<br />
            </div>
</td>
                  </tr>
    <tr>
      <td align="right"><span class="Form_Required_Item">*</span>網址：</td>
      <td><span id="FrilinkIink">
...
25</td>
    ...
    <tr>
      ...
      <td><span id="FrilinkSdescription">
...
<script type="text/javascript">
<!--
var sprytextfield1 = new Spry.Widget.ValidationTextField("FrilinkName", "none", {validateOn:["blur"]});
var spryradio1 = new Spry.Widget.ValidationRadio("FrilinkIndicate", {validateOn:["blur"]});
var sprytextfield4 = new Spry.Widget.ValidationTextField("FrilinkNotes1", "none", {validateOn:["blur"], isRequired:false});
var spryselect1 = new Spry.Widget.ValidationSelect("FrilinkType", {invalidValue:"-1", validateOn:["blur"]});
var sprytextfield2 = new Spry.Widget.ValidationTextField("FrilinkSdescription", "none", {validateOn:["blur"], isRequired:false});
var sprytextfield3 = new Spry.Widget.ValidationTextField("FrilinkIink", "none", {validateOn:["blur"]});
//-->
</script>
<?php
