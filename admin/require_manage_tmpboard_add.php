...
if (isset($_GET['GP_upload'])) {
	...
	$ppu->path = $SiteImgFilePathAdmin . $_POST['webname'] . "/image/tmpboard";
	$ppu->extensions = "GIF,JPG,JPEG,BMP,PNG";
	$ppu->formName = "form_TmpBoard";
	$ppu->storeType = "file";
	$ppu->sizeLimit = "1000";
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_TmpBoard")) {
  $insertSQL = sprintf("INSERT INTO demo_tmpboard (name, type, tmp_w_marge_top, tmp_w_marge_bottom, tmp_w_marge_left, tmp_w_marge_right, tmp_w_padding_top, tmp_w_padding_bottom, tmp_w_padding_left, tmp_w_padding_right, tmp_w_font_color, tmp_w_board_style, tmp_w_board_width, tmp_w_board_color, tmp_w_background_color, tmp_w_background_img, borderradius_t_l, borderradius_t_r, borderradius_b_l, borderradius_b_r, boxshadow_x, boxshadow_y, boxshadow_size, boxshadow_color, lineargradient_top, lineargradient_bottom, tmp_l_t_background_img, tmp_l_t_repeat, tmp_l_t_width, tmp_l_t_height, tmp_m_t_background_img, tmp_m_t_repeat, tmp_m_t_height, tmp_r_t_background_img, tmp_r_t_repeat, tmp_r_t_width, tmp_r_t_height, tmp_l_m_background_img, tmp_l_m_repeat, tmp_l_m_width, tmp_m_m_background_img, tmp_m_m_repeat, tmp_r_m_background_img, tmp_r_m_repeat, tmp_r_m_width, tmp_l_b_background_img, tmp_l_b_repeat, tmp_l_b_width, tmp_l_b_height, tmp_m_b_background_img, tmp_m_b_repeat, tmp_m_b_height, tmp_r_b_background_img, tmp_r_b_repeat, tmp_r_b_width, tmp_r_b_height, skeyword, notes1, lang, userid, webname) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['tmp_w_background_img'], "text"),
                       ...
                       GetSQLValueString($_POST['tmp_l_t_background_img'], "text"),
                       ...
                       GetSQLValueString($_POST['tmp_m_t_background_img'], "text"),
                       GetSQLValueString($_POST['tmp_m_t_repeat'], "text"),
                       GetSQLValueString($_POST['tmp_m_t_height'], "int"),
                       GetSQLValueString($_POST['tmp_r_t_background_img'], "text"),
                       ...
                       GetSQLValueString($_POST['tmp_m_b_background_img'], "text"),
                       GetSQLValueString($_POST['tmp_m_b_repeat'], "text"),
                       GetSQLValueString($_POST['tmp_m_b_height'], "int"),
                       GetSQLValueString($_POST['tmp_r_b_background_img'], "text"),
  ...
  $insertGoTo = "manage_tmp.php?Opt=tmpboard&lang=" . $_POST['lang'];
  /*if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 區塊外框 <small>新增</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?><?php echo '&amp;GP_upload=true'; ?>" class="form-horizontal form-bordered" data-parsley-validate="" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      <input name="name" type="text" required="" class="form-control" id="name" value="外框" maxlength="200" data-parsley-trigger="blur"/>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">上</span></div>
                  <input name="tmp_w_marge_top" class="form-control" id="tmp_w_marge_top" value="0" maxlength="3" data-parsley-min="-50" data-parsley-max="200" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1" required=""/>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">下</span></div>
                  <input name="tmp_w_marge_bottom" class="form-control" id="tmp_w_marge_bottom" value="0" maxlength="3" data-parsley-min="-50" data-parsley-max="200" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1" required=""/>
                     <div class="input-group-append"><span class="input-group-text">px</span></div>                 
              </div>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">左</span></div>
                  <input name="tmp_w_marge_left" class="form-control" id="tmp_w_marge_left" value="0" maxlength="3" data-parsley-min="-50" data-parsley-max="200" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1" required=""/>
                  <div class="input-group-append"><span class="input-group-text">px</span></div>                    
              </div>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">右</span></div>
                  <input name="tmp_w_marge_right" class="form-control" id="tmp_w_marge_right" value="0" maxlength="3" data-parsley-min="-50" data-parsley-max="200" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1" required=""/>
                    <div class="input-group-append"><span class="input-group-text">px</span></div>                  
              </div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">上</span></div>
                  <input name="tmp_w_padding_top" class="form-control" id="tmp_w_padding_top" value="0" maxlength="3" data-parsley-min="-50" data-parsley-max="200" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1" required=""/>
                      <div class="input-group-append"><span class="input-group-text">px</span></div>                
              </div>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">下</span></div>
                  <input name="tmp_w_padding_bottom" class="form-control" id="tmp_w_padding_bottom" value="0" maxlength="3" data-parsley-min="-50" data-parsley-max="200" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1" required=""/>
                     <div class="input-group-append"><span class="input-group-text">px</span></div>                 
              </div>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">左</span></div>
                  <input name="tmp_w_padding_left" class="form-control" id="tmp_w_padding_left" value="0" maxlength="3" data-parsley-min="-50" data-parsley-max="200" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1" required=""/>
                  <div class="input-group-append"><span class="input-group-text">px</span></div>                    
              </div>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">右</span></div>
                  <input name="tmp_w_padding_right" class="form-control" id="tmp_w_padding_right" value="0" maxlength="3" data-parsley-min="-50" data-parsley-max="200" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1" required=""/>
                    <div class="input-group-append"><span class="input-group-text">px</span></div>                  
              </div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-9">
          		<div class="input-group colorpicker-component colorpicker-element">				
                   <input name="tmp_w_font_color" type="text" required class="form-control colorpicker-element" id="tmp_w_font_color" value="transparent" maxlength="20" data-parsley-errors-container="#error_tmp_w_font_color" data-parsley-trigger="blur"/>
          ...
          <div class="col-md-1">
          	<button type="button" class="btn btn-default btn-block" id="TransparentButtom2" name="TransparentButtom1"><i class="fa fa-tint"></i> 設為透明</button>
          </div>
      </div>
      ...
      <div class="form-group row">
          ...
          <div class="row">
                    ...
                    <select name="tmp_w_board_style" id="tmp_w_board_style" class="form-control" data-parsley-trigger="blur">
                      <option>-- 選擇樣式 --</option>
                    ...
                    <div class="col-md-4">
                        <div class="input-group p-0">
                          ...
                          <div class="input-group-prepend"><span class="input-group-text">框線寬度</span></div>
                              <input name="tmp_w_board_width" class="form-control" id="tmp_w_board_width" value="0" maxlength="3" data-parsley-min="0" data-parsley-max="5" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                                  <div class="input-group-append"><span class="input-group-text">px</span></div>                
                          </div>
                    ...
                    <div class="col-md-4">
                        <div class="input-group colorpicker-component colorpicker-element">				
                           <input name="tmp_w_board_color" type="text" required class="form-control colorpicker-element" id="tmp_w_board_color" value="#000000" maxlength="20" data-parsley-errors-container="#error_tmp_w_board_color" data-parsley-trigger="blur"/>
                           <span class="input-group-addon"><i style="background-color: rgb(64, 18, 18);"></i></span>
                      </div>
                      <div id="error_tmp_w_board_color"></div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-9">
          		<div class="input-group colorpicker-component colorpicker-element">				
                   <input name="tmp_w_background_color" type="text" required class="form-control colorpicker-element" id="tmp_w_background_color" value="transparent" maxlength="20" data-parsley-errors-container="#error_tmp_w_background_color" data-parsley-trigger="blur"/>
                   <span class="input-group-addon"><i style="background-color: rgb(64, 18, 18);"></i></span>
              </div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
               <input id="tmp_w_background_img" name="tmp_w_background_img" type="file" size="50" maxlength="50" class="file"  data-parsley-trigger="blur" data-parsley-errors-container="#error_tmp_w_background_img" />
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">左上</span></div>
                  <input name="borderradius_t_l" class="form-control" id="borderradius_t_l" value="0" maxlength="3" data-parsley-min="0" data-parsley-max="200" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                      <div class="input-group-append"><span class="input-group-text">px</span></div>                
            </div>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">右上</span></div>
                  <input name="borderradius_t_r" class="form-control" id="borderradius_t_r" value="0" maxlength="3" data-parsley-min="0" data-parsley-max="200" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                     <div class="input-group-append"><span class="input-group-text">px</span></div>                 
            </div>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">右下</span></div>
                  <input name="borderradius_b_r" class="form-control" id="borderradius_b_r" value="0" maxlength="3" data-parsley-min="0" data-parsley-max="200" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                  <div class="input-group-append"><span class="input-group-text">px</span></div>                    
            </div>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">左下</span></div>
                  <input name="borderradius_b_l" class="form-control" id="borderradius_b_l" value="0" maxlength="3" data-parsley-min="0" data-parsley-max="200" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                    <div class="input-group-append"><span class="input-group-text">px</span></div>                  
            </div>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">X位移</span></div>
                  <input name="boxshadow_x" class="form-control" id="boxshadow_x" value="0" maxlength="3" data-parsley-min="0" data-parsley-max="200" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                      <div class="input-group-append"><span class="input-group-text">px</span></div>                
            </div>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">Y位移</span></div>
                  <input name="boxshadow_y" class="form-control" id="boxshadow_y" value="0" maxlength="3" data-parsley-min="0" data-parsley-max="200" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                     <div class="input-group-append"><span class="input-group-text">px</span></div>                 
            </div>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">陰影大小</span></div>
                  <input name="boxshadow_size" class="form-control" id="boxshadow_size" value="0" maxlength="3" data-parsley-min="0" data-parsley-max="200" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                  <div class="input-group-append"><span class="input-group-text">px</span></div>                    
            </div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-9">
          		<div class="input-group colorpicker-component colorpicker-element">				
                   <input name="boxshadow_color" type="text" required class="form-control colorpicker-element" id="boxshadow_color" value="transparent" maxlength="20" data-parsley-errors-container="#error_boxshadow_color" data-parsley-trigger="blur"/>
                   <span class="input-group-addon"><i style="background-color: rgb(64, 18, 18);"></i></span>
              </div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-3">
          		<div class="input-group colorpicker-component colorpicker-element">				
                   <input name="lineargradient_top" type="text" required class="form-control colorpicker-element" id="lineargradient_top" value="transparent" maxlength="20" data-parsley-errors-container="#error_lineargradient_top" data-parsley-trigger="blur"/>
                   <span class="input-group-addon"><i style="background-color: rgb(64, 18, 18);"></i></span>
              </div>
          ...
          <div class="col-md-3">
          		<div class="input-group colorpicker-component colorpicker-element">				
                   <input name="lineargradient_bottom" type="text" required class="form-control colorpicker-element" id="lineargradient_bottom" value="transparent" maxlength="20" data-parsley-errors-container="#error_lineargradient_bottom" data-parsley-trigger="blur"/>
                   <span class="input-group-addon"><i style="background-color: rgb(64, 18, 18);"></i></span>
              </div>
      ...
      <div class="form-group row">
       ...
       <div class="form-group row">
          <label class="col-md-2 col-form-label">背景圖</label>
          <div class="col-md-10">
               <input id="tmp_l_t_background_img" name="tmp_l_t_background_img" type="file" size="50" maxlength="50" class="file"  data-parsley-trigger="blur" data-parsley-errors-container="#error_tmp_l_t_background_img" />
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">寬度</span></div>
                  <input name="tmp_l_t_width" class="form-control" id="tmp_l_t_width" value="0" maxlength="3" data-parsley-min="0" data-parsley-max="200" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1" required=""/>
                      <div class="input-group-append"><span class="input-group-text">px</span></div>                
            </div>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">高度</span></div>
                  <input name="tmp_l_t_height" class="form-control" id="tmp_l_t_height" value="0" maxlength="3" data-parsley-min="0" data-parsley-max="200" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1" required=""/>
                     <div class="input-group-append"><span class="input-group-text">px</span></div>                 
            </div>
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">背景圖</label>
          <div class="col-md-10">
               <input id="tmp_m_t_background_img" name="tmp_m_t_background_img" type="file" size="50" maxlength="50" class="file"  data-parsley-trigger="blur" data-parsley-errors-container="#error_tmp_m_t_background_img" />
      ...
      <div class="form-group row">
        ...
        <option value="repeat">水平垂直皆重複</option>
        <option value="repeat-x" selected="selected">水平重複</option>
        <option value="repeat-y">垂直重複</option>
      </select>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">高度</span></div>
                  <input name="tmp_m_t_height" class="form-control" id="tmp_m_t_height" value="0" maxlength="3" data-parsley-min="0" data-parsley-max="200" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1" required/>
                     <div class="input-group-append"><span class="input-group-text">px</span></div>                 
              </div>
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">背景圖</label>
          <div class="col-md-10">
               <input id="tmp_r_t_background_img" name="tmp_r_t_background_img" type="file" size="50" maxlength="50" class="file"  data-parsley-trigger="blur" data-parsley-errors-container="#error_tmp_r_t_background_img" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">寬度</span></div>
                  <input name="tmp_r_t_width" class="form-control" id="tmp_r_t_width" value="0" maxlength="3" data-parsley-min="0" data-parsley-max="200" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1" required/>
                      <div class="input-group-append"><span class="input-group-text">px</span></div>                
            </div>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">高度</span></div>
                  <input name="tmp_r_t_height" class="form-control" id="tmp_r_t_height" value="0" maxlength="3" data-parsley-min="0" data-parsley-max="200" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1" required/>
                     <div class="input-group-append"><span class="input-group-text">px</span></div>                 
              </div>
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">背景圖</label>
          <div class="col-md-10">
               <input id="tmp_l_m_background_img" name="tmp_l_m_background_img" type="file" size="50" maxlength="50" class="file"  data-parsley-trigger="blur" data-parsley-errors-container="#error_tmp_l_m_background_img" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">寬度</span></div>
                  <input name="tmp_l_m_width" class="form-control" id="tmp_l_m_width" value="0" maxlength="3" data-parsley-min="0" data-parsley-max="200" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1" required/>
                      <div class="input-group-append"><span class="input-group-text">px</span></div>                
            </div>
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">背景圖</label>
          <div class="col-md-10">
               <input id="tmp_m_m_background_img" name="tmp_m_m_background_img" type="file" size="50" maxlength="50" class="file"  data-parsley-trigger="blur" data-parsley-errors-container="#error_tmp_m_m_background_img" />
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">背景圖</label>
          <div class="col-md-10">
               <input id="tmp_r_m_background_img" name="tmp_r_m_background_img" type="file" size="50" maxlength="50" class="file"  data-parsley-trigger="blur" data-parsley-errors-container="#error_tmp_r_m_background_img" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">寬度</span></div>
                  <input name="tmp_r_m_width" class="form-control" id="tmp_r_m_width" value="0" maxlength="3" data-parsley-min="0" data-parsley-max="200" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1" required/>
                      <div class="input-group-append"><span class="input-group-text">px</span></div>                
            </div>
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">背景圖</label>
          <div class="col-md-10">
               <input id="tmp_l_b_background_img" name="tmp_l_b_background_img" type="file" size="50" maxlength="50" class="file"  data-parsley-trigger="blur" data-parsley-errors-container="#error_tmp_l_b_background_img" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">寬度</span></div>
                  <input name="tmp_l_b_width" class="form-control" id="tmp_l_b_width" value="0" maxlength="3" data-parsley-min="0" data-parsley-max="200" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1" required/>
                      <div class="input-group-append"><span class="input-group-text">px</span></div>                
            </div>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">高度</span></div>
                  <input name="tmp_l_b_height" class="form-control" id="tmp_l_b_height" value="0" maxlength="3" data-parsley-min="0" data-parsley-max="200" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1" required/>
                     <div class="input-group-append"><span class="input-group-text">px</span></div>                 
              </div>
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">背景圖</label>
          <div class="col-md-10">
               <input id="tmp_m_b_background_img" name="tmp_m_b_background_img" type="file" size="50" maxlength="50" class="file"  data-parsley-trigger="blur" data-parsley-errors-container="#error_tmp_m_b_background_img" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">高度</span></div>
                  <input name="tmp_m_b_height" class="form-control" id="tmp_m_b_height" value="0" maxlength="3" data-parsley-min="0" data-parsley-max="200" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1" required/>
                     <div class="input-group-append"><span class="input-group-text">px</span></div>                 
              </div>
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">背景圖</label>
          <div class="col-md-10">
               <input id="tmp_r_b_background_img" name="tmp_r_b_background_img" type="file" size="50" maxlength="50" class="file"  data-parsley-trigger="blur" data-parsley-errors-container="#error_tmp_r_b_background_img" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">寬度</span></div>
                  <input name="tmp_r_b_width" class="form-control" id="tmp_r_b_width" value="0" maxlength="3" data-parsley-min="0" data-parsley-max="200" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1" required/>
                      <div class="input-group-append"><span class="input-group-text">px</span></div>                
            </div>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">高度</span></div>
                  <input name="tmp_r_b_height" class="form-control" id="tmp_r_b_height" value="0" maxlength="3" data-parsley-min="0" data-parsley-max="200" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1" required/>
                     <div class="input-group-append"><span class="input-group-text">px</span></div>                 
              </div>
      ...
      <input type="hidden" name="MM_insert" value="form_TmpBoard" />
  </form>
  </div>
  <!-- end panel-body --> 
</div>
...
$(document).ready(function() {
	$("#tmp_w_background_img, #tmp_l_t_background_img, #tmp_m_t_background_img, #tmp_r_t_background_img, #tmp_l_m_background_img, #tmp_m_m_background_img, #tmp_r_m_background_img, #tmp_l_b_background_img, #tmp_m_b_background_img, #tmp_r_b_background_img").fileinput({
		showUpload:true, 
		showPreview: true,
