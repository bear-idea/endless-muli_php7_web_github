...
<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>sqldatatable/js/accounts_summonsbook_cash_datatable.js"></script>
<!-- ================== END Datatables JS ================== -->
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 現金簿 <small>總覽</small>
    ...
    <table id="data-table-default" class="table table-striped table-bordered table-hover table-condensed">
      <thead>
        <tr>
          ...
          <th width="100" data-priority="1"><strong>對方會計項目</strong></th>
          <th width="100" data-priority="1"><strong>對方項目名稱</strong></th>
          <th width="100"><strong>支出金額</strong></th>
          <th width="100"><strong>收入金額</strong></th>
