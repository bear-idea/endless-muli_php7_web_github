...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_dealer.php"); ?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include_once("require_manage_dealer_index.php");			
					break;
				case "addpage":
					include_once("require_manage_dealer_add.php");
					break;
				case "addpagepic":
					include_once("require_manage_dealer_add_with_pic.php");
					break;
				case "addpagepureupload":
					include_once("require_manage_dealer_add_with_pic_pureuploadik.php");
					break;
				case "editpage":
					include_once("require_manage_dealer_edit.php"); 
					break;
				case "editpagepureupload":
					include_once("require_manage_dealer_edit_with_pic_pureuploadik.php");
					break;
				case "editpage_avatar":
					include_once("require_manage_dealer_edit_with_pic_pureupload_avatar.php");
					break;
				case "deletepage":
					include_once("require_manage_dealer_delete.php");
					break;
				case "listpage":
					include_once("require_manage_dealer_list.php");
					break;
				case "listitempage":
					include_once("require_manage_dealer_listitem.php");
					break;
				case "configpage":
					include_once("require_manage_dealer_config.php");
					break;
				case "setpage":
					include_once("require_manage_dealer_set.php");
					break;
				default:
					include_once("require_manage_dealer_index.php");
					break;
