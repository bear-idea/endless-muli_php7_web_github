...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_scaleorder_clearance.php"); ?>
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{			
				case "viewpage":
					include("require_manage_scaleorder_clearance_index.php");			
					break;
				case "addpage":
					include("require_manage_scaleorder_clearance_add.php");
					break;
				case "editpage":
					include("require_manage_scaleorder_clearance_edit.php"); 
					break;
				case "viewpage_day":
					include("require_manage_scaleorder_clearance_index_day.php"); 
					break;
				case "viewpage_month":
					include("require_manage_scaleorder_clearance_index_month.php"); 
					break;
				case "chart_month":
					include("require_manage_scaleorder_clearance_chart_month.php"); 
					break;
				case "export":
					include_once("require_manage_scaleorder_clearance_export.php");
					break;
				case "maintain":
					include_once("require_manage_scaleorder_clearance_maintain.php");
					break;
				case "setpage":
					include_once("require_manage_scaleorder_clearance_set.php");
					break;
				default:
					include("require_manage_scaleorder_clearance_index.php");
					break;
