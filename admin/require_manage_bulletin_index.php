...
<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>sqldatatable/js/bulletin_datatable.js?<?php echo time(); ?>"></script>
<!-- ================== END Datatables JS ================== -->
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> <?php echo $ModuleName_Bulletin; ?> <small>總覽</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
    ...
    <table id="data-table-default" class="table table-striped table-bordered table-hover table-condensed">
      <thead>
        <tr>
          ...
          <th data-priority="1"><strong>標題</strong></th>
        ...
        var intro = introJs();
          intro.setOptions({
            steps: [
              {
                element: '#Step_Tip1',
                intro: '<img src="images/tip/tip057.jpg" width="239" height="233" /><br /><br />依照以下的步驟操作，您可替目前的網站加入公告提示訊息。'
              },
			  {
                element: '#Step_Tip2',
                intro: '當您<span style="color:#F00; font-size:16px; font-weight:bolder">發布一份新公告</span>時或在<span style="color:#F00; font-size:16px; font-weight:bolder">使用者第一次進入網站</span>時，即尚未看過該資訊，才會產生提示訊息顯示於網站中央，之後需於右上角 <i class="fa fa-tag"></i>圖示查看。'
              },
			  {
                element: '#Step_Tip3',
                intro: '<img src="images/tip/tip058.jpg" width="422" height="474" /><br /><br />可以加入圖片及連結資訊。'
              },
			  {
                element: '#Step_Add',
                intro: '點選新增即可建立資料。'
