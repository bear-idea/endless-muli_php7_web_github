...
<span class="textfieldInvalidFormatMsg">格式無效。</span></span></td>
  ...
  <tr>
    <td>
      ...
      <input name="indicate" type="hidden" id="indicate" value="1" /></td>
    </tr>
</table>
</div>
...
$(function() {
    $("#button").click(function() {
        ...
        $.ajax({
            type: "post",
            url: url,
			data: "content="+$("#content").val()+"&pid="+$("#pid").val()+"&author="+"(訪客)"+$("#author").val()+"&remail="+$("#remail").val()+"&reurl="+$("#reurl").val()+"&indicate="+$("#indicate").val()+"&userid="+$("#userid").val(),
            //dataType: "json",
            //data: params,
...
var sprytextfield2 = new Spry.Widget.ValidationTextField("BlogPostAuthor", "none", {validateOn:["blur"]});
