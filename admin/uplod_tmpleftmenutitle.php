...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Tmp")) {
  $updateSQL = sprintf("UPDATE demo_tmpleftmenu SET tmp_title_pic=IFNULL(%s,tmp_title_pic) WHERE id=%s",
  ...
  $updateGoTo = "uplod_tmpleftmenutitle.php";
  if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <form action="<?php echo $editFormAction;?>" class="form-horizontal form-bordered" data-parsley-validate="" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
            ...
            <input name="oldpic" type="hidden" id="oldpic" value="<?php echo $row_RecordTmp['tmp_title_pic']; ?>" />
...
$(document).ready(function() {
	$("#pic").fileinput({
		...
		maxFileSize: 3000,  
		<?php if ($row_RecordTmp['tmp_title_pic'] != "") { ?>
		initialPreview: ["<?php echo $SiteImgUrlAdmin; ?><?php echo $wshop; ?>/image/tmpleftmenu/<?php echo $row_RecordTmp['tmp_title_pic']; ?>"],
		<?php } ?>
