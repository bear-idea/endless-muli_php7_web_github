...
<?php } ?>
      ...
      ?>
          ...
          ?>
                    <tr class= "<?php echo $chahgecolorcount; ?>">
                      <td align="center" valign="top" width="20"><?php if (isset($row_RecordPublish['pushtop']) && $row_RecordPublish['pushtop'] == '1') { ?><img src="<?php echo $TplImagePath; ?>/sicon/icon_newslist_top.gif" alt="icon" width="18" height="18" /><?php } else { ?><img src="<?php echo $TplImagePath; ?>/sicon/icon_newslist.gif" width="18" height="18" /><?php } ?></td>
                      <td valign="top"><?php 
              #
              # ============== [if] ============== #
			  #
      ...
      <?php } ?>
                  ...
                  <div style="height:10px;"></div>
                    <?php if($totalPages_RecordPublish > 0) { ?>
 				    <div class="col-md-7 col-xs-12">
                        <div style="text-align:center;">
                        <?php //if ($page > 0) { // Show if not first page ?>
                        <div class="col-md-3 col-xs-12">
                            <a href="<?php printf("%s?page=%d%s", $currentPage, 0, $queryString_RecordPublish); ?>" class="btn btn-reveal btn-white" style="width:100%; margin:2px;">
                        ...
                        <div class="col-md-3 col-xs-12">
                            <a href="<?php printf("%s?page=%d%s", $currentPage, max(0, $page-1), $queryString_RecordPublish); ?>" class="btn  btn-reveal btn-white" style="width:100%; margin:2px;">
                            <i class="fa fa-angle-left"></i>
                            <span><?php echo $Lang_Prev; ?></span>
                            </a> 
                        </div>
                        <div class="col-md-3 col-xs-12">
                            <a href="<?php printf("%s?page=%d%s", $currentPage, min($totalPages_RecordPublish, $page+1), $queryString_RecordPublish); ?>" class="btn  btn-reveal btn-white" style="width:100%; margin:2px;">
                        ...
                        <div class="col-md-3 col-xs-12">
                            <a href="<?php printf("%s?page=%d%s", $currentPage, $totalPages_RecordPublish, $queryString_RecordPublish); ?>" class="btn btn-reveal btn-white" style="width:100%; margin:2px;">
                        ...
                        <div> 
                            ...
                            <div style="margin:2px 0px 2px 0px;">
                                <select class="form-control" onchange="location = this.options[this.selectedIndex].value;">
                                    <?php for($i=0; $i<ceil($totalRows_RecordPublish/$maxRows_RecordPublish); $i++) { ?>
                                    <option value="<?php printf("%s?page=%d%s", $currentPage, $i,  $queryString_RecordPublish); ?>" <?php if($_GET['page'] == $i) { ?>selected="selected"<?php } ?>><?php echo $i+1; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            </div>
                            ...
                            <a href="#" class="btn btn-white" style="width:100%; margin:2px 0px 2px 0px;">
                                <span><?php echo $Lang_Content_Count_Total; ?><?php echo $totalRows_RecordPublish; ?><?php echo $Lang_Content_Count_Lots; ?></span>
                            </a>
                            </div>
                        </div>
                    </div>
