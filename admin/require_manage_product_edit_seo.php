...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Product")) {
  ...
  $updateSQL = sprintf("UPDATE demo_product SET name=%s, sdescription=%s, skeyword=%s, ogtitle=%s, ogtype=%s, ogurl=%s, ogimage=%s, ogdescription=%s, notes1=%s, lang=%s WHERE id=%s",
  ...
  $updateGoTo = "manage_product.php?Opt=seo&lang=" . $_POST['lang'];
  /*if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <form action="<?php echo $editFormAction;?><?php echo '&amp;GP_upload=true'; ?>" class="form-horizontal form-bordered" data-parsley-validate="" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="ogtitle" type="text" class="form-control" id="ogtitle" value="<?php echo $row_RecordProduct['ogtitle']; ?>" maxlength="200" data-parsley-trigger="blur" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="ogtype" type="text" class="form-control" id="ogtype" value="<?php echo $row_RecordProduct['ogtype']; ?>" maxlength="200" data-parsley-trigger="blur" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="ogurl" type="url" class="form-control" id="ogurl" value="<?php echo $row_RecordProduct['ogurl']; ?>" maxlength="200" data-parsley-trigger="blur" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                 <input name="ogdescription" type="text" class="form-control" id="ogdescription" value="<?php echo $row_RecordProduct['ogdescription']; ?>" size="100" maxlength="150"/> 
          </div>
      </div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
            ...
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordProduct['indicate'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="indicate" id="indicate_1" value="1" />
                <label for="indicate_1">公佈</label>
            </div>
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordProduct['indicate'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="indicate" id="indicate_2" value="0" />
                <label for="indicate_2">隱藏</label>
            </div>
	        <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordProduct['indicate'],"2"))) {echo "checked=\"checked\"";} ?> type="radio" name="indicate" id="indicate_3" value="2" />
      ...
      <div class="form-group row">
        ...
        <div class="col-md-10">
          <button type="submit" class="btn btn btn-primary btn-block">送出</button>
            ...
            <input name="lang" type="hidden" id="lang" value="<?php echo $row_RecordProduct['lang']; ?>" />
            <input name="editdate" type="hidden" id="editdate" value="<?php echo date("Y-m-d H-i-s"); ?>" />
            <input name="wshop" type="hidden" id="wshop" value="<?php echo $wshop; ?>" />
            <input name="oldpic" type="hidden" id="oldpic" value="<?php echo $row_RecordProduct['ogimage']; ?>" />
          </div>
      </div>
...
$(document).ready(function() {
	$("#ogimage").fileinput({
		...
		<?php if($row_RecordProduct['ogimage'] != "") { ?>
		initialPreview: [<?php echo "'" . $SiteImgUrlAdmin . $wshop ."/image/seo/" . $row_RecordProduct['ogimage'] .  "'"; ?>],
		initialPreviewConfig: [<?php echo "{url: 'sqldatatable/product_seophoto_del.php?id_del=".$row_RecordProduct['id']."', key: ".$row_RecordProduct['id'].", extra: {id:".$row_RecordProduct['id']."} }"; ?>],
		<?php } ?>
