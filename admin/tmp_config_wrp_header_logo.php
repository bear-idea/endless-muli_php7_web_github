...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Tmp")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmplogomargintop=%s, tmplogomarginleft=%s WHERE id=%s",
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post" id="form_Tmp" name="form_Tmp">
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
            ...
            <div style="color: #CCC; font-size: 30px; font-weight: bolder; padding: 10px; position: absolute; left: 50px; top: 50px;border:#CCC dotted 1px; width:200px;">Logo<span style="font-size:16px;"> <a href="tmplogo_home.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;id=<?php echo $row_RecordTmp['id']; ?>" data-original-title="選擇您的Logo樣式。" data-toggle="tooltip" data-placement="top" class="btn btn-info">Logo選擇</a></span></div>
            <div style="position: absolute; right: 409px; top: 3px;"><img src="images/z_w.png" width="44" height="44" /></div>
              ...
              <div class="input-group p-0">
                      ...
                      <div class="input-group-prepend"><span class="input-group-text">距離左方 <i class="fa fa-info-circle text-black" data-original-title="在此輸入X軸的距離，可允許輸入負值，例如若您輸入數字為5代表此Logo會右移5px；輸入的數字為-3代表此Logo會向左移3px。" data-toggle="tooltip" data-placement="top"></i></span></div>
                          <input name="tmplogomarginleft" id="tmplogomarginleft" value="<?php echo $row_RecordTmp['tmplogomarginleft']; ?>" size="4" class="form-control" maxlength="4" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
          ...
          <span style="color: #CCC; font-size: 30px; font-weight: bolder; padding: 10px; position: absolute; right: 5px; bottom: 5px;">頁首區塊</span>
            </div>
            </div>
            </div>          
        </div>
