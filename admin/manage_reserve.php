...
$(document).ready(function() 
{
   ...
   $('.tip_img_r1').qtip({
      content: '<img src="images/tip/tip017.jpg" width="356" height="171" />'
   });
   $('.tip_img_r2').qtip({
      content: '<img src="images/tip/tip019.jpg" width="212" height="137" />'
   });
   $('.tip_img_r3').qtip({
      content: '<img src="images/tip/tip020.jpg" width="266" height="142" />'
   });
   $('.tip_img_r4').qtip({
      content: '<img src="images/tip/tip050.jpg" width="479" height="222" />'
   });
});
</script>
<script type="text/javascript" src="js/jquery.isotope.min.js"></script>
<script type="text/javascript">$(function(){$(".Menu_ListView_Index_Room").isotope({itemSelector:".Menu_ListView_Icon_Board_Room",layoutMode:"masonry"})});</script>
<!-- InstanceEndEditable -->
</head>
<body>
...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_reserve.php"); ?>
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include_once("require_manage_reserve_index_search.php");			
					break;
				case "gen":
					include_once("require_manage_reserve_generate.php");			
					break;
				case "gen_st":
					include_once("require_manage_reserve_generate_setting.php");			
					break;
				case "odpage":
					include_once("require_manage_reserve_setting.php");			
					break;
				case "order":
					include_once("require_manage_reserve_order.php");			
					break;
				case "state":
					include_once("require_manage_reserve_state.php");			
					break;
				case "sv":
					include_once("require_manage_reserve_sv.php");			
					break;
				case "listpage":
					include_once("require_manage_reserve_list.php");
					break;
				case "listitempage":
					include_once("require_manage_reserve_listitem.php");
					break;
				case "setpage":
					include_once("require_manage_reserve_set.php");
					break;
				default:
					include_once("require_manage_reserve_index_search.php");
					break;
