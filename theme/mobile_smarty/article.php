  ...
  <?php 
    ...
    <?php if ($TmpWrpViewLineLocate == '2') { ?>               
        ...
        <section class="page-header page-header-xxs">
			...
			<?php echo $ModuleName['Article']; ?>
			<!-- InstanceEndEditable --></h1>
            <!-- InstanceBeginEditable name="導覽列" -->
                                    <?php require("require_article_viewline_mobile.php"); ?>
                    <!-- InstanceEndEditable -->
        </section>
	...
	<?php } ?>
      ...
      <div class="row">      
        ...
        <?php
			...
			{
				case "viewpage":
					include_once("require_article.php");				
					break;
				case "subpage":		
				case "typepage":
				case "maintypepage":
					include_once("require_article_type.php");				
					break;
				case "detailed":
					include_once("require_article_detailed.php");				
					break;
				default:   
					include_once("require_article.php");	
					break;  
