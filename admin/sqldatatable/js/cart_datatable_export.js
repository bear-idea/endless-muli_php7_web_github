var handleDataTableDefault = function() {
    ...
    if ($('#data-table-default').length !== 0) {
		...
		"dom":"lBprtip",buttons:[{extend:"copy",className:"btn-sm"},{extend:"csv",className:"btn-sm"},{extend:"excel",className:"btn-sm"},{extend:"pdf",className:"btn-sm"},{extend:"print",className:"btn-sm"},{extend:"colvis",className:"btn-sm"}],
			//"dom": "lprtip",
			//"scrollX": true,
			"buttons":[{extend:"copy",className:"btn-sm"},{extend:"csv",className:"btn-sm"},{extend:"excel",className:"btn-sm"},{extend:"pdf",className:"btn-sm"},{extend:"print",className:"btn-sm"},{extend:"colvis",className:"btn-sm"}],
            "autoWidth": false,
            "ajax": {
                "url": "sqldatatable/cart_view_export.php",
                "type": "post",
				"data": function ( d ) {
					...
					d.search_state = $('#col23_filter').val();
					
					d.search_postdate = $('#col1_filter').val();
					
					
					//console.log($('#col14_filter').val());
			...
			{
                "data": "ocinvoiceetselect",
                "orderable": true
            },
			{
                "data": "ocinvoicecompanyno",
                "orderable": true
            },
			{
                "data": "ocinvoicetitle",
			...
			{
                "data": "ocfreepricedesc",
                "orderable": true
            },
			{
                "data": "ocfreightstateonly",
                "orderable": true
            },
			{
                "data": "ocexprice",
            ...
            "lengthMenu": [[10, 25, 50, 100], [10, 25, 50, 100] // change per page values here
            ],
            "language": //把文本變為中文
            {
                "sProcessing": "處理中...",
			...
			"stateSaveParams": function (settings, data) {
				...
				data.search.field = {
					...
					state: $("#col7_filter").val(),
					postdate: $("#col4_filter").val(),
			...
			"stateLoadParams": function (settings, data) {
				...
				$("#col7_filter").val(data.search.field.state);
				
				$("#col4_filter").val(data.search.field.postdate);
            ...
            "fnDrawCallback": function(oSettings) {
                ...
                $('#data-table-default').editable({
                    selector: ".ed_title",
                    url: 'sqledit/cartorders_jedit.php',
                    type: 'text',
                    name: 'title',
                    //title: '輸入標題',
				...
				$('#data-table-default').editable({
                    ...
                    url: 'sqledit/cartorders_jedit.php',
                    name: "type",
                    source: "sqledit/cart_get_list.php?list_id=1",
                    validate: function(value) {
                        if ($.trim(value) == '') {
                            return '值不能為空';
                        }
				...
				$('#data-table-default').editable({
                    ...
                    url: 'sqledit/cartorders_jedit.php',
                    name: "state",
                    source: "sqledit/cart_get_list_state.php?list_id=1",
                    validate: function(value) {
                        if ($.trim(value) == '') {
                            return '值不能為空';
                        }
    ...
    swal({
        ...
        preConfirm: function() {
            return new Promise(function(resolve) {
                ...
                $.ajax({
                    url: "sqldatatable/cart_del.php?id_del=" + id,
                    type: "GET"
        ...
        swal({
            ...
            preConfirm: function() {
                return new Promise(function(resolve) {
                    ...
                    $.ajax({
                        url: "sqldatatable/cart_del_muti.php",
                        data: {
                            id: list_id
                        },
						//dataType: text,
