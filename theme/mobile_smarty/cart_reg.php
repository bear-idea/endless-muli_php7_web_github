  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
          ...
          <td><?php echo $Lang_Classify_Context_You_Must_Be_Logged_In_To_Purchase; //您必須登入會員才可購物 ?> <a href="<?php echo $SiteBaseUrl . url_rewrite("member",array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'log'),'',$UrlWriteEnable);?>"><?php echo $Lang_Classify_Context_Login_Member; //登入會員 ?></a><br />
<?php echo $Lang_Classify_Not_Yet_A_Member; ?><a href="<?php echo $SiteBaseUrl . url_rewrite("member",array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'reg'),'',$UrlWriteEnable);?>"><?php echo $Lang_Classify_Click_Here_To_Register; //點此註冊 ?> </a></td>
        </tr>
    </table>
    </td>
  </tr>
