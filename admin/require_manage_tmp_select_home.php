...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 首頁版型 <small>設定</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-body">
    ...
    <div class="alert alert-warning m-t-5 m-b-5"><i class="fa fa-info-circle"></i> <b>您可以在此設定首頁排版方式及外觀風格，請注意此區僅顯示目前使用中的版型外觀。<a href="manage_mobile.php?wshop=<?php echo $wshop;?>&amp;Opt=selectpage&amp;lang=<?php echo $_SESSION['lang']; ?>" class="btn btn-primary btn-xs" data-original-title="若需更換目前的版型風格，請前往此處設定" data-toggle="tooltip" data-placement="top"><i class="fa fa-chevron-right"></i> 樣板套用</a></b></div>
