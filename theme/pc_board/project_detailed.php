...
div .project_inner_board{margin:5px}
...
<?php if (ceil($totalRows_RecordProject/$maxRows_RecordProject) > 1) { ?><span class="Record_Board"><?php echo $Lang_PageNum;; // 頁數?>：<?php print $pageNum_RecordProject+1; ?> / <?php echo ceil($totalRows_RecordProject/$maxRows_RecordProject); ?></span><?php } ?>
        ...
        <?php if ($row_RecordProject['location'] != '') { ?><?php echo $Lang_Classify_Context_Location_Project //地點： ?><?php echo $row_RecordProject['location']; ?><?php } ?> <?php if  ($row_RecordProject['startdate'] != '' || $row_RecordProject['enddate'] != '') { ?><strong><?php echo $Lang_Classify_Context_Date_Project //時間： ?></strong><?php echo $row_RecordProject['startdate']; ?><?php if  ($row_RecordProject['startdate'] != '' && $row_RecordProject['enddate'] != '') { ?>~<?php } ?><?php echo $row_RecordProject['enddate']; ?><?php } ?>
        </div>
 ...
 <?php if ($row_RecordProject['content'] != '') { ?>
 <hr />
 <?php } ?>
                   ...
                   <div class="photoFrame_<?php echo $TmpProjectBoard; ?>">
                	...
                	<div class='<?php echo $TmpProjectBoardIcon; ?>'></div>
                       ...
                       <?php if ($row_RecordProject['pic'] != "") { ?>
                         <a href="<?php echo $SiteImgUrl; ?><?php echo $_GET['wshop']; ?>/image/project/<?php echo $row_RecordProject['pic']; ?>" title="<?php echo $row_RecordProject['sdescription']; ?>" rel="prettyPhoto[pp_gal]"><img src="<?php echo $SiteImgUrl; ?><?php echo $_GET['wshop']; ?>/image/project/thumb/small_<?php echo GetFileThumbExtend($row_RecordProject['pic']); ?>" alt="<?php echo $row_RecordProject['sdescription']; ?>" alumb="false" _w="190" _h="130" /></a><span></span>
                         <?php } else { ?>      
                          <a><img src="<?php echo $TplNoLangImagePath ?>/190x130_noimage.jpg" alumb="true" _w="190" _h="130"/></a><span></span>
                          <?php } ?>
                       </div> 
                     </div>  
                   </div>
