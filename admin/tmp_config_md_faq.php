...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Tmp")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmpfaqstate=%s, tmpfaqtitlefontcolor=%s, tmpfaqtitlefontsize=%s, tmpfaqbgcolor=%s, tmpfaqshadow=%s WHERE id=%s",
                       GetSQLValueString($_POST['tmpfaqstate'], "int"),
                       GetSQLValueString($_POST['tmpfaqtitlefontcolor'], "text"),
                       GetSQLValueString($_POST['tmpfaqtitlefontsize'], "text"),
                       GetSQLValueString($_POST['tmpfaqbgcolor'], "text"),
					   GetSQLValueString($_POST['tmpfaqshadow'], "text"),
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post" id="form_Tmp" name="form_Tmp">
       ...
       <div class="form-group row">
          <label class="col-md-2 col-form-label">起始狀態<span class="text-red">*</span></label>                       	
          <div class="col-md-10">
          
      <select name="tmpfaqstate" id="tmpfaqstate" class="form-control" data-parsley-trigger="blur" required="">
        <option value="0" <?php if (!(strcmp("0", $row_RecordTmp['tmpfaqstate']))) {echo "selected=\"selected\"";} ?>>開始時不顯示問題答案</option>
        <option value="1" <?php if (!(strcmp("1", $row_RecordTmp['tmpfaqstate']))) {echo "selected=\"selected\"";} ?>>開始時顯示全部問題答案</option>
      </select>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
          		<div class="input-group colorpicker-component colorpicker-element">				
                   <input name="tmpfaqtitlefontcolor" type="text" required class="form-control colorpicker-element" id="tmpfaqtitlefontcolor" value="<?php echo $row_RecordTmp['tmpfaqtitlefontcolor']; ?>" maxlength="20" data-parsley-errors-container="#error_tmpfaqtitlefontcolor" data-parsley-trigger="blur"/>
                   <span class="input-group-addon"><i style="background-color: rgb(64, 18, 18);"></i></span>
              </div>
              <div id="error_tmpfaqtitlefontcolor"></div>
  	  ...
  	  <div class="form-group row">
          <label class="col-md-2 col-form-label">標題文字大小<span class="text-red">*</span></label>
          <div class="col-md-10">
                      
                      <select name="tmpfaqtitlefontsize" id="tmpfaqtitlefontsize" class="form-control">
          <option value="0.563em" <?php if (!(strcmp("0.563em", $row_RecordTmp['tmpfaqtitlefontsize']))) {echo "selected=\"selected\"";} ?>>9px</option>
          <option value="0.625em" <?php if (!(strcmp("0.625em", $row_RecordTmp['tmpfaqtitlefontsize']))) {echo "selected=\"selected\"";} ?>>10px</option>
          <option value="0.688em" <?php if (!(strcmp("0.688em", $row_RecordTmp['tmpfaqtitlefontsize']))) {echo "selected=\"selected\"";} ?>>11px</option>
          <option value="0.75em" <?php if (!(strcmp("0.75em", $row_RecordTmp['tmpfaqtitlefontsize']))) {echo "selected=\"selected\"";} ?>>12px</option>
          <option value="0.875em" <?php if (!(strcmp("0.875em", $row_RecordTmp['tmpfaqtitlefontsize']))) {echo "selected=\"selected\"";} ?>>14px</option>
          <option value="1em" <?php if (!(strcmp("1em", $row_RecordTmp['tmpfaqtitlefontsize']))) {echo "selected=\"selected\"";} ?>>16px</option>
          <option value="xx-small" <?php if (!(strcmp("xx-small", $row_RecordTmp['tmpfaqtitlefontsize']))) {echo "selected=\"selected\"";} ?>>xx-small</option>
          <option value="x-small" <?php if (!(strcmp("x-small", $row_RecordTmp['tmpfaqtitlefontsize']))) {echo "selected=\"selected\"";} ?>>x-small</option>
          <option value="small" <?php if (!(strcmp("small", $row_RecordTmp['tmpfaqtitlefontsize']))) {echo "selected=\"selected\"";} ?>>small</option>
          <option value="medium" <?php if (!(strcmp("medium", $row_RecordTmp['tmpfaqtitlefontsize']))) {echo "selected=\"selected\"";} ?>>medium</option>
          <option value="large" <?php if (!(strcmp("large", $row_RecordTmp['tmpfaqtitlefontsize']))) {echo "selected=\"selected\"";} ?>>large</option>
        </select>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
          		<div class="input-group colorpicker-component colorpicker-element-rgba">				
                   <input name="tmpfaqbgcolor" type="text" required class="form-control colorpicker-element-rgba" id="tmpfaqbgcolor" value="<?php echo $row_RecordTmp['tmpfaqbgcolor']; ?>" maxlength="30" data-parsley-errors-container="#error_tmpfaqbgcolor" data-parsley-trigger="blur" data-color-format="rgba"/>
                   <span class="input-group-addon"><i style="background-color: rgb(64, 18, 18, 0.6);"></i></span>
              </div>
              <div id="error_tmpfaqbgcolor"></div>
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">外框陰影<span class="text-red">*</span></label>                       	
          <div class="col-md-10">
          
      <select name="tmpfaqshadow" id="tmpfaqshadow" class="form-control" data-parsley-trigger="blur" required="">
        <option value="0" <?php if (!(strcmp("0", $row_RecordTmp['tmpfaqshadow']))) {echo "selected=\"selected\"";} ?>>預設</option>
        <option value="1" <?php if (!(strcmp("1", $row_RecordTmp['tmpfaqshadow']))) {echo "selected=\"selected\"";} ?>>無</option>
      </select>
...
<script>
	$(document).ready(function() {
	  ...
	  $(".colorpicker-element-rgba").colorpicker();
		//Highlight.init();
