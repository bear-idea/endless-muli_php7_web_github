...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_Company")) {
  $insertSQL = sprintf("INSERT INTO invoicing_company (type, title, code, sname, leader, contactperson, sales, mail, tel, tel2, cellphone, companyaddr, invoiceaddr, invoicetittle, fax, VATnumber, createdate, indicate, notes1, lang, userid) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 公司資料 <small>新增</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
