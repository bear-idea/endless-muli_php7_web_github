...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-body">
    ...
    <div class="alert alert-warning"><i class="fa fa-info-circle"></i> <b>此頁面版型套用後即為您網站於 <span class="label label-warning">電腦 / 筆電</span> 的外觀。</b></div>
    
    <div class="row">
      <div class="col-md-6">
        <div class="m-b-10 f-s-10 m-t-0"><b class="text-inverse"><span class="label label-success">目前套用</span> <span class="label label-success">桌面裝置</span> <span class="label label-danger">雙版型</span> <span class="label label-warning">電腦 / 筆電</span></b></div>
