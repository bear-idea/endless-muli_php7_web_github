    ...
    <div class="container">
      <div class="column">  
        <div class="container ct_board ct_title">
          <h1 style="font-size:large"><?php if($TmpTitleBgImage != ''){ ?><span class="titlesicon" data-scroll-reveal="enter top"><img src="<?php if($SiteBaseUrlOuter != "" && $TmpTitleBgWebName == 'playweb') { echo $SiteImgUrlOuter; } else { echo $SiteImgUrl; } ?><?php echo $TmpTitleBgWebName; ?>/image/tmpbackground/<?php echo $TmpTitleBgImage; ?>" /></span><?php } ?> <span class="titlesicon" data-scroll-reveal="enter right"><?php echo $Lang_Dfpage_Search; // 文章搜尋 ?></span></h1>
                </div>
            </div>
        </div>        
</div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  class="TB_General_style00">
  <tr>
    ...
    <td width="50%" align="right"><?php //if ($DfPageSearchSelect == "1") { ?>
      <form id="form_DfPage" name="form_DfPage" method="get" action="<?php echo $editFormAction; ?>">
        <label>
          ...
          <input name="Opt" type="hidden" id="Opt" value="search" />
          <input name="tp" type="hidden" id="tp" value="<?php echo $_GET['tp'] ?>" />
      ...
      $pages_navigation_RecordDfPage = buildNavigation($pageNum_RecordDfPage,$totalPages_RecordDfPage,$prev_RecordDfPage,$next_RecordDfPage,$separator,$max_links,true); 
       ?>
        ...
        <?php print $pages_navigation_RecordDfPage[0]; ?> <?php print $pages_navigation_RecordDfPage[1]; ?> <?php print $pages_navigation_RecordDfPage[2]; ?>
        ...
        <?php if (ceil($totalRows_RecordDfPage/$maxRows_RecordDfPage) > 1) { ?>
        <span class="Record_Board"><?php echo $Lang_PageNum;; // 頁數?>：<?php print $pageNum_RecordDfPage+1; ?> / <?php echo ceil($totalRows_RecordDfPage/$maxRows_RecordDfPage); ?></span>
        <?php } ?>
      </div></td>
  </tr>
</table>
      ...
      ?>
		  ...
		  #
		  # 表格隔行換色
		  $oddtr=TR_DfPage_Odd_Color_Style;
          $eventr=TR_DfPage_Even_Color_Style;
          ...
          ?>
                    <tr class= "<?php echo $chahgecolorcount; ?>">
                      ...
                      <td valign="top">
                        <a href="<?php echo $SiteBaseUrl . url_rewrite("dfpage",array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'viewpage','aid'=>$row_RecordDfPage['aid']),'',$UrlWriteEnable);?>"><?php echo $row_RecordDfPage['title']; ?></a></td>
                      <td width="120" valign="top"><?php echo highLight(date('Y-m-d',strtotime($row_RecordDfPage['postdate'])), @$_GET['searchkey'], $HighlightSelect); ?></td>
                    </tr>
                    <?php 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="TB_General_style00">
  ...
  <tr>
    <td align="center"><?php if (isset($_SESSION['MM_UserGroup'])) { ?>您可登入後台之維護介面：  <strong style="color:#090;"><?php echo $ModuleName['DfPage']; // 標題文字 ?>  →  新增</strong> 來建立新資料<?php } ?></td>
  </tr>
</table>
<br />
<br />
