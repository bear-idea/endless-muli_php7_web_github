              ...
              <div class="container product_inner_board">
                ...
                <div class='<?php echo $TmpProductBoardIcon; ?>'></div>
                  ...
                  <?php if ($row_RecordProduct['pic'] != "") { ?>	 
                        <a href="product.php?wshop=<?php echo $_GET['wshop'];?>&amp;Opt=detailed&amp;lang=<?php echo $_SESSION['lang']; ?>&amp;tp=Product&amp;level=<?php echo $level; ?>&amp;type1=<?php echo $row_RecordProduct['type1']; ?>&amp;type2=<?php echo $row_RecordProduct['type2']; ?>&amp;type3=<?php echo $row_RecordProduct['type3']; ?>&amp;subitem_id=<?php echo $_GET['subitem_id']; ?>&amp;id=<?php echo $row_RecordProduct['id']; ?>" title="<?php echo $row_RecordProduct['name']; ?>"><img src="<?php echo $SiteImgUrl; ?><?php echo $_GET['wshop']; ?>/image/product/thumb/small_<?php echo GetFileThumbExtend($row_RecordProduct['pic']); ?>" alt="<?php echo $row_RecordProduct['sdescription']; ?>" alumb="true" _w="100" _h="100"/></a><span></span>
                  <?php } else { ?>      
                    ...
                    <div class="product_inner_board_context">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td>
                            <a href="product.php?wshop=<?php echo $_GET['wshop'];?>&amp;Opt=detailed&amp;lang=<?php echo $_SESSION['lang']; ?>&amp;tp=Product&amp;level=<?php echo $level; ?>&amp;type1=<?php echo $row_RecordProduct['type1']; ?>&amp;type2=<?php echo $row_RecordProduct['type2']; ?>&amp;type3=<?php echo $row_RecordProduct['type3']; ?>&amp;subitem_id=<?php echo $_GET['subitem_id']; ?>&amp;id=<?php echo $row_RecordProduct['id']; ?>"><span style="color: <?php echo $TmpProductBoardFontColor; ?>"><u><?php echo $row_RecordProduct['name']; ?></u></span></a>
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td><?php echo $Lang_Classify_Context_Currency_units; ?><?php echo doFormatMoney($row_RecordProduct['price']); ?></td>
                          </tr>
                          <?php } ?>
                          ...
                          <tr>
                            ...
                            <td><?php echo TrimByLength($row_RecordProduct['sdescription'], 25, false); ?></td>
                          </tr>
                          <?php } ?>
                        </table>
                  </div>   
