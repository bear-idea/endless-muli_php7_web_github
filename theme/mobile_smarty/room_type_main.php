                    ...
                    <div class="room_inner_board_context">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            ...
                            <td><?php echo $Lang_Classify_Context_Currency_units; ?><?php echo doFormatMoney($row_RecordRoom['price']); ?></td>
                          </tr>
                          <?php } ?>
                          <?php if ($row_RecordRoom['spprice'] !='') { ?>
                          <tr>
                            <td align="right" valign="top">特惠價：</td>
                            <td><?php echo $Lang_Classify_Context_Currency_units; ?><?php echo doFormatMoney($row_RecordRoom['spprice']); ?></td>
                          </tr>
                          <?php } ?>
