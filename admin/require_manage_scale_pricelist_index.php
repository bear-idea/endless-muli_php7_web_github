...
<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>sqldatatable/js/scale_datatable_pricelist.js"></script>
<!-- ================== END Datatables JS ================== -->
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 物料價格 <small>區間</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-heading">
    ...
    <div class="btn-group pull-right"><a href="inner_scale.php?wshop=<?php echo $wshop; ?>&amp;Opt=pricelistadd&amp;lang=<?php echo $_SESSION['lang']; ?>&amp;code=<?php echo $_GET['code']; ?>" class="btn btn-default btn-sm"><i class="fa fa-plus"></i> 新增</a></div>
  ...
  <div class="panel-body">
    ...
    <div class="alert alert-warning"><i class="fa fa-info-circle"></i> <b>舊物料價格不須更動，價格會依據時間範圍來自動抓取。</b></div>
    
    <div class="row justify-content-end">
      <div class="col-md-2 m-b-10">
        <div class="input-group" data-column="8"> <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 狀態</span></span>
      ...
      <div class="col-md-2 col-sm-12 m-b-10">
        <div class="input-group" data-column="6"> <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 廠商</span></span>
            <select name="manufacturer" class="form-control search_filter" id="col6_filter">
    ...
    <table id="data-table-default" class="table table-striped table-bordered table-hover table-condensed">
      <thead>
        <tr>
          ...
          <th width="-1" data-priority="1"><strong>價格</strong></th>
          <th width="100" data-priority="1"><strong>起始時間</strong></th>
          <th width="100" data-priority="1"><strong>結束時間</strong></th>
          <th width="40" data-priority="1"><strong>代碼</strong></th>
          <th width="40" data-priority="1"><strong>計費方式</strong></th>
...
<script>
	...
	$(document).ready(function() {
		/* 字串須加 ' ' */
		TableManageDefault.init('<?php echo $_GET['code']?>');		
	});
</script>
