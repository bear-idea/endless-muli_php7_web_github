...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmphomebottombackground=%s WHERE id=%s",
   ...
   <table width="100%" border="0" cellspacing="0" cellpadding="0" class="TB_General_style02">
          <tr>
            ...
            <td width="155" align="right">
               <div>
                  <a href="tmp_config_<?php echo $_GET['board']; ?>.php?lang=<?php echo $_SESSION['lang']; ?>&amp;id_edit=<?php echo $_GET['id']; ?>&amp;board=<?php echo $_GET['board']; ?>" class="button_a">
                     <span class="button_b">
          ...
          <tr>
            ...
            <form id="form_TmpBackGround" name="form_TmpBackGround" method="get" action="<?php echo $editFormAction; ?>">
              <input name="Opt_Tmp" type="hidden" id="Opt_Tmp" value="tmpbk" />
                ...
                <input name="board" type="hidden" id="board" value="<?php echo $_GET['board']; ?>" />
...
?>
    ...
    <tbody>
      ...
      <tr>    
	   ...
	   <div style="padding:5px; border: 1px dotted #CCC; margin-bottom:2px; width:115px; float:left; margin:5px; text-align:center;" class="<?php if($row_RecordTmpBackGroundSelect['tmphomebottombackground'] == ''){echo "bg_active";} ?> bg_board"><!--無圖片指定-->
       <div class="TmpBgSelectIcon" style="display:<?php if($row_RecordTmpBackGroundSelect['tmphomebottombackground'] != ''){echo "none";} ?>;"></div>
       ...
       <?php do { ?>
           <div style="padding:5px; border: 1px dotted #CCC; margin-bottom:2px; width:115px; float:left; margin:5px; text-align:center; position:relative;" class="<?php if($row_RecordTmpBackGroundSelect['tmphomebottombackground'] == $row_RecordTmpBackGround['id']){echo "bg_active";} ?> bg_board">
           <div class="TmpBgSelectIcon" style="display:<?php if($row_RecordTmpBackGroundSelect['tmphomebottombackground'] != $row_RecordTmpBackGround['id']){echo "none";} ?>;"></div>
