...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Tmp")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmpwordcolor=%s, tmpwordsize=%s, tmplink=%s, tmplinkvisit=%s, tmplinkhover=%s WHERE id=%s",
...
<div style="padding:10px; margin:10px; position:relative;" id="wrapper_config">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="TB_General_style01">
    <tr>
      <td align="right"><i class="fa fa-chevron-right" style="color:#F00"></i> <strong>外圍框架：</strong></td>
      <td>&nbsp;</td>
    </tr>
