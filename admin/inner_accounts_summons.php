  ...
  <div id="content_full" class="content" style="padding:15px">
    ...
    <div class="col-lg-12">
      ...
      <?php
			...
			{
				case "detailpage":
					include("require_manage_accounts_summons_detail.php");			
					break;
				case "detailaddpage":
					include("require_manage_accounts_summons_detail_add.php");
					break;
				case "detaileditpage":
					include("require_manage_accounts_summons_detail_edit.php"); 
					break;
				default:
					break;
			}
