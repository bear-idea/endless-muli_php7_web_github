var handleDataTableDefault = function() {
    ...
    if ($('#data-table-default').length !== 0) {
        var otable = $('#data-table-default').DataTable({       
            ...
            "autoWidth": false,
            "ajax": {
                "url": "sqldatatable/yearend_view.php",
                "type": "post",
				"data": function ( d ) {
					...
					d.search_particularyear = $('#col6_filter').val();
					//d.search_indicate = $('#col10_filter').val();
					d.search_job = $('#col3_filter').val();
					d.search_department = $('#col2_filter').val();
			...
			"stateSaveParams": function (settings, data) {
				...
				data.search.field = {
					...
					//indicate: $("#col9_filter").val(),
					job: $('#col3_filter').val(),
					department: $('#col2_filter').val(),
					particularyear: $('#col6_filter').val()
			...
			"stateLoadParams": function (settings, data) {
				...
				$("#col10_filter").val(data.search.field.indicate);
				
				$("#col6_filter").val(data.search.field.particularyear);
				
				$("#col3_filter").val(data.search.field.job);
				
				$("#col2_filter").val(data.search.field.department);
            ...
            "fnDrawCallback": function(oSettings) {
				...
				$('#data-table-default').editable({
                    ...
                    url: 'sqledit/yearend_jedit.php',
                    name: "type",
                    source: "sqledit/yearend_get_list.php?list_id=1",
                    validate: function(value) {
                        if ($.trim(value) == '') {
                            return '值不能為空';
                        }
    ...
    swal({
        ...
        preConfirm: function() {
            return new Promise(function(resolve) {
                ...
                $.ajax({
                    url: "sqldatatable/yearend_del.php?id_del=" + id,
                    type: "GET"
        ...
        swal({
            ...
            preConfirm: function() {
                return new Promise(function(resolve) {
                    ...
                    $.ajax({
                        url: "sqldatatable/yearend_del_muti.php",
                        data: {
                            id: list_id
                        },
                        type: "POST"
