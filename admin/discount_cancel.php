...
<div style="padding:10px; margin:10px;">
  <div style="background-color:#FFFFFF; padding:5px; border: 1px solid #CCC; min-height:500px;">
   ...
   <table width="100%" border="0" cellspacing="0" cellpadding="0" class="TB_General_style02">
          <tr>
            <td><h4><strong><font color="#756b5b"><?php echo $ModuleName['Product']; ?></font><font color="#756b5b">取消 [<?php echo $langname; ?>编辑介面]</font></strong></h4></td>
            <td width="155" align="right">
              <span class = "InnerPage" style=" display:block"><a href="discount_mix.php?id=<?php echo $_GET['id']; ?>&amp;lang=<?php echo $_SESSION['lang'] ?>" title="选择当前指定商品" class="colorbox_iframe_cd" rel="tipsy_l"><strong> <i class="fa fa-reply-all"></i> 前往选择指定商品</strong></a></span>
            </td>
        </tr>
    </table>
    ...
    <tr>
      ...
      <th align="left"><strong><?php echo $ModuleName['Product']; ?>取消</strong></th>
      <th align="left">&nbsp;</th>
    ...
    <tbody>
     ...
     <?php } while ($row_RecordProduct = mysqli_fetch_assoc($RecordProduct)); ?>
       ...
       <tfoot>
        <tr>
        <td colspan="4"><input type="submit" name="button" id="button" value="提交选择" />
   ...
   <?php if ($totalRows_RecordProductListType == 0 && $totalRows_RecordProduct == 0) { // Show if recordset empty ?>
