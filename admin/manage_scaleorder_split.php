...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_scaleorder_split.php"); ?>
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include("require_manage_scaleorder_split_index.php");			
					break;
				case "addpage":
					include("require_manage_scaleorder_split_add.php");
					break;
				case "editpage":
					include("require_manage_scaleorder_split_edit.php");
					break;
				case "print_select_month":
					include("require_manage_split_print_select_month.php");
					break;
				default:
					include("require_manage_scaleorder_split_index.php");
					break;
