...
<div id="header" class="app-header {{ $appHeaderClass }}">
	...
	@includeWhen($appHeaderMegaMenu, 'backstage.includes.component.header-mega-menu')
	...
	<div class="navbar-nav">
		...
		<div class="navbar-item dropdown">
			...
			@include('backstage.includes.component.header-dropdown-notification')
		</div>

		@isset($appHeaderLanguageBar)
			@include('backstage.includes.component.header-language-bar')
		@endisset
		...
		<div class="navbar-item navbar-user dropdown">
			...
			@include('backstage.includes.component.header-dropdown-profile')
		</div>
