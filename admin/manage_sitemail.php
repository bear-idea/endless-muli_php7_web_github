...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require("require_leftmainmenu_sitemail.php");?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include("require_manage_sitemail_index.php");			
					break;
				case "advpage":
					include("require_manage_sitemail_adv_index.php");			
					break;
				case "draftpage":
					include("require_manage_sitemail_draftpage_index.php");			
					break;
				case "backuppage":
					include("require_manage_sitemail_backup_index.php");			
					break;
				case "sendpage":
					include("require_manage_sitemail_send.php");			
					break;
				case "mailpage":
					include("require_manage_sitemail_index.php");			
					break;
				case "addpage":
					include("require_manage_sitemail_add.php");
					break;
				case "addadvpage":
					include("require_manage_sitemail_adv_add.php");
					break;
				case "editpage":
					include("require_manage_sitemail_edit.php"); 
					break;
				case "addmailpage":
					include("require_manage_sitemailmail_add.php");
					break;
				case "editmailpage":
					include("require_manage_sitemailmail_edit.php"); 
					break;
				case "deletepage":
					include("require_manage_sitemail_delete.php");
					break;
				case "listpage":
					include("require_manage_sitemail_list.php");
					break;
				case "listitempage":
					include("require_manage_sitemail_listitem.php");
					break;
				case "configpage":
					include("require_manage_sitemail_config.php");
					break;
				default:
					include("require_manage_sitemail_index.php");
					break;
