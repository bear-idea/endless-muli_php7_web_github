  ...
  <div class="container">
    <div class="column">
      <div class="container ct_board">
        <h3><img src="<?php echo $TplImagePath; ?>/dot_02.jpg" width="15" height="20" /> <?php echo $Lang_Content_Title_News; // 標題文字 ?></h3>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="container board">
      ...
      -->
            ...
            <tr class= "TR_Even_Color_Style">
              ...
              <td align="left" valign="top"><span class="TipTypeStyle">[<?php echo $row_RecordNewsPushTop['type']; ?>]</span> <a href="../theme/sinlonn/news.php?Opt=detailed&amp;tp=<?php echo $_GET['tp']; ?>&amp;lang=<?php echo $_SESSION['lang']; ?>&amp;id=<?php echo $row_RecordNewsPushTop['id']; ?>"><?php echo $row_RecordNewsPushTop['title']; ?></a></td>
      ...
      ?>
          ...
          ?>
            <tr class= "<?php echo $chahgecolorcount; ?>">
			  ...
			  # ============== [/if] ============== #
              ?>
                <a href="../theme/sinlonn/news.php?Opt=detailed&amp;tp=<?php echo $_GET['tp']; ?>&amp;lang=<?php echo $_SESSION['lang']; ?>&amp;id=<?php echo $row_RecordNews['id']; ?>"><?php echo $row_RecordNews['title']; ?></a></td>
