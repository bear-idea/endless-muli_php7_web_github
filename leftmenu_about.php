...
<?php if ($totalRows_RecordAboutMultiLeftMenu > 0) { // Show if recordset not empty ?>
        <?php do { ?> 
          <li class="list-group-item">
            <a href="<?php echo $SiteBaseUrl . url_rewrite("about",array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'detailed','id'=>$row_RecordAboutMultiLeftMenu['id']),'',$UrlWriteEnable);?>"><?php echo $row_RecordAboutMultiLeftMenu['title']; ?></a>
          </li>
