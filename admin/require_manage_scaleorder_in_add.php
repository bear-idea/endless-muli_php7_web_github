...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_Scaleorder_in")) {
  ...
  $insertSQL = sprintf("INSERT INTO erp_scaleorderindetail (title, code, author, warehouse, Totalweight, Minweight, Oriweight, postdate, notes1, lang, userid) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 庫存物料 <small>新增</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
