  ...
  <?php 
    ...
    <?php if ($TmpWrpViewLineLocate == '2') { ?>               
        ...
        <section class="page-header page-header-xxs">
			...
			<?php echo $ModuleName['Timeline']; ?>
			<!-- InstanceEndEditable --></h1>
            <!-- InstanceBeginEditable name="導覽列" -->
                                    <?php require("require_timeline_viewline_mobile.php"); ?>
                    <!-- InstanceEndEditable -->
        </section>
      ...
      <div class="row">      
		...
		<!-- InstanceBeginEditable name="主內容" -->
      	...
      	<?php
			...
			{
				case "viewpage":
					include_once("require_timeline.php");				
					break;
				case "detailed":
					include_once("require_timeline_detailed.php");				
					break;
				default:
					include_once("require_timeline.php");
					break;
