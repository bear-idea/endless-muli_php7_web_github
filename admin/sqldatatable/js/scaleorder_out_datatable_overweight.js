var handleDataTableDefault = function() {
    ...
    if ($('#data-table-default').length !== 0) {
        var otable = $('#data-table-default').DataTable({       
		    "dom":"lBprtip",buttons:[{extend:"copy",className:"btn-sm",title:"過磅明細表"},{extend:"csv",className:"btn-sm",title:"過磅明細表"},{extend:"excel",className:"btn-sm",title:"過磅明細表"},{extend:"pdf",className:"btn-sm",title:"過磅明細表"},{extend:"print",className:"btn-sm",title:"過磅明細表"},{extend:"colvis",className:"btn-sm",title:"過磅明細表"}],
			//"dom": "lprtip",
            "autoWidth": false,
            "ajax": {
                "url": "sqldatatable/scaleorder_out_view_overweight.php",
                "type": "post",
				"data": function ( d ) {
					// servermode default value

					d.search_postdate = $('#col5_filter').val();
					d.search_scale = $('#col0_filter').val();
			...
			"stateLoadParams": function (settings, data) {
				...
				$("#col0_filter").val(data.search.field.scale);
