...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_scaleorder_out.php"); ?>
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include("require_manage_scaleorder_out_index.php");			
					break;
				case "viewpage2":
					include("require_manage_scaleorder_index2.php");			
					break;
				case "viewpage3":
					include("require_manage_scaleorder_index3.php");			
					break;
				case "viewpage_order":
					include("require_manage_scaleorder_out_index_order.php");			
					break;
				/*case "addpage":
					include("require_manage_scaleorder_out_add.php");
					break;*/
				case "setpage":
					include("require_manage_scaleorder_out_set_order.php");
					break;
				case "outaddpage":
					include("require_manage_scaleorder_out_add_order.php");
					break;
				case "outaddpage_old":
					include("require_manage_scaleorder_out_add_order_oseries.php");
					break;
				case "outeditpage":
					include("require_manage_scaleorder_out_edit_order.php");
					break;
				case "outaddnewpage":
					include("require_manage_scaleorder_out_add_order_new.php");
					break;
				case "outaddoldpage":
					include("require_manage_scaleorder_out_add_order_old.php");
					break;
				case "selectpage":
					include("require_manage_scaleorder_out_add_order_select.php");
					break;
				case "qradd":
					include("require_manage_scaleorder_qradd.php");
					break;
				case "Sticker":
					include("require_manage_scaleorder_sticker.php");
					break;	
				case "Sticker_qr":
					include("require_manage_scaleorder_sticker_qr.php");
					break;	
				case "editpage":
					include("require_manage_scaleorder_out_edit.php"); 
					break;
				case "notes":
					include("require_manage_scaleorder_notes.php"); 
					break;
				case "odpage":
					include("require_manage_scaleorder_setting.php"); 
					break;
				case "ivcpage":
					include("require_manage_scaleorder_inventory_correction.php"); 
					break;
				case "deletepage":
					include("require_manage_scaleorder_delete.php");
					break;
				case "listpage":
					include("require_manage_scaleorder_list.php");
					break;
				case "listitempage":
					include("require_manage_scaleorder_listitem.php");
					break;
				case "mulilistitempage":
					include_once("require_manage_scaleorder_mulilistitem.php");
					break;
				case "sub_mulilistitempage":
					include_once("require_manage_scaleorder_mulilistitem_sub.php");
					break;
				case "nvitempage":
					include_once("require_manage_scaleorder_nvlistitem.php");
					break;
				case "transititempage":
					include_once("require_manage_scaleorder_transitlistitem.php");
					break;
				case "transitset":
					include_once("require_manage_scaleorder_transitlistitem_set.php");
					break;
				case "paymentitempage":
					include_once("require_manage_scaleorder_paymentlistitem.php");
					break;
				case "paymentset":
					include_once("require_manage_scaleorder_paymentlistitem_set.php");
					break;
				case "paymentdefault":
					include_once("require_manage_scaleorder_paymentlistitem_default.php");
					break;
				case "configpage":
					include_once("require_manage_scaleorder_config.php");
					break;
				case "setpage":
					include_once("require_manage_scaleorder_set.php");
					break;
				case "exprice":
					include_once("require_manage_scaleorder_exprice.php");
					break;
				case "freeprice":
					include_once("require_manage_scaleorder_freeprice.php");
					break;
				case "invoice":
					include_once("require_manage_scaleorder_invoice.php");
					break;
				case "export":
					include_once("require_manage_scaleorder_out_export.php");
					break;
				case "exportout":
					include_once("require_manage_scaleorder_export_out.php");
					break;
				case "anypdsell":
					include_once("require_manage_scaleorder_analysis_product_sell.php");
					break;
				case "anyusbuy":
					include_once("require_manage_scaleorder_analysis_user_buy.php");
					break;
				case "anypdhot":
					include_once("require_manage_scaleorder_analysis_product_hot.php");
					break;
				case "paytip":
					include_once("require_manage_scaleorder_paytip.php");
					break;
				case "FAQ":
					include_once("require_manage_scaleorder_faq.php");
					break;
				case "discount":
					include_once("require_manage_scaleorder_discount_index.php");
					break;
				case "discount_page":
					include_once("require_manage_scaleorder_discount_page.php");
					break;
				case "discount_page_add":
					include_once("require_manage_scaleorder_discount_page_add.php");
					break;
				case "discount_page_edit":
					include_once("require_manage_scaleorder_discount_page_edit.php");
					break;
			    case "gift":
					include_once("require_manage_scaleorder_discount_gift.php");
					break;
				case "gift_add":
					include_once("require_manage_scaleorder_discount_gift_add.php");
					break;
				case "gift_edit":
					include_once("require_manage_scaleorder_discount_gift_edit.php");
					break;
				case "discount_add":
					include_once("require_manage_scaleorder_discount_add_select.php");
					break;
				case "discount_add_1":
					include_once("require_manage_scaleorder_discount_add_type1.php");
					break;
				case "discount_add_2":
					include_once("require_manage_scaleorder_discount_add_type2.php");
					break;
				case "discount_add_3":
					include_once("require_manage_scaleorder_discount_add_type3.php");
					break;
				case "discount_add_4":
					include_once("require_manage_scaleorder_discount_add_type4.php");
					break;
				case "discount_add_5":
					include_once("require_manage_scaleorder_discount_add_type5.php");
					break;
				case "discount_add_6":
					include_once("require_manage_scaleorder_discount_add_type6.php");
					break;
				case "discount_add_7":
					include_once("require_manage_scaleorder_discount_add_type7.php");
					break;
				case "discount_add_8":
					include_once("require_manage_scaleorder_discount_add_type8.php");
					break;
				case "discount_add_9":
					include_once("require_manage_scaleorder_discount_add_type9.php");
					break;
				case "discount_edit_1":
					include_once("require_manage_scaleorder_discount_edit_type1.php");
					break;
				case "discount_edit_2":
					include_once("require_manage_scaleorder_discount_edit_type2.php");
					break;
				case "discount_edit_3":
					include_once("require_manage_scaleorder_discount_edit_type3.php");
					break;
				case "discount_edit_4":
					include_once("require_manage_scaleorder_discount_edit_type4.php");
					break;
				case "discount_edit_5":
					include_once("require_manage_scaleorder_discount_edit_type5.php");
					break;
				case "discount_edit_6":
					include_once("require_manage_scaleorder_discount_edit_type6.php");
					break;
				case "discount_edit_7":
					include_once("require_manage_scaleorder_discount_edit_type7.php");
					break;
				case "discount_edit_8":
					include_once("require_manage_scaleorder_discount_edit_type8.php");
					break;
				case "discount_edit_9":
					include_once("require_manage_scaleorder_discount_edit_type9.php");
					break;
				default:
					include("require_manage_scaleorder_index.php");
					break;
			}
		?>
		<!-- InstanceEndEditable -->
