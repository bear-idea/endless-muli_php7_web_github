var handleDataTableDefault = function() {
    ...
    if ($('#data-table-default').length !== 0) {
        var otable = $('#data-table-default').DataTable({       //"dom":"lBfrtip",buttons:[{extend:"copy",className:"btn-sm"},{extend:"csv",className:"btn-sm"},{extend:"excel",className:"btn-sm"},{extend:"pdf",className:"btn-sm"},{extend:"print",className:"btn-sm"},{extend:"colvis",className:"btn-sm"}],
            ...
            "autoWidth": false,
            "ajax": {
                "url": "sqldatatable/attendance_view.php",
                "type": "post",
				"data": function ( d ) {
					...
					d.search_department = $('#col3_filter').val();
					d.search_job = $('#col4_filter').val();
            ...
            'columnDefs': [{
                ...
                'className': 'dt-body-center',
                'render': function(data, type, full, meta) {
                    return '<div class="table-responsive"><table class="table table-bordered table-condensed">'+
			...
			"stateSaveParams": function (settings, data) {
				...
				data.search.field = {
					...
					//level: $('#col1_filter').val(),
					//TimeSlot: $('#col3_filter').val(),
			...
			"stateLoadParams": function (settings, data) {
				...
				//$("#col1_filter").val(data.search.field.level);
				
				//$("#col3_filter").val(data.search.field.TimeSlot);
            ...
            "fnDrawCallback": function(oSettings) {
				...
				$('#data-table-default').editable({
                    selector: ".ed_department",
                    url: 'sqledit/staff_jedit.php',
                    name: "department",
                    source: "sqledit/staff_get_list.php?list_id=1",
				...
				$('#data-table-default').editable({
                    ...
                    url: 'sqledit/staff_jedit.php',
                    name: "job",
                    source: "sqledit/staff_get_list.php?list_id=2",
                    validate: function(value) {
                        if ($.trim(value) == '') {
                            return '值不能為空';
                        }
                ...
                $('#data-table-default').editable({
                    selector: ".ed_sortid",
                    url: 'sqledit/attendance_jedit.php',
                    type: 'text',
                    name: 'sortid',
                    //title: '輸入排序',
				...
				$('#data-table-default').editable({
                    ...
                    url: 'sqledit/attendance_jedit.php',
                    name: "level",
                    source: "sqledit/attendance_get_list.php?list_id=1",
                    validate: function(value) {
                        if ($.trim(value) == '') {
                            return '值不能為空';
                        }
    ...
    swal({
        ...
        preConfirm: function() {
            return new Promise(function(resolve) {
                ...
                $.ajax({
                    url: "sqldatatable/attendance_del.php?id_del=" + id,
                    type: "GET"
        ...
        swal({
            ...
            preConfirm: function() {
                return new Promise(function(resolve) {
                    ...
                    $.ajax({
                        url: "sqldatatable/attendance_del_muti.php",
                        data: {
                            id: list_id
                        },
                        type: "POST"
