...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 文章資料 <small>新增</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
do {  
?>
                      <option value="<?php echo $row_RecordDfPageListType['item_id']?>"><?php echo $row_RecordDfPageListType['itemname']?></option>
                      <?php
