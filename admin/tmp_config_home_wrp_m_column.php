...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Tmp")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmphomeboardtitleindicate=%s WHERE id=%s",
                       GetSQLValueString($_POST['tmphomeboardtitleindicate'], "int"),
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post" id="form_Tmp" name="form_Tmp">
       ...
       <div class="form-group row">
          <label class="col-md-2 col-form-label">區塊標題顯示<span class="text-red">*</span></label>                       	
          <div class="col-md-10">
          
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmphomeboardtitleindicate'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmphomeboardtitleindicate" id="tmphomeboardtitleindicate_0" value="1" />
                <label for="tmphomeboardtitleindicate_0">顯示</label>
            </div>
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmphomeboardtitleindicate'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmphomeboardtitleindicate" id="tmphomeboardtitleindicate_1" value="0" />
                <label for="tmphomeboardtitleindicate_1">隱藏</label>
            </div>
