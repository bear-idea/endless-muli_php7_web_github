...
$query_RecordAboutListType = sprintf("SELECT * FROM demo_aboutitem WHERE list_id = 1 && lang=%s && level='0' && userid=%s ORDER BY sortid ASC, item_id DESC", GetSQLValueString($colname_RecordAboutListType, "text"),GetSQLValueString($coluserid_RecordAboutListType, "int"));
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> <?php echo $ModuleName['About']; ?> <small>新增</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
do {  
?>
                      <option value="<?php echo $row_RecordAboutListType['item_id']?>"><?php echo $row_RecordAboutListType['itemname']?></option>
                      <?php
