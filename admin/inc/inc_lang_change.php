...
<?php 
// Top SiteName
if($_SESSION['lang'] == 'en' && $SiteSName_en != ""){$WshopTopName = $SiteSName_en;}else if($_SESSION['lang'] == 'zh-cn' && $SiteSName_cn != ""){$WshopTopName = $SiteSName_cn;}else if($_SESSION['lang'] == 'zh-tw' && $SiteSName != ""){$WshopTopName = $SiteSName;}else if($_SESSION['lang'] == 'jp' && $SiteSName_jp != ""){$WshopTopName = $SiteSName_jp;}else if($_SESSION['lang'] == 'kr' && $SiteSName_kr != ""){$WshopTopName = $SiteSName_kr;}else if($_SESSION['lang'] == 'sp' && $SiteSName_sp != ""){$WshopTopName = $SiteSName_sp;}else{} 
// Footer
