...
class MenuBackend extends BaseEloquent
{
    use LikeScope;
    use DatatablesTraits;

    protected $table = 'demo_menu_backend';
    ...
    {
        $data = $request->all();
        MenuBackend::where('id', '=', $request->input('id'))
            ->update([
    ...
    {
        return $this->belongsTo(MenuBackend::class, 'parent_id');
    }
    ...
    {
        return $this->hasMany(MenuBackend::class, 'parent_id');
    }
    ...
    /**
     * 定義 MenuBackend 與 Modules 之間的關聯（通過 Routes）
