...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Tmp")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmppublishindicate=%s WHERE id=%s",
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post" id="form_Tmp" name="form_Tmp">
       <div class="form-group row">
        ...
        <div class="col-md-12"><span class="badge badge-primary"><i class="fa fa-paper-plane"></i> <?php echo $ModuleName['Publish']; ?></span></div>
      </div>
       <div class="form-group row">
          ...
          <div class="col-md-10">
            ...
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmppublishindicate'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmppublishindicate" id="tmppublishindicate_0" value="1" />
                <label for="tmppublishindicate_0">啟用</label>
            </div>
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmppublishindicate'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmppublishindicate" id="tmppublishindicate_1" value="0" />
                <label for="tmppublishindicate_1">關閉</label>
            </div>
