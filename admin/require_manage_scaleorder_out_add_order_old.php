...
<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>sqldatatable/js/scaleorder_out_datatable_order_add_new.js"></script>
<!-- ================== END Datatables JS ================== -->
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 庫存物料 <small>選擇</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="manage_scaleorder_out.php?wshop=<?php echo $wshop;?>&amp;Opt=outaddpage_old&amp;lang=<?php echo $_SESSION['lang']; ?>" method="POST" name="Form_Choose" id="Form_Choose" data-parsley-validate=""> 
    ...
    <button type="submit" class="btn btn btn-primary btn-block m-t-10">下一步 - 選擇舊有出貨單</button>
