...
<title>Sample</title>
<!-- TemplateEndEditable -->
<link href="css/thiagosf-SkitterSlideshow/skitter.styles.min.css" type="text/css" media="all" rel="stylesheet">
<link rel="stylesheet" type="text/css" href="fonts/font-awesome/css/font-awesome.min.css">
<link rel="stylesheet" type="text/css" href="fonts/Geomanist/stylesheet.css">
<!--<link rel="stylesheet" type="text/css" href="fonts/Map-Icons-master/css/map-icons.css" />-->
...
<link rel="stylesheet" href="css/easytooltip/footable.standalone.min.css">
...
<!-- TemplateEndEditable -->
<!--<script src="fonts/Map-Icons-master/js/map-icons.js"></script>-->
<script type="text/javascript" src="<?php if($SiteBaseUrlOuter != "") { echo $SiteJsUrlOuter; } else { echo $SiteJsUrl; } ?>/thiagosf-SkitterSlideshow/jquery.animate-colors-min.js"></script>
<script type="text/javascript" src="<?php if($SiteBaseUrlOuter != "") { echo $SiteJsUrlOuter; } else { echo $SiteJsUrl; } ?>/thiagosf-SkitterSlideshow/jquery.skitter.min.js"></script>
...
<script type="text/javascript" src="<?php if($SiteBaseUrlOuter != "") { echo $SiteJsUrlOuter; } else { echo $SiteJsUrl; } ?>/freewall.js"></script>
...
<script type="text/javascript" src="<?php if($SiteBaseUrlOuter != "") { echo $SiteJsUrlOuter; } else { echo $SiteJsUrl; } ?>/jquery.abgne-minwt.divalign.js"></script>
...
<script type="text/javascript" src="<?php if($SiteBaseUrlOuter != "") { echo $SiteJsUrlOuter; } else { echo $SiteJsUrl; } ?>/cropper.js"></script>
...
$(".photoFrame_photographic07").photoFrame({skin:"photographic07",direction:"all"});$(".photoFrame_photographic08").photoFrame({skin:"photographic08",direction:"all"});$(".photoFrame_photographic09").photoFrame({skin:"photographic09",direction:"all"})});</script>  
...
<div id="header_full" >
	...
	<?php if ($TmpMainMenuLocation == '1') { // 當自定選單採用100%寬度時採用?>
        <div id="apDiv_outmenu"><div style="position:relative; width:<?php echo ($TmpWebWidth+$Tmp_Wrp_R_M_Width+$Tmp_Wrp_L_M_Width) .  $TmpWebWidthUnit; ?>; margin-left:auto; margin-right:auto;"><div id="apDiv_dftmenu"><?php require_once("mainmenu_userdfcustom.php"); ?></div></div></div>
    <?php } ?>
<?php } ?>
...
<!--  Banner  -->      
  <div id="banner" _height="none">
	...
	<div class="mdbanner_c g_p_hide">
  	...
  	<div id="context">
        <?php 
		if($Tp_Page == 'Main' && $TmpHomeBannerSelect == '1') { // 當目前版面為首頁時讀取首頁橫幅
  ...
  <div id="Left_column" >
  	<div id="context">
		<?php 
			...
			}else if ($_GET['tp'] == 'Home' || $Tp_Page == 'Main'){
