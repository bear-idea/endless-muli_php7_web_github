...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_News")) {
  ...
  $updateSQL = sprintf("UPDATE demo_news SET title=%s, sdescription=%s, skeyword=%s, ogtitle=%s, ogtype=%s, ogurl=%s, ogimage=%s, ogdescription=%s, notes1=%s, lang=%s WHERE id=%s",
  ...
  $updateGoTo = "manage_news.php?Opt=seo&lang=" . $_POST['lang'];
  /*if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="card bg-silver-lighter mb-10px" style="overflow:hidden">
  <div class="card-body">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> <?php echo $ModuleName['News']; ?> <small>修改</small> <?php require($page_view_path_vendor."require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $request->getRequestUri(); ?><?php echo '&amp;GP_upload=true'; ?>" class="form-horizontal form-bordered" data-parsley-validate="" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">標題 <i class="fa fa-info-circle text-orange" data-bs-original-title="og:title 網頁標題或是顯示內容的標題" data-bs-toggle="tooltip" data-bs-placement="top"></i></label>
          <div class="col-md-10">
                      
                      <input name="ogtitle" type="text" class="form-control" id="ogtitle" value="<?php echo $row_RecordNews['ogtitle']; ?>" maxlength="200" data-parsley-trigger="blur" />
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">類型 <i class="fa fa-info-circle text-orange" data-bs-original-title="og:type 網頁內容的類型 (有 article, book, profile, website, music, video 等類型" data-bs-toggle="tooltip" data-bs-placement="top"></i></label>
          <div class="col-md-10">
                      
                      <input name="ogtype" type="text" class="form-control" id="ogtype" value="<?php echo $row_RecordNews['ogtype']; ?>" maxlength="200" data-parsley-trigger="blur" />
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">唯一網址 <i class="fa fa-info-circle text-orange" data-bs-original-title="網頁的唯一網址 canonical URL。如果您有手機版和電腦版二個網頁、將二個網頁的og:url設成電腦版的網址，兩個網頁的facebook按讚次數就可以加總統計在一起" data-bs-toggle="tooltip" data-bs-placement="top"></i></label>
          <div class="col-md-10">
                      
                      <input name="ogurl" type="url" class="form-control" id="ogurl" value="<?php echo $row_RecordNews['ogurl']; ?>" maxlength="200" data-parsley-trigger="blur" />
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">預覽圖 <i class="fa fa-info-circle text-orange" data-bs-original-title="og:image 分享的縮圖 (網頁的預覽圖)" data-bs-toggle="tooltip" data-bs-placement="top"></i></label>
          <div class="col-md-10">
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">描述 <i class="fa fa-info-circle text-orange" data-bs-original-title="og:description 網頁內容的簡單說明、建議以二至四句話來說明。" data-bs-toggle="tooltip" data-bs-placement="top"></i></label>
          <div class="col-md-10">
                 <input name="ogdescription" type="text" class="form-control" id="ogdescription" value="<?php echo $row_RecordNews['ogdescription']; ?>" size="100" maxlength="150"/> 
          </div>
      </div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
            ...
            <div class="form-check form-check-inline">
                <input <?php if (!(strcmp($row_RecordNews['indicate'],"1"))) {echo "checked=\"checked\"";} ?> class="form-check-input"  type="radio" name="indicate" id="indicate_1" value="1" />
                <label for="indicate_1">公佈</label>
            </div>
            <div class="form-check form-check-inline">
                <input <?php if (!(strcmp($row_RecordNews['indicate'],"0"))) {echo "checked=\"checked\"";} ?> class="form-check-input"  type="radio" name="indicate" id="indicate_2" value="0" />
      ...
      <div class="form-group row">
        ...
        <div class="col-md-10">
          <button type="submit" class="btn btn btn-primary w-100 btn-block">送出</button>
            ...
            <input name="oldpic" type="hidden" id="oldpic" value="<?php echo $row_RecordNews['ogimage']; ?>" />
          </div>
      </div>
...
$(document).ready(function() {
	$("#ogimage").fileinput({
		...
		<?php if($row_RecordNews['ogimage'] != "") { ?>
		initialPreview: [<?php echo "'" . $SiteImgUrlAdmin . $wshop ."/image/seo/" . $row_RecordNews['ogimage'] .  "'"; ?>],
		initialPreviewConfig: [<?php echo "{url: 'sqldatatable/news_seophoto_del.php?id_del=".$row_RecordNews['id']."', key: ".$row_RecordNews['id'].", extra: {id:".$row_RecordNews['id']."} }"; ?>],
		<?php } ?>
