...
$coltmpid_RecordTmpConfig = "1";
if (isset($_GET['tmpid'])) {
  $coltmpid_RecordTmpConfig = $_GET['tmpid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpConfig = sprintf("SELECT * FROM demo_tmp WHERE id = %s", GetSQLValueString($coltmpid_RecordTmpConfig, "int"));
...
$coltmpid_RecordTmpHeaderBg = "1";
if (isset($_GET['tmpid'])) {
  $coltmpid_RecordTmpHeaderBg = $_GET['tmpid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpHeaderBg = sprintf("SELECT * FROM demo_tmpbackground WHERE id = (SELECT tmpheaderbackground FROM demo_tmp WHERE id=%s) ", GetSQLValueString($coltmpid_RecordTmpHeaderBg, "int"));
...
$coltmpid_RecordTmpWrpBg = "1";
if (isset($_GET['tmpid'])) {
  $coltmpid_RecordTmpWrpBg = $_GET['tmpid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpWrpBg = sprintf("SELECT * FROM demo_tmpbackground WHERE id = (SELECT tmpwrpbackground FROM demo_tmp WHERE id=%s) ", GetSQLValueString($coltmpid_RecordTmpWrpBg, "int"));
...
$coltmpid_RecordTmpLeftBg = "1";
if (isset($_GET['tmpid'])) {
  $coltmpid_RecordTmpLeftBg = $_GET['tmpid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpLeftBg = sprintf("SELECT * FROM demo_tmpbackground WHERE id = (SELECT tmpleftbackground FROM demo_tmp WHERE id=%s) ", GetSQLValueString($coltmpid_RecordTmpLeftBg, "int"));
...
$coltmpid_RecordTmpRightBg = "1";
if (isset($_GET['tmpid'])) {
  $coltmpid_RecordTmpRightBg = $_GET['tmpid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpRightBg = sprintf("SELECT * FROM demo_tmpbackground WHERE id = (SELECT tmprightbackground FROM demo_tmp WHERE id=%s) ", GetSQLValueString($coltmpid_RecordTmpRightBg, "int"));
...
$coltmpid_RecordTmpMiddleBg = "1";
if (isset($_GET['tmpid'])) {
  $coltmpid_RecordTmpMiddleBg = $_GET['tmpid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpMiddleBg = sprintf("SELECT * FROM demo_tmpbackground WHERE id = (SELECT tmpmiddlebackground FROM demo_tmp WHERE id=%s) ", GetSQLValueString($coltmpid_RecordTmpMiddleBg, "int"));
...
$coltmpid_RecordTmpFooterBg = "1";
if (isset($_GET['tmpid'])) {
  $coltmpid_RecordTmpFooterBg = $_GET['tmpid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpFooterBg = sprintf("SELECT * FROM demo_tmpbackground WHERE id = (SELECT tmpfooterbackground FROM demo_tmp WHERE id=%s) ", GetSQLValueString($coltmpid_RecordTmpFooterBg, "int"));
...
$coltmpid_RecordTmpHomeBoard = "1";
if (isset($_GET['tmpid'])) {
  $coltmpid_RecordTmpHomeBoard = $_GET['tmpid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpHomeBoard = sprintf("SELECT * FROM demo_tmpboard WHERE id = (SELECT tmphomeboard FROM demo_tmp WHERE id=%s) ", GetSQLValueString($coltmpid_RecordTmpHomeBoard, "int"));
...
$coltmpid_RecordTmpWrpBoard = "1";
if (isset($_GET['tmpid'])) {
  $coltmpid_RecordTmpWrpBoard = $_GET['tmpid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpWrpBoard = sprintf("SELECT * FROM demo_tmpboard WHERE id = (SELECT tmpwrpboard FROM demo_tmp WHERE id=%s) ", GetSQLValueString($coltmpid_RecordTmpWrpBoard, "int"));
...
$coltmpid_RecordTmpBannerBoard = "1";
if (isset($_GET['tmpid'])) {
  $coltmpid_RecordTmpBannerBoard = $_GET['tmpid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpBannerBoard = sprintf("SELECT * FROM demo_tmpboard WHERE id = (SELECT tmpbannerboard FROM demo_tmp WHERE id=%s) ", GetSQLValueString($coltmpid_RecordTmpBannerBoard, "int"));
...
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpViewlineBoard = sprintf("SELECT * FROM demo_tmpboard WHERE id = (SELECT tmpviewlineboard FROM demo_tmp WHERE id=(SELECT MSTmpSelect FROM demo_setting_fr WHERE userid=%s)) ", GetSQLValueString($coluserid_RecordTmpViewlineBoard, "int"));
...
$coltmpid_RecordTmpMiddleBoard = "1";
if (isset($_GET['tmpid'])) {
  $coltmpid_RecordTmpMiddleBoard = $_GET['tmpid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpMiddleBoard = sprintf("SELECT * FROM demo_tmpboard WHERE id = (SELECT tmpmiddleboard FROM demo_tmp WHERE id=%s) ", GetSQLValueString($coltmpid_RecordTmpMiddleBoard, "int"));
...
$coltmpid_RecordTmpTitleBoard = "1";
if (isset($_GET['tmpid'])) {
  $coltmpid_RecordTmpTitleBoard = $_GET['tmpid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpTitleBoard = sprintf("SELECT * FROM demo_tmpboard WHERE id = (SELECT tmptitleboard FROM demo_tmp WHERE id=%s) ", GetSQLValueString($coltmpid_RecordTmpTitleBoard, "int"));
...
$coltmpid_RecordTmpTitleBg = "1";
if (isset($_GET['tmpid'])) {
  $coltmpid_RecordTmpTitleBg = $_GET['tmpid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpTitleBg = sprintf("SELECT * FROM demo_tmpbackground WHERE id = (SELECT tmptitlebackground FROM demo_tmp WHERE id=%s) ", GetSQLValueString($coltmpid_RecordTmpTitleBg, "int"));
...
$coltmpid_RecordTmpTitleLineBg = "1";
if (isset($_GET['tmpid'])) {
  $coltmpid_RecordTmpTitleLineBg = $_GET['tmpid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpTitleLineBg = sprintf("SELECT * FROM demo_tmpbackground WHERE id = (SELECT tmptitlelinebackground FROM demo_tmp WHERE id=%s) ", GetSQLValueString($coltmpid_RecordTmpTitleLineBg, "int"));
...
$coltmpid_RecordTmpBodyBg = "1";
if (isset($_GET['tmpid'])) {
  $coltmpid_RecordTmpBodyBg = $_GET['tmpid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpBodyBg = sprintf("SELECT * FROM demo_tmpbackground WHERE id = (SELECT tmpbodybackground FROM demo_tmp WHERE id=%s) ", GetSQLValueString($coltmpid_RecordTmpBodyBg, "int"));
...
$coltmpid_RecordTmpLeftMenu = "1";
if (isset($_GET['tmpid'])) {
  $coltmpid_RecordTmpLeftMenu = $_GET['tmpid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpLeftMenu = sprintf("SELECT * FROM demo_tmpleftmenu WHERE id = (SELECT tmpleftmenu FROM demo_tmp WHERE id=%s) ", GetSQLValueString($coltmpid_RecordTmpLeftMenu, "int"));
...
$coltmpid_RecordTmpAnimeBg = "1";
if (isset($_GET['tmpid'])) {
  $coltmpid_RecordTmpAnimeBg = $_GET['tmpid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpAnimeBg = sprintf("SELECT * FROM demo_tmpbackground WHERE id = (SELECT tmpanimebackground FROM demo_tmp WHERE id=%s) ", GetSQLValueString($coltmpid_RecordTmpAnimeBg, "int"));
...
$coltmpid_RecordTmpNewsEvenBg = "1";
if (isset($_GET['tmpid'])) {
  $coltmpid_RecordTmpNewsEvenBg = $_GET['tmpid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpNewsEvenBg = sprintf("SELECT * FROM demo_tmpbackground WHERE id = (SELECT tmpnewsevenbackground FROM demo_tmp WHERE id=%s) ", GetSQLValueString($coltmpid_RecordTmpNewsEvenBg, "int"));
...
$coltmpid_RecordTmpNewsOddBg = "1";
if (isset($_GET['tmpid'])) {
  $coltmpid_RecordTmpNewsOddBg = $_GET['tmpid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpNewsOddBg = sprintf("SELECT * FROM demo_tmpbackground WHERE id = (SELECT tmpnewsoddbackground FROM demo_tmp WHERE id=%s) ", GetSQLValueString($coltmpid_RecordTmpNewsOddBg, "int"));
...
$coltmpid_RecordTmpMainMenu = "1";
if (isset($_GET['tmpid'])) {
  $coltmpid_RecordTmpMainMenu = $_GET['tmpid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpMainMenu = sprintf("SELECT * FROM demo_tmpmainmenu WHERE id = (SELECT tmpmainmenu FROM demo_tmp WHERE id=%s) ", GetSQLValueString($coltmpid_RecordTmpMainMenu, "int"));
...
$coltmpid_RecordTmpLogo = "1";
if (isset($_GET['tmpid'])) {
  $coltmpid_RecordTmpLogo = $_GET['tmpid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpLogo = sprintf("SELECT * FROM demo_tmplogo WHERE id = (SELECT tmplogoid FROM demo_tmp WHERE id=%s) ", GetSQLValueString($coltmpid_RecordTmpLogo, "int"));
...
$coltmpid_RecordTmpHomeLogo = "1";
if (isset($_GET['tmpid'])) {
  $coltmpid_RecordTmpHomeLogo = $_GET['tmpid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpHomeLogo = sprintf("SELECT * FROM demo_tmplogo WHERE id = (SELECT tmphomelogoid FROM demo_tmp WHERE id=%s) ", GetSQLValueString($coltmpid_RecordTmpHomeLogo, "int"));
...
$coltmpid_RecordTmpLogoDefault = "1";
if (isset($_GET['tmpid'])) {
  $coltmpid_RecordTmpLogoDefault = $_GET['tmpid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpLogoDefault = sprintf("SELECT * FROM demo_tmplogo WHERE id = (SELECT TmpLogoID FROM demo_setting_fr WHERE userid=%s)", GetSQLValueString($coltmpid_RecordTmpLogoDefault, "int"));
...
$coltmpid_RecordTmpBlock = "1";
if (isset($_GET['tmpid'])) {
  $coltmpid_RecordTmpBlock = $_GET['tmpid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpBlock = sprintf("SELECT * FROM demo_tmpblock WHERE id = (SELECT tmpblock FROM demo_tmp WHERE id=%s) ", GetSQLValueString($coltmpid_RecordTmpBlock, "int"));
...
$coltmpid_RecordTmpBottomBg = "1";
if (isset($_GET['tmpid'])) {
  $coltmpid_RecordTmpBottomBg = $_GET['tmpid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpBottomBg = sprintf("SELECT * FROM demo_tmpbackground WHERE id = (SELECT tmpbottombackground FROM demo_tmp WHERE id=%s) ", GetSQLValueString($coltmpid_RecordTmpBottomBg, "int"));
...
$coltmpid_RecordTmpHomeBodyBg = "1";
if (isset($_GET['tmpid'])) {
  $coltmpid_RecordTmpHomeBodyBg = $_GET['tmpid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpHomeBodyBg = sprintf("SELECT * FROM demo_tmpbackground WHERE id = (SELECT tmphomebodybackground FROM demo_tmp WHERE id=%s) ", GetSQLValueString($coltmpid_RecordTmpHomeBodyBg, "int"));
...
$coltmpid_RecordTmpHomeAnimeBg = "1";
if (isset($_GET['tmpid'])) {
  $coltmpid_RecordTmpHomeAnimeBg = $_GET['tmpid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpHomeAnimeBg = sprintf("SELECT * FROM demo_tmpbackground WHERE id = (SELECT tmphomeanimebackground FROM demo_tmp WHERE id=%s) ", GetSQLValueString($coltmpid_RecordTmpHomeAnimeBg, "int"));
...
$coltmpid_RecordTmpHomeBottomBg = "1";
if (isset($_GET['tmpid'])) {
  $coltmpid_RecordTmpHomeBottomBg = $_GET['tmpid'];
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpHomeBottomBg = sprintf("SELECT * FROM demo_tmpbackground WHERE id = (SELECT tmphomebottombackground FROM demo_tmp WHERE id=%s) ", GetSQLValueString($coltmpid_RecordTmpHomeBottomBg, "int"));
...
if($tplname == 'board009'){ /* 雙版型不適合滿版*/
	$tplrwdboxed = 1;
}else{
	$tplrwdboxed = rand(0,1);
}


/* ----------隨機調整版面大小---------- */
//$tplrwdboxedwidth = $row_RecordTmpConfig['boxwidth']; // 版面寬度大小
$tplrwdboxedwidth = rand(0,2); // 版面寬度大小
...
$TmpFaqShadow =  $row_RecordTmpConfig['tmpfaqshadow']; // 常見問答陰影狀
...
<?php 
/* 行動裝置判斷 */
if(isset($tplname) && ($tplname == 'board009' || $tplname == 'board010')){
