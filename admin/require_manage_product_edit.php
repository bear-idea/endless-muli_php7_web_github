...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Product")) {
  ...
  $updateSQL = sprintf("UPDATE demo_product SET name=%s, type1=%s, type2=%s, type3=%s, pdseries=%s, model=%s, price=%s, spprice=%s, pic=%s, skeyword=%s, sdescription=%s, skeywordindicate=%s, content=%s, postdate=%s, indicate=%s, plot=%s, homeshow=%s, notes1=%s, lang=%s WHERE id=%s",
