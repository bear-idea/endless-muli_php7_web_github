...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmpviewlineboard=%s WHERE id=%s",
...
.mdviewline_show{min-height:1px; _height:1px}
.mdviewline_show_t{position:relative; font-size:12px}
.mdviewline_show_t_l, .mdviewline_show_t_r{position:absolute; top:0px; font-size:1px; overflow:hidden}
.mdviewline_show_t_l{left:0}
.mdviewline_show_t_r{right:0; float:right}
.mdviewline_show_t_m{position:absolute; text-align:left; height:20px; line-height:20px}
.mdviewline_show_t_m h3{font-size:14px; width:120px}
.mdviewline_show_t_c{position:relative; text-align:left; overflow:hidden}
.mdviewline_show_t_c span.a_a{text-decoration:none}
.mdviewline_show_c{position:relative; overflow:hidden}
.mdviewline_show_c .mdviewline_show_m_t, .mdviewline_show_c .mdviewline_show_m_c, .mdviewline_show_c .mdviewline_show_m_b{padding:0 2px}
.mdviewline_show_c .mdviewline_show_m_t, .mdviewline_show_c .mdviewline_show_m_b{text-align:left}
.mdviewline_show_c_l, .mdviewline_show_c_r{position:absolute; top:0; font-size:1px}
.mdviewline_show_c_l{left:0}
.mdviewline_show_c_r{right:0}
.mdviewline_show_c_c{position:relative; zoom:1}
.mdviewline_show_b{position:relative; overflow:hidden}
.mdviewline_show_b_l, .mdviewline_show_b_r{position:absolute; top:0; font-size:1px}
.mdviewline_show_b_l{left:0}
.mdviewline_show_b_r{right:0}
...
<div style="background-color:#999; color:#FFF; text-align:center; padding:5px; cursor:pointer;" class="Acc_Title"><span class="Acc_Change"><i class="fa fa-plus-square"></i></span> 導覽列區塊 - 外框樣式</div>
  ...
  <div style="background-color:#FFFFFF; padding:5px; border: 1px solid #CCC; overflow-y:scroll; height:800px;">
    ...
    <tbody>
      ...
      <tr>    
	   ...
	   <div style="padding:5px; border: 1px dotted #CCC; margin-bottom:2px; width:350px;; float:left; margin:5px; text-align:center;" class="<?php if($row_RecordTmpBoardShowSelect['tmpviewlineboard'] == ''){echo "bg_active";} ?> bg_board"><!--無圖片指定--><a><img src="images/no_bg.jpg" alt="" width="50" height="50" alumb="true" _w="50" _h="50"/></a>
...
$("#chang_tmp_none").click(function(){     
	$(".ViewlineBoardStyle").css({"background-image":"none", "background-color":"transparent"});
	$(".mdviewline_t_l").css({"background-image":"none", "background-color":"transparent"});
	$(".mdviewline_t_r").css({"background-image":"none", "background-color":"transparent"});
	$(".mdviewline_t_c").css({"background-image":"none", "background-color":"transparent"});
	$(".mdviewline_c_l").css({"background-image":"none", "background-color":"transparent"});
	$(".mdviewline_c_r").css({"background-image":"none", "background-color":"transparent"});
	$(".mdviewline_c_c").css({"background-image":"none", "background-color":"transparent"});
	$(".mdviewline_b_l").css({"background-image":"none", "background-color":"transparent"});
	$(".mdviewline_b_r").css({"background-image":"none", "background-color":"transparent"});
	$(".mdviewline_b_c").css({"background-image":"none", "background-color":"transparent"});
});
$("#use_tmp_none").click(function(){     
$.ajax({
		type: "POST",
		url: "sqlgettmp/tmpviewlineboard_get.php?id=none&Operate=M_Update&tmpid=<?php echo $row_RecordTmp['id']; ?>&<?php echo time();?>",
		success: function(data){
			$(".ViewlineBoardStyle").css({"background-image":"none", "background-color":"transparent"});
			$(".mdviewline_t_l").css({"background-image":"none", "background-color":"transparent", "height":"0px", "width":"0px"});
			$(".mdviewline_t_r").css({"background-image":"none", "background-color":"transparent", "height":"0px", "width":"0px"});
			$(".mdviewline_t_c").css({"background-image":"none", "background-color":"transparent", "height":"0px", "width":"0px"});
			$(".mdviewline_c_l").css({"background-image":"none", "background-color":"transparent", "width":"0px"});
			$(".mdviewline_c_r").css({"background-image":"none", "background-color":"transparent", "width":"0px"});
			$(".mdviewline_c_c").css({"background-image":"none", "background-color":"transparent", });
			$(".mdviewline_b_l").css({"background-image":"none", "background-color":"transparent", "height":"0px", "width":"0px"});
			$(".mdviewline_b_r").css({"background-image":"none", "background-color":"transparent", "height":"0px", "width":"0px"});
			$(".mdviewline_b_c").css({"background-image":"none", "background-color":"transparent", "height":"0px"});
...
$.ajax({
		type: "POST",
		url: "sqlgettmp/tmpviewlineboard_get.php?id=<?php echo $row_RecordTmpBoardShow['id']; ?>&Operate=M_Update&tmpid=<?php echo $row_RecordTmp['id']; ?>&<?php echo time();?>",
		success: function(data){
			$(".ViewlineBoardStyle").css({"background-color":"<?php echo $row_RecordTmpBoardShow['tmp_w_background_color']; ?>","border":"<?php echo $row_RecordTmpBoardShow['tmp_w_board_width']; ?>px <?php echo $row_RecordTmpBoardShow['tmp_w_board_style']; ?> <?php echo $row_RecordTmpBoardShow['tmp_w_board_color']; ?>","background-image":"url(upload/image/tmpboard/<?php echo $row_RecordTmpBoardShow['tmp_w_background_img'] ?>)","-webkit-border-radius":"<?php echo $row_RecordTmpBoardShow['borderradius_t_l']; ?>px <?php echo $row_RecordTmpBoardShow['borderradius_t_r']; ?>px <?php echo $row_RecordTmpBoardShow['borderradius_b_r']; ?>px <?php echo $row_RecordTmpBoardShow['borderradius_b_l']; ?>px","-moz-border-radius":"<?php echo $row_RecordTmpBoardShow['borderradius_t_l']; ?>px <?php echo $row_RecordTmpBoardShow['borderradius_t_r']; ?>px <?php echo $row_RecordTmpBoardShow['borderradius_b_r']; ?>px <?php echo $row_RecordTmpBoardShow['borderradius_b_l']; ?>px","border-radius":"<?php echo $row_RecordTmpBoardShow['borderradius_t_l']; ?>px <?php echo $row_RecordTmpBoardShow['borderradius_t_r']; ?>px <?php echo $row_RecordTmpBoardShow['borderradius_b_r']; ?>px <?php echo $row_RecordTmpBoardShow['borderradius_b_l']; ?>px","-webkit-box-shadow":"<?php echo $row_RecordTmpBoardShow['boxshadow_x']; ?>px <?php echo $row_RecordTmpBoardShow['boxshadow_y']; ?>px <?php echo $row_RecordTmpBoardShow['boxshadow_size']; ?>px <?php echo $row_RecordTmpBoardShow['boxshadow_color']; ?>","-moz-box-shadow":"<?php echo $row_RecordTmpBoardShow['boxshadow_x']; ?>px <?php echo $row_RecordTmpBoardShow['boxshadow_y']; ?>px <?php echo $row_RecordTmpBoardShow['boxshadow_size']; ?>px <?php echo $row_RecordTmpBoardShow['boxshadow_color']; ?>","box-shadow":"<?php echo $row_RecordTmpBoardShow['boxshadow_x']; ?>px <?php echo $row_RecordTmpBoardShow['boxshadow_y']; ?>px <?php echo $row_RecordTmpBoardShow['boxshadow_size']; ?>px <?php echo $row_RecordTmpBoardShow['boxshadow_color']; ?>","background":"-webkit-gradient(linear, 0 0, 0 bottom, from(<?php echo $row_RecordTmpBoardShow['lineargradient_top']; ?>), to(<?php echo $row_RecordTmpBoardShow['lineargradient_bottom']; ?>))","background":"-webkit-linear-gradient(<?php echo $row_RecordTmpBoardShow['lineargradient_top']; ?>, <?php echo $row_RecordTmpBoardShow['lineargradient_bottom']; ?>)","background":"-moz-linear-gradient(<?php echo $row_RecordTmpBoardShow['lineargradient_top']; ?>, <?php echo $row_RecordTmpBoardShow['lineargradient_bottom']; ?>)","background":"-ms-linear-gradient(<?php echo $row_RecordTmpBoardShow['lineargradient_top']; ?>, <?php echo $row_RecordTmpBoardShow['lineargradient_bottom']; ?>)","background":"-o-linear-gradient(<?php echo $row_RecordTmpBoardShow['lineargradient_top']; ?>, <?php echo $row_RecordTmpBoardShow['lineargradient_bottom']; ?>)","background":"linear-gradient(<?php echo $row_RecordTmpBoardShow['lineargradient_top']; ?>, <?php echo $row_RecordTmpBoardShow['lineargradient_bottom']; ?>)","-pie-background":"linear-gradient(<?php echo $row_RecordTmpBoardShow['lineargradient_top']; ?>, <?php echo $row_RecordTmpBoardShow['lineargradient_bottom']; ?>)", "behavior": "url(http://easy.fullvision.net/PIE.htc)"});
	$(".mdviewline_t_l").css({"background":"url(<?php echo $SiteImgUrlAdmin; ?><?php echo $row_RecordTmpBoardShow['webname']; ?>/image/tmpboard/<?php echo $row_RecordTmpBoardShow['tmp_l_t_background_img']; ?>) <?php echo $row_RecordTmpBoardShow['tmp_l_t_repeat']; ?> scroll left top","width":"<?php echo $row_RecordTmpBoardShow['tmp_l_t_width']; ?>px","height":"<?php echo $row_RecordTmpBoardShow['tmp_l_t_height']; ?>px"});
	$(".mdviewline_t_r").css({"background":"url(<?php echo $SiteImgUrlAdmin; ?><?php echo $row_RecordTmpBoardShow['webname']; ?>/image/tmpboard/<?php echo $row_RecordTmpBoardShow['tmp_r_t_background_img']; ?>) <?php echo $row_RecordTmpBoardShow['tmp_r_t_repeat']; ?> scroll left top","width":"<?php echo $row_RecordTmpBoardShow['tmp_r_t_width']; ?>px","height":"<?php echo $row_RecordTmpBoardShow['tmp_r_t_height']; ?>px"});
