...
#v_wrp{width:800px; margin-left:auto; margin-right:auto; margin-top:100px; border:#CCC dashed 1px; position:relative; padding-right:20px; padding-bottom:20px; padding-top:20px; padding-left:20px; background-position:center center; background-repeat:no-repeat}
      ...
      <td>
       ...
       <div id="v_out_wrp">
        ...
        <a href="tmpbodybackground_home.php?id=<?php echo $row_RecordTmp['id']; ?>&amp;type=拼貼材質" data-original-title="選擇您要更換的背景" data-toggle="tooltip" data-placement="right" class="btn btn-primary btn-xs btn-block">底層背景</a>
       	...
       	<div id="v_wrp">
        <span style="position: absolute; top: -80px; left: -160px; border: #CCC dashed 1px; padding: 5px;"><img src="images/sty07.jpg" width="100" height="100" /><br />
        ...
        <span style="position: absolute; top: 57px; right: -89px;">
        	<img src="images/z_line_e.png" width="101" height="123" /> 
        </span>
        <span style="margin-right: 5px; margin-top: 5px; padding: 5px; border: #CCC dotted 1px; height: 125px; position: absolute; top: -5px; right: -157px;" id="Step_WrpBoard">
        ...
        <!--獨立背景-->
        <span style="margin-right: 5px; margin-top: 150px; padding: 5px; border: #CCC dotted 1px; height: 75px; position: absolute; top: -1px; right: -157px;">
