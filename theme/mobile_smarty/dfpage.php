  ...
  <?php 
    ...
    <?php if ($TmpWrpViewLineLocate == '2') { ?>               
        ...
        <section class="page-header page-header-xxs">
			...
			<?php echo $ModuleName['DfPage']; ?>
			<!-- InstanceEndEditable --></h1>
            <!-- InstanceBeginEditable name="導覽列" -->
                                    <?php require("require_dfpage_viewline_mobile.php"); ?>
                    <!-- InstanceEndEditable -->
        </section>
	...
	<?php } ?>
      ...
      <div class="row">      
        ...
        <?php
			  ...
			  {
				  case "viewpage":
					  include_once("require_dfpage.php");				
					  break;
				  case "typepage":
					  include_once("require_dfpage_type.php");				
					  break;
				  case "maintypepage":
					  include_once("require_dfpage_type.php");				
					  break;
				  case "subpage":
					  ...
					  break;
				  case "detailed":
					  include_once("require_dfpage_detailed.php");				
					  break;
				  case "search":
					  include_once("require_dfpage_search.php");				
					  break;
				  default:   
					  include_once("require_dfpage.php");	
					  break;  
