...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  class="TB_General_style00">
  ...
  <thead>
    ...
    <tr>
		...
		<?php if ($_GET['level'] == '3') { ?><a href="manage_dfpage.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage_sub&amp;lang=<?php echo $_SESSION['lang']; ?>&amp;item_id=<?php echo $row_RecordDfPageListType['item_id']; ?>&amp;level=4&amp;type1=<?php echo $_GET['type1']; ?>&amp;type2=<?php echo $_GET['type2']; ?>&amp;type3=<?php echo $_GET['type3']; ?>&amp;aid=<?php echo $_GET['aid']; ?>&amp;tpt=<?php echo $row_RecordTpt['title']; ?>" onfocus="undefined" data-bs-original-title="點選查看此項目下的所有文章或分類" data-bs-toggle="tooltip" data-bs-placement="right"><i class="fa fa-files-o"></i> 頁面內容</a><?php } ?></span>
