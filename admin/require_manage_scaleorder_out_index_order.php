...
<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>sqldatatable/js/scaleorder_out_datatable_order.js"></script>
<!-- ================== END Datatables JS ================== -->
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 出庫單號 <small>總覽</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
    ...
    <div class="row justify-content-end">
      <div class="col-md-3 col-sm-12 m-b-10">
          <div class="input-group" data-column="11">
              <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 出貨日期</span></span>
      ...
      <div class="col-md-3 m-b-10">
        <div class="input-group"> <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 出貨單號</span></span>
    ...
    <table id="data-table-default" class="table table-striped table-bordered table-hover table-condensed">
      <thead>
        <tr>
          ...
          <th width="-1" data-priority="1"><strong>出庫單號</strong></th>
          <th width="250" data-priority="1"><strong>聯單號碼</strong></th>
          <th width="100" data-priority="1"><strong>司機</strong></th>
          <th width="100" data-priority="1"><strong>車號</strong></th>
          <th width="100"><strong>廠區</strong></th>
          <th width="70"><strong>修改帳號</strong></th>
          <th width="100"><strong>出貨日期</strong></th>
          <th width="100"><strong>到達日期</strong></th>
          <th width="100"><strong>到達地點</strong></th>
