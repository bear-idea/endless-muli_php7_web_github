...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 首頁橫幅輪播 <small>總覽</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-body">
    ...
    <div class="alert alert-warning m-t-5"><i class="fa fa-info-circle"></i> <b>此區橫幅可設置多個並且可在 版型設計 > 首頁版型設定 之橫幅區塊作設定。</b></div>
    ...
    <?php if ($totalRows_RecordAdtype == 0) { // Show if recordset not empty ?>
     <form action="" method="post" name="Banner_Gen" id="Banner_Gen">
