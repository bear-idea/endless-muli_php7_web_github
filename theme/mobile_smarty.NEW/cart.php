  ...
  <?php 
    ...
    <?php if ($TmpWrpViewLineLocate == '2') { ?>               
        ...
        <section class="page-header page-header-xxs">
			...
			<?php echo $ModuleName['Cart']; ?>
			<!-- InstanceEndEditable --></h1>
            <!-- InstanceBeginEditable name="導覽列" -->
                                    <?php require("require_cart_viewline_mobile.php"); ?>
                    <!-- InstanceEndEditable -->
        </section>
	...
	<?php } ?>
      ...
      <div class="row">      
        ...
        <?php
			...
			{
				case "showpage":
                    include_once("require_cart_show.php");	
					break;
				case "addpage":
					include_once("require_cart_add.php");				
					break;
				case "checkpage":
					include_once("require_cart_check.php");				
					break;
				case "flow":
				    if($CartRegSelect == '1' && $_SESSION['MM_UserGroup_' . $_GET['wshop']] == '' ){
						include_once("require_member_login.php");
					}else{
						include_once("require_cart_flow.php");
					}				
					break;
				case "purchasepage":
				    if($CartRegSelect == '1' && $_SESSION['MM_UserGroup_' . $_GET['wshop']] == '' ){
						...
						include_once("require_cart_purchase.php");
					}	
					break;
				case "purchasecheckpage":
				    if($CartRegSelect == '1' && $_SESSION['MM_UserGroup_' . $_GET['wshop']] == '' ){
						...
						include_once("require_cart_purchase_check.php");
					}					
					break;
				case "clearpage":
					include_once("require_cart_clear.php");				
					break;
				case "sendpage":
					include_once("require_cart_ordersend.php");				
					break;	
				case "reg":
				...
				case "pswfgt2":
					...
					break;
				case "payok":
					include_once("require_cart_payok.php");				
					break;
				case "paysearch":
					include_once("require_cart_pay_search.php");				
					break;
				case "shoppingnotes":
					include_once("require_cart_shoppingnotes.php");				
					break;
				default:
					include_once("require_cart_show.php");
					break;
