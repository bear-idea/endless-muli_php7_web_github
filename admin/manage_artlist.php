...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_artlist.php"); ?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "areapage":
					include_once("require_manage_artlist_area_index.php");			
					break;
				case "viewpage":
					include_once("require_manage_artlist_index.php");			
					break;
				case "addpage":
					include_once("require_manage_artlist_add.php");
					break;
				case "editpage":
					include_once("require_manage_artlist_edit.php"); 
					break;
				case "listpage":
					include_once("require_manage_artlist_list.php");
					break;
				case "listitempage":
					include_once("require_manage_artlist_listitem.php");
					break;
				case "configpage":
					include_once("require_manage_artlist_config.php");
					break;
				default:
					include_once("require_manage_artlist_index.php");
					break;
