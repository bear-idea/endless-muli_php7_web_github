...
if ((isset($_GET['id_del'])) && ($_GET['id_del'] != "")) {
  ...
  $updateSQL = sprintf("UPDATE erp_scaleorderout SET pic5=%s WHERE oid=%s",
  ...
  @unlink('../' . $SiteImgFilePathAdmin . $wshop . '/image/scaleorder/' . $row_RecordScaleorder['pic5']);
  @unlink('../' . $SiteImgFilePathAdmin . $wshop . '/image/scaleorder/thumb/small_' . GetFileThumbExtend($row_RecordScaleorder['pic5']));
}
