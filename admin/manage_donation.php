...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_donation.php"); ?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include_once("require_manage_donation_index.php");			
					break;
				case "addpage":
					include_once("require_manage_donation_add.php");
					break;
				case "editpage":
					include_once("require_manage_donation_edit.php"); 
					break;
				case "deletepage":
					include_once("require_manage_donation_delete.php");
					break;
				case "listpage":
					include_once("require_manage_donation_list.php");
					break;
				case "listitempage":
					include_once("require_manage_donation_listitem.php");
					break;
				case "configpage":
					include_once("require_manage_donation_config.php");
					break;
				default:
					include_once("require_manage_donation_index.php");
					break;
