...
<link href="<?php //echo $SiteBaseUrl . $SiteBaseAdminPath; ?>assets/plugins/DataTables/extensions/Responsive/css/responsive.dataTables.min.css" rel="stylesheet" />
<link href="<?php //echo $SiteBaseUrl . $SiteBaseAdminPath; ?>assets/plugins/DataTables/extensions/Responsive/css/responsive.bootstrap4.min.css" rel="stylesheet" />
<link href="<?php //echo $SiteBaseUrl . $SiteBaseAdminPath; ?>assets/plugins/DataTables/media/css/dataTables.bootstrap4.min.css" rel="stylesheet" />
<link href="<?php //echo $SiteBaseUrl . $SiteBaseAdminPath; ?>assets/plugins/DataTables/extensions/RowReorder/css/rowReorder.dataTables.min.css" rel="stylesheet" />
<link href="<?php //echo $SiteBaseUrl . $SiteBaseAdminPath; ?>assets/plugins/DataTables/extensions/Select/css/select.bootstrap.min.css" rel="stylesheet" />
<!--<link href="<?php //echo $SiteBaseUrl . $SiteBaseAdminPath; ?>assets/plugins/DataTables/extensions/Buttons/css/buttons.bootstrap4.min.css" rel="stylesheet" />-->
<!-- ================== END Datatables CSS ================== -->

<!-- ================== BEGIN X-Editable CSS ================== -->
<link href="<?php //echo $SiteBaseUrl . $SiteBaseAdminPath; ?>assets/plugins/bootstrap3-editable/css/bootstrap4-editable.min.css" rel="stylesheet" />
<!-- ================== END X-Editable CSS ================== -->

<!-- ================== BEGIN Datatables JS ================== -->
<script src="<?php //echo $SiteBaseUrl . $SiteBaseAdminPath; ?>assets/plugins/DataTables/media/js/jquery.dataTables.min.js"></script>
<script src="<?php //echo $SiteBaseUrl . $SiteBaseAdminPath; ?>assets/plugins/DataTables/extensions/ColVis/js/dataTables.colVis.min.js"></script>
<script src="<?php //echo $SiteBaseUrl . $SiteBaseAdminPath; ?>assets/plugins/DataTables/extensions/ColReorder/js/dataTables.colReorder.min.js"></script>
<script src="<?php //echo $SiteBaseUrl . $SiteBaseAdminPath; ?>assets/plugins/DataTables/media/js/dataTables.bootstrap4.min.js"></script>
<script src="<?php //echo $SiteBaseUrl . $SiteBaseAdminPath; ?>assets/plugins/DataTables/extensions/Responsive/js/dataTables.responsive.min.js"></script>
<script src="<?php //echo $SiteBaseUrl . $SiteBaseAdminPath; ?>assets/plugins/DataTables/extensions/Responsive/js/responsive.bootstrap4.min.js"></script>
<!--<script src="<?php //echo $SiteBaseUrl . $SiteBaseAdminPath; ?>assets/plugins/DataTables/extensions/Select/js/dataTables.select.min.js"></script>-->
<!--<script src="<?php //echo $SiteBaseUrl . $SiteBaseAdminPath; ?>assets/plugins/DataTables/extensions/Buttons/js/dataTables.buttons.min.js"></script>
<script src="<?php //echo $SiteBaseUrl . $SiteBaseAdminPath; ?>assets/plugins/DataTables/extensions/Buttons/js/buttons.bootstrap4.min.js"></script>
<script src="<?php //echo $SiteBaseUrl . $SiteBaseAdminPath; ?>assets/plugins/DataTables/extensions/Buttons/js/buttons.flash.min.js"></script>
<script src="<?php //echo $SiteBaseUrl . $SiteBaseAdminPath; ?>assets/plugins/DataTables/extensions/Buttons/js/jszip.min.js"></script>
<script src="<?php //echo $SiteBaseUrl . $SiteBaseAdminPath; ?>assets/plugins/DataTables/extensions/Buttons/js/pdfmake.min.js"></script>
<script src="<?php //echo $SiteBaseUrl . $SiteBaseAdminPath; ?>assets/plugins/DataTables/extensions/Buttons/js/vfs_fonts.min.js"></script>
<script src="<?php //echo $SiteBaseUrl . $SiteBaseAdminPath; ?>assets/plugins/DataTables/extensions/Buttons/js/buttons.html5.min.js"></script>
<script src="<?php //echo $SiteBaseUrl . $SiteBaseAdminPath; ?>assets/plugins/DataTables/extensions/Buttons/js/buttons.print.min.js"></script>-->
<!--<script src="//cdn.datatables.net/plug-ins/1.10.16/api/fnFilterClear.js"></script>-->
<script src="<?php //echo $SiteBaseUrl . $SiteBaseAdminPath; ?>sqldatatable/js/scaleorder_source_datatable.js"></script>
<!-- ================== END Datatables JS ================== -->

<!-- ================== BEGIN X-Editable JS ================== -->
<script src="<?php //echo $SiteBaseUrl . $SiteBaseAdminPath; ?>assets/plugins/bootstrap3-editable/js/bootstrap4-editable.min.js"></script>
<!-- ================== END X-Editable JS ================== -->

<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 貨源庫存 <small>總覽</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
  ...
  <div class="panel-body">
    <div class="row justify-content-end">
      <div class="col-md-3 col-sm-12 m-b-10">
          <div class="input-group" data-column="11">
              <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 時間</span></span>
              <input name="postdate" type="text" class="form-control search_filter" placeholder="" id="col11_filter"/>		
          </div>
      </div>
      <div class="col-md-2 col-sm-12 m-b-10">
        <div class="input-group" data-column="8"> <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 過磅人員</span></span>
            <input type="text" class="form-control search_filter" placeholder="" id="col8_filter">
        </div>
      </div>
      <div class="col-md-2 col-sm-12 m-b-10">
        <div class="input-group" data-column="10"> <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 修改帳號</span></span>
            <input type="text" class="form-control search_filter" placeholder="" id="col10_filter">
        </div>
      </div>
    ...
    <table id="data-table-default" class="table table-striped table-bordered table-hover table-condensed">
      <thead>
        <tr>
          ...
          <th width="100" data-priority="1"><strong>聯單號碼</strong></th>
          <th width="100" data-priority="1"><strong>總重</strong></th>
          <th width="100" data-priority="1"><strong>扣重</strong></th>
          <th width="100" data-priority="1"><strong>淨重</strong></th>
          <th width="70"><strong>倉庫</strong></th>
          <th width="70"><strong>車號</strong></th>
