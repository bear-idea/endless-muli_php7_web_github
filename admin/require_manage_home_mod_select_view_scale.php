...
<a href="manage_scale.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td height="20" align="center">物料管理</td>
    </tr>
  </table>
</div>
</a>
<a href="manage_warehouse.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_094.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">倉庫管理</td>
    </tr>
  </table>
</div>
</a>
<a href="manage_manufacturer.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
    ...
    <tr>
      <td height="20" align="center">廠商管理</td>
    </tr>
  </table>
</div>
</a>
<a href="manage_driver.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_096.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">司機管理</td>
    </tr>
  </table>
</div>
</a>
<a href="manage_carnumber.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_097.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">車號管理</td>
    </tr>
  </table>
</div>
</a>
<div class="Menu_ListView_Icon_Board cl_blue4" style="background-image:url(images/mt_color_010.png); color:#4d5258; font-weight:bolder;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="100" align="center">貨源<br/>管理
        </td>
    </tr>
  </table>
</div>
<a href="manage_scalesource.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_101.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">貨源物料</td>
    </tr>
  </table>
</div>
</a>
<a href="manage_scaleorder_source.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_100.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">貨源記錄</td>
    </tr>
  </table>
</div>
</a>
...
<a href="manage_scaleorder_out.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage_order&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
...
<div class="Menu_ListView_Icon_Board cl_blue4" style="background-image:url(images/mt_color_010.png); color:#4d5258; font-weight:bolder;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="100" align="center">統計<br/>報表
        </td>
    </tr>
  </table>
</div>
<a href="manage_scaleorder_clearance.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_109.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">清運明細</td>
    </tr>
  </table>
</div>
</a>
<a href="manage_scaleorder_carcontrol.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_112.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">車輛管制</td>
    </tr>
  </table>
</div>
</a>
<a href="manage_scaleorder_overweight.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_113.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">過磅明細</td>
    </tr>
  </table>
</div>
</a>
<div class="Menu_ListView_Icon_Board cl_blue4" style="background-image:url(images/mt_color_010.png); color:#4d5258; font-weight:bolder;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="100" align="center">物料<br/>拆分紀錄
        </td>
    </tr>
  </table>
</div>
<a href="manage_scaleorder_split.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_107.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">拆分紀錄</td>
    </tr>
  </table>
</div>
</a>
<div class="Menu_ListView_Icon_Board cl_blue4" style="background-image:url(images/mt_color_010.png); color:#4d5258; font-weight:bolder;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="100" align="center">報表<br/>統計
        </td>
    </tr>
  </table>
</div>
<a href="manage_scaleorder_price.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
    ...
    <tr>
      <td height="20" align="center">對帳明細</td>
    </tr>
  </table>
</div>
</a>
