...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmpwrpbackground=%s WHERE id=%s",
...
if (isset($row_RecordTmpBackGroundBoardStyle['tmpwrpbackground'])) {
  $colid_RecordTmpBackGround = $row_RecordTmpBackGroundBoardStyle['tmpwrpbackground'];
}
...
<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>sqldatatable/js/tmpwrpbackground_datatable_get.js"></script>
<!-- ================== END Datatables JS ================== -->
  ...
  <div class="row">
      <div class="col-md-12">
        <div class="card bg-grey-transparent-1">
          <div class="card-block">
            <?php if($row_RecordTmpBackGroundBoardStyle['tmpwrpbackground'] != "") { ?>
