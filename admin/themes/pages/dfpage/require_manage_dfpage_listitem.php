...
<div class="panel panel-inverse bg-white-transparent-9">
  ...
  <div class="panel-heading">
    ...
    <div class="btn-group float-end mr-10px"><a href="manage_dfpage.php?wshop=<?php echo $wshop;?>&amp;Opt=listpage&amp;lang=<?php echo $_SESSION['lang']; ?>" data-bs-original-title="" data-bs-toggle="tooltip" data-bs-placement="top" class="text-nowrap btn btn-default btn-sm"><i class="fa fa-reply fa-fw"></i> 上一頁</a></div>
    ...
    <div class="widget-card bg-cyan-transparent-1">
          <div class="card-body">
              ...
              <div class="form-group row">
                  <!--<div class="col-md-6" style="border:0">-->
                      <div class="input-group p-0">
                      <a class="btn btn-info w-100 btn-block colorbox_iframe" href="mod_dfpage_select.php?wshop=<?php echo $wshop;?>&amp;Opt_Mod=modpage&amp;lang=<?php echo $_SESSION['lang']; ?>&amp;item_id=<?php echo $row_RecordDfPageListItem['item_id']; ?>&amp;pdname=<?php echo urlencode($row_RecordBlog['title']); ?>" data-bs-original-title="設定此項目連結所要使用之模組" data-bs-toggle="tooltip" data-bs-placement="right">模組選擇 <i class="fa fa-chevron-circle-right"></i></a>
                      </div>
                  ...
                  <!--<div class="col-md-6" style="border:0">-->
                      <div class="input-group p-0">
                          <div class="checkbox checkbox-css">
                              <input name="deltype[]" class="form-check-input" type="checkbox" id="deltype<?php echo $row_RecordDfPageListItem['item_id']; ?>" value="<?php echo $row_RecordDfPageListItem['item_id']; ?>" />
...
<script type="text/javascript">
swal({ title: "刪除失敗！！該項目下方尚有分類！！!", text: "", type: "warning",buttonsStyling: false,confirmButtonText: "確認",confirmButtonClass: "btn btn-primary m-5px"});
</script>
<?php } ?>
<?php if(isset($_GET['Operate']) && $_GET['Operate'] == "delErrorP") { ?>
<script type="text/javascript">
swal({ title: "刪除失敗！！此分類尚有資料！！", text: "", type: "warning",buttonsStyling: false,confirmButtonText: "確認",confirmButtonClass: "btn btn-primary m-5px"});
</script>
<?php } ?>
