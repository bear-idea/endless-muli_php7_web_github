...
<?php do { ?>
<li class="<?php if ($totalRows_RecordProductMultiTopMenu_l1 > 0 && $TmpSubMainmenuIndicate == "3") { ?>dropdown-toggle<?php } ?> <?php if ($_GET['type1'] == $row_RecordProductMultiTopMenu_l1['item_id']) { ?>active<?php } ?>"><a href="<?php echo $SiteBaseUrl . url_rewrite("product",array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'subpage','type1'=>$row_RecordProductMultiTopMenu_l1['item_id']),'',$UrlWriteEnable);?>"><?php echo $row_RecordProductMultiTopMenu_l1['itemname']; ?></a>
...
<?php
					...
					?>
<?php if($TmpSubMainmenuIndicate == "3" && $totalRows_RecordProductMultiTopMenu_l2 > 0) { ?>
<ul class="dropdown-menu <?php if (((int)$totalRows_RecordDfTypeMultiTopMenu_l2 - (int)$Count_TypeMultiTopMenu) < 2) { ?>pull-right<?php } ?>">
        ...
        <!--<div class="col-md-6"> <?php //echo "mega-menu"; ?>
          <ul class="list-unstyled">--> <?php //echo "mega-menu"; ?>
            ...
            <?php if ($row_RecordProductMultiTopMenu_l2['endnode'] != 'child') { ?>
            	<a href="<?php echo $SiteBaseUrl . url_rewrite("product",array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'subpage','type1'=>$row_RecordProductMultiTopMenu_l2['item_id']),'',$UrlWriteEnable);?>" class="dropdown-toggle"><?php echo $row_RecordProductMultiTopMenu_l2['itemname']; ?></a>
			<?php } else { ?>
                 <a href="<?php echo $SiteBaseUrl . url_rewrite("product",array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'subpage','type1'=>$row_RecordProductMultiTopMenu_l2['item_id']),'',$UrlWriteEnable);?>"><?php echo $row_RecordProductMultiTopMenu_l2['itemname']; ?></a>
            <?php }  ?>
            	<?php if ($row_RecordProductMultiTopMenu_l2['endnode'] != 'child') { // 若第一層節點不為child則印出下層選單 ?>
...
?>
                    ...
                    <?php if ($row_RecordProductMultiTopMenu_l3['endnode'] != 'child') { ?>
                    	<a href="<?php echo $SiteBaseUrl . url_rewrite("product",array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'subpage','type1'=>$row_RecordProductMultiTopMenu_l2['item_id'],'type2'=>$row_RecordProductMultiTopMenu_l3['item_id']),'',$UrlWriteEnable);?>" class="dropdown-toggle"><strong><?php echo $row_RecordProductMultiTopMenu_l3['itemname']; ?></strong></a>
                    <?php } else { ?>
                    <a href="<?php echo $SiteBaseUrl . url_rewrite("product",array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'subpage','type1'=>$row_RecordProductMultiTopMenu_l2['item_id'],'type2'=>$row_RecordProductMultiTopMenu_l3['item_id']),'',$UrlWriteEnable);?>"><?php echo $row_RecordProductMultiTopMenu_l3['itemname']; ?></a>
                    <?php } ?>
                    </li>
