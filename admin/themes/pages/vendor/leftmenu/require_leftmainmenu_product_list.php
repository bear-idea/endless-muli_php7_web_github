...
$query_RecordMultiLeftMenu_l1 = sprintf("SELECT * FROM demo_productitem WHERE list_id = 1 && lang = %s && level = '0' && userid=%s ORDER BY sortid ASC, item_id DESC", GetSQLValueString($collang_RecordMultiLeftMenu_l1, "text"),GetSQLValueString($coluserid_RecordMultiLeftMenu_l1, "int"));
...
<ul class="accordion"  id="accordion-3">
        <?php do { ?>
            ...
            <a class="menu-link" href="manage_product.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage_sub&lang=<?php echo $_GET['lang']; ?>&level=<?php echo $row_RecordMultiLeftMenu_l1['level']; ?>&type1=<?php echo $row_RecordMultiLeftMenu_l1['item_id']; ?>&item_id=<?php echo $row_RecordMultiLeftMenu_l1['item_id']; ?>"><?php echo $row_RecordMultiLeftMenu_l1['itemname']; ?><?php if($row_RecordMultiLeftMenu_l1['indicate'] == '0'){?><span class="TBSort_spboardf">隱</span><?php }?></a>
				    <?php
					 #
...
if (isset($w_userid)) {
  $coluserid_RecordMultiLeftMenu_l2 = $w_userid;
}
...
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordMultiLeftMenu_l2 = sprintf("SELECT * FROM demo_productitem WHERE list_id = 1 && lang = %s && level = '1' && subitem_id = %s && userid=%s ORDER BY sortid ASC, item_id DESC", GetSQLValueString($collang_RecordMultiLeftMenu_l2, "text"),GetSQLValueString($colsubitem_id_RecordMultiLeftMenu_l2, "int"),GetSQLValueString($coluserid_RecordMultiLeftMenu_l2, "int"));
...
$totalRows_RecordMultiLeftMenu_l2 = mysqli_num_rows($RecordMultiLeftMenu_l2);
                    ...
                    <a class="menu-link" href="manage_product.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage_sub&lang=<?php echo $_GET['lang']; ?>&level=<?php echo $row_RecordMultiLeftMenu_l2['level']; ?>&type1=<?php echo $row_RecordMultiLeftMenu_l1['item_id']; ?>&type2=<?php echo $row_RecordMultiLeftMenu_l2['item_id']; ?>&subitem_id=<?php echo $row_RecordMultiLeftMenu_l2['subitem_id']; ?>"><?php echo $row_RecordMultiLeftMenu_l2['itemname']; ?><?php if($row_RecordMultiLeftMenu_l2['indicate'] == '0'){?><span class="TBSort_spboardf">隱</span><?php }?></a>
						<?php
                         #
...
if (isset($w_userid)) {
  $coluserid_RecordMultiLeftMenu_l3 = $w_userid;
}
...
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordMultiLeftMenu_l3 = sprintf("SELECT * FROM demo_productitem WHERE list_id = 1 && lang = %s && level = '2' && subitem_id = %s && userid=%s ORDER BY sortid ASC, item_id DESC", GetSQLValueString($collang_RecordMultiLeftMenu_l3, "text"),GetSQLValueString($colsubitem_id_RecordMultiLeftMenu_l3, "int"),GetSQLValueString($coluserid_RecordMultiLeftMenu_l3, "int"));
                      ...
                      <ul>
						<?php do { ?>
                          <li class="<?php echo $row_RecordMultiLeftMenu_l3['endnode']; ?>">
                            <a class="menu-link" href="manage_product.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage_sub&lang=<?php echo $_GET['lang']; ?>&level=<?php echo $row_RecordMultiLeftMenu_l3['level']; ?>&type1=<?php echo $row_RecordMultiLeftMenu_l1['item_id']; ?>&type2=<?php echo $row_RecordMultiLeftMenu_l2['item_id']; ?>&type3=<?php echo $row_RecordMultiLeftMenu_l3['item_id']; ?>&subitem_id=<?php echo $row_RecordMultiLeftMenu_l3['subitem_id']; ?>"><?php echo $row_RecordMultiLeftMenu_l3['itemname']; ?><?php if($row_RecordMultiLeftMenu_l3['indicate'] == '0'){?><span class="TBSort_spboardf">隱</span><?php }?></a>
                          </li>
