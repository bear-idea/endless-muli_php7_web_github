...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require("require_leftmainmenu_yearend.php");?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include("require_manage_yearend_index.php");			
					break;
				case "addpage":
					include("require_manage_yearend_add.php");
					break;
				case "editpage":
					include("require_manage_yearend_edit.php"); 
					break;
				case "capital":
					include("require_manage_yearend_capital.php"); 
					break;
				case "yearend":
					include("require_manage_yearend_yearend.php"); 
					break;
				case "yearend_general":
					include("require_manage_yearend_general.php"); 
					break;
				case "yearend_del":
					include("require_manage_yearend_delete.php"); 
					break;
				case "print_select_year":
					include("require_manage_yearend_print_select_year.php"); 
					break;
				case "listpage":
					include("require_manage_yearend_list.php");
					break;
				case "listitempage":
					include("require_manage_yearend_listitem.php");
					break;
				default:
					include("require_manage_yearend_index.php");
					break;
