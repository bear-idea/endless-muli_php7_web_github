...
<script type="text/javascript" src="js/footable-standalone.js"></script>
<script type="text/javascript" src="js/jquery.mobile-menu.min.js"></script>
<script src="jquery.mobile-menu.min.js"></script>
<script type="text/javascript" src="js/freewall.js"></script>
<script type="text/javascript" src="js/jcolumn-0.2.0.min.js"></script>
<script type="text/javascript" src="js/jquery.spritely-0.5.js"></script>
<script type="text/javascript" src="js/jquery.abgne-minwt.divalign.js"></script>
<script type="text/javascript" src="js/imgcentering.min.js"></script>
...
<script type="text/javascript" src="js/jquery.rater/jquery.rater.js"></script>
...
<div style="background-color:#CF0;">
        <div class="mm-toggle-wrap" style="background-color:#090; position:absolute; top:0;">
            <div class="mm-toggle">
...
<div id="Top_Content" style="display:none"><?php require("require_top.php"); ?></div>
<header>
...
<a href="#" class="scrollup">Scroll</a>
    ...
    <div id="mobile-menu" style="background-color:#F00">
	<ul>
		<li><a href="#">item 1</a>
			<ul>
