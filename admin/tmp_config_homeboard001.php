    ...
    <tr>
      <td>
       ...
       <div id="v_out_wrp">
        ...
        <!--獨立背景--><!--獨立背景-->
          <div style="color: #CCC; font-size: 30px; font-weight: bolder; padding: 10px; position: absolute; left: -36px; top: -41px;">主框架<span style="font-size:16px;"> <a href="tmp_config_wrp_rwd_home.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=<?php echo $_GET['lang']; ?>" data-original-title="您可在此設定整體網站的版面風格等" data-toggle="tooltip" data-placement="right" class="btn btn-info btn-circle btn-xs" >更多設定 <i class="fa fa-chevron-circle-right"></i></a></span></div>
        	<div id="v_wrp_header">
            <!--獨立背景-->
...
橫幅區塊</span>
            ...
            <div id="v_wrp_l_column">
              <div class="v_md"><img src="images/mt_049.png" width="60" height="60" /><br />
          		<a href="#" data-original-title="您可在此加入您要放置的功能，並且可對其做排序,另外此區的《自訂欄位》功能和內頁板型的《自訂欄位》是分開的，您可個別加入不同的內容，而內頁的《自訂欄位》您可在版型修改的左選單找到。" data-toggle="tooltip" data-placement="right" class="btn btn-white btn-xs btn-block disabled">自訂欄位</a>
                
                  <?php if ($LangChooseEN == '1' || $defaultlang == "en") { ?>
                  <a href="tmp_config_homeboard001_column_en.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=en" class="btn btn-primary btn-xs" data-original-title="英文設定" data-toggle="tooltip" data-placement="top">英</a>
                  <?php } ?>
                  <?php if ($LangChooseZHCN == '1' || $defaultlang == "zh-cn") { ?>
                  <a href="tmp_config_homeboard001_column_cn.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=zh-cn" class="btn btn-primary btn-xs" data-original-title="簡體設定" data-toggle="tooltip" data-placement="top">簡</a>
                  <?php } ?>
                  <?php if ($LangChooseZHTW == '1' || $defaultlang == "zh-tw") { ?>
                  <a href="tmp_config_homeboard001_column.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=zh-tw" class="btn btn-primary btn-xs" data-original-title="繁體設定" data-toggle="tooltip" data-placement="top">繁</a>
                  <?php } ?>
                  <?php if ($LangChooseJP == '1' || $defaultlang == "jp") { ?>
                  <a href="tmp_config_homeboard001_column_jp.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=jp" class="btn btn-primary btn-xs" data-original-title="日文設定" data-toggle="tooltip" data-placement="top">日</a>
                  <?php } ?>
                  <?php if ($LangChooseKR == '1' || $defaultlang == "kr") { ?>
                  <a href="tmp_config_homeboard001_column_kr.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=kr" class="btn btn-primary btn-xs" data-original-title="韓文設定" data-toggle="tooltip" data-placement="top">韓</a>
                  <?php } ?>
                  <?php if ($LangChooseSP == '1' || $defaultlang == "sp") { ?>
                  <a href="tmp_config_homeboard001_column_sp.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=sp" class="btn btn-primary btn-xs" data-original-title="西班牙語設定" data-toggle="tooltip" data-placement="top">西</a>
                  <?php } ?>
            ...
            <div id="v_wrp_middle">
              <div class="v_md"><img src="images/mt_060.png" width="60" height="60" /><br />
          		<a href="#" data-original-title="您可在此加入您要放置的功能，並且可對其做排序。" data-toggle="tooltip" data-placement="right" class="btn btn-white btn-xs btn-block disabled">功能區塊</a>
                <?php if ($LangChooseEN == '1' || $defaultlang == "en") { ?>
                <a href="tmp_config_homeboard001_block_en.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=en" class="btn btn-primary btn-xs" data-original-title="英文設定" data-toggle="tooltip" data-placement="top">英</a>
                <?php } ?>
                <?php if ($LangChooseZHCN == '1' || $defaultlang == "zh-cn") { ?>
                <a href="tmp_config_homeboard001_block_cn.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=zh-cn" class="btn btn-primary btn-xs" data-original-title="簡體設定" data-toggle="tooltip" data-placement="top">簡</a>
                <?php } ?>
                <?php if ($LangChooseZHTW == '1' || $defaultlang == "zh-tw") { ?>
                <a href="tmp_config_homeboard001_block.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=zh-tw" class="btn btn-primary btn-xs" data-original-title="繁體設定" data-toggle="tooltip" data-placement="top">繁</a>
                <?php } ?>
                <?php if ($LangChooseJP == '1' || $defaultlang == "jp") { ?>
                <a href="tmp_config_homeboard001_block_jp.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=jp" class="btn btn-primary btn-xs" data-original-title="日文設定" data-toggle="tooltip" data-placement="top">日</a>
                <?php } ?>
                <?php if ($LangChooseKR == '1' || $defaultlang == "kr") { ?>
                <a href="tmp_config_homeboard001_block_kr.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=kr" class="btn btn-primary btn-xs" data-original-title="韓語設定" data-toggle="tooltip" data-placement="top">韓</a>
                <?php } ?>
                <?php if ($LangChooseSP == '1' || $defaultlang == "sp") { ?>
                <a href="tmp_config_homeboard001_block_sp.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=sp" class="btn btn-primary btn-xs" data-original-title="西班牙語設定" data-toggle="tooltip" data-placement="top">西</a>
                <?php } ?>
            </div>
