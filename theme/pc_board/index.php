...
<div id="abgne_float_right_menu">
        ...
        <div id="abgne_float_right_context">
            ...
            <a href="cart.php?wshop=<?php echo $_GET['wshop'];?>&amp;Opt=showpage&amp;lang=<?php echo $_SESSION['lang']; ?>"><img src="images/floatmenu_cart_A.png" width="50" height="35" /></a>
            <?php } ?>
  ...
  <div id="Left_column">
  	<div id="context">
        ...
        switch($MSTMP)
		{
			case "userdefault":
		?>
        <!-- InstanceBeginEditable name="左選單標頭" -->
        <?php
				// 左選單標頭
		...
		if ($MSMemberLeftLogin == '1') {
			...
			switch($MSLMenu)
			{
				case "0":
		?>
        <!-- InstanceBeginEditable name="左選單分類" -->
        <?php
					// 左選單[分類] - 個別分類頁面
      ...
      <div id="context" >
        ...
        <div class="container board">
            <div class="column span-2">
                <div class="container">
                	<?php require("require_news_index_tab.php"); // 引入最新訊息檔案(標籤) ?>
                </div>
            </div>
            <div class="column">
                <div class="container">
        ...
        <?php //require("require_product_picsli.php"); // 引入最新訊息檔案(標籤) ?>
		<?php //include("require_sponsor_index.php"); // 引入贊助廠商檔案 ?>
        <?php //require("require_product_index.php"); // 引入最新訊息檔案(標籤) ?>
        <?php //include("require_sponsor_index_bubble.php"); // 引入贊助廠商檔案(冒泡) ?>
      	<!-- InstanceEndEditable -->
      </div>
  	</div>  
    <div id="Rght_column">
      <div id="context">     
        <!-- InstanceBeginEditable name="右選單" -->
