...
$query_RecordMultiLeftMenu_l1 = sprintf("SELECT * FROM demo_articleitem WHERE list_id = 1 && lang = %s && level = '0' && indicate = '1' && userid=%s ORDER BY sortid ASC, item_id DESC", GetSQLValueString($collang_RecordMultiLeftMenu_l1, "text"),GetSQLValueString($coluserid_RecordMultiLeftMenu_l1, "int"));
...
<div id="menu1" class="menuTree">
        <ul>
        <?php do { ?>
            <li class="<?php if(isset($row_RecordMultiLeftMenu_l1['endnode'])) { echo $row_RecordMultiLeftMenu_l1['endnode']; } ?>">
            <a href="article.php?Opt=typepage&navi=<?php echo $_GET['navi']; ?>&lang=<?php echo $_SESSION['lang']; ?>&mtype=Article&level=<?php echo $row_RecordMultiLeftMenu_l1['level']; ?>&type1=<?php echo $row_RecordMultiLeftMenu_l1['item_id']; ?>&subitem_id=<?php echo $row_RecordMultiLeftMenu_l1['subitem_id']; ?>"><?php echo $row_RecordMultiLeftMenu_l1['itemname']; ?>
            </a>
...
$totalRows_RecordMultiLeftMenu_l2 = mysqli_num_rows($RecordMultiLeftMenu_l2);
					?>
					<?php do { ?>
                    <li class="<?php if(isset($row_RecordMultiLeftMenu_l2['endnode'])) { echo $row_RecordMultiLeftMenu_l2['endnode']; } ?>">
                    <a href="article.php?Opt=typepage&navi=<?php echo $_GET['navi']; ?>&lang=<?php echo $_SESSION['lang']; ?>&mtype=Article&level=<?php echo $row_RecordMultiLeftMenu_l2['level']; ?>&type1=<?php echo $row_RecordMultiLeftMenu_l1['item_id']; ?>&type2=<?php echo $row_RecordMultiLeftMenu_l2['item_id']; ?>&subitem_id=<?php echo $row_RecordMultiLeftMenu_l2['subitem_id']; ?>"><?php echo $row_RecordMultiLeftMenu_l2['itemname']; ?>
                    </a>
...
$totalRows_RecordMultiLeftMenu_l3 = mysqli_num_rows($RecordMultiLeftMenu_l3);
                        ?>
						<?php do { ?>
                          <li class="<?php if(isset($row_RecordMultiLeftMenu_l3['endnode'])) { echo $row_RecordMultiLeftMenu_l3['endnode']; } ?>">
                            <a href="article.php?Opt=typepage&navi=<?php echo $_GET['navi']; ?>&lang=<?php echo $_SESSION['lang']; ?>&mtype=Article&level=<?php echo $row_RecordMultiLeftMenu_l3['level']; ?>&type1=<?php echo $row_RecordMultiLeftMenu_l1['item_id']; ?>&type2=<?php echo $row_RecordMultiLeftMenu_l2['item_id']; ?>&type3=<?php echo $row_RecordMultiLeftMenu_l3['item_id']; ?>&subitem_id=<?php echo $row_RecordMultiLeftMenu_l3['subitem_id']; ?>"><?php echo $row_RecordMultiLeftMenu_l3['itemname']; ?>
                              </a>
                          </li>
