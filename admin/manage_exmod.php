...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_exmod.php"); ?>
    	<!-- InstanceEndEditable -->
  ...
  <div id="content_full" class="content" style="padding:15px">
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			switch($_GET['Opt_Exmod'])
			{
				case "viewpage":
					include_once("require_manage_exmod_index.php");			
					break;
				case "showpage":
					include_once("require_manage_exmod_cartshow.php");			
					break;
				case "addpage":
					include_once("require_manage_exmod_cartadd.php");			
					break;
				case "clearpage":
					include_once("require_manage_exmod_cartclear.php");			
					break;
				case "purchasepage":
					include_once("require_manage_exmod_cartpurchase.php");			
					break;
				case "checkpage":
					include_once("require_manage_exmod_cartpurchasecheck.php");			
					break;
				case "orderpage":
					if ($_SESSION['MM_UserGroup'] == 'superadmin') {
						include_once("require_manage_exmod_order_for_admin.php");	
					}else{
						include_once("require_manage_exmod_order.php");	
					}
					break;
				case "modenable":
					include_once("require_manage_exmod_mod_enable.php");			
					break;
				case "tut":
					include_once("require_manage_exmod_tutorials.php");			
					break;
				case "tut01":
					include_once("require_manage_exmod_tutorials01.php");			
					break;
				case "tut02":
					include_once("require_manage_exmod_tutorials02.php");			
					break;
				default:
					include_once("require_manage_exmod_index.php");
					break;
