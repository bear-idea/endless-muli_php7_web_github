...
<div class="post_content padding-3">
          ...
          <div class="row">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-4">
                          <div class="box-image text-center" style="margin:5px 0; background-color:#FFF;">
            
                                        <div class="box-icon" style="margin:20px 0;">
                        ...
                        <div class="box-image text-center" style="margin:5px 0; background-color:#FFF;">
							...
							<div class="box-icon" style="margin:20px 0;">
								<a class="box-icon-title" href="<?php echo $SiteBaseUrl . url_rewrite('member',array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'order'),'',$UrlWriteEnable);?>">
									...
									<h3><i class="fa fa-clipboard" aria-hidden="true"></i> 查詢訂單資料</h3>
								</a>
								<p class="text-muted"></p>
							</div>
                        ...
                        <div class="box-image text-center" style="margin:5px 0; background-color:#FFF;">
							...
							<div class="box-icon" style="margin:20px 0;">
								<a class="box-icon-title" href="<?php echo $SiteBaseUrl . url_rewrite('splitorder',array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'order'),'',$UrlWriteEnable);?>">
									
									<h3><i class="fa fa-wrench" aria-hidden="true"></i> 物料拆分查詢</h3>
								</a>
								<p class="text-muted"></p>
							</div>
                        ...
                        <div class="box-image text-center" style="margin:5px 0; background-color:#FFF;">
							...
							<div class="box-icon" style="margin:20px 0;">
								<a class="box-icon-title" href="<?php echo $SiteBaseUrl . url_rewrite('scalesource',array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'order'),'',$UrlWriteEnable);?>">
									...
									<h3><i class="fa fa-archive" aria-hidden="true"></i> 貨源庫存查詢</h3>
								</a>
								<p class="text-muted"></p>
							</div>
                        ...
                        <div class="box-image text-center" style="margin:5px 0; background-color:#FFF;">
							...
							<div class="box-icon" style="margin:20px 0;">
								<a class="box-icon-title" href="<?php echo $SiteBaseUrl . url_rewrite('scaleclearance',array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'order'),'',$UrlWriteEnable);?>">
									
									<h3><i class="fa fa-archive" aria-hidden="true"></i> 清運明細查詢</h3>
								</a>
								<p class="text-muted"></p>
							</div>
                        ...
                        <div class="box-image text-center" style="margin:5px 0; background-color:#FFF;">
							...
							<div class="box-icon" style="margin:20px 0;">
							  <a class="box-icon-title" href="<?php echo $logoutAction ?>">
									...
									<h3><i class="fa fa-sign-out" aria-hidden="true"></i> 登出系統</h3>
								</a>
								<p class="text-muted"></p>
							</div>
