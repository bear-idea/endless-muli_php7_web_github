        ...
        <!--<div class="col-md-6"> <?php //echo "mega-menu"; ?>
          <ul class="list-unstyled">--> <?php //echo "mega-menu"; ?>
            ...
            <?php if ($row_RecordProductMultiTopMenu_l2['endnode'] != 'child') { ?>
            	<a href="<?php echo $SiteBaseUrl . url_rewrite("product",array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'subpage','type1'=>$row_RecordProductMultiTopMenu_l1['item_id'],'type2'=>$row_RecordProductMultiTopMenu_l2['item_id']),'',$UrlWriteEnable);?>" class="dropdown-toggle"><?php echo $row_RecordProductMultiTopMenu_l2['itemname']; ?></a>
			<?php } else { ?>
