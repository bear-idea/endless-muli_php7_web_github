...
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpBackGround = sprintf("SELECT * FROM demo_tmpbackground WHERE ((name LIKE %s)) && (type LIKE %s) && (userid=%s || userid=1) ORDER BY type DESC, id DESC", GetSQLValueString("%" . $colname_RecordTmpBackGround . "%", "text"),GetSQLValueString("%" . $coltype_RecordTmpBackGround . "%", "text"),GetSQLValueString($coluserid_RecordTmpBackGround, "int"));
...
?>
    ...
    <div style="width:100%"><span class="Type_Sum"><a href="tmpheaderbackground_home.php?id=<?php echo $_GET['id']; ?>" <?php if($_GET['type'] == "") { ?>class="active"<?php } ?>>全部</a></span>
    <?php do { ?>
      <span class="Type_Sum"><a href="tmpheaderbackground_home.php?id=<?php echo $_GET['id']; ?>&amp;type=<?php echo $row_RecordTmpBackGroundListType['itemname']; ?>" <?php if($_GET['type'] == $row_RecordTmpBackGroundListType['itemname']) { ?>class="active"<?php } ?>><?php echo $row_RecordTmpBackGroundListType['itemname']; ?></a></span>
...
<div style="height:10px; clear:both;"></div></div>
    ...
    <tbody>
      ...
      <tr>    
	   ...
	   <div style="padding:5px; border: 1px dotted #CCC; margin-bottom:2px; width:115px; float:left; margin:5px; text-align:center;" class="<?php if($row_RecordTmpBackGroundSelect['tmpheaderbackground'] == ''){echo "bg_active";} ?> bg_board"><!--無圖片指定-->
       <div class="TmpBgSelectIcon" style="display:<?php if($row_RecordTmpBackGroundSelect['tmpheaderbackground'] != ''){echo "none";} ?>;"></div>
  ...
  <?php do { ?>
    <div style="padding:5px; border: 1px dotted #CCC; margin-bottom:2px; width:115px; float:left; margin:5px; text-align:center; position:relative;" class="<?php if($row_RecordTmpBackGroundSelect['tmpheaderbackground'] == $row_RecordTmpBackGround['id']){echo "bg_active";} ?> bg_board">
      <div class="TmpBgSelectIcon" style="display:<?php if($row_RecordTmpBackGroundSelect['tmpheaderbackground'] != $row_RecordTmpBackGround['id']){echo "none";} ?>;"></div>
      ...
      <div class="div_table-cell" style="background-image:url(images/ap_p_u.jpg);">
        <div style="position:absolute; z-index:100; margin-top:80px;"><a href="#"  data-original-title="您可以點此查看預覽範例" data-toggle="tooltip" data-placement="top"><img src="images/menu_local_see.jpg" width="20" height="20" onclick="MM_openBrWindow('tmp_background_show.php?id_edit=<?php echo $row_RecordTmpBackGround['id']; ?>&amp;lang=<?php echo $_SESSION['lang']; ?>','','resizable=yes,width=1200,height=500')" /></a></div>
        ...
        <a><img src="<?php echo $SiteImgUrlAdmin; ?><?php echo $row_RecordTmpBackGround['webname']; ?>/image/tmpbackground/<?php echo $row_RecordTmpBackGround['bgimage']; ?>" alt="" alumb="true" _w="100" _h="100"/></a><span></span>
        </div>
      <?php } else { ?>
