...
<script type="text/javascript">
        $(document).ready(function() {
            $("#urlbuilddate, #webenabledate, #webrenewdate").datetimepicker({
				changeMoneth:!0,changeYear:!0,
...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require("require_leftmainmenu_webuser_sub.php");?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include("require_manage_webuser_index_sub.php");			
					break;
				case "searchpage":
					include("require_manage_webuser_index_search_sub.php");			
					break;
				case "addpage":
					include("require_manage_webuser_add_sub.php");
					break;
				case "editpage":
					include("require_manage_webuser_edit_sub.php"); 
					break;
				default:
