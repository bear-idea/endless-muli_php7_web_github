...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_Accounts_summons")) {
  ...
  $insertGoTo = "inner_accounts_summons.php?Opt=detailpage&lang=" . $_POST['lang'] . '&aid=' . $_POST['aid'];
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 會計傳票細項 <small>新增</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post">
	  ...
	  <div class="form-group row">
          ...
          <div class="col-md-10">
              <input name="postdate" type="text" required="" class="form-control" id="postdate" autocomplete="off" value="<?php $dt = new DateTime($row_RecordAccounts_summonsorder['postdate']); echo $dt->format('Y-m-d'); ?>" maxlength="10" readonly="readonly" data-date-format="yyyy-mm-dd" data-parsley-trigger="blur" data-date-language="zh-TW"/>  
	  ...
	  <div class="form-group row">
          ...
          <div class="row p-10">
                    ...
                    <select name="type1" id="type1" class="form-control col-md-3" style="display:inline-block" data-parsley-trigger="blur" required>
...
?>
     ...
     <div class="form-group row">
          ...
          <div class="col-md-10">
                      <input name="debitamount" id="debitamount" value="0" maxlength="11" class="form-control col-md-4" data-parsley-min="0" data-parsley-max="9999999" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1" required="" <?php if ($row_RecordAccounts_summonsorder['type'] == '收入') { echo 'readonly="readonly"';} ?>/>                      
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      <input name="creditamount" id="creditamount" value="0" maxlength="11" class="form-control col-md-4" data-parsley-min="0" data-parsley-max="9999999" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1" required="" <?php if ($row_RecordAccounts_summonsorder['type'] == '支出') { echo 'readonly="readonly"';} ?>/>                      
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
            ...
            <input id="fullIdPath" type="hidden" value="" />
          </div>
      </div>
