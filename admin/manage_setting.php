...
<link href="<?php if($SiteBaseUrlOuter != "") { echo $SiteBaseUrlOuter . $SiteBaseAdminPath; } else { echo $SiteBaseUrl . $SiteBaseAdminPath; } ?>assets/plugins/password-indicator/css/password-indicator.css" rel="stylesheet" />
<script src="<?php if($SiteBaseUrlOuter != "") { echo $SiteBaseUrlOuter . $SiteBaseAdminPath; } else { echo $SiteBaseUrl . $SiteBaseAdminPath; } ?>assets/plugins/password-indicator/js/password-indicator.js"></script>
<!-- InstanceEndEditable -->
</head>
<body>
...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_config.php"); ?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "settingpage_ap":
					include_once("require_manage_config_ap_index.php");			
					break;
				case "settingpage_ip":
					include_once("require_manage_config_ip_index.php");			
					break;
				case "settingpage_user":
					include_once("require_manage_config_userdata_index.php");			
					break;
				case "settingpage_fr":
					include_once("require_manage_config_fr_index.php");
					break;
				case "settingpage_otr":
					include_once("require_manage_config_otr_index.php"); 
					break;
				case "settingpage_bs":
					if($_SESSION['lang'] == 'en') {
						include_once("require_manage_config_bs_index_en.php"); 
					}else if($_SESSION['lang'] == 'zh-cn') {
						include_once("require_manage_config_bs_index_cn.php"); 
					} else {
						include_once("require_manage_config_bs_index.php"); 
					}
					break;
				case "configpage_list":
					include_once("require_manage_config_list.php"); 
					break;
				case "settingpage_list":
					include_once("require_manage_setting_list.php"); 
					break;
				case "settingpage_listitem":
					include_once("require_manage_setting_listitem.php"); 
					break;
				case "settingpage_mulilistitem":
					include_once("require_manage_setting_mulilistitem.php"); 
					break;
				case "settingpage_mulilistitempage":
					include_once("require_manage_setting_mulilistitem.php");
					break;
				case "settingpage_sub_mulilistitempage":
					include_once("require_manage_setting_mulilistitem_sub.php");
					break;
				case "deletepage":
					include_once("require_manage_config_delete.php");
					break;
				case "listpage":
					include_once("require_manage_config_list.php");
					break;
				case "listitempage":
					include_once("require_manage_config_listitem.php");
					break;
				default:
					include_once("require_manage_config_ap_index.php");
					break;
