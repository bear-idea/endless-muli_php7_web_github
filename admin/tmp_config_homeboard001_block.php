...
if ((isset($_GET['id_del'])) && ($_GET['id_del'] != "") && $_GET['userid'] == $w_userid) {
  ...
  if($_GET['type'] == 'News' || $_GET['type'] == 'Publish' || $_GET['type'] == 'Letters' || $_GET['type'] == 'Actnews' || $_GET['type'] == 'Partner' || $_GET['type'] == 'Video' || $_GET['type'] == 'Product' || $_GET['type'] == 'Project' || $_GET['type'] == 'Activities' || $_GET['type'] == 'Sponsor')
  {
	  ...
	  $updateSQLLock = sprintf("UPDATE demo_setting_fr SET %s=0 WHERE userid=%s",
	                       GetSQLValueString("Home" . $_GET['type'] . "Lock", "none"),
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "TmpColumnFree")) {
  ...
  if($_POST['type'] == 'News' || $_POST['type'] == 'Publish' || $_POST['type'] == 'Letters' || $_POST['type'] == 'Actnews' || $_POST['type'] == 'Partner' || $_POST['type'] == 'Video' || $_POST['type'] == 'Product' || $_POST['type'] == 'Project' || $_POST['type'] == 'Activities' || $_POST['type'] == 'Sponsor')
  {
	  ...
	  $updateSQLLock = sprintf("UPDATE demo_setting_fr SET %s=1 WHERE userid=%s",
	  					   GetSQLValueString("Home" . $_POST['type'] . "Lock", "none"),
						   GetSQLValueString($_POST['userid'], "int"));
...
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpColumn = sprintf("SELECT * FROM demo_tmphomeblockcolumn WHERE lang=%s && userid=%s ORDER BY sortid ASC, id DESC", GetSQLValueString($collang_RecordTmpColumn, "text"),GetSQLValueString($coluserid_RecordTmpColumn, "int"));
...
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordSettingLock = sprintf("SELECT HomeNewsLock, HomePublishLock, HomeLettersLock, HomeActnewsLock, HomePartnerLock, HomeVideoLock, HomeProductLock, HomeProjectLock, HomeActivitiesLock, HomeSponsorLock FROM demo_setting_fr WHERE userid = %s", GetSQLValueString($coluserid_RecordSettingLock, "text"));
  ...
  <div class="panel-body">
    <div class="table-responsive">
        <table class="table table-hover m-b-0">
			...
			<?php do { ?>
            <?php if (
		  ($row_RecordTmpAddColumn['type'] == 'News' && ($row_RecordSettingLock['HomeNewsLock'] == '1' OR $OptionNewsSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'Publish' && ($row_RecordSettingLock['HomePublishLock'] == '1' OR $OptionPublishSelect == '0')) ||
		  ($row_RecordTmpAddColumn['type'] == 'Letters' && ($row_RecordSettingLock['HomeLettersLock'] == '1' OR $OptionLettersSelect == '0')) ||
		  ($row_RecordTmpAddColumn['type'] == 'Actnews' && ($row_RecordSettingLock['HomeActnewsLock'] == '1' OR $OptionActnewsSelect == '0')) ||
		  ($row_RecordTmpAddColumn['type'] == 'Partner' && ($row_RecordSettingLock['HomePartnerLock'] == '1' OR $OptionPartnerSelect == '0')) ||
		  ($row_RecordTmpAddColumn['type'] == 'Video' && ($row_RecordSettingLock['HomeVideoLock'] == '1' OR $OptionVideoSelect == '0')) ||
		  ($row_RecordTmpAddColumn['type'] == 'Product' && ($row_RecordSettingLock['HomeProductLock'] == '1' OR $OptionProductSelect == '0')) ||
		  ($row_RecordTmpAddColumn['type'] == 'Project' && ($row_RecordSettingLock['HomeProjectLock'] == '1' OR $OptionProjectSelect == '0')) ||
		  ($row_RecordTmpAddColumn['type'] == 'Activities' && ($row_RecordSettingLock['HomeActivitiesLock'] == '1' OR $OptionActivitiesSelect == '0')) ||
		  ($row_RecordTmpAddColumn['type'] == 'Sponsor' && ($row_RecordSettingLock['HomeSponsorLock'] == '1' OR $OptionSponsorSelect == '0'))
		  ) { ?>
          <?php } else { ?>
