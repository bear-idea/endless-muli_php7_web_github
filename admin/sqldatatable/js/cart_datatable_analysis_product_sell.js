var handleDataTableDefault = function() {
    ...
    if ($('#data-table-default').length !== 0) {
		...
		"dom":"lBprtip",buttons:[{extend:"copy",className:"btn-sm"},{extend:"csv",className:"btn-sm"},{extend:"excel",className:"btn-sm"},{extend:"pdf",className:"btn-sm"},{extend:"print",className:"btn-sm"},{extend:"colvis",className:"btn-sm"}],
            ...
            "autoWidth": false,
            "ajax": {
                "url": "sqldatatable/cart_analysis_product_sell_view.php",
                "type": "post",
				"data": function ( d ) {
					...
					//d.search_state = $('#col7_filter').val();
					
					d.search_postdate = $('#col13_filter').val();
            ...
            'columnDefs': [{
                ...
                'render': function(data, type, full, meta) {
                    return meta.row + meta.settings._iDisplayStart + 1;} /* 自動序號 */
                }],
			"select": true,
