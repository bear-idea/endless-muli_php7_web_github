...
<script type="text/javascript" src="<?php if($SiteBaseUrlOuter != "") { echo $SiteJsUrlOuter; } else { echo $SiteJsUrl; } ?>nicConfig.js"></script>
<script type="text/javascript" src="<?php if($SiteBaseUrlOuter != "") { echo $SiteJsUrlOuter; } else { echo $SiteJsUrl; } ?>nicEdit.js"></script>
<!-- InstanceEndEditable -->
...
<div class="mdviewline ViewlineBoardStyle">
	...
	<div class="mdviewline_c g_p_hide">
			...
			<div class="mdviewline_c_c">
			    ...
			    <!--導覽列外框--> 
                <?php require("require_forum_viewline.php"); ?>
                <!--導覽列外框-->
  				<!--</div>
...
<?php } ?>
        ...
        <?php
			...
			{
				case "viewpage":
					include_once("require_forum.php");				
					break;
				case "postpage":
					include_once("require_forumpost.php");				
					break;
				case "editpostpage":
					include_once("require_forumedit.php");				
					break;
				case "detailed":
					include_once("require_forum_detailed.php");				
					break;
				case "reg":
