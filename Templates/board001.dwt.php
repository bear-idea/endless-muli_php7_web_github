  ...
  <div id="Bk_Bottom_Wrapper">
	...
	?>
		...
		?>
                    ...
                    <!-- TemplateBeginEditable name="導覽列" --> <!-- TemplateEndEditable -->
                    <div id="Left_column">
                      <div id="context">
                        <?php 
		...
		?>
                    ...
                    <div id="Content_containter" _height="auto">
                      <div id="Main_content">
                        <div id="context" > <!-- TemplateBeginEditable name="主內容" -->
                          <?php include($TplPath . "/main_content.php"); ?>
                          <!-- TemplateEndEditable --> </div>
                      </div>
                      <div id="Right_column">
                        <div id="context"> <!-- TemplateBeginEditable name="右選單" --> <!-- TemplateEndEditable -->
                          <?php 
