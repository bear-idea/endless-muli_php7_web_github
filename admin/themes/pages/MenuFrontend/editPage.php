...
$formFields = [
    ...
    'subtitle' => ['label' => '子選單標題', 'type' => 'text', 'maxlength' => 100, 'required' => true, 'value' => $row_RecordMenuBackend['subtitle']],
        ...
        <form action="<?php echo $request->getRequestUri(); ?>" class="form-horizontal form-bordered" data-parsley-validate="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    ...
                    <input name="id" type="hidden" id="id" value="<?php echo $row_RecordMenuBackend['id']; ?>" />
                    <input name="lang" type="hidden" id="lang" value="<?php echo $row_RecordMenuBackend['lang']; ?>" />
                    <input name="wshop" type="hidden" id="wshop" value="<?php echo $wshop; ?>" />
                    <input name="editdate" type="hidden" id="editdate" value="<?php echo date("Y-m-d H:i:s"); ?>" />
                </div>
            </div>
            <input type="hidden" name="MM_update" value="form_MenuBackend" />
