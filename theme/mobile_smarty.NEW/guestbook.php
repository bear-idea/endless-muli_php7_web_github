...
<title><?php echo $Lang_Title_Guestbook; ?></title>
<!-- InstanceEndEditable -->
  ...
  <?php 
    ...
    <?php if ($TmpWrpViewLineLocate == '2') { ?>               
        ...
        <section class="page-header page-header-xxs">
			...
			<?php echo $ModuleName['Guestbook']; ?>
			<!-- InstanceEndEditable --></h1>
            <!-- InstanceBeginEditable name="導覽列" -->
                                    <?php require("require_guestbook_viewline_mobile.php"); ?>
                    <!-- InstanceEndEditable -->
        </section>
	...
	<?php } ?>
      ...
      <div class="row">      
        ...
        <?php
			...
			{
				case "viewpage":
					include_once("require_guestbook.php");				
					break;
				case "addpage":
					include_once("require_guestbook_add.php");				
					break;
				case "detailed":
					include_once("require_guestbook_detailed.php");				
					break;
				default:
					include_once("require_guestbook.php");
					break;
