var handleDataTableDefault = function() {
    ...
    if ($('#data-table-default').length !== 0) {
		...
		//"dom":"lBfrtip",buttons:[{extend:"copy",className:"btn-sm"},{extend:"csv",className:"btn-sm"},{extend:"excel",className:"btn-sm"},{extend:"pdf",className:"btn-sm"},{extend:"print",className:"btn-sm"},{extend:"colvis",className:"btn-sm"}],
            ...
            "autoWidth": false,
            "ajax": {
                "url": "sqldatatable/scaleorder_in_view.php",
                "type": "post",
				"data": function ( d ) {
            ...
            'columnDefs': [{
                ...
                'render': function(data, type, full, meta) {
                    return '<input type="checkbox" class="data-check" name="addscaleorder[]" id="addscaleorder[]" value="' + $('<div/>').text(data).html() + '">';}
                }],
			"select": true,
            ...
            "fnDrawCallback": function(oSettings) {
                ...
                $('#data-table-default').editable({
                    selector: ".ed_title",
                    url: 'sqledit/scaleorder_in_jedit.php',
                    type: 'text',
                    name: 'title',
                    //title: '輸入標題',
				...
				$('#data-table-default').editable({
                    ...
                    url: 'sqledit/scaleorder_in_jedit.php',
                    name: "type",
                    source: "sqledit/scaleorder_in_get_list.php?list_id=1",
                    validate: function(value) {
                        if ($.trim(value) == '') {
                            return '值不能為空';
                        }
    ...
    swal({
        ...
        preConfirm: function() {
            return new Promise(function(resolve) {
                ...
                $.ajax({
                    url: "sqldatatable/scaleorder_in_del.php?id_del=" + id,
                    type: "GET"
        ...
        swal({
            ...
            preConfirm: function() {
                return new Promise(function(resolve) {
                    ...
                    $.ajax({
                        url: "sqldatatable/scaleorder_in_del_muti.php",
                        data: {
                            id: list_id
                        },
                        type: "POST"
