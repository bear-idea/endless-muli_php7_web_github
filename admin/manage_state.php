...
<script type="text/javascript" src="js/jquery.isotope.min.js"></script>
  <script>
    $(function(){
      var $container = $('.Menu_ListView_Index');
      $container.isotope({
        itemSelector: '.mod_board'
      });
    });
  </script>
<style type="text/css">
...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_state.php"); ?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include_once("require_manage_state_mod.php");			
					break;
				case "statepage":
					include_once("require_manage_state_state.php");			
					break;
