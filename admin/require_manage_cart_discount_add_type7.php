...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_Discount")) {
  $insertSQL = sprintf("INSERT INTO demo_productdiscount (name, type, discountFullamount, discountNowfold, startdate, enddate, `limitdate`, skeyword, sdescription, content, menuname, menuindicate, indicate, notes1, lang, userid) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 滿額多重減價(-) <small>新增</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post">
        ...
        <label class="col-md-2 col-form-label">折扣方式<span class="text-red">*</span> <i class="fa fa-info-circle text-orange" data-original-title="例如:80代表8折/10代表1折。" data-toggle="tooltip" data-placement="top"></i></label>
          ...
          <div class="col-md-2">
                  <div class="input-group p-0">
                    ...
                    <input name="discountNowfold" id="discountNowfold" maxlength="11" class="form-control col-md-12" data-parsley-min="0" data-parsley-max="9999999" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1" data-parsley-errors-container="#error_discountNowfold" required=""/>
                    <div class="input-group-append"><span class="input-group-text">元</span></div> 
                  </div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
            ...
            <input name="type" type="hidden" id="type" value="6" />
          </div>
      </div>
