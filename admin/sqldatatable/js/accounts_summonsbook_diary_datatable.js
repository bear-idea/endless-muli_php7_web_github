var handleDataTableDefault = function(aid) {
    ...
    if ($('#data-table-default').length !== 0) {
        ...
        var otable = $('#data-table-default').DataTable({       
		    "dom":"lBprtip",buttons:[{extend:"copy",className:"btn-sm",title:"日記帳"+NowToday},{extend:"csv",className:"btn-sm",title:"日記帳"+NowToday},{extend:"excel",className:"btn-sm",title:"日記帳"+NowToday},{extend:"pdf",className:"btn-sm",title:"日記帳"+NowToday},{extend:"print",className:"btn-sm",title:"日記帳"+NowToday},{extend:"colvis",className:"btn-sm",title:"日記帳"+NowToday}],
			//"dom": "lprtip",
            "autoWidth": false,
            "ajax": {
                "url": "sqldatatable/accounts_summonsbook_diary_view.php?aid=" + aid,
                "type": "post",
				"data": function ( d ) {
					...
					d.search_postdate = $('#col1_filter').val();
					d.search_ordertype = $('#col2_filter').val();
			...
			"stateSaveParams": function (settings, data) {
				...
				data.search.field = {
					...
					postdate: $("#col1_filter").val(),
					ordertype: $("#col2_filter").val(),
			...
			"stateLoadParams": function (settings, data) {
				...
				$("#col1_filter").val(data.search.field.postdate);
				$("#col2_filter").val(data.search.field.ordertype);
            ...
            "fnDrawCallback": function(oSettings) {
                ...
                $('#data-table-default').editable({
                    selector: ".ed_notes1",
                    url: 'sqledit/accounts_summonsbook_diary_jedit.php',
                    type: 'text',
                    name: 'notes1',
                    //title: '輸入標題',
    ...
    swal({
        ...
        preConfirm: function() {
            return new Promise(function(resolve) {
                ...
                $.ajax({
                    url: "sqldatatable/accounts_summonsbook_diary_del.php?id_del=" + id,
                    type: "GET"
        ...
        swal({
            ...
            preConfirm: function() {
                return new Promise(function(resolve) {
                    ...
                    $.ajax({
                        url: "sqldatatable/accounts_summonsbook_diary_del_muti.php",
                        data: {
                            id: list_id
                        },
                        type: "POST"
