...
$tableConfig = [
    ...
    'ajaxUrl' => ADMINURL . '/sqldatatable/menufrontend_view.php',
    'editUrl' => ADMINURL . '/sqledit/menufrontend_jedit.php',
    'editListUrl' => ADMINURL . '/sqledit/menufrontend_get_list.php?list_id=1',
    'deleteUrl' => ADMINURL . '/sqldatatable/menufrontend_del.php',
    'deleteMutiUrl' => ADMINURL . '/sqldatatable/menufrontend_del_muti.php',
    'columns' => [
