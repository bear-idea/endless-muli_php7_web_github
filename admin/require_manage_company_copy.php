...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_Company") && $_POST['sdescription'] == "") { 
	$_POST['sdescription'] = TrimSummary($_POST['content']);
}
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_Company")) {
  $insertSQL = sprintf("INSERT INTO invoicing_company (title, type, content, postdate, indicate, sdescription, skeyword, notes1, lang, userid) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "manage_company.php?Opt=viewpage&lang=" . $_POST['lang'];
  /*if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> <?php echo '公司資料'; ?> <small>複增</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
?>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
               <input name="skeyword" type="text" class="form-control" id="skeyword" value="<?php echo $row_RecordCompany['skeyword']; ?>" maxlength="300" data-role="tagsinput" />
          </div>
      </div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                 <input name="sdescription" type="text" class="form-control" id="sdescription" value="<?php echo $row_RecordCompany['sdescription']; ?>" size="100" maxlength="150"/> 
          </div>
      </div>
      ...
      <div class="form-group row">
          ...
          <div class="table-responsive">
                <textarea name="content" id="content" cols="100%" rows="35" class="form-control"><?php echo $row_RecordCompany['content']; ?></textarea>  
          </div>
          </div>
      </div>
      <div class="form-group row">
      ...
      <input type="hidden" name="MM_insert" value="form_Company" />
  </form>
  </div>
  <!-- end panel-body --> 
</div>
