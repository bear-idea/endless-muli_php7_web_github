  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post">
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="socialnameid" type="email" required="" class="form-control" id="socialnameid" value="<?php echo $row_RecordSocialchat['socialnameid']; ?>" maxlength="200" data-parsley-trigger="blur"/>
