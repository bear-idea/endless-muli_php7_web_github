...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_TmpColumn")) {
  $updateSQL = sprintf("UPDATE demo_tmpcolumn SET customname=%s, content=%s, sortid=%s, indicatetitle=%s, indicatemiddle=%s, indicatewrp=%s, indicatetopmenu=%s, indicatebottommenu=%s, lang=%s WHERE id=%s",
  ...
  $updateGoTo = "manage_tmp.php?Operate=addSuccess&Opt=tmpcolumn&lang=" . $_POST['lang'];
  if (isset($_SERVER['QUERY_STRING'])) {
...
<form action="require_manage_tmpcolumn_setting_fbfan.php" method="POST" enctype="multipart/form-data" name="form_TmpColumn" id="form_TmpColumn">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="TB_General_style01">
    ...
    <tr>
      ...
      <td><span id="TmpColumnName">
        ...
        <span class="textfieldRequiredMsg">欄位不可為空。</span></span><span class="Form_Caption_Word">(此名稱您可至<a href="manage_tmp.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>" target="_blank">版型設計</a>畫面中設定是否顯示)</span></td>
    </tr>
    <tr>
      <td align="right"><span class="Form_Required_Item">*</span>粉絲頁名稱ID：</td>
      <td><span id="sprytextfield3">
        <label for="content">https://www.facebook.com/</label>
        <input name="content" type="text" id="content" value="<?php echo $row_RecordTmpColumn['content']; ?>" />
    ...
    <tr>
      <td align="right"><i class="fa fa-chevron-right" style="color:#F00"></i> <strong>側邊裝飾外框：</strong></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      <td align="right"><i class="fa fa-chevron-right" style="color:#F00"></i> <strong>側邊選單：</strong></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td align="right"><span class="Form_Required_Item">*</span>選單標題圖片：</td>
      <td><span id="spryradio4">
        <label>
          <input <?php if (!(strcmp($row_RecordTmpColumn['indicatetopmenu'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="indicatetopmenu" value="1" id="indicatetopmenu_0" />
          顯示</label>
        <label>
          <input <?php if (!(strcmp($row_RecordTmpColumn['indicatetopmenu'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="indicatetopmenu" value="0" id="indicatetopmenu_1" />
          隱藏</label>
        <span class="radioRequiredMsg">請進行選取。</span></span></td>
    </tr>
    <tr>
      <td align="right"><span class="Form_Required_Item">*</span>選單底部圖片：</td>
      <td><span id="spryradio5">
        <label>
          <input <?php if (!(strcmp($row_RecordTmpColumn['indicatebottommenu'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="indicatebottommenu" value="1" id="indicatebottommenu_0" />
          顯示</label>
        <label>
          <input <?php if (!(strcmp($row_RecordTmpColumn['indicatebottommenu'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="indicatebottommenu" value="0" id="indicatebottommenu_1" />
          隱藏</label>
        <span class="radioRequiredMsg">請進行選取。</span></span></td>
    </tr>
    <tr>
