...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Partner")) {
  $updateSQL = sprintf("UPDATE demo_partner SET name=%s, type=%s, link=%s, sdescription=%s, indicate=%s, notes1=%s, lang=%s WHERE id=%s",
  ...
  $updateGoTo = "manage_partner.php?Opt=viewpage&lang=" . $_POST['lang'];
  /*if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> <?php echo $ModuleName['Partner']; ?> <small>修改</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post">
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                 <a href="uplod_partner.php?id_edit=<?php echo $row_RecordPartner['id']; ?>&amp;lang=<?php echo $_GET['lang']; ?>" class="btn btn-warning colorbox_iframe"><i class="fa fa-image"></i> 圖片修改</a>
          </div>
      </div>
      <div class="form-group row">
