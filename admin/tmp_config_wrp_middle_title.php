...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Tmp")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmp_middle_title_font_color=%s, tmp_middle_title_x=%s, tmp_middle_title_height=%s, tmp_middle_title_indicate=%s, tmp_middle_title_location=%s, tmp_middle_title_width=%s, tmp_middle_title_location_y=%s, tmp_middle_title_location_x=%s, tmp_middle_title_block_y=%s, tmp_middle_title_post_content_y=%s, tmp_middle_title_marquee=%s WHERE id=%s",
					   ...
					   GetSQLValueString($_POST['tmp_middle_title_indicate'], "int"),
					   GetSQLValueString($_POST['tmp_middle_title_location'], "int"),
					   GetSQLValueString($_POST['tmp_middle_title_width'], "text"),
					   GetSQLValueString($_POST['tmp_middle_title_location_y'], "text"),
					   GetSQLValueString($_POST['tmp_middle_title_location_x'], "text"),
					   GetSQLValueString($_POST['tmp_middle_title_block_y'], "text"),
					   GetSQLValueString($_POST['tmp_middle_title_post_content_y'], "text"),
					   GetSQLValueString($_POST['tmp_middle_title_marquee'], "int"),
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post" id="form_Tmp" name="form_Tmp">
      <div class="form-group row">
        ...
        <div class="col-md-12"><span class="badge badge-primary"><i class="fa fa-paper-plane"></i> 中央標題區塊</span></div>
      </div>
  	  <div class="form-group row">
          ...
          <div class="col-md-10">
          		<div class="input-group colorpicker-component colorpicker-element">				
                   <input name="tmp_middle_title_font_color" type="text" required class="form-control colorpicker-element" id="tmp_middle_title_font_color" value="<?php echo $row_RecordTmp['tmp_middle_title_font_color']; ?>" maxlength="20" data-parsley-errors-container="#error_tmp_middle_title_font_color" data-parsley-trigger="blur"/>
                   <span class="input-group-addon"><i style="background-color: rgb(64, 18, 18);"></i></span>
              </div>
              <div id="error_tmp_middle_title_font_color"></div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      <input name="tmp_middle_title_x" class="form-control" id="tmp_middle_title_x" value="<?php echo $row_RecordTmp['tmp_middle_title_x']; ?>" maxlength="3" data-parsley-min="0" data-parsley-max="999" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                      
        </div>
      </div>
      <div class="form-group row">
          <label class="col-md-2 col-form-label">區塊高度<span class="text-red">*</span></label>
          <div class="col-md-10">
                      <input name="tmp_middle_title_height" class="form-control" id="tmp_middle_title_height" value="<?php echo $row_RecordTmp['tmp_middle_title_height']; ?>" maxlength="3" data-parsley-min="0" data-parsley-max="999" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1" required />
                      
        </div>
      </div>
      
      <div class="form-group row">
          <label class="col-md-2 col-form-label">區塊位置調整</label>
          <div class="col-md-10">
                     <div class="input-group p-0">
            
                      <div class="input-group-prepend"><span class="input-group-text">距上方 <i class="fa fa-info-circle text-black" data-original-title="此設定可讓區塊位置和橫幅距離/導覽列做微調。" data-toggle="tooltip" data-placement="top"></i></span></div>
                         <input name="tmp_middle_title_block_y" class="form-control" id="tmp_middle_title_block_y" value="<?php echo $row_RecordTmp['tmp_middle_title_block_y']; ?>" maxlength="3" data-parsley-min="0" data-parsley-max="999" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">內文位置調整</label>
          <div class="col-md-10">
                     <div class="input-group p-0">
            
                      <div class="input-group-prepend"><span class="input-group-text">距上方 <i class="fa fa-info-circle text-black" data-original-title="此設定可讓內文內容和標題距離做微調。" data-toggle="tooltip" data-placement="top"></i></span></div>
                         <input name="tmp_middle_title_post_content_y" class="form-control" id="tmp_middle_title_post_content_y" value="<?php echo $row_RecordTmp['tmp_middle_title_post_content_y']; ?>" maxlength="3" data-parsley-min="0" data-parsley-max="999" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                              <div class="input-group-append"><span class="input-group-text">px</span></div>                
                    </div>
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">是否隱藏<span class="text-red">*</span><i class="fa fa-info-circle text-orange" data-original-title="是否將標題區塊隱藏。" data-toggle="tooltip" data-placement="top"></i></label>                       	
          <div class="col-md-10">
          
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmp_middle_title_indicate'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmp_middle_title_indicate" id="tmp_middle_title_indicate_2" value="0" />
                <label for="tmp_middle_title_indicate_2">不顯示</label>
            </div>
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmp_middle_title_indicate'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmp_middle_title_indicate" id="tmp_middle_title_indicate_1" value="1" />
                <label for="tmp_middle_title_indicate_1">顯示</label>
            </div>
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">標題位置<span class="text-red">*</span><i class="fa fa-info-circle text-orange" data-original-title="設定標題位置是否為相對位置(relative)及絕對位置(absolute)" data-toggle="tooltip" data-placement="top"></i></label>                       	
          <div class="col-md-4">
          
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmp_middle_title_location'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmp_middle_title_location" id="tmp_middle_title_location_2" value="0" />
                <label for="tmp_middle_title_location_2">預設位置(relative)</label>
            </div>
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmp_middle_title_location'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmp_middle_title_location" id="tmp_middle_title_location_1" value="1" />
                <label for="tmp_middle_title_location_1">浮動位置(absolute)</label>
            </div>
          ...
          <div class="col-md-2">
                     <div class="input-group p-0">
                      ...
                      <div class="input-group-prepend"><span class="input-group-text">寬度 <i class="fa fa-info-circle text-black" data-original-title="若您選擇的標題位置是預設位置(relative)此設定不會生效，選擇的標題位置是浮動位置(absolute)則必須設定長寬，寬度可設定跟背景圖依樣大小。" data-toggle="tooltip" data-placement="top"></i></span></div>
                         <input name="tmp_middle_title_width" class="form-control" id="tmp_middle_title_width" value="<?php echo $row_RecordTmp['tmp_middle_title_width']; ?>" maxlength="4" data-parsley-min="0" data-parsley-max="9999" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                              <div class="input-group-append"><span class="input-group-text">px</span></div>                
                    </div>
        ...
        <div class="col-md-2">
                     <div class="input-group p-0">
                      ...
                      <div class="input-group-prepend"><span class="input-group-text">距上方 <i class="fa fa-info-circle text-black" data-original-title="若您選擇的標題位置是預設位置(relative)此設定不會生效，此值可以為負數。" data-toggle="tooltip" data-placement="top"></i></span></div>
                         <input name="tmp_middle_title_location_y" class="form-control" id="tmp_middle_title_location_y" value="<?php echo $row_RecordTmp['tmp_middle_title_location_y']; ?>" maxlength="4" data-parsley-min="-999" data-parsley-max="999" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                              <div class="input-group-append"><span class="input-group-text">px</span></div>                
                    </div>
        ...
        <div class="col-md-2">
                     <div class="input-group p-0">
                      ...
                      <div class="input-group-prepend"><span class="input-group-text">距左方 <i class="fa fa-info-circle text-black" data-original-title="若您選擇的標題位置是預設位置(relative)此設定不會生效，此值可以為負數。" data-toggle="tooltip" data-placement="top"></i></span></div>
                         <input name="tmp_middle_title_location_x" class="form-control" id="tmp_middle_title_location_x" value="<?php echo $row_RecordTmp['tmp_middle_title_location_x']; ?>" maxlength="4" data-parsley-min="-999" data-parsley-max="999" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                              <div class="input-group-append"><span class="input-group-text">px</span></div>                
                    </div>
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">是否使用跑馬燈<span class="text-red">*</span><i class="fa fa-info-circle text-orange" data-original-title="當有設定寬度時若文字超出區塊可使用此設定，此設定僅適用於某些內頁，例如最新訊息內頁標題。" data-toggle="tooltip" data-placement="top"></i></label>                       	
          <div class="col-md-10">
          
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmp_middle_title_marquee'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmp_middle_title_marquee" id="tmp_middle_title_marquee_2" value="0" />
                <label for="tmp_middle_title_marquee_2">不使用</label>
            </div>
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmp_middle_title_marquee'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmp_middle_title_marquee" id="tmp_middle_title_marquee_1" value="1" />
                <label for="tmp_middle_title_marquee_1">使用</label>
            </div>
