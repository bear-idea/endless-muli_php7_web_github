...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 拆分月報表 <small>選擇</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-body p-0">
    ...
    <?php //if ($totalRows_RecordYearend == 0) { // Show if recordset not empty ?>
     <form action="manage_split_print_month.php" method="post"  name="Yearend_Gen" target="_blank" class="form-horizontal form-bordered m-t-0" id="Yearend_Gen" data-parsley-validate="">
        ...
        <label class="col-md-2 col-form-label">選擇年份<span class="text-red">*</span></label>
          <div class="col-md-10">
                    ...
                    <select name="particularyear" id="particularyear" class="form-control" data-parsley-trigger="blur" required="">
						...
						for($y=$dt->format('Y')-10; $y <= $dt->format('Y')+1; $y++) {
						?>
      ...
      <div class="form-group row">
        <label class="col-md-2 col-form-label">選擇月份<span class="text-red">*</span></label>
          <div class="col-md-10">
                    ...
                    <select name="particularmonth" id="particularmonth" class="form-control" data-parsley-trigger="blur" required="">
