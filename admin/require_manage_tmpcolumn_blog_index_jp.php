...
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordSettingLock = sprintf("SELECT productlistLock_jp, frilinkLock_jp, fbfanLock_jp, articlelistLock_jp, alllistLock_jp, newslistLock_jp, blogplistLock_jp, blogcalendarLock_jp, blogrlistLock_jp, bloglistLock_jp, blogviewcountLock_jp, blogwhoscountLock_jp FROM demo_setting_fr WHERE userid = %s", GetSQLValueString($coluserid_RecordSettingLock, "int"));
...
<div>
  ...
  <td width="100" align="right"><?php echo $row_RecordTmpColumn['dftname']; ?></td>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-left:10px; margin-right:10px;border:solid 1px #CCCCCC;" class="TB_General_style01">
		  ...
		  <?php do { ?>
          <?php if (
		  ($row_RecordTmpAddColumn['type'] == 'blogwhoscount' && ($row_RecordSettingLock['blogwhoscountLock_jp'] == '1')) || 
		  ($row_RecordTmpAddColumn['type'] == 'blogviewcount' && ($row_RecordSettingLock['blogviewcountLock_jp'] == '1')) || 
		  ($row_RecordTmpAddColumn['type'] == 'blogrlist' && ($row_RecordSettingLock['blogrlistLock_jp'] == '1')) || 
		  ($row_RecordTmpAddColumn['type'] == 'bloglist' && ($row_RecordSettingLock['bloglistLock_jp'] == '1')) || 
		  ($row_RecordTmpAddColumn['type'] == 'blogcalendar' && ($row_RecordSettingLock['blogcalendarLock_jp'] == '1')) || 
		  ($row_RecordTmpAddColumn['type'] == 'blogplist' && ($row_RecordSettingLock['blogplistLock_jp'] == '1')) || 
