...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_template.php"); ?>
    	<!-- InstanceEndEditable -->
  ...
  <div id="content_full" class="content" style="padding:15px">
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
		    require_once('require_manage_tmp_agree_check.php');
		    if(($row_RecordTmpAgree['tmpagree'] == '1' && $OptionTmpSelect == '1') || $_SESSION['MM_UserGroup'] == 'superadmin')
			{
			switch($_GET['Opt'])
			{
				case "viewpage":
					include_once("require_manage_tmp_index.php");			
					break;
				case "addpage":
					include_once("require_manage_tmp_add.php");
					break;
				case "selectpage":
					include_once("require_manage_tmp_select.php");			
					break;
				case "selectpage_home":
					include_once("require_manage_tmp_select_home.php");			
					break;
				case "getpage":
					include_once("require_manage_tmp_get.php");			
					break;
				case "changepage_b":
					include_once("require_manage_tmp_change_base.php");			
					break;
				case "changepage_rwd":
					include_once("require_manage_tmp_change_rwd.php");			
					break;
				case "changepage_a":
					include_once("require_manage_tmp_change_all.php");			
					break;
				case "changepage_x":
					include_once("require_manage_tmp_change_allx.php");			
					break;
				case "sourceviewpage":
					include_once("require_manage_tmp_source_index.php");
					break;
				case "sourceaddpage":
					include_once("require_manage_tmp_source_add.php");
					break;
				case "sourceeditpage":
					include_once("require_manage_tmp_source_edit.php");
					break;
				case "getpage":
					include_once("require_manage_tmp_source_get.php");
					break;
				case "editpage":
					include_once("require_manage_tmp_edit.php"); 
					break;
				case "deletepage":
					include_once("require_manage_tmp_delete.php");
					break;
				case "listpage":
					include_once("require_manage_tmp_list.php");
					break;
				case "listitempage":
					include_once("require_manage_tmp_listitem.php");
					break;
				case "nvlistitempage":
					include_once("require_manage_tmp_nvlistitem.php");
					break;
				case "configpage":
					include_once("require_manage_tmp_config.php");
					break;
				case "configcopypage":
					include_once("require_manage_tmp_config_copy.php");
					break;
				case "tmpbk":
					include_once("require_manage_tmpbackground_index.php");
					break;
				case "tmpaddbk":
					include_once("require_manage_tmpbackground_add.php");
					break;
				case "tmpeditbk":
					include_once("require_manage_tmpbackground_edit.php");
					break;
				case "logoviewpage":
					include_once("require_manage_tmplogo_index.php");
					break;
				case "logonext":
					include_once("require_manage_tmplogo_next.php");
					break;
				case "logoaddpage_s":
					include_once("require_manage_tmplogo_add_select.php");
					break;
				case "logoaddpage_i":
					include_once("require_manage_tmplogo_add_image.php");
					break;
				case "logoaddpage_w":
					include_once("require_manage_tmplogo_add_word.php");
					break;
				case "logoeditpage_i":
					include_once("require_manage_tmplogo_edit_image.php");
					break;
				case "logoeditpage_w":
					include_once("require_manage_tmplogo_edit_word.php");
					break;
				case "tmpboard":
					include_once("require_manage_tmpboard_index.php");
					break;
				case "tmpaddboard":
					include_once("require_manage_tmpboard_add.php");
					break;
				case "tmpeditboard":
					include_once("require_manage_tmpboard_edit.php");
					break;
				case "tmpmainmenu":
					include_once("require_manage_tmpmainmenu_index.php");
					break;
				case "tmpmainmenu_c":
					include_once("require_manage_tmpmainmenu_index_color.php");
					break;
				case "tmpaddmainmenu":
					include_once("require_manage_tmpmainmenu_add.php");
					break;
				case "tmpeditmainmenu":
					include_once("require_manage_tmpmainmenu_edit.php");
					break;
				case "tmpleftmenu":
					include_once("require_manage_tmpleftmenu_index.php");
					break;
				case "tmpaddleftmenu":
					include_once("require_manage_tmpleftmenu_add.php");
					break;
				case "tmpeditleftmenu":
					include_once("require_manage_tmpleftmenu_edit.php");
					break;
				case "tmpblock":
					include_once("require_manage_tmpblock_index.php");
					break;
				case "tmpaddblock":
					include_once("require_manage_tmpblock_add.php");
					break;
				case "tmpeditblock":
					include_once("require_manage_tmpblock_edit.php");
					break;
				case "tmpcolumn":
					if($_SESSION['lang'] == 'en') {
						include_once("require_manage_tmpcolumn_index_en.php"); 
					}else if($_SESSION['lang'] == 'zh-cn') {
						include_once("require_manage_tmpcolumn_index_cn.php"); 
					}else if($_SESSION['lang'] == 'jp') {
						include_once("require_manage_tmpcolumn_index_jp.php"); 
					}else if($_SESSION['lang'] == 'kr') {
						include_once("require_manage_tmpcolumn_index_kr.php"); 
					}else if($_SESSION['lang'] == 'sp') {
						include_once("require_manage_tmpcolumn_index_sp.php"); 
					} else {
						include_once("require_manage_tmpcolumn_index.php");
					}
					break;
				case "tmpcolumn_plus":
					if($_SESSION['lang'] == 'en') {
						include_once("require_manage_tmpcolumn_index_plus_en.php"); 
					}else if($_SESSION['lang'] == 'zh-cn') {
						include_once("require_manage_tmpcolumn_index_plus_cn.php"); 
					}else if($_SESSION['lang'] == 'jp') {
						include_once("require_manage_tmpcolumn_index_plus_jp.php"); 
					}else if($_SESSION['lang'] == 'kr') {
						include_once("require_manage_tmpcolumn_index_plus_kr.php"); 
					}else if($_SESSION['lang'] == 'sp') {
						include_once("require_manage_tmpcolumn_index_plus_sp.php"); 
					} else {
						include_once("require_manage_tmpcolumn_index_plus.php");
					}
					break;
				case "tmpcolumn_setting":
					include_once("require_manage_tmpcolumn_setting.php");
					break;
				case "tmpcolumn_setting_free":
					include_once("require_manage_tmpcolumn_setting_free.php");
					break;
				case "tmpcolumn_setting_menu":
					include_once("require_manage_tmpcolumn_setting_menu.php");
					break;
				case "tmpcolumn_setting_fbfan":
					include_once("require_manage_tmpcolumn_setting_fbfan.php");
					break;
				case "tmpblogcolumn":
				    if($_SESSION['lang'] == 'en') {
						include_once("require_manage_tmpcolumn_blog_index_en.php"); 
					}else if($_SESSION['lang'] == 'zh-cn') {
						include_once("require_manage_tmpcolumn_blog_index_cn.php"); 
					}else if($_SESSION['lang'] == 'jp') {
						include_once("require_manage_tmpcolumn_blog_index_jp.php"); 
					} else {
						include_once("require_manage_tmpcolumn_blog_index.php");
					}
					break;
				case "deltmpblogcolumn":
					include_once("require_manage_tmpcolumn_blog_del.php");
					break;
				case "tmpblogcolumn_setting":
					include_once("require_manage_tmpcolumn_blog_setting.php");
					break;
				case "tmpblogcolumn_setting_free":
					include_once("require_manage_tmpcolumn_blog_setting_free.php");
					break;
				case "tmpblogcolumn_setting_menu":
					include_once("require_manage_tmpcolumn_blog_setting_menu.php");
					break;
				case "tmp_step_map":
					include_once("require_manage_tmp_step_map.php");
					break;
				case "tmp_column_step_map":
					include_once("require_manage_tmp_column_step_map.php");
					break;
				case "tmp_mobile":
					include_once("require_manage_tmp_mobile.php");
					break;
				case "tmp_mobile_config":
					include_once("require_manage_tmp_mobile_config.php");
					break;
				case "tmpcolorget":
					include_once("require_manage_tmp_colorget.php");
					break;
				case "tmpagree":
					include_once("require_manage_tmp_agree.php");
					break;
				default:
					include_once("require_manage_tmp_index.php");
					break;
