...
<?php } else if ($_SESSION['MM_UserGroup_' . $_GET['wshop']] == 'member'){ ?>
<div style="border: 1px solid #CCC; padding:3px; margin-bottom:5px;">
<table width="200" border="0" cellspacing="0" cellpadding="0">
  <tr>
  ...
  <tr>
    <td>»<a href="member.php?Opt=editpage&amp;tp=Member&amp;amplang=<?php echo $_SESSION['lang'] ?>">修改資料</a> »<a href="<?php echo $logoutAction ?>">登出</a></td>
  </tr>
</table>
</div>
<?php } ?>
