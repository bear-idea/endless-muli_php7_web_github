var handleDataTableDefault = function() {
    ...
    if ($('#data-table-default').length !== 0) {
        var otable = $('#data-table-default').DataTable({       //"dom":"lBfrtip",buttons:[{extend:"copy",className:"btn-sm"},{extend:"csv",className:"btn-sm"},{extend:"excel",className:"btn-sm"},{extend:"pdf",className:"btn-sm"},{extend:"print",className:"btn-sm"},{extend:"colvis",className:"btn-sm"}],
            ...
            "autoWidth": false,
            "ajax": {
                "url": "sqldatatable/permission_view.php",
                "type": "post",
				"data": function ( d ) {
					...
					d.search_usegroup = $('#col5_filter').val();
					d.search_type = $('#col4_filter').val();
					d.search_indicate = $('#col7_filter').val();
					d.search_module = $('#col3_filter').val();
			...
			"stateSaveParams": function (settings, data) {
				...
				data.search.field = {
					...
					module: $("#col3_filter").val(),
					usegroup: $("#col5_filter").val(),
					indicate: $("#col7_filter").val(),
			...
			"stateLoadParams": function (settings, data) {
				...
				$("#col3_filter").val(data.search.field.usegroup);
            ...
            "fnDrawCallback": function(oSettings) {
                ...
                $('#data-table-default').editable({
                    selector: ".ed_title",
                    url: 'sqledit/permission_jedit.php',
                    type: 'text',
                    name: 'title',
                    //title: '輸入標題',
				...
				$('#data-table-default').editable({
                    ...
                    url: 'sqledit/permission_jedit.php',
                    name: "type",
                    source: "sqledit/permission_get_list.php?list_id=1",
                    validate: function(value) {
                        if ($.trim(value) == '') {
                            return '值不能為空';
                        }
    ...
    swal({
        ...
        preConfirm: function() {
            return new Promise(function(resolve) {
                ...
                $.ajax({
                    url: "sqldatatable/permission_del.php?id_del=" + id,
                    type: "GET"
        ...
        swal({
            ...
            preConfirm: function() {
                return new Promise(function(resolve) {
                    ...
                    $.ajax({
                        url: "sqldatatable/permission_del_muti.php",
                        data: {
                            id: list_id
                        },
                        type: "POST"
