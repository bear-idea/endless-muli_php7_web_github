...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_coupons.php"); ?>
    	<!-- InstanceEndEditable -->
  ...
  <div id="content_full" class="content" style="padding:15px">
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			switch($_GET['Opt_Coupons'])
			{
				case "viewpage":
					include_once("require_manage_coupons_index.php");			
					break;
				case "addpage":
					include_once("require_manage_coupons_add.php");
					break;
				case "saddpage":
					include_once("require_manage_coupons_sadd.php");
					break;
				case "editpage":
					include_once("require_manage_coupons_edit.php"); 
					break;
				case "listpage":
					include_once("require_manage_coupons_list.php");
					break;
				case "listitempage":
					include_once("require_manage_coupons_listitem.php");
					break;
				case "configpage":
					include_once("require_manage_coupons_config.php");
					break;
				default:
					include_once("require_manage_coupons_index.php");
					break;
