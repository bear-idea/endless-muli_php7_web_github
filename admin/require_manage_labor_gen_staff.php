...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 勞保費表 <small>代入</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-heading">
    ...
    <h4 class="panel-title"><i class="fa fa-plus"></i> 代入資料</h4>
  </div>
  <!-- end panel-heading --> 
  <!-- begin panel-body -->
...
<div class="alert alert-warning m-10"><i class="fa fa-info-circle"></i> <b>勞保級距及分攤表(108.01.01適用)																										
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post">
     ...
     <div class="form-group row">
      ...
      <div class="form-group row">
        <label class="col-md-2 col-form-label">普保費率<span class="text-red">*</span></label>
          <div class="col-md-10">
      ...
      <div class="form-group row">
        <label class="col-md-2 col-form-label">就保費率<span class="text-red">*</span></label>
          <div class="col-md-10">
