...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_webanalytics.php"); ?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include_once("require_manage_webanalytics_index.php");			
					break;
				case "fbpixel":
					include_once("require_manage_webanalytics_fbpixel.php");			
					break;
				case "gtm":
					include_once("require_manage_webanalytics_gtm.php");			
					break;
				case "fbmeta":
					include_once("require_manage_webanalytics_fbmeta.php");			
					break;
				case "checkpage":
					include_once("require_manage_webanalytics_check.php");			
					break;
				case "sitemap":
					include_once("require_manage_webanalytics_sitemap.php");			
					break;
				case "sitemap_g":
					include_once("require_manage_webanalytics_sitemap_generate.php");			
					break;
				case "keywords":
					include_once("require_manage_webanalytics_keywords.php");			
					break;
				case "tut01":
					include_once("require_manage_webanalytics_tutorial01.php");			
					break;
				case "tut02":
					include_once("require_manage_webanalytics_tutorial02.php");			
					break;
				case "tut03":
					include_once("require_manage_webanalytics_tutorial03.php");			
					break;
				default:
					include_once("require_manage_webanalytics_index.php");
					break;
