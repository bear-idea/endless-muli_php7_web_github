...
$query_RecordCatalogMultiLeftMenu_l1 = sprintf("SELECT * FROM demo_catalogitem WHERE list_id = 1 && lang = %s && userid=%s ORDER BY item_id DESC", GetSQLValueString($collang_RecordCatalogMultiLeftMenu_l1, "text"),GetSQLValueString($coluserid_RecordCatalogMultiLeftMenu_l1, "int"));
