  ...
  <?php 
    ...
    <?php if ($TmpWrpViewLineLocate == '2') { ?>               
        ...
        <section class="page-header page-header-xxs">
			...
			<?php echo $ModuleName['Knowledge']; ?>
			<!-- InstanceEndEditable --></h1>
            <!-- InstanceBeginEditable name="導覽列" -->
                                    <?php require("require_knowledge_viewline_mobile.php"); ?>
                    <!-- InstanceEndEditable -->
        </section>
        ...
        <?php
			switch($_GET['Opt'])
			{
				case "viewpage":
					...
					{	
						default:
							include_once("require_knowledge.php");	
							break;
					}
					break;		
				case "typepage":
				...
				case "maintypepage":
					...
					{	
						/*case '0':
							include_once("require_knowledge_type_main_ela.php");	
							break;
						case '1':
							include_once("require_knowledge_type_main_4col.php");	
							break;
						case '2':
							include_once("require_knowledge_type_main_3col.php");	
							break;
						case '3':
							include_once("require_knowledge_type_main_2col.php");		
							break;
						case '4':
							include_once("require_knowledge_type_main_1col.php");	
							break;*/
						default:
							include_once("require_knowledge.php");	
							break;
					...
					break;		
				case "detailed":
					switch($MSKnowledgeContent)
					{	
						/*case '0':
							include_once("require_knowledge_detailed_ela_base.php");
							break;
						case '1':
							include_once("require_knowledge_detailed_ela.php");
							break;*/
						default:
							include_once("require_knowledge_detailed.php");
							break;
					}
					break;		
				default:
