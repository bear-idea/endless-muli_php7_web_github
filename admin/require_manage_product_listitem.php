...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_ProductItemAdd")) {
  $insertSQL = sprintf("INSERT INTO demo_productitem (list_id, itemname, lang, userid) VALUES (%s, %s, %s, %s)",
