...
<div class="columns on-1">
  ...
  <tr>
    <td align="center"></td>
                ...
                <?php } else { ?>
                <form id="ADlogin" name="ADlogin" method="POST" action="<?php echo $SiteBaseUrl . url_rewrite('dealer',array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'log'),'',$UrlWriteEnable);?>">
                  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td valign="middle" class="ErrorInputWord">
                        <?php if (isset($_GET['errMsg']) && $_GET['errMsg'] == "y") { ?><i class="fa fa-times-circle"></i> <?php echo $Lang_Classify_Tip07; //帳號或密碼錯誤!!請重新輸入 ?> <?php } ?></td>
                      </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="60%">
                          <div style="border:1px #DDD solid; padding:5px; min-height:255px;" class="Daeler_Board">
                          <p class="dealer_center_style6"><span class="dealer_center_style5"><br />
                            <br />
                            【經銷中心】 </span><br />
                            <br />
                            在「經銷中心」裡，您可以查看、修改、管理與您相關的各項資料。 <br />
                            請您安心地進行各項資料的維護。 <br />
  <br />
                            「經銷中心」提供如下數種服務： </p>
                            <ol>
                              <li class="dealer_center_style6"> 修改基本資料，例如地址、e-mail等。 </li>
                              <li class="dealer_center_style6"> 修改/查詢密碼。 </li>
                          ...
                          <td>
                          <div style="border:1px #DDDDDD solid; padding:5px; min-height:255px; margin-left:10px; margin-right:5px;" class="Daeler_Board">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              <td width="50"><?php echo $Lang_Classify_Context_Account_Member; //帳號 ?>：</td>
                            ...
                            <tr>
                              <td colspan="2"><?php echo $Lang_Classify_Not_Yet_A_Member; ?> <a href="<?php echo $SiteBaseUrl . url_rewrite('dealer',array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'reg'),'',$UrlWriteEnable);?>"><?php echo $Lang_Classify_Click_Here_To_Register; ?></a></td>
                            </tr>
                            <tr>
                              <td colspan="2">»<a href="<?php echo $SiteBaseUrl . url_rewrite('dealer',array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'pswfgt'),'',$UrlWriteEnable);?>"><?php echo $Lang_Classify_Forgot_Psw ?></a></td>
                            </tr>
                          </table>
                          </div>
                            </td>
                      ...
                      <tr>
                      <td valign="middle"><p class="dealer_center_style6">&nbsp;</p></td>
