...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_Discount")) {
  $insertSQL = sprintf("INSERT INTO demo_productdiscount (name, type, discountFullamount, discountFoldnumber, startdate, enddate, `limitdate`, skeyword, sdescription, content, menuname, menuindicate, indicate, notes1, lang, userid) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 滿額折扣(%) <small>新增</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
