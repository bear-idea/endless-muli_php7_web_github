        ...
        <?php do { ?>
          ...
          <ul>
            <?php
					...
					?>
            <?php do { ?>
              <li><?php echo $row_RecordMultiLeftMenu_l2['itemname']; ?>
                ...
                <ul>
                  <?php
                        ...
                        ?>
                  <?php do { ?>
                    <li><?php echo $row_RecordMultiLeftMenu_l3['itemname']; ?>
							...
							<li><?php echo $row_RecordMultiLeftMenu_l4['itemname']; ?>
								...
								<ul>
								  ...
								  <?php do { ?>
									...
									<?php } while ($row_RecordMultiLeftMenu_l5 = mysqli_fetch_assoc($RecordMultiLeftMenu_l5)); ?>
								  <?php mysqli_free_result($RecordMultiLeftMenu_l5);?>
								</ul>
								<?php } // Show if recordset not empty ?>
							</li>
							<?php } while ($row_RecordMultiLeftMenu_l4 = mysqli_fetch_assoc($RecordMultiLeftMenu_l4)); ?>
