...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 內頁橫幅輪播 <small>總覽</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-body">
    ...
    <div class="alert alert-warning m-t-5"><i class="fa fa-info-circle"></i> <b>此處橫幅的設定僅適用於在 <a href="manage_tmp.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>" class="btn btn-primary btn-xs" data-original-title="前往更改設定" data-toggle="tooltip" data-placement="top">版型設計 <i class="fa fa-chevron-circle-right"></i></a>【版型設定】中的 橫幅區塊 > 更多設定 > 橫幅模式 設定為【使用公版橫幅 <i class="fa fa-question-circle" data-original-title="代表設定此選項的的樣板皆會使用一個統一的橫幅,而此橫幅可在此區設定。註：版型須為自己建立的才能設定，官方版型套用的為預設橫幅，不行更改。" data-toggle="tooltip" data-placement="top"></i> 】才會使用此區橫幅設定，您也可在 <a href="manage_ads.php?wshop=<?php echo $wshop;?>&amp;Opt=step_map&amp;lang=<?php echo $_SESSION['lang']; ?>" class="btn btn-primary btn-xs" data-original-title="查看目前網站使用中的版型狀態" data-toggle="tooltip" data-placement="top">橫幅導覽 <i class="fa fa-chevron-circle-right"></i></a> 查看。</b></div>
    <?php } ?>
