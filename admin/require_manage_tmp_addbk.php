...
<br />
    ...
    <tr>
      ...
      <td><span id="sprytextfield3">
        <input name="tmpwebwidth" type="text" <?php if ($_SESSION['MM_UserGroup'] != 'superadmin') {?>disabled="disabled"<?php } ?> id="tmpwebwidth" value="960" size="4" maxlength="4" />
        <span class="textfieldRequiredMsg">需要有一個值。</span></span><span id="spryselect2">
        <label for="tmpwebwidthunit"></label>
        <select name="tmpwebwidthunit" id="tmpwebwidthunit" <?php if ($_SESSION['MM_UserGroup'] != 'superadmin') {?>disabled="disabled"<?php } ?>>
