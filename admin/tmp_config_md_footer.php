...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Tmp")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmpfootermodselect=%s WHERE id=%s",
                       GetSQLValueString($_POST['tmpfootermodselect'], "text"),
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post" id="form_Tmp" name="form_Tmp">
       <div class="form-group row">
        ...
        <div class="col-md-12"><span class="badge badge-primary"><i class="fa fa-paper-plane"></i> 頁尾</span></div>
      </div>
       <div class="form-group row">
          <label class="col-md-2 col-form-label">頁尾模式<span class="text-red">*</span><i class="fa fa-info-circle text-orange" data-original-title="此選項可設定頁尾的顯示模式。" data-toggle="tooltip" data-placement="top"></i></label>                       	
          <div class="col-md-10">
          
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmpfootermodselect'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpfootermodselect" id="tmpfootermodselect_2" value="0" />
                <label for="tmpfootermodselect_2">預設</label>
            </div>
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmpfootermodselect'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpfootermodselect" id="tmpfootermodselect_1" value="1" />
                <label for="tmpfootermodselect_1">自訂</label>  <a href="inner_tmp.php?Opt=footer&amp;id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;lang=<?php echo $_SESSION['lang'] ?>" target="" class="btn btn-primary btn-xs"> 前往設定 <i class="fa fa-chevron-circle-right"></i></a>
            </div>
