...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Tmp")) {
  $updateSQL = sprintf("UPDATE demo_tmpboard SET tmp_w_background_img=IFNULL(%s,tmp_w_background_img) WHERE id=%s",
  ...
  $updateGoTo = "uplod_tmpboard_wrp.php";
  if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <form action="<?php echo $editFormAction;?>" class="form-horizontal form-bordered" data-parsley-validate="" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
            ...
            <input name="oldpic" type="hidden" id="oldpic" value="<?php echo $row_RecordTmp['tmp_w_background_img']; ?>" />
...
$(document).ready(function() {
	$("#pic").fileinput({
		...
		maxFileSize: 3000,  
		<?php if ($row_RecordTmp['tmp_w_background_img'] != "") { ?>
		initialPreview: ["<?php echo $SiteImgUrlAdmin; ?><?php echo $wshop; ?>/image/tmpboard/<?php echo $row_RecordTmp['tmp_w_background_img']; ?>"],
		<?php } ?>
