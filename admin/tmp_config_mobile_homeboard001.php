...
#apDiv_config{position:fixed;width:230px;height:115px;z-index:1;float:right;right:0;top:60px}
...
#v_wrp{width:600px;margin-left:auto;margin-right:auto;margin-top:100px;border:#CCC dotted 1px;position:relative;background-position:center center;background-repeat:no-repeat;padding:20px}
#v_wrp:hover{border:1px dotted #C30}
#v_wrp_header{border:#CCC dotted 1px;margin:5px;position:relative;min-height:200px;background-color:#EEE}
...
#v_wrp_l_column{border:#CCC dotted 1px;margin:5px;float:right;width:588px;position:relative;min-height:200px}
...
#v_wrp_footer{border:#CCC dotted 1px;margin:5px;clear:both;position:relative;min-height:100px;background-color:#EEE}
#v_wrp_footer:hover{border:#C30 dotted 1px}
#v_wrp_md{width:600px;border:#CCC dotted 1px;position:relative;background-position:center center;background-repeat:no-repeat;height:250px;margin:10px auto 100px;padding:5px 20px 20px}
       ...
       <div id="v_out_wrp">
        ...
        <div id="v_wrp"><!--獨立外框--><!--獨立背景--><!--獨立背景-->
          <div style="color: #CCC; font-size: 30px; font-weight: bolder; padding: 10px; position: absolute; left: -36px; top: -41px;">主框架</div>
            ...
            <div id="v_wrp_banner">
            	<span style="color: #CCC; font-size:30px; font-weight:bolder; padding:10px; position: absolute; right: 5px; bottom: 5px;"><br />
            	<span style="font-size:16px;"><a href="manage_ads_mobile_image.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>" data-original-title="您可在此設定橫幅的類型" data-toggle="tooltip" data-placement="right">(更多設定)</a></span><br />
橫幅區塊</span>
            </div>
            ...
            <div id="v_wrp_l_column">
              <div class="v_md"><img src="images/mt_054.png" width="60" height="60" /><br />
          		<a href="#" data-original-title="您可在此加入您要的內容，例如：圖片、Youtube影片、文字等等。" data-toggle="tooltip" data-placement="right">自訂內容</a>
                <div style="position: absolute; top: 68px; left: 65px; width: 138px;">
                <?php if ($LangChooseEN == '1') { ?>
                <span class = "InnerPage"><a href="tmp_config_mobile_home_content.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;id=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=en"  data-original-title="輸入英文內容" data-toggle="tooltip" data-placement="top"><i class="fa fa-tachometer"></i>英</a></span>
                <?php } ?>
                <?php if ($LangChooseZHCN == '1') { ?>
                <span class = "InnerPage"><a href="tmp_config_mobile_home_content.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;id=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=zh-cn"  data-original-title="輸入簡體內容" data-toggle="tooltip" data-placement="top"><i class="fa fa-tachometer"></i>簡</a></span>
                <?php } ?>
                <span class = "InnerPage"><a href="tmp_config_mobile_home_content.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;id=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=zh-tw"  data-original-title="輸入繁體內容" data-toggle="tooltip" data-placement="top"><i class="fa fa-tachometer"></i>繁</a></span>
                </div>
            </div><!--獨立背景-->
