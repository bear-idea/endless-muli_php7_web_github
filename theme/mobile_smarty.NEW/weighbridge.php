...
<link href="<?php echo $SiteBaseUrl; ?>assets/plugins/sumoselect/sumoselect.min.css" rel="stylesheet" />
<script src="<?php echo $SiteBaseUrl; ?>assets/plugins/sumoselect/jquery.sumoselect.min.js"></script>
    ...
    <?php if ($TmpWrpViewLineLocate == '2') { ?>               
        ...
        <section class="page-header page-header-xxs">
            ...
            <!-- InstanceBeginEditable name="導覽列" -->
                                    <?php require("require_weighbridge_viewline_mobile.php"); ?>
                    <!-- InstanceEndEditable -->
        </section>
			...
			switch($_GET['Opt'])
			{
				case "viewpage":
				    if ((isset($_SESSION['MM_UserGroup_' . $_GET['wshop']]) && in_array($_SESSION['MM_UserGroup_' . $_GET['wshop']], $arr_MM_authorizedUsers))) {
						include_once("require_weighbridge.php");			
					}else{
						include_once("require_member_login.php");	
					}
					break;
				case "order_source":
					include_once("require_weighbridge_order_source.php");				
					break;
				case "editpage":
