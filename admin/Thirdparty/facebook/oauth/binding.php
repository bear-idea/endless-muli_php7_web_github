            ...
            <div class="login-content">
                ...
                <div class="alert alert-warning fade show m-b-10">
                    <span class="close" data-dismiss="alert">×</span>
                     <i class="fa fa-times-circle"></i> 您尚未綁定您的 Facebook 帳號<br>請在下方輸入您欲連結的官網帳號
                </div>
                <?php } ?>
                ...
                <div class="alert alert-danger fade show m-b-10">
                    <span class="close" data-dismiss="alert">×</span>
                     <i class="fa fa-times-circle"></i> 此帳號已有綁訂的 Facebook 帳號！！ <br>請確認您登入的 Facebook 是否正確！！ 
                </div>
                <?php } ?>
                ...
                <div class="alert alert-danger fade show m-b-10">
                    <span class="close" data-dismiss="alert">×</span>
                     <i class="fa fa-times-circle"></i> 此 Facebook 帳號已註冊過！！ <br>請更換您登入的 Facebook 帳號！！
                </div>
                <?php } ?>
                
                <div class="note note-secondary m-b-15">
                    <b>您好!! <i class="fa fa-facebook-square" aria-hidden="true"></i> <?php echo $_SESSION["fb_last_name"] . $_SESSION["fb_first_name"]; ?></b>
                </div>
