...
<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>sqldatatable/js/product_datatable_reply.js"></script>
<!-- ================== END Datatables JS ================== -->
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 回應 <small>總覽</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-heading">
    ...
    <div class="btn-group pull-right"><a href="inner_product.php?wshop=<?php echo $wshop; ?>&amp;Opt=replyaddpage&amp;lang=<?php echo $_SESSION['lang']; ?>&amp;post_id=<?php echo $_GET['post_id']; ?>&amp;pd_id=<?php echo $_GET['pd_id']; ?>" class="btn btn-default btn-sm"><i class="fa fa-plus"></i> 新增</a></div>
  ...
  <div class="panel-body">
    ...
    <div class="alert alert-warning"><b><i class="fa fa-question-circle"></i> 提問內容<?php echo $row_RecordProductPost["content"]; ?></b></div>
    ...
    <table id="data-table-default" class="table table-striped table-bordered table-hover table-condensed">
      <thead>
        <tr>
          ...
          <th data-priority="1"><strong>回應內容</strong></th>
          <th width="100"><strong>回應時間</strong></th>
...
<script>
	...
	$(document).ready(function() {
		TableManageDefault.init(<?php echo $_GET['post_id']; ?>);		
	});
</script>
