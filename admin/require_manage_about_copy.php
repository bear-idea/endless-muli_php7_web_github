...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_About") && $_POST['sdescription'] == "") { 
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_About")) {
  $insertSQL = sprintf("INSERT INTO demo_about (title, type1, type2, type3, content, indicate, skeyword, sdescription, skeywordindicate, notes1, lang, userid) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> <?php echo $ModuleName['About']; ?><small>複增</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
