...
<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>sqldatatable/js/cart_datatable_analysis_user_buy.js"></script>
<!-- ================== END Datatables JS ================== -->
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 商品瀏覽 <small>統計</small> 
  ...
  <div class="panel-body">
    ...
    <div class="row justify-content-end">
      <div class="col-md-3 col-sm-12 m-b-10">
          <div class="input-group" data-column="3">
              <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 更新日期</span></span>
              <input name="postdate" type="text" class="form-control search_filter" placeholder="" id="col13_filter" autocomplete="off"/><?php /* 加上autocomplete="off"后，自动提示就没有了 */ ?>
              
          </div>
      </div>
      <div class="col-md-3 m-b-10">
        <div class="input-group"> <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 訂購人</span></span>
    ...
    <table id="data-table-default" class="table table-striped table-bordered table-hover table-condensed">
      <thead>
        <tr>
          ...
          <th width="50" data-priority="1"><strong>排行</strong></th>
          <th width="-1" data-priority="1"><strong>訂購人</strong></th>
          <th width="100" data-priority="1"><strong>手機</strong></th>
          <th width="150" data-priority="1"><strong>E-mail</strong></th>
          <th width="150" data-priority="1"><strong>更新時間</strong></th>
          <th width="50" data-priority="1"><strong>售出金額</strong></th>
        </tr>
      </thead>
      <tfoot>
        <tr>
