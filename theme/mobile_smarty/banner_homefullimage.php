...
<div class="slider fullwidthbanner-container roundedcorners <?php if ($row_RecordAds['tool'] == "2") {echo "margin-bottom-100";} ?>">
  <div class="fullscreenbanner <?php echo $thumbshow; ?>" data-height="<?php echo $row_RecordAds['dataheight']; ?>" data-shadow="3" data-navigationStyle="<?php echo $datanavigationStyle; ?>">
    <ul class="hide">
      <?php do { ?>
<?php 
...
?>
        ...
        <div class="tp-caption medium_light_white lfb start" data-x="<?php echo $datax; ?>" data-hoffset="<?php echo $datahoffset; ?>" data-y="<?php echo $datay; ?>" data-voffset="<?php echo $datavoffset; ?>" data-speed="300" data-start="1200" data-easing="easeOutExpo" data-splitin="none" data-splitout="none" data-elementdelay="0.1" data-endelementdelay="0.1" data-endspeed="300" style="word-wrap:break-word;"><?php echo $row_RecordAds['datacontent']; ?></div>
 </li>
