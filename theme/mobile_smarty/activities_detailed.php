...
<ul class="list-inline row nomargin lightbox" data-plugin-options='{"type":"image","delegate": "a","gallery": {"enabled": "true"}}'>
 ...
 <?php do { ?> 
                           <li class="col-md-4 col-sm-6 col-xs-6"><!-- item -->
                                ...
                                <div class="imgLiquid" data-fill="<?php echo $TmpActivitiesImageMethods; /* resize or crop */ ?>" data-board="<?php echo $TmpActivitiesImageBoard; /* 方型 or 矩形 */ ?>">
										...
										<a class="ico-rounded" href="<?php echo $SiteImgUrl; ?><?php echo $_GET['wshop']; ?>/image/activities/<?php echo $row_RecordActivities['pic']; ?>"><img src="<?php echo $SiteImgUrl; ?><?php echo $_GET['wshop']; ?>/image/activities/thumb/small_<?php echo GetFileThumbExtend($row_RecordActivities['pic']); ?>" alt=""></a>
