...
$colname_RecordAccounts_payable = "-1";
if (isset($_GET['id_edit'])) {
  $colname_RecordAccounts_payable = $_GET['id_edit'];
}
...
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordAccounts_payable = sprintf("SELECT * FROM invoicing_accounts_payabledetail WHERE id = %s && userid=%s", GetSQLValueString($colname_RecordAccounts_payable, "int"),GetSQLValueString($coluserid_RecordAccounts_payable, "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Accounts_payable")) {
	...
	$updateSQL = sprintf("UPDATE invoicing_accounts_payabledetail SET company=%s, supplier=%s, suppliercode=%s, amountr=%s, amountp=%s, amountmin=%s, amountreal=%s, postdate=%s, editdate=%s, indicate=%s, notes1=%s, lang=%s WHERE id=%s",
  ...
  $updateGoTo = "manage_accounts_payable.php?Opt=viewpage&lang=" . $_POST['lang'];
  /*if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 應付帳款 <small>修改</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post">
          ...
          <div class="col-md-10">
                    <select name="company" id="company" class="form-control" data-parsley-trigger="blur" required="">
                      ...
                      <?php
						do {  
						?>
											  <option value="<?php echo $row_RecordCompany['code']?>"<?php if (!(strcmp($row_RecordAccounts_payable['company'], $row_RecordCompany['code']))) {echo "selected=\"selected\"";} ?>><?php echo $row_RecordCompany['code']?> <?php echo $row_RecordCompany['title']?></option>
											  <?php
          ...
          <div class="col-md-10">
                    <select name="supplier" id="supplier" class="form-control" data-parsley-trigger="blur" required="">
                      ...
                      <?php
						do {  
						?>
											  <option value="<?php echo $row_RecordSupplier['code']?>"<?php if (!(strcmp($row_RecordAccounts_payable['suppliercode'], $row_RecordSupplier['code']))) {echo "selected=\"selected\"";} ?>><?php echo $row_RecordSupplier['code']?> <?php echo $row_RecordSupplier['name']?></option>
											  <?php
	  ...
	  <div class="form-group row">
          ...
          <div class="col-md-10">
                      <input name="amountr" id="amountr" value="<?php echo $row_RecordAccounts_payable['amountr']; ?>" maxlength="11" class="form-control col-md-4" data-parsley-min="0" data-parsley-max="9999999" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1" required=""/>                      
	  ...
	  <div class="form-group row">
          ...
          <div class="col-md-10">
                      <input name="amountp" id="amountp" value="<?php echo $row_RecordAccounts_payable['amountp']; ?>" maxlength="11" class="form-control col-md-4" data-parsley-min="0" data-parsley-max="9999999" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>                      
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
              <input name="notes1" type="text" id="notes1" value="<?php echo $row_RecordAccounts_payable['notes1']; ?>" size="50" maxlength="50" class="form-control"/>    
          </div>
      </div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
			...
			<input name="id" type="hidden" id="id" value="<?php echo $row_RecordAccounts_payable['id']; ?>" />  
            <input name="lang" type="hidden" id="lang" value="<?php echo $_GET['lang']; ?>" />
            <input name="userid" type="hidden" id="userid" value="<?php echo $w_userid; ?>" />
			<input name="editdate" type="hidden" id="editdate" value="<?php echo date("Y-m-d H-i-s"); ?>" />
          </div>
      </div>
      <input type="hidden" name="MM_update" value="form_Accounts_payable" />
  </form>
  </div>
  <!-- end panel-body --> 
</div>
