...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Video")) {
  $updateSQL = sprintf("UPDATE demo_video SET name=%s, type=%s, link=%s, skeyword=%s, sdescription=%s, indicate=%s, notes1=%s, lang=%s WHERE id=%s",
  ...
  $updateGoTo = "manage_video.php?Opt=viewpage&lang=" . $_POST['lang'];
  /*if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> <?php echo $ModuleName['Video']; ?> <small>修改</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
?>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">      
          <a href="uplod_video.php?id_edit=<?php echo $row_RecordVideo['id']; ?>&amp;lang=<?php echo $_GET['lang']; ?>" class="btn btn-warning colorbox_iframe_cd"><i class="fa fa-image"></i> 圖片修改</a>                    
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-10">
          <button type="submit" class="btn btn btn-primary btn-block">送出</button>
            ...
            <input name="lang" type="hidden" id="lang" value="<?php echo $row_RecordVideo['lang']; ?>" />
