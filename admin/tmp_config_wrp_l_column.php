...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Tmp")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmpshowblockname=%s, tmpleftminheight=%s, tmpleftpaddingtop=%s, tmpleftpaddingbttom=%s, tmpleftpaddingleft=%s, tmpleftpaddingright=%s, tmpleftfontcolor=%s WHERE id=%s",
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post" id="form_Tmp" name="form_Tmp">
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">區塊標題名稱<span class="text-red">*</span><i class="fa fa-info-circle text-orange" data-original-title="此選項可設定樣板的區塊標題是否可顯示，您可配合此選項搭配《側邊裝飾外框》的樣式來做使用，即此區塊可設定外觀，若您要更改各區塊的名稱可由《自訂欄位》中您所加入的區塊做修改。" data-toggle="tooltip" data-placement="top"></i></label>                       	
          <div class="col-md-10">
          
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmpshowblockname'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpshowblockname" id="tmpshowblockname_0" value="1" />
                <label for="tmpshowblockname_0">顯示</label>
            </div>
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmpshowblockname'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpshowblockname" id="tmpshowblockname_1" value="0" />
                <label for="tmpshowblockname_1">隱藏</label>
            </div>
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">區塊</label>
          <div class="col-md-10">
            <div class="table-responsive">
                      <div style="border:1px #CCCCCC dotted; width:600px; margin-left:25px; margin-top:5px; padding:10px;position:relative;">
      <span style="color: #CCC; font-size:30px; font-weight:bolder; padding:10px; position: absolute; right: 0px; bottom: 5px;">主框架</span>
            <div style="border:1px #CCCCCC dotted; width:250px; position:relative; height:600px;">
            <div style="border:1px #CCCCCC dotted; position:relative; margin:5px; height:300px;">
            
            <div style="border:1px #CCCCCC dotted; position:relative; margin:5px; padding:5px; color:#BBB">區塊標題</div>
            <div style="border:1px #CCCCCC dotted; position:relative; margin:5px; height:180px;">
            <span style="color: #CCC; font-size: 30px; font-weight: bolder; padding: 5px; position: absolute; right: 2px; bottom: -2px;"><span style="font-size:16px;"> <a href="tmpleftmenu_home.php?id=<?php echo $row_RecordTmp['id']; ?>" class="btn btn-info">樣式選擇</a></span><br />選單樣式</span>
            </div>
            <span style="color: #CCC; font-size: 30px; font-weight: bolder; padding: 5px; position: absolute; right: 2px; bottom: -2px;">側邊裝飾外框</span>
            </div>
            <div style="border:1px #CCCCCC dotted; position:relative; margin:5px; height:80px;"><div style="border:1px #CCCCCC dotted; position:relative; margin:5px; padding:5px; color:#BBB">區塊標題</div><span style="color: #CCC; font-size:30px; font-weight:bolder; padding:5px; position: absolute; right: 0px; bottom: 0px;">側邊裝飾外框</span></div>
            <div style="border:1px #CCCCCC dotted; position:relative; margin:5px; height:130px;"><div style="border:1px #CCCCCC dotted; position:relative; margin:5px; padding:5px; color:#BBB">區塊標題</div><span style="color: #CCC; font-size:30px; font-weight:bolder; padding:5px; position: absolute; right: 0px; bottom: 0px;"><span style="font-size:16px;"> <a href="tmpblock_home.php?id=<?php echo $row_RecordTmp['id']; ?>" class="btn btn-info">樣式選擇</a></span><br />側邊裝飾外框</span></div>
            <span style="color: #CCC; font-size:30px; font-weight:bolder; padding:10px; position: absolute; right: 0px; bottom: 5px;">欄位區塊</span>
            </div>
           </div>
            </div>          
        </div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      <input name="tmpleftminheight" class="form-control" id="tmpleftminheight" value="<?php echo $row_RecordTmp['tmpleftminheight']; ?>" maxlength="5" data-parsley-min="0" data-parsley-max="9999" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">上</span></div>
                  <input name="tmpleftpaddingtop" class="form-control" id="tmpleftpaddingtop" value="<?php echo $row_RecordTmp['tmpleftpaddingtop']; ?>" maxlength="3" data-parsley-min="-50" data-parsley-max="50" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">下</span></div>
                  <input name="tmpleftpaddingbttom" class="form-control" id="tmpleftpaddingbttom" value="<?php echo $row_RecordTmp['tmpleftpaddingbttom']; ?>" maxlength="3" data-parsley-min="-50" data-parsley-max="50" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                     <div class="input-group-append"><span class="input-group-text">px</span></div>                 
              </div>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">左</span></div>
                  <input name="tmpleftpaddingleft" class="form-control" id="tmpleftpaddingleft" value="<?php echo $row_RecordTmp['tmpleftpaddingleft']; ?>" maxlength="3" data-parsley-min="-50" data-parsley-max="50" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                  <div class="input-group-append"><span class="input-group-text">px</span></div>                    
              </div>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">右</span></div>
                  <input name="tmpleftpaddingright" class="form-control" id="tmpleftpaddingright" value="<?php echo $row_RecordTmp['tmpleftpaddingright']; ?>" maxlength="3" data-parsley-min="-50" data-parsley-max="50" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                    <div class="input-group-append"><span class="input-group-text">px</span></div>                  
              </div>
