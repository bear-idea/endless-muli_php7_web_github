...
<div class="columns on-1">
        <div class="container">
            <div class="column">
                ...
                <?php echo $Lang_Content_Title_Actnews; // 標題文字 ?></h3>
                </div>
            </div>
        </div>        
</div>
<div class="columns on-1">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td width="50%">
              <!-- **************************************************************** -->
              <strong><?php echo $row_RecordActnews['title']; ?></strong>
              <!-- **************************************************************** -->            
            </td>
...
document.write('<iframe  src="http://www.facebook.com/plugins/like.php?href=' + $url + '" scrolling="no"  frameborder="0" style="height: 25px; width: 100%"  allowTransparency="true"></iframe>');
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="TB_General_style01">
        <tr>
          <td valign="top"><?php echo $row_RecordActnews['content']; ?></td>
        </tr>
      </table>  
      <!-- **************************************************************** -->
<div id="fb-root"></div>
...
<?php } else { ?>
<?php include($TplPath . "/actnews_detailed.php"); ?>
<?php } ?>
<?php
