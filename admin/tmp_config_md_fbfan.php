...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post" id="form_Tmp" name="form_Tmp">
       <div class="form-group row">
        ...
        <div class="col-md-12"><span class="badge badge-primary"><i class="fa fa-paper-plane"></i> Facebook粉絲頁</span></div>
      </div>
       <div class="form-group row">
          <label class="col-md-2 col-form-label">是否顯示<span class="text-red">*</span></label>                       	
          <div class="col-md-10">
          
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmpfbfanselect'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpfbfanselect" id="tmpfbfanselect_0" value="1" />
                <label for="tmpfbfanselect_0">啟用</label>
            </div>
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmpfbfanselect'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpfbfanselect" id="tmpfbfanselect_1" value="0" />
                <label for="tmpfbfanselect_1">關閉</label>
            </div>
  	  ...
  	  <div class="form-group row">
          <label class="col-md-2 col-form-label">外框顏色<span class="text-red">*</span></label>
          <div class="col-md-10">
          		<div class="input-group colorpicker-component colorpicker-element">				
                   <input name="tmpfbfanboardcolor" type="text" required class="form-control colorpicker-element" id="tmpfbfanboardcolor" value="<?php echo $row_RecordTmp['tmpfbfanboardcolor']; ?>" maxlength="20" data-parsley-errors-container="#error_tmpfbfanboardcolor" data-parsley-trigger="blur"/>
                   <span class="input-group-addon"><i style="background-color: rgb(64, 18, 18);"></i></span>
              </div>
              <div id="error_tmpfbfanboardcolor"></div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
          		<div class="input-group colorpicker-component colorpicker-element">				
                   <input name="tmpfbfanbkcolor" type="text" required class="form-control colorpicker-element" id="tmpfbfanbkcolor" value="<?php echo $row_RecordTmp['tmpfbfanbkcolor']; ?>" maxlength="20" data-parsley-errors-container="#error_tmpfbfanbkcolor" data-parsley-trigger="blur"/>
                   <span class="input-group-addon"><i style="background-color: rgb(64, 18, 18);"></i></span>
              </div>
              <div id="error_tmpfbfanbkcolor"></div>
