...
$query_RecordProductListItem = sprintf("SELECT demo_productitem.item_id, demo_productlist.list_id, demo_productlist.listname, demo_productitem.itemname, demo_productitem.itemvalue, demo_productitem.lang FROM demo_productlist LEFT OUTER JOIN demo_productitem ON demo_productlist.list_id = demo_productitem.list_id WHERE demo_productlist.list_id = %s && demo_productitem.lang=%s  && demo_productitem.userid=%s ORDER BY demo_productitem. sortid ASC", GetSQLValueString($collistid_RecordProductListItem, "int"),GetSQLValueString($collang_RecordProductListItem, "text"),GetSQLValueString($coluserid_RecordProductListItem, "int"));
...
<?php do { ?>
  <?php $data[$row_RecordProductListItem['itemvalue']] = $row_RecordProductListItem['itemname']; ?>
