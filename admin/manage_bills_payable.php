...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_bills_payable.php"); ?>
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include("require_manage_bills_payable_index.php");			
					break;
				case "addpage":
					include("require_manage_bills_payable_add.php");
					break;
				case "editpage":
					include("require_manage_bills_payable_edit.php"); 
					break;
				default:
					include("require_manage_bills_payable_index.php");
					break;
