...
<div class="card bg-silver-lighter mb-10px" style="overflow:hidden">
  <div class="card-body">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 網站使用者 <small>新增</small> <?php require($page_view_path_vendor."require_lang_show.php"); ?></h4>
  </div>
</div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <select name="Defaultlang" id="Defaultlang" class="form-control" data-parsley-trigger="blur" required="">
                        <option value="zh_TW" <?php if($_POST['modselect'] == "1" || $_POST['modselect'] == "2") { ?>selected="selected"<?php } ?>>繁體</option>
