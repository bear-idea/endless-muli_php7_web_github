...
<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>sqldatatable/js/product_datatable_inventory.js"></script>
<!-- ================== END Datatables JS ================== -->
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-heading">
    ...
    <h4 class="panel-title"><i class="fa fa-database"></i> 庫存一覽</h4>
  </div>
  <!-- end panel-heading --> 
  <!-- begin panel-body -->
  <div class="panel-body">
  
    <div class="alert alert-warning m-b-0"><i class="fa fa-info-circle"></i> <b>管理產品目前庫存量，當消費者購物後，庫存數量會自動減少，當刪除訂單時庫存量會自動加回若不想使用庫存功能，則不需輸入。 </b></div>
    
    <div class="alert alert-warning m-t-5 m-b-0"><i class="fa fa-info-circle"></i> <b>庫存量顯示為是否要公開顯示目前庫存量給消費者知道。 </b></div>
    
    <div class="alert alert-warning m-t-5"><i class="fa fa-info-circle"></i> <b>自動停賣功能為當<span style="color:#900; font-weight:bolder">【啟用自動停賣功能】</span>，商品目前庫存<span style="color:#900; font-weight:bolder">【小於或等於0】</span>或<span style="color:#900; font-weight:bolder">【庫存量未輸入】</span>，商品會無法購買並顯示已售完。 </b></div>
    ...
    <table id="data-table-default" class="table table-striped table-bordered table-hover table-condensed">
      <thead>
        <tr>
          ...
          <th width="70" data-priority="1"><strong>庫存量 <i class="fa fa-info-circle text-orange" data-original-title="可輸入正負整數。" data-toggle="tooltip" data-placement="top"></i></strong></th>
          <th width="70" data-priority="1"><strong>庫存量顯示</strong></th>
          <th width="70" data-priority="1"><strong>自動停賣</strong></th>
