...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Catalog")) {
  $updateSQL = sprintf("UPDATE demo_catalog SET title=%s, author=%s, type=%s, content=%s, sdescription=%s, postdate=%s, indicate=%s, auth=%s, notes1=%s, lang=%s WHERE id=%s",
...
?>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                <textarea name="content" id="content" cols="100%" rows="35" class="form-control"><?php echo $row_RecordCatalog['content']; ?>
                </textarea>  
        </div>
      </div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
            ...
            <input name="lang" type="hidden" id="lang" value="<?php echo $_GET['lang']; ?>" />
                    ...
                    <input name="menutype" type="hidden" id="menutype" value="link" /></td>
          </div>
      </div>
