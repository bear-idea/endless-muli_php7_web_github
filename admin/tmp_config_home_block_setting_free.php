...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_TmpColumn")) {
    $updateSQL = sprintf("UPDATE demo_tmphomeblockcolumn SET customname=%s, content=%s, height=%s, sortid=%s, lang=%s WHERE id=%s",
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post" id="form_TmpColumn" name="form_TmpColumn">
      ...
      <div class="form-group row">
          ...
          <div class="table-responsive">
                <textarea name="content" id="content" cols="100%" rows="35" class="form-control"><?php echo $row_RecordTmpColumn['content']; ?></textarea>  
          </div>
          </div>
      </div>
      
      <div class="form-group row">
          <label class="col-md-2 col-form-label">插入預設圖片</label>
          <div class="col-md-10">
                <input type="image" src="images/tmp_df_pic_04.jpg" id="change_unit01" onclick="return false" style="margin-right:5px;"><input type="image" src="images/tmp_df_pic_05.jpg" id="change_unit02" onclick="return false" style="margin-right:5px;"><div style="color:#CC6600;">點選您想要的圖示外觀即可在【詳細內容欄位】之【游標處】加入預設圖片。圖片可雙擊滑鼠左鍵，在視窗中點選【上傳】頁面，在上傳您要的圖片即可。</div>
          </div>
      </div>
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">區塊高度</label>
          <div class="col-md-10">
                      
                      <input name="height" class="form-control" id="height" value="<?php echo $row_RecordTmpColumn['height']; ?>" data-parsley-min="0" data-parsley-max="9999" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1" />
                      <div style="color:#CC6600;">留空為不限制高度，會依據內容自動調整高度。</div>
...
<script type="text/javascript">
	$(document).ready(function() {
			$("#change_unit01").click(function(){
					CKEDITOR.instances.content.insertHtml("<img src=\"http://www.shop3500.com/images/tmp/banner_01.jpg\" alt=\"\" width=\"700\" height=\"100\" style=\"display:block; margin:auto;\" /><br />");
			});
			$("#change_unit02").click(function(){
					CKEDITOR.instances.content.insertHtml("<img src=\"http://www.shop3500.com/images/tmp/image_05.jpg\" alt=\"\" width=\"700\" height=\"300\" style=\"display:block; margin:auto;\" /><br />");
			});
	});
</script>
