var handleDataTableDefault = function() {
    ...
    if ($('#data-table-default').length !== 0) {
		...
		//"dom":"lBfrtip",buttons:[{extend:"copy",className:"btn-sm"},{extend:"csv",className:"btn-sm"},{extend:"excel",className:"btn-sm"},{extend:"pdf",className:"btn-sm"},{extend:"print",className:"btn-sm"},{extend:"colvis",className:"btn-sm"}],
			"dom":"lBprtip",buttons:[{extend:"copy",className:"btn-sm",title:"清運明細日報表"},{extend:"csv",className:"btn-sm",title:"清運明細日報表"},{extend:"excel",className:"btn-sm",title:"清運明細日報表",footer:true},{extend:"pdf",className:"btn-sm",title:"清運明細日報表"},{extend:"print",className:"btn-sm",title:"清運明細日報表"},{extend:"colvis",className:"btn-sm",title:"清運明細日報表"}],
			//"dom": "lprtip",
			//"buttons":[{extend:"copy",className:"btn-sm"},{extend:"excel",className:"btn-sm"},{extend:"pdf",className:"btn-sm"},{extend:"print",className:"btn-sm"},{extend:"colvis",className:"btn-sm"}],
            "autoWidth": false,
            "ajax": {
                "url": "sqldatatable/scaleorder_clearance_view_day.php",
                "type": "post",
				"data": function ( d ) {
					...
					d.search_manufacturer = $('#col8_filter').val();
					d.search_carnumber = $('#col11_filter').val();
					d.search_postdate = $('#col12_filter').val();
            ...
            "fnDrawCallback": function(oSettings) {
                ...
                $('#data-table-default').editable({
                    selector: ".ed_title",
                    url: 'sqledit/scaleorder_clearance_jedit.php',
                    type: 'text',
                    name: 'title',
                    //title: '輸入標題',
				...
				$('#data-table-default').editable({
                    ...
                    url: 'sqledit/scaleorder_clearance_jedit.php',
                    name: "type",
                    source: "sqledit/scaleorder_clearance_get_list.php?list_id=1",
                    validate: function(value) {
                        if ($.trim(value) == '') {
                            return '值不能為空';
                        }
			...
			"footerCallback": function ( row, data, start, end, display ) {
                ...
                $(api.column(6).footer()).html( this.api().column(6).data().reduce( function (a, b) { return intVal(a) + intVal(b);}, 0 ) );
				$(api.column(7).footer()).html( this.api().column(7).data().reduce( function (a, b) { return intVal(a) + intVal(b);}, 0 ) );
				$(api.column(8).footer()).html( this.api().column(8).data().reduce( function (a, b) { return intVal(a) + intVal(b);}, 0 ) );
				$(api.column(10).footer()).html( this.api().column(10).data().reduce( function (a, b) { return intVal(a) + intVal(b);}, 0 ) );
    ...
    swal({
        ...
        preConfirm: function() {
            return new Promise(function(resolve) {
                ...
                $.ajax({
                    url: "sqldatatable/scaleorder_clearance_del.php?id_del=" + id,
                    type: "GET"
        ...
        swal({
            ...
            preConfirm: function() {
                return new Promise(function(resolve) {
                    ...
                    $.ajax({
                        url: "sqldatatable/scaleorder_clearance_del_muti.php",
                        data: {
                            id: list_id
                        },
                        type: "POST"
