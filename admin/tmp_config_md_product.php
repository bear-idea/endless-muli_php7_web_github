...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Tmp")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmpproductboard=%s, tmpproductboardicon=%s, tmpproductboardfontcolor=%s, tmpproductviewcolumn=%s, tmpproductimagemethods=%s, tmpproductimageboard=%s WHERE id=%s",
					   ...
					   GetSQLValueString($_POST['tmpproductimagemethods'], "text"),
					   GetSQLValueString($_POST['tmpproductimageboard'], "int"),
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post" id="form_Tmp" name="form_Tmp">
       <div class="form-group row">
        ...
        <div class="col-md-12"><span class="badge badge-primary"><i class="fa fa-paper-plane"></i> <?php echo $ModuleName['Product']; ?></span></div>
      </div>
       <div class="form-group row">
          ...
          <div class="col-md-10">
                             ...
                             <div class="card pull-left m-5">
                                  <img src="images/col4.jpg" width="60" height="60" />
                                  <div class="card-block">
                                      <div class="radio radio-css radio-inline">
                                            <input <?php if (!(strcmp($row_RecordTmp['tmpproductviewcolumn'],"4"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpproductviewcolumn" value="4" id="tmpproductviewcolumn_0"  />
                                            <label for="tmpproductviewcolumn_0">風格1</label>
                                      </div>
                                  </div>
                              </div> 
                          
                             <div class="card pull-left m-5">
                                  <img src="images/col3.jpg" width="60" height="60" />
                                  <div class="card-block">
                                      <div class="radio radio-css radio-inline">
                                            <input <?php if (!(strcmp($row_RecordTmp['tmpproductviewcolumn'],"3"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpproductviewcolumn" value="3" id="tmpproductviewcolumn_1"  />
                                            <label for="tmpproductviewcolumn_1">風格2</label>
                                      </div>
                                  </div>
                              </div> 
                              <div class="card pull-left m-5">
                                  <img src="images/col2.jpg" width="60" height="60" />
                                  <div class="card-block">
                                      <div class="radio radio-css radio-inline">
                                            <input <?php if (!(strcmp($row_RecordTmp['tmpproductviewcolumn'],"2"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpproductviewcolumn" value="2" id="tmpproductviewcolumn_2"  />
                                            <label for="tmpproductviewcolumn_2">風格3</label>
                                      </div>
                                  </div>
                              </div> 
                              <div class="card pull-left m-5">
                                  <img src="images/col1.jpg" width="60" height="60" />
                                  <div class="card-block">
                                      <div class="radio radio-css radio-inline">
                                            <input <?php if (!(strcmp($row_RecordTmp['tmpproductviewcolumn'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpproductviewcolumn" value="1" id="tmpproductviewcolumn_3"  />
                                            <label for="tmpproductviewcolumn_3">風格4</label>
                                      </div>
                                  </div>
                              </div> 
      ...
      <select name="tmpproductboard" id="tmpproductboard" class="form-control" data-parsley-trigger="blur" required="">
        <option value="none" <?php if (!(strcmp("none", $row_RecordTmp['tmpproductboard']))) {echo "selected=\"selected\"";} ?>>無外框</option>
        ...
        <option value="baseline01" <?php if (!(strcmp("baseline01", $row_RecordTmp['tmpproductboard']))) {echo "selected=\"selected\"";} ?>>基本線條A</option>
        <option value="baseline02" <?php if (!(strcmp("baseline02", $row_RecordTmp['tmpproductboard']))) {echo "selected=\"selected\"";} ?>>基本線條B</option>
        <option value="baseline03" <?php if (!(strcmp("baseline03", $row_RecordTmp['tmpproductboard']))) {echo "selected=\"selected\"";} ?>>基本線條C</option>
        <option value="baseline04" <?php if (!(strcmp("baseline04", $row_RecordTmp['tmpproductboard']))) {echo "selected=\"selected\"";} ?>>基本線條D</option>
        <option value="baseline05" <?php if (!(strcmp("baseline05", $row_RecordTmp['tmpproductboard']))) {echo "selected=\"selected\"";} ?>>基本線條E</option>
      </select>
      ...
      <select name="tmpproductboardicon" id="tmpproductboardicon" class="form-control" data-parsley-trigger="blur" >
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">標題文字顏色<span class="text-red">*</span></label>
          <div class="col-md-10">
          		<div class="input-group colorpicker-component colorpicker-element">				
                   <input name="tmpproductboardfontcolor" type="text" required class="form-control colorpicker-element" id="tmpproductboardfontcolor" value="<?php echo $row_RecordTmp['tmpproductboardfontcolor']; ?>" maxlength="20" data-parsley-errors-container="#error_tmpproductboardfontcolor" data-parsley-trigger="blur"/>
                   <span class="input-group-addon"><i style="background-color: rgb(64, 18, 18);"></i></span>
              </div>
              <div id="error_tmpproductboardfontcolor"></div>
  	  ...
  	  <div class="form-group row">
          ...
          <div class="col-md-10">
                             ...
                             <div class="card pull-left m-5">
                                  ...
                                  <div class="card-block">
                                      <div class="radio radio-css radio-inline">
                                            <input <?php if (!(strcmp($row_RecordTmp['tmpproductimagemethods'],"resize"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpproductimagemethods" value="resize" id="tmpproductimagemethods_0"  />
                                            <label for="tmpproductimagemethods_0">縮放</label>
                                      </div>
                                  </div>
                              </div> 
                             ...
                             <div class="card pull-left m-5">
                                  ...
                                  <div class="card-block">
                                      <div class="radio radio-css radio-inline">
                                            <input <?php if (!(strcmp($row_RecordTmp['tmpproductimagemethods'],"crop"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpproductimagemethods" value="crop" id="tmpproductimagemethods_1"  />
                                            <label for="tmpproductimagemethods_1">裁切</label>
                                      </div>
                                  </div>
                              </div> 
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                             ...
                             <div class="card pull-left m-5">
                                  ...
                                  <div class="card-block">
                                    <div class="radio radio-css radio-inline">
                                            <input <?php if (!(strcmp($row_RecordTmp['tmpproductimageboard'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpproductimageboard" value="0" id="tmpproductimageboard_0"  />
                                            <label for="tmpproductimageboard_0">方型</label>
                                      </div>
                                  </div>
                              </div> 
                             ...
                             <div class="card pull-left m-5">
                                  ...
                                  <div class="card-block">
                                      <div class="radio radio-css radio-inline">
                                            <input <?php if (!(strcmp($row_RecordTmp['tmpproductimageboard'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpproductimageboard" value="1" id="tmpproductimageboard_1"  />
                                            <label for="tmpproductimageboard_1">矩形</label>
                                      </div>
                                  </div>
