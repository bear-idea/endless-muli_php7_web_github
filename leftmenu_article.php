...
?>
<?php if ($totalRows_RecordArticleMultiLeftMenu_l1 > 0) { ?>
        <?php do { ?>
            <li class="<?php if(isset($row_RecordArticleMultiLeftMenu_l1['endnode'])) { echo $row_RecordArticleMultiLeftMenu_l1['endnode']; } ?> list-group-item <?php if($row_RecordTmpConfig['tmpcolumnmenumode'] == "1") { echo "dropdown";} ?>">
            <?php if ($row_RecordArticleMultiLeftMenu_l1['endnode'] != 'child') { ?>
            	<a href="#" class="dropdown-toggle"><?php echo $row_RecordArticleMultiLeftMenu_l1['itemname']; ?></a>
			<?php } else { ?>
            ...
            <?php }  ?>
                ...
                <ul class="<?php if($row_RecordTmpConfig['tmpcolumnmenumode'] == "1") { echo "dropdown-menu";} ?>">
					...
					if (isset($_GET['lang'])) {
					  $collang_RecordArticleMultiLeftMenu_l2 = $_GET['lang'];
					}
					...
					?>
					<?php do { ?>
                    <li class="<?php if(isset($row_RecordArticleMultiLeftMenu_l2['endnode'])) { echo $row_RecordArticleMultiLeftMenu_l2['endnode']; } ?> list-group-item <?php if($row_RecordTmpConfig['tmpcolumnmenumode'] == "1") { echo "dropdown";} ?>">
                    <?php if ($row_RecordArticleMultiLeftMenu_l2['endnode'] != 'child') { ?>
                    	<a href="#" class="dropdown-toggle"><strong><?php echo $row_RecordArticleMultiLeftMenu_l2['itemname']; ?></strong></a>
                    <?php } else { ?>
                    <a href="<?php echo $SiteBaseUrl . url_rewrite("article",array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'subpage','type1'=>$row_RecordArticleMultiLeftMenu_l1['item_id'],'type2'=>$row_RecordArticleMultiLeftMenu_l2['item_id']),'',$UrlWriteEnable);?>"><?php echo $row_RecordArticleMultiLeftMenu_l2['itemname']; ?></a>
                    <?php } ?>
                    <?php if ($row_RecordArticleMultiLeftMenu_l2['endnode'] != 'child') { // 若第二層節點不為child則印出下層選單 ?>
                      <ul class="<?php if($row_RecordTmpConfig['tmpcolumnmenumode'] == "1") { echo "dropdown-menu";} ?>">
                        ...
                        if (isset($_GET['lang'])) {
                          $collang_RecordArticleMultiLeftMenu_l3 = $_GET['lang'];
                        }
...
?>
						<?php do { ?>
                          <li class="<?php if(isset($row_RecordArticleMultiLeftMenu_l3['endnode'])) { echo $row_RecordArticleMultiLeftMenu_l3['endnode']; } ?> list-group-item <?php if($row_RecordTmpConfig['tmpcolumnmenumode'] == "1") { echo "dropdown";} ?>">
                          <?php if ($row_RecordArticleMultiLeftMenu_l3['endnode'] != 'child') { ?>
                    		<a href="#" class="dropdown-toggle"><?php echo $row_RecordArticleMultiLeftMenu_l3['itemname']; ?>></a>
                    	  <?php } else { ?>
                            <a href="<?php echo $SiteBaseUrl . url_rewrite("article",array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'subpage','type1'=>$row_RecordArticleMultiLeftMenu_l1['item_id'],'type2'=>$row_RecordArticleMultiLeftMenu_l2['item_id'],'type3'=>$row_RecordArticleMultiLeftMenu_l3['item_id']),'',$UrlWriteEnable);?>"><?php echo $row_RecordArticleMultiLeftMenu_l3['itemname']; ?></a>
                            <?php } ?>
                          </li>
