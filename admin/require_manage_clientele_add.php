...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_Clientele")) {
  ...
  $insertGoTo = "manage_clientele.php?Opt=viewpage&lang=" . $_POST['lang'];
  /*if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 客戶管理 <small>新增</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post">
      ...
      <input type="hidden" name="MM_insert" value="form_Clientele" />
  </form>
  </div>
  <!-- end panel-body --> 
</div>
