                	...
                	<!--    <tr>
                      ...
                      <tr class= "<?php echo $chahgecolorcount; ?>">       
                        ...
                        <td valign="top">
                              ...
                              # ============== [/if] ============== #
                              ?>
                              <a href="<?php echo $SiteBaseUrl . url_rewrite("publish",array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'detailed','id'=>$row_RecordPublish['id']),'',$UrlWriteEnable);?>"><?php echo $row_RecordPublish['title']; ?></a>
                              </td>
