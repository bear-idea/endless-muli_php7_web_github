...
<div class="columns on-1">
        <div class="container">
            <div class="column">
                ...
                <h1 style="font-size:large"><?php if($TmpTitleBgImage != ''){ ?><span class="titlesicon" data-scroll-reveal="enter top"><img src="<?php if($SiteBaseUrlOuter != "" && $TmpTitleBgWebName == 'playweb') { echo $SiteImgUrlOuter; } else { echo $SiteImgUrl; } ?><?php echo $TmpTitleBgWebName; ?>/image/tmpbackground/<?php echo $TmpTitleBgImage; ?>" /></span><?php } ?> <span class="titlesicon" data-scroll-reveal="enter right"><?php echo $row_RecordArticle['title']; ?></span></h1>
                </div>
            </div>
        </div>        
</div>
...
<div class="columns on-1">
    ...
    <div class="column">
      ...
      <span style="float:right; margin-right:5px;"><?php require("require_article_cmenu_list.php"); ?></span>
      <?php //require("require_fb_like.php"); ?>
          <?php echo pageBreak($row_RecordArticle['content']); ?>
          <?php if($row_RecordArticle['skeyword'] != "") { ?>
                        <div style="clear:both;"></div>
                        <div style="border:0px #CCCCCC dotted; padding:5px;" class="keytag">
                        <a>&nbsp;<i class="fa fa-tag"></i>&nbsp;</a><?php
                        $arr_tag = explode(',', $row_RecordArticle['skeyword']);
                        for($i = 0; $i < count($arr_tag); $i++){ echo "<a href=\"article.php?wshop=".$_GET['wshop']."&amp;Opt=search&amp;tp=".$_GET['tp']."&amp;lang=".$_SESSION['lang']."&amp;tag=".$arr_tag[$i] ."\">".$arr_tag[$i]."</a>";}
                        ?></div>
