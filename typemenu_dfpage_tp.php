...
<!--<div class="dcjq-vertical-mega-menu">
        ...
        <span class="typemenu_btn">
            ...
            <a href="<?php echo $SiteBaseUrl . url_rewrite(strtolower($row_RecordDfPageMultiTypeMenu_l1['typemenu']),array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'subpage','aid'=>$row_RecordDfPageMultiTypeMenu_l1['aid'],'type1'=>$row_RecordDfPageMultiTypeMenu_l1['item_id']),'',$UrlWriteEnable);?>"><?php echo $row_RecordDfPageMultiTypeMenu_l1['itemname']; ?></a>
            <?php } ?>
            <?php
            switch($row_RecordDfPageMultiTypeMenu_l1['typemenu']) // 抓取 inc_title 中的值(取的目前分類)
			  {
				  case "News":
				      echo "<ul>";
...
<!--<div class="dcjq-vertical-mega-menu">
        <ul id="mega-tp" class="menu">--> 	
<span class="typemenu_btn"><a href="<?php echo $SiteBaseUrl . url_rewrite(strtolower("dfpage"),array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'subpage','aid'=>$_GET['aid']),'',$UrlWriteEnable);?>"><?php echo $row_RecorddfpageKeyWordHome['title']; ?></a></span>
   <!--     </ul>
</div>-->
<?php } ?>
