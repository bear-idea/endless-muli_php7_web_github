    ...
    <thead>
      ...
      <?php do { ?>
        <tr>
          ...
          <td width="45" align="left" valign="middle" class="MenuViewPage"><a href="manage_ads_content_image.php?wshop=<?php echo $wshop;?>&amp;Opt=photoaddpage&amp;lang=<?php echo $_SESSION['lang']; ?>&amp;act_id=<?php echo $row_RecordAds['act_id']; ?>"><img src="images/add.gif" alt="" width="45" height="18" /></a></td>
          <td width="45" align="left" valign="middle" class="MenuViewPage"><a href="manage_ads_content_image.php?wshop=<?php echo $wshop;?>&amp;Opt=photoeditpage&amp;lang=<?php echo $_SESSION['lang']; ?>&amp;act_id=<?php echo $row_RecordAds['act_id']; ?>&amp;actphoto_id=<?php echo $row_RecordAds['actphoto_id']; ?>"><img src="images/edit.gif" alt="" width="45" height="18" /></a></td>
          <td width="49" align="left" valign="middle" class="MenuViewPage"><a href="manage_ads_content_image.php?wshop=<?php echo $wshop;?>&amp;Opt=photoviewpage&amp;actphoto_del_id=<?php echo $row_RecordAds['actphoto_id']; ?>&amp;Operate=delSuccess&amp;lang=<?php echo $_SESSION['lang']; ?>&amp;act_id=<?php echo $row_RecordAds['act_id']; ?>&amp;pic=<?php echo $row_RecordAds['pic']; ?>"><img src="images/del.gif" width="45" height="18" /></a></td>
        </tr>
