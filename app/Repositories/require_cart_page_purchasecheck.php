...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insert = Cartorder::create(
    [
		'oserial' => $_POST['D_OrderID'],
		'ocname' => $_POST['ocname'],
		'ocaddr' => $_POST['ocaddr'],
		'ocphone' => $_POST['ocphone'],
		'ocmail' => $_POST['ocmail'],
		'ocgender' => $_POST['ocgender'],				   
		'ocbuyname' => $_POST['ocbuyname'],
		'ocbuyphone' => $_POST['ocbuyphone'],
		'ocbuytel' => $_POST['ocbuytel'],
		'ocbuymail' => $_POST['ocbuymail'],
		'ocbuygender' => $_POST['ocbuygender'],	   
		'ocpdprice' => $_POST['ocpdprice'],
		'octel' => $_POST['octel'],
		'ocrfreight' => $_POST['ocrfreight'],
		'ocfreightstateonly' => $_POST['ocfreightstateonly'],
		'ocfreightprice' => $_POST['ocfreightprice'],
		'ocinvoiceformat' => $_POST['ocinvoiceformat'],
		'ocinvoiceetselect' => $_POST['ocinvoiceetselect'],
		'ocinvoicesupportno' => $_POST['ocinvoicesupportno'],
		'ocinvoiceloveno' => $_POST['ocinvoiceloveno'],
		'ocinvoicecompanyno' => $_POST['ocinvoicecompanyno'],
		'ocinvoicetitle' => $_POST['ocinvoicetitle'],
		'ocinvoiceusername' => $_POST['ocinvoiceusername'],
		'ocinvoiceaddr' => $_POST['ocinvoiceaddr'],
		'ocinvoiceprice' => $_POST['ocinvoiceprice'],
		'ocfreepriceok' => $_POST['ocfreepriceok'],
		'ocfreepricedesc' => $_POST['ocfreepricedesc'],
		'ocexpriceselect' => $_POST['ocexpriceselect'],
		'ocexpricename' => $_POST['ocexpricename'],
		'ocexprice' => $_POST['ocexprice'],
		'ocDiscountShowAlldiscount_type_0' => $_POST['ocDiscountShowAlldiscount_type_0'],
		'ocDiscountShowAlldiscount_type_1' => $_POST['ocDiscountShowAlldiscount_type_1'],
		'ocDiscountShowAlldiscount_type_2' => $_POST['ocDiscountShowAlldiscount_type_2'],
		'ocDiscountShowAlldiscount_type_3' => $_POST['ocDiscountShowAlldiscount_type_3'],
		'ocDiscountShowAlldiscount_type_4' => $_POST['ocDiscountShowAlldiscount_type_4'],
		'ocDiscountShowAlldiscount_type_5' => $_POST['ocDiscountShowAlldiscount_type_5'],
		'ocDiscountShowAlldiscount_type_6' => $_POST['ocDiscountShowAlldiscount_type_6'],
		'ocpaymentselect' => $_POST['ocpaymentselect'],
		'ocfreightselect' => $_POST['ocfreightselect'],
		'ocreceipt' => $_POST['ocreceipt'],
		'ocfreightdesc' => $_POST['ocfreightdesc'],
		'ocotherprice' => $_POST['ocotherprice'],
		'oczip' => $_POST['oczip'],
		'occounty' => $_POST['occounty'],
		'ocdistrict' => $_POST['ocdistrict'],
		'octotal' => $_POST['octotal'],
		'ocCVSStoreID' => $_POST['ocCVSStoreID'],
		'ocCVSStoreName' => $_POST['ocCVSStoreName'],
		'postdate' => $_POST['postdate'],
		'ocnotes1' => $_POST['ocnotes1'],
		'memberid' => $row_RecordMember['id'],
