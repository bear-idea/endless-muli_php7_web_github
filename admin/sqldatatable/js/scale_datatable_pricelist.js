var handleDataTableDefault = function(code) {
    "use strict";
    if ($('#data-table-default').length !== 0) {
        var otable = $('#data-table-default').DataTable({       //"dom":"lBfrtip",buttons:[{extend:"copy",className:"btn-sm"},{extend:"csv",className:"btn-sm"},{extend:"excel",className:"btn-sm"},{extend:"pdf",className:"btn-sm"},{extend:"print",className:"btn-sm"},{extend:"colvis",className:"btn-sm"}],
            ...
            "autoWidth": false,
            "ajax": {
                "url": "sqldatatable/scale_pricelist_view.php?code=" + code,
                "type": "post",
				"data": function ( d ) {
					...
					d.search_indicate = $('#col8_filter').val();
					d.search_mode = $('#col6_filter').val();
...
var TableManageDefault = function(code) {
    "use strict";
    return {
        //main function
        init: function(code) {
            handleDataTableDefault(code);
        }
    };
} ();
    ...
    swal({
        ...
        preConfirm: function() {
            return new Promise(function(resolve) {
                ...
                $.ajax({
                    url: "sqldatatable/scale_pricelist_del.php?id_del=" + id + "&pic=" + pic,
                    type: "GET"
        ...
        swal({
            ...
            preConfirm: function() {
                return new Promise(function(resolve) {
                    ...
                    $.ajax({
                        url: "sqldatatable/scale_pricelist_del_muti.php",
                        data: {
                            id: list_id
                        },
                        type: "POST"
