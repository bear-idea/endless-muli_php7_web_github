...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_TmpColumn")) {
    $updateSQL = sprintf("UPDATE demo_tmphomecolumn SET customname=%s, content=%s, sortid=%s, indicatewrp=%s, indicatetitle=%s, indicatemiddle=%s, lang=%s WHERE id=%s",
...
{
	CKEDITOR.replace( 'content',{width : '250px', toolbar : 'Free'} );
};
</script>
