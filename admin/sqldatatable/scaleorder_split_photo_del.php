...
if ((isset($_GET['id_del'])) && ($_GET['id_del'] != "")) {
  ...
  $query_RecordSplitorderphotoGet = sprintf("SELECT * FROM erp_splitorderphoto WHERE pid = %s", GetSQLValueString($colname_RecordSplitorderphotoGet, "int"));
  ...
  $deleteSQL = sprintf("DELETE FROM erp_splitorderphoto WHERE userid=%s && pid=%s",
