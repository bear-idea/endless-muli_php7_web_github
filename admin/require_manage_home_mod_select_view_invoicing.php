...
<div class="Menu_ListView_Icon_Board cl_gray">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td height="20" align="center">返回首頁</td>
    </tr>
  </table>
</div>
</a> 
<div class="Menu_ListView_Icon_Board cl_blue4" style="background-image:url(images/mt_color_010.png); color:#4d5258; font-weight:bolder;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="100" align="center">資料<br/>建檔
        </td>
    </tr>
  </table>
</div>
<a href="manage_company.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_095.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">公司資料</td>
    </tr>
  </table>
</div>
</a>
<a href="manage_bank.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_130.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">銀行帳戶</td>
    </tr>
  </table>
</div>
</a>
<a href="manage_commodity.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_093.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">產品管理</td>
    </tr>
  </table>
</div>
</a>
<a href="manage_clientele.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_103.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">客戶管理</td>
    </tr>
  </table>
</div>
</a>
<a href="manage_supplier.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_104.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">供應廠商</td>
    </tr>
  </table>
</div>
</a>
<div class="Menu_ListView_Icon_Board cl_blue4" style="background-image:url(images/mt_color_010.png); color:#4d5258; font-weight:bolder;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="100" align="center">出入庫<br/>管理
        </td>
    </tr>
  </table>
</div>
<a href="manage_scaleorder_in.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_099.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">入庫管理</td>
    </tr>
  </table>
</div>
</a>
<a href="manage_scaleorder_out.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_098.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">出庫管理</td>
    </tr>
  </table>
</div>
</a>
<div class="Menu_ListView_Icon_Board cl_blue4" style="background-image:url(images/mt_color_010.png); color:#4d5258; font-weight:bolder;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="100" align="center">期初<br/>開帳
        </td>
    </tr>
  </table>
</div>
<a href="manage_accounts_receivable.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_126.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">應收帳款</td>
    </tr>
  </table>
</div>
</a>
<a href="manage_accounts_payable.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_127.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">應付帳款</td>
    </tr>
  </table>
</div>
</a>
<a href="manage_bills_receivable.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_128.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">應收票據</td>
    </tr>
  </table>
</div>
</a>
<a href="manage_bills_payable.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_129.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">應付票據</td>
    </tr>
  </table>
</div>
</a>
<a href="manage_accounts_summons.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_131.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">會計傳票</td>
    </tr>
  </table>
</div>
</a>
<div class="Menu_ListView_Icon_Board cl_blue4" style="background-image:url(images/mt_color_010.png); color:#4d5258; font-weight:bolder;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="100" align="center">會計<br/>
        報表</td>
    </tr>
  </table>
</div>
<a href="manage_accounts_book.php?wshop=<?php echo $wshop;?>&amp;Opt=diarypage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_110.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">帳簿</td>
    </tr>
  </table>
</div>
</a>
<a href="manage_accounts_report.php?wshop=<?php echo $wshop;?>&amp;Opt=trialbalancepage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_132.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">報表</td>
    </tr>
  </table>
</div>
</a>
...
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_133.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">專案</td>
    </tr>
  </table>
</div>
</a>
...
<a href="manage_bulletin.php?wshop=<?php echo $wshop;?>&amp;Opt_Bulletin=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
...
<div class="Menu_ListView_Icon_Board cl_blue2">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><?php if ($OptionTmpHomeSelect == '1') {?>
...
<a href="manage_weburl.php?wshop=<?php echo $wshop;?>&amp;Opt_Weburl=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_red">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
...
<a href="manage_webanalytics.php?wshop=<?php echo $wshop;?>&amp;Opt_Webanalytics=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_red">
