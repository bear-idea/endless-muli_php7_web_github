...
// 導覽
if($.cookie("intro_catalog") == null){
	jQuery(window).load(function() {startIntro();})
	$.cookie('intro_catalog', '1', { path:'/', expires: 365 });
}
</script>
<!-- InstanceEndEditable -->
</head>
...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_catalog.php"); ?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include_once("require_manage_catalog_index.php");			
					break;
				case "addpage_s":
					include_once("require_manage_catalog_add_select.php");
					break;
				case "addpage_d":
					include_once("require_manage_catalog_add_default.php");
					break;
				case "addpage_l":
					include_once("require_manage_catalog_add_link.php");
					break;
				case "addpage_p":
					include_once("require_manage_catalog_add_page.php");
					break;
				case "copypage_d":
					include_once("require_manage_catalog_copy_default.php"); 
					break;
				case "copypage_l":
					include_once("require_manage_catalog_copy_link.php"); 
					break;
				case "copypage_p":
					include_once("require_manage_catalog_copy_page.php"); 
					break;
				case "editpage_d":
					include_once("require_manage_catalog_edit_default.php"); 
					break;
				case "editpage_l":
					include_once("require_manage_catalog_edit_link.php"); 
					break;
				case "editpage_p":
					include_once("require_manage_catalog_edit_page.php"); 
					break;
				case "mix":
					include_once("require_manage_product_mix.php"); 
					break;
				case "listpage":
					include_once("require_manage_catalog_list.php");
					break;
				case "listitempage":
					include_once("require_manage_catalog_listitem.php");
					break;
				case "configpage":
					include_once("require_manage_catalog_config.php");
					break;
				case "tmp_step_map":
					include_once("require_manage_catalog_step_map.php");
					break;
				default:
					include_once("require_manage_catalog_index.php");
					break;
