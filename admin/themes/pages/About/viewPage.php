...
$RecordAboutListType = (new Aboutitem)->getItemType( $request);
...
$tableConfig = [
    ...
    'ajaxUrl' => ADMINURL . '/sqldatatable/about_view.php',
    'editUrl' => ADMINURL . '/sqledit/about_jedit.php',
    'editListUrl' => ADMINURL . '/sqledit/about_get_list.php?list_id=1',
    //'deleteUrl' => ADMINURL . '/sqldatatable/about_del.php',
    ...
    'columns' => [
        ...
        //['title' => '類別', 'data' => 'type', 'orderable' => true, 'className' => 'ed_type', 'inputclass' => 'form-select', 'sourceUrl' => ADMINURL . '/sqledit/about_get_list.php?list_id=1', 'width' => '100px'],
