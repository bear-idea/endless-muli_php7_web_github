...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_article.php"); ?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include_once("require_manage_article_index.php");			
					break;
				case "viewpage_sub":
					include_once("require_manage_article_index_sub.php");			
					break;
				case "addpage":
					include_once("require_manage_article_add.php");
					break;
				case "editpage":
					include_once("require_manage_article_edit.php"); 
					break;
				case "copypage":
					include_once("require_manage_article_copy.php"); 
					break;
				case "startpage":
					include_once("require_manage_article_start.php"); 
					break;
				case "listpage":
					include_once("require_manage_article_list.php");
					break;
				case "listitempage":
					include_once("require_manage_article_listitem.php");
					break;
				case "mulilistitempage":
					include_once("require_manage_article_mulilistitem.php");
					break;
				case "sub_mulilistitempage":
					include_once("require_manage_article_mulilistitem_sub.php");
					break;
				case "configpage":
					include_once("require_manage_article_config.php");
					break;
				default:
					include_once("require_manage_article_index.php");
					break;
