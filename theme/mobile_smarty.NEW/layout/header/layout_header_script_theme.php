...
<link href="<?php echo $TplPluginsPath; ?>/bootstrap/3.3.5/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
...
<link href="<?php echo $TplPluginsPath; ?>/slider.revolution/css/extralayers.css" rel="stylesheet" type="text/css" />
<link href="<?php echo $TplPluginsPath; ?>/slider.revolution/css/settings.css" rel="stylesheet" type="text/css" />
<link href="<?php echo $TplPluginsPath; ?>/photoFrame/css/photoFrame.css" rel="stylesheet" type="text/css" />
<link href="<?php echo $TplPluginsPath; ?>/jquery-nicelabel/jquery-nicelabel.css" rel="stylesheet" type="text/css" />
<link href="<?php echo $TplPluginsPath; ?>/bootstrap-touchspin/jquery.bootstrap-touchspin.min.css" rel="stylesheet">
<?php require_once("inc/inc_css_setting.mobile.smarty.min.php"); // 自訂樣式?>
<script type="text/javascript">var plugin_path = '<?php echo $TplPluginsPath; ?>/';</script>
...
<script type="text/javascript" src="<?php echo $TplPluginsPath; ?>/jquery-cookie/jquery.cookie.js"></script>
<script type="text/javascript" src="<?php echo $TplPluginsPath; ?>/slider.revolution/js/jquery.themepunch.tools.min.js"></script>
<script type="text/javascript" src="<?php echo $TplPluginsPath; ?>/slider.revolution/js/jquery.themepunch.revolution.min.js"></script>
...
<script type="text/javascript" src="<?php echo $TplPluginsPath; ?>/jquery-nicelabel/jquery.nicelabel.js"></script>
<script type="text/javascript" src="<?php echo $TplPluginsPath; ?>/bootstrap-touchspin/jquery.bootstrap-touchspin.min.js"></script>
