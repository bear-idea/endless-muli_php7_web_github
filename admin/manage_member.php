...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_member.php"); ?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include_once("require_manage_member_index.php");			
					break;
				case "rightpage":
					include_once("require_manage_member_right.php");			
					break;
				case "addpage":
					include_once("require_manage_member_add.php");
					break;
				case "addpagepic":
					include_once("require_manage_member_add_with_pic.php");
					break;
				case "addpagepureupload":
					include_once("require_manage_member_add_with_pic_pureuploadik.php");
					break;
				case "editpage":
					include_once("require_manage_member_edit.php"); 
					break;
				case "editpagepureupload":
					include_once("require_manage_member_edit_with_pic_pureuploadik.php");
					break;
				case "editpage_avatar":
					include_once("require_manage_member_edit_with_pic_pureupload_avatar.php");
					break;
				case "deletepage":
					include_once("require_manage_member_delete.php");
					break;
				case "listpage":
					include_once("require_manage_member_list.php");
					break;
				case "listitempage":
					include_once("require_manage_member_listitem.php");
					break;
				case "configpage":
					include_once("require_manage_member_config.php");
					break;
				case "setpage":
					include_once("require_manage_member_set.php");
					break;
				case "thirdparty":
					include_once("require_manage_member_thirdparty.php");
					break;
				default:
					include_once("require_manage_member_index.php");
					break;
