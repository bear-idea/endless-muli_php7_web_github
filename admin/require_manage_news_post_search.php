    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablesorter" id="TBSort">
        ...
        <?php
		 ...
		 ?>
            ...
            <a href="../news.php?wshop=<?php echo $wshop;?>&amp;Opt=detailed&amp;lang=<?php echo $_SESSION['lang']; ?>&amp;id=<?php echo $row_RecordNewsPost['pid']; ?>" class="colorbox_iframe"  data-original-title="您可在此查看目前留言所在之前台位置。" data-toggle="tooltip" data-placement="top"><i class="fa fa-eye"></i> 資料頁面</a>
            </span>
              </td>
