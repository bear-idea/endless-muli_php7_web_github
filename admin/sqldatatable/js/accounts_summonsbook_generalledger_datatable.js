var handleDataTableDefault = function(aid) {
    ...
    if ($('#data-table-default').length !== 0) {
        ...
        var otable = $('#data-table-default').DataTable({       
            ...
            "autoWidth": false,
            "ajax": {
                "url": "sqldatatable/accounts_summonsbook_generalledger_view.php?aid=" + aid,
                "type": "post",
				"data": function ( d ) {
					...
					d.search_postdate = $('#col3_filter').val();
			...
			"footerCallback": function ( row, data, start, end, display ) {
				...
				var total_debitamount = api
					.column(6)
					.data()
					.reduce( function (a, b) {
						return intVal(a) + intVal(b);
					}, 0 );
				var total_creditamount = api
					.column(7)
					.data()
					.reduce( function (a, b) {
						return intVal(a) + intVal(b);
			  ...
			  // Total over this page
			   /*var  pageTotal = api
				...
				// Update footer
				$( api.column(5).footer() ).html('借貸差額:'+total_minamount);
				$( api.column(6).footer() ).html('借方合計:'+total_debitamount);
				$( api.column(7).footer() ).html('貸方合計:'+total_creditamount);
			  },
            'columnDefs': [{
                'targets': 0,
                'searchable': false,
			...
			"stateLoadParams": function (settings, data) {
				...
				$("#col3_filter").val(data.search.field.postdate);
            ...
            "fnDrawCallback": function(oSettings) {
                ...
                $('#data-table-default').editable({
                    selector: ".ed_notes1",
                    url: 'sqledit/accounts_summonsbook_generalledger_jedit.php',
                    type: 'text',
                    name: 'notes1',
                    //title: '輸入標題',
    ...
    swal({
        ...
        preConfirm: function() {
            return new Promise(function(resolve) {
                ...
                $.ajax({
                    url: "sqldatatable/accounts_summonsbook_generalledger_del.php?id_del=" + id,
                    type: "GET"
        ...
        swal({
            ...
            preConfirm: function() {
                return new Promise(function(resolve) {
                    ...
                    $.ajax({
                        url: "sqldatatable/accounts_summonsbook_generalledger_del_muti.php",
                        data: {
                            id: list_id
                        },
                        type: "POST"
