...
<div style="background-color:#999; color:#FFF; text-align:center; padding:5px; cursor:pointer;" class="Acc_Title"><span class="Acc_Change"><i class="fa fa-plus-square"></i></span> 主框架 - 外框樣式</div>
  ...
  <div style="background-color:#FFFFFF; padding:5px; border: 1px solid #CCC; overflow-y:scroll; height:800px;">
    ...
    <tbody>
      ...
      <tr>    
	   ...
	   <div style="padding:5px; border: 1px dotted #CCC; margin-bottom:2px; width:350px;; float:left; margin:5px; text-align:center;" class="<?php if($row_RecordTmpBoardShowSelect['tmpwrpboard'] == ''){echo "bg_active";} ?> bg_board"><!--無圖片指定--><a><img src="images/no_bg.jpg" alt="" width="50" height="50" alumb="true" _w="50" _h="50"/></a>
...
$("#chang_tmp_none").click(function(){     
	$(".WrpBoardStyle").css({"background-image":"none", "background-color":"transparent"});
	$(".mdl_t_l").css({"background-image":"none", "background-color":"transparent"});
	$(".mdl_t_r").css({"background-image":"none", "background-color":"transparent"});
	$(".mdl_t_c").css({"background-image":"none", "background-color":"transparent"});
	$(".mdl_c_l").css({"background-image":"none", "background-color":"transparent"});
	$(".mdl_c_r").css({"background-image":"none", "background-color":"transparent"});
	$(".mdl_c_c").css({"background-image":"none", "background-color":"transparent"});
	$(".mdl_b_l").css({"background-image":"none", "background-color":"transparent"});
	$(".mdl_b_r").css({"background-image":"none", "background-color":"transparent"});
	$(".mdl_b_c").css({"background-image":"none", "background-color":"transparent"});
});
$("#use_tmp_none").click(function(){     
$.ajax({
		type: "POST",
		url: "sqlgettmp/tmpwrpboard_get.php?id=none&Operate=M_Update&tmpid=<?php echo $row_RecordTmp['id']; ?>&<?php echo time();?>",
		success: function(data){
			$(".WrpBoardStyle").css({"background-image":"none", "background-color":"transparent"});
			$(".mdl_t_l").css({"background-image":"none", "background-color":"transparent", "height":"0px", "width":"0px"});
			$(".mdl_t_r").css({"background-image":"none", "background-color":"transparent", "height":"0px", "width":"0px"});
			$(".mdl_t_c").css({"background-image":"none", "background-color":"transparent", "height":"0px", "width":"0px"});
			$(".mdl_c_l").css({"background-image":"none", "background-color":"transparent", "width":"0px"});
			$(".mdl_c_r").css({"background-image":"none", "background-color":"transparent", "width":"0px"});
			$(".mdl_c_c").css({"background-image":"none", "background-color":"transparent", });
			$(".mdl_b_l").css({"background-image":"none", "background-color":"transparent", "height":"0px", "width":"0px"});
			$(".mdl_b_r").css({"background-image":"none", "background-color":"transparent", "height":"0px", "width":"0px"});
			$(".mdl_b_c").css({"background-image":"none", "background-color":"transparent", "height":"0px"});
       ...
       <?php do { ?>
           <div style="padding:5px; border: 1px dotted #CCC; margin-bottom:2px; width:350px; float:left; margin:5px; text-align:center; position:relative;" class="<?php if($row_RecordTmpBoardShowSelect['tmpwrpboard'] == $row_RecordTmpBoardShow['id']){echo "bg_active";} ?> bg_board">
