...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_forum.php"); ?>
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include_once("require_manage_forum_index.php");			
					break;
				case "viewpage_sub":
					include_once("require_manage_forum_index_sub.php");			
					break;
				case "searchpage":
					include_once("require_manage_forum_index_search.php");			
					break;
				case "postpage":
					include_once("require_manage_forum_post_index.php");			
					break;
				case "postaddpage":
					include_once("require_manage_forum_post_add.php");			
					break;
				case "posteditpage":
					include_once("require_manage_forum_post_edit.php");			
					break;
				case "replypage":
					include_once("require_manage_forum_reply_index.php");			
					break;
				case "replyaddpage":
					include_once("require_manage_forum_reply_add.php");			
					break;
				case "replyeditpage":
					include_once("require_manage_forum_reply_edit.php");			
					break;
				case "addpage":
					include_once("require_manage_forum_add.php");
					break;
				case "editpage":
					include_once("require_manage_forum_edit.php"); 
					break;
				case "edittabpage":
					include_once("require_manage_forum_tab_edit.php"); 
					break;
				case "listpage":
					include_once("require_manage_forum_list.php");
					break;
				case "listitempage":
					include_once("require_manage_forum_listitem.php");
					break;
				case "mulilistitempage":
					include_once("require_manage_forum_mulilistitem.php");
					break;
				case "advlistitempage":
					include_once("require_manage_forum_advlilistitem.php");
					break;
				case "adminlistitempage":
					include_once("require_manage_forum_adminlilistitem.php");
					break;
				case "sub_mulilistitempage":
					include_once("require_manage_forum_mulilistitem_sub.php");
					break;
				case "configpage":
					include_once("require_manage_forum_config.php");
					break;
				default:
					include_once("require_manage_forum_index.php");
					break;
