...
$query_RecordAllpayData = sprintf("SELECT allpaypaymentnumber, allpaypaymentHashKey, allpaypaymentHashIV FROM demo_setting_otr WHERE userid = (SELECT id FROM demo_admin WHERE webname=%s)", GetSQLValueString($colwebname_RecordAllpayData, "text"));
...
?>
<?php 
$HashKey = $row_RecordAllpayData['allpaypaymentHashKey']; 
$HashIV = $row_RecordAllpayData['allpaypaymentHashIV']; 
