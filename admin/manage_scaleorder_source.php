...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_scaleorder_source.php"); ?>
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include("require_manage_scaleorder_source_index.php");			
					break;
				case "outpage":
					include("require_manage_scaleorder_sourcedex_out.php");			
					break;
				case "addpage":
					include("require_manage_scaleorder_source_add.php");
					break;
				case "editpage":
					include("require_manage_scaleorder_source_edit.php"); 
					break;
				case "export":
					include_once("require_manage_scaleorder_source_export.php");
					break;
				case "print_cartransport_select":
					include_once("require_manage_scaleorder_source_carcontrol_select.php"); 
					break;
				default:
					include("require_manage_scaleorder_source_index.php");
					break;
