...
$query_RecordMDName = "SELECT itemname, customname, customname_en, customname_cn, customname_jp, itemvalue FROM demo_configitem";
...
if (isset($_SESSION['lang'])) {
  $colname_RecordDfTypeMDName = $_SESSION['lang'];
}
$coluserid_RecordDfTypeMDName = "-1";
if (isset($w_userid)) {
  $coluserid_RecordDfTypeMDName = $w_userid;
}
////mysqli_select_db($database_DB_Conn, $DB_Conn);
...
if (isset($_SESSION['lang'])) {
  $colnamelang_RecordModlinkMDName = $_SESSION['lang'];
}
$coluserid_RecordModlinkMDName = "-1";
if (isset($w_userid)) {
  $coluserid_RecordModlinkMDName = $w_userid;
}
////mysqli_select_db($database_DB_Conn, $DB_Conn);
...
{
	case "News":
	    if($_SESSION['lang'] == 'en') {$MD_Name = $row_RecordMDName['customname_en'];} else if ($_SESSION['lang'] == 'zh-cn'){$MD_Name = $row_RecordMDName['customname_cn'];} else if ($_SESSION['lang'] == 'jp'){$MD_Name = $row_RecordMDName['customname_jp'];}else {$MD_Name = $row_RecordMDName['customname'];} 
