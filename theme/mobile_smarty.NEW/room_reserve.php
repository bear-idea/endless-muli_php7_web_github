...
do {  
?>
  <option value="room.php?wshop=<?php echo $_GET['wshop'];?>&Opt=reserve&lang=<?php echo $_SESSION['lang']; ?>&tp=Room&level=<?php echo $level; ?>&type1=<?php echo $row_RecordRoomList['type1']; ?>&type2=<?php echo $row_RecordRoomList['type2']; ?>&type3=<?php echo $row_RecordRoomList['type3']; ?>&subitem_id=<?php echo $_GET['subitem_id']; ?>&id=<?php echo $row_RecordRoomList['id']; ?>&MM=<?php echo $_GET['MM']; ?>&YY=<?php echo $_GET['YY']; ?>"<?php if (!(strcmp($row_RecordRoomList['id'], $_GET['id']))) {echo "selected=\"selected\"";} ?>><?php echo $row_RecordRoomList['name']?>  / <?php echo "住房人數：" . $row_RecordRoomList['peoplenum'] . "人" ?></option>
  <?php
...
$stringDate = strftime("%d %b %Y",mktime (0,0,0,$MM,1,$YYYY));
        ...
        $nextYear = strftime("%Y",mktime (0,0,0,$MM+1,1,$YYYY));
          ...
          echo "<span style=\"font-size:36px; float:left\">" . "<a href=".$_SERVER['PHP_SELF'] ."?wshop=".$_GET['wshop']."&amp;Opt=reserve&amp;tp=Room&amp;lang=".$_SESSION['lang']."&MM=".$preMonth."&YY=".$preYear."&level=".$_GET['level']."&type1=".$_GET['type1']."&type2=".$_GET['type2']."&type3=".$_GET['type3']."&id=".$_GET['id']."><i class=\"fa fa-chevron-left\"></i></a>" . "</span>";
          echo "<span style=\"font-size:24px;\">" . $YYYY. "." . $MM . "</span>";
          echo "<span style=\"font-size:36px; float:right\">" . "<a href=".$_SERVER['PHP_SELF'] ."?wshop=".$_GET['wshop']."&amp;Opt=reserve&amp;tp=Room&amp;lang=".$_SESSION['lang']."&MM=".$nextMonth."&YY=".$nextYear."&level=".$_GET['level']."&type1=".$_GET['type1']."&type2=".$_GET['type2']."&type3=".$_GET['type3']."&id=".$_GET['id']."><i class=\"fa fa-chevron-right\"></i></a>" . "</span>";
...
<div>
<form id="form_Room" name="form_Room" method="post" action="room.php?wshop=<?php echo $_GET['wshop'];?>&amp;Opt=roomlist&amp;tp=Room&amp;lang=<?php echo $_SESSION['lang']; ?>">
<br>
