...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Product")) {
  $updateSQL = sprintf("UPDATE demo_product SET pic=IFNULL(%s,pic) WHERE id=%s",
...
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordProduct = sprintf("SELECT * FROM demo_product WHERE id = %s", GetSQLValueString($colname_RecordProduct, "int"));
