...
<?php do { ?>
  <?php 
	...
	$dvalue['action'] = "<div class='radio radio-css radio-inline'><input type='radio' name='TmpBoardSelect' value='".$row_RecordTmpBoard["id"]."' id='TmpBoardSelect_".$row_RecordTmpBoard["id"]."' data-parsley-trigger='blur' data-parsley-errors-container='#error_action' ><label for='TmpBoardSelect_".$row_RecordTmpBoard["id"]."'>選擇目前外框樣式</label></div>";
