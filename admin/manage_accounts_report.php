...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_accounts_report.php"); ?>
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			switch($_GET['Opt'])
			{
				case "trialbalancepage":
					include("require_manage_accounts_report_trialbalance.php");		
					break;
				case "profitlosslistpage_select":
					include("require_manage_accounts_report_profitlosslist_select.php");		
					break;
				case "balancesheetpage_select":
					include("require_manage_accounts_report_balancesheet_select.php");		
					break;
				case "statementsofcashflowspage":
					include("require_manage_accounts_report_statementsofcashflows.php");		
					break;
				case "accountslistpage":
					include("require_manage_accounts_report_accountslist.php");		
					break;
				case "monthendpage":
					include("require_manage_accounts_report_monthend.php");		
					break;
				case "annualresultpage":
					include("require_manage_accounts_report_annualresult.php");		
					break;
				default:
					include("require_manage_accounts_report_trialbalance.php");
					break;
