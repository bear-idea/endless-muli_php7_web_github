...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmptitlebackground=%s WHERE id=%s",
...
if (isset($row_RecordTmpBackGroundBoardStyle['tmptitlebackground'])) {
  $colid_RecordTmpBackGround = $row_RecordTmpBackGroundBoardStyle['tmptitlebackground'];
}
...
<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>sqldatatable/js/tmptitlebackground_datatable_get.js"></script>
<!-- ================== END Datatables JS ================== -->
  ...
  <div class="row">
      <div class="col-md-12">
        <div class="card bg-grey-transparent-1">
          <div class="card-block">
            <?php if($row_RecordTmpBackGroundBoardStyle['tmptitlebackground'] != "") { ?>
    ...
    <table id="data-table-default" class="table table-bordered table-hover cards" style="width:100%">
      <thead>
        <tr>
          ...
          <th data-priority="1"><strong>可選擇背景<div id="error_action"></div></strong></th>
        </tr>
      </thead>
      <tfoot>
        <tr>
