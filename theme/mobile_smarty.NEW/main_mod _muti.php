...
<div style="position:relative;">
  ...
  <!--標題外框--> 
  <div class="Scroll_Bar" style="height:380px;">
        <?php
			switch($Tp_Page)
			{
				case "Home":
					  ...
					  {
						  case "homeboard014":
						      include_once("require_news_home_mobile.php");
							  break;
						  case "homeboard015":
						  	  include_once("require_news_home_mobile.php");
							  break;
						  ...
						  case "homeboard018":
							  ...
							  break;
						  case "homeboard019":
						  	  include_once("require_product_home_mobile.php");
							  break;
						  case "homeboard020":
						  	  include_once("require_project_home_mobile.php");
							  break;
					  }	 	
				default:
					break;
    ...
    <div class="mdhome_c g_p_hide">
      ...
      <div class="mdhome_c_c">
        <!-- <div class="mdhome_m_t"></div>
					<div class="mdhome_m_c">  --> 
  <!--標題外框--> 
        <div class="Scroll_Bar" style="height:380px;"><?php require('require_tmphomecontentsmall.php'); ?>
        		  <div class="clearfix"></div></div>
  <!--標題外框-->
        <!--</div>
					<div class="mdhome_m_b"></div>-->
				...
				case "Home":
					  switch($HomeStyle) /*  判斷要使用的首頁版型 */
					  {
						  ...
						  case "homeboard015":
							  ...
							  break;
						  case "homeboard016":
						  	  include_once("require_activities_home_mobile.php");
							  break;
						  case "homeboard017":
						  	  include_once("require_sponsor_home_mobile.php");
							  break;
						  case "homeboard018":
						  	  include_once("require_video_home_mobile.php");
							  break;
						  case "homeboard019":
						  	  include_once("require_sponsor_home_mobile.php");
							  break;
    ...
    <div class="mdhome_c g_p_hide">
      ...
      <div class="mdhome_c_c">
        <!-- <div class="mdhome_m_t"></div>
					<div class="mdhome_m_c">  --> 
  <!--標題外框--> 
        <div class="Scroll_Bar" style="height:380px;"><?php require('require_tmphomecontentsmall2.php'); ?>
        		  <div class="clearfix"></div></div>
  <!--標題外框-->
        <!--</div>
					<div class="mdhome_m_b"></div>-->
