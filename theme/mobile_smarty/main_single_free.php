...
<script type="text/javascript" src="<?php if($SiteBaseUrlOuter != "") { echo $SiteJsUrlOuter; } else { echo $SiteJsUrl; } ?>jquery.isotope.min.js"></script>
<script>
...
<div class="mdviewline ViewlineBoardStyle" class="hidden-xs">
	...
	<div class="mdviewline_c g_p_hide">
			...
			<div class="mdviewline_c_c">
			    ...
			    <!--導覽列外框--> 
                <?php //require("require_news_viewline.php"); ?>
                <!--導覽列外框-->
  				<!--</div>
...
<!-- 導覽列外框-->
        ...
        <?php
			...
			{
				case "Home":
					include_once("require_main_noboard.php");				
					break;			
				default:
					include_once("require_main_noboard.php");
					break;
