var handleDataTableDefault = function(aid) {
    ...
    if ($('#data-table-default').length !== 0) {
        ...
        var otable = $('#data-table-default').DataTable({       
		    "dom":"lBprtip",buttons:[{extend:"copy",className:"btn-sm",title:"現金簿"+NowToday},{extend:"csv",className:"btn-sm",title:"現金簿"+NowToday},{extend:"excel",className:"btn-sm",title:"現金簿"+NowToday},{extend:"pdf",className:"btn-sm",title:"現金簿"+NowToday},{extend:"print",className:"btn-sm",title:"現金簿"+NowToday},{extend:"colvis",className:"btn-sm",title:"現金簿"+NowToday}],
			//"dom": "lprtip",
            "autoWidth": false,
            "ajax": {
                "url": "sqldatatable/accounts_summonsbook_cash_view.php?aid=" + aid,
                "type": "post",
				"data": function ( d ) {
			...
			"footerCallback": function ( row, data, start, end, display ) {
			  ...
			  // Total over this page
			   /*var  pageTotal = api
				...
				// Update footer
				$( api.column(5).footer() ).html('收支差額:'+total_minamount);
				$( api.column(6).footer() ).html('支出合計:'+total_debitamount);
				$( api.column(7).footer() ).html('收入合計:'+total_creditamount);
			  },
            'columnDefs': [{
                'targets': 0,
                'searchable': false,
            ...
            "fnDrawCallback": function(oSettings) {
                ...
                $('#data-table-default').editable({
                    selector: ".ed_notes1",
                    url: 'sqledit/accounts_summonsbook_cash_jedit.php',
                    type: 'text',
                    name: 'notes1',
                    //title: '輸入標題',
    ...
    swal({
        ...
        preConfirm: function() {
            return new Promise(function(resolve) {
                ...
                $.ajax({
                    url: "sqldatatable/accounts_summonsbook_cash_del.php?id_del=" + id,
                    type: "GET"
        ...
        swal({
            ...
            preConfirm: function() {
                return new Promise(function(resolve) {
                    ...
                    $.ajax({
                        url: "sqldatatable/accounts_summonsbook_cash_del_muti.php",
                        data: {
                            id: list_id
                        },
                        type: "POST"
