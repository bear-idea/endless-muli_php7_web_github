...
$colmodshow_RecordAds = "-1";
if (isset($Tp_Page)) {
  $colmodshow_RecordAds = $Tp_Page;
}
...
$query_RecordAds = sprintf("SELECT demo_adtype.act_id, demo_adtype.userid, demo_adtype.content, demo_adtype.bhight, demo_adtype.bwight, demo_adtype.velocity, demo_adtype.numbers, demo_adtype.navigation, demo_adtype.thumbs, demo_adtype.label, demo_adtype.interval, demo_adtype.hideTools, demo_adtype.dots, demo_adtype.title, demo_adtype.type, demo_adtype_sub.modshow, demo_adtype_sub.sdescription, demo_adtype_sub.link, demo_adtype_sub.linktarget, demo_adtype_sub.linkstyle, demo_adtype_sub.linkcolor, demo_adtype_sub.linkword, demo_adtype_sub.linkwordcolor, demo_adtype_sub.pic, demo_adtype_sub.indicate, demo_adtype.dataheight, demo_adtype_sub.datakenburns, demo_adtype_sub.datatransition, demo_adtype_sub.databgposition, demo_adtype_sub.databgzoom, demo_adtype_sub.datacontent, demo_adtype_sub.datacontentlocation, demo_adtype_sub.datacontentoverlay1, demo_adtype_sub.datacontentoverlay2, demo_adtype.author, demo_adtype.startdate, demo_adtype.enddate, demo_adtype.style, demo_adtype.modstyle, demo_adtype.navigationstate, demo_adtype.tool, demo_adtype.theme, demo_adtype_sub.actphoto_id, demo_adtype_sub.animation, demo_adtype.lang FROM demo_adtype LEFT OUTER JOIN demo_adtype_sub ON demo_adtype.act_id = demo_adtype_sub.act_id HAVING (demo_adtype.lang = %s) && userid=%s && demo_adtype_sub.indicate=1 && type='banner' && (demo_adtype_sub.modshow=%s || demo_adtype_sub.modshow='All') ORDER BY demo_adtype_sub.sortid ASC, demo_adtype_sub.actphoto_id DESC", GetSQLValueString($collang_RecordAds, "text"),GetSQLValueString($coluserid_RecordAds, "int"),GetSQLValueString($colmodshow_RecordAds, "text"));
