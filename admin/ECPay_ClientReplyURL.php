...
if($_POST['AllPayLogisticsID'] != "") {
$updateSQL = sprintf("UPDATE demo_cartorders SET ocAllPayLogisticsID=%s WHERE oserial=%s",
                       GetSQLValueString($_POST['AllPayLogisticsID'], "text"),
                       GetSQLValueString($_GET['oserial'], "text"));

$Result1 = mysqli_query($DB_Conn, $updateSQL) or die(mysqli_error($DB_Conn));
}

if($_POST['CVSPaymentNo'] != "") {
$updateSQL = sprintf("UPDATE demo_cartorders SET ocCVSPaymentNo=%s WHERE oserial=%s",
                       GetSQLValueString($_POST['CVSPaymentNo'], "text"),
                       GetSQLValueString($_GET['oserial'], "text"));

$Result1 = mysqli_query($DB_Conn, $updateSQL) or die(mysqli_error($DB_Conn));
}

if($_POST['CVSValidationNo'] != "") {
$updateSQL = sprintf("UPDATE demo_cartorders SET ocCVSValidationNo=%s WHERE oserial=%s",
                       GetSQLValueString($_POST['CVSValidationNo'], "text"),
                       GetSQLValueString($_GET['oserial'], "text"));
...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-without-sidebar p-0">
  ...
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 綠界物流訂單 <small>回傳</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-heading">
    ...
    <h4 class="panel-title"><i class="fa fa-edit"></i> 訂單建立成功</h4>
  </div>
  <!-- end panel-heading --> 
  <!-- begin panel-body -->
  <div class="panel-body p-10">
                    ...
                    <table width="100%" class="table table-striped m-b-0">
                      <thead>
                        <tr>
                          <th colspan="2" align="center" class="btit"><strong style="color:#900">以下資訊為伺服器回傳訊息</strong></tr>
                      </thead>
                      <tbody>
                      <tr>
                        <td width="150" class="tit">廠商編號</td>
                        <td class=""><?php echo $_POST['MerchantID']; ?></td>
                      </tr>
                      <tr>
                        <td class="tit">廠商交易編號</td>
                        <td class=""><?php echo $_POST['MerchantTradeNo']; ?></td>
                      </tr>
                      <tr>
                        <td class="tit">目前物流狀態</td>
                        <td class=""><?php echo $_POST['RtnCode']; ?></td>
                      </tr>
                      <tr>
                        <td class="tit">物流狀態說明</td>
                        <td class=""><?php echo $_POST['RtnMsg']; ?></td>
                      </tr>
                      <tr>
                        <td class="tit">Ecpay 的物流交易編號</td>
                        <td class=""><?php echo $_POST['AllPayLogisticsID']; ?></td>
                      </tr>
                      <tr>
                        <td class="tit">物流類型</td>
                        <td class="">		
                        <?php
                      ...
                      <tr>
                        <td class="tit">物流子類型</td>
                        <td class=""><?php echo $_POST['LogisticsSubType'] ?></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td class="tit">物流狀態更新時間</td>
                        <td class=""><?php echo $_POST['UpdateStatusDate'] ?></td>
                      </tr>
                      <tr>
                        <td class="tit">收件人姓名</td>
                        <td class=""><?php echo $_POST['ReceiverName'] ?></td>
                      </tr>
                      <tr>
                        <td class="tit">收件人電話</td>
                        <td class=""><?php echo $_POST['ReceiverPhone']; ?></td>
                      </tr>
                      <tr>
                        <td class="tit">收件人手機</td>
                        <td class=""><?php echo $_POST['ReceiverCellPhone']; ?></td>
                      </tr>
                      <tr>
                        <td class="tit">收件人 email</td>
                        <td class=""><?php echo $_POST['ReceiverEmail']; ?></td>
                      </tr>
                      <tr>
                        <td class="tit">收件人地址</td>
                        <td class=""><?php echo $_POST['ReceiverAddress']; ?></td>
                      </tr>
                      <tr>
                        <td class="tit">寄貨編號</td>
                        <td class=""><?php echo $_POST['CVSPaymentNo']; ?></td>
                      </tr>
                      <tr>
                        <td class="tit">驗證碼</td>
                        <td class=""><?php echo $_POST['CVSValidationNo']; ?></td>
                      </tr>
                      <tr>
                        <td class="tit">托運單號</td>
                        <td class=""><?php echo $_POST['BookingNote']; ?></td>
                      </tr>
                      </tbody>
