...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_TmpLogo")) {
  $updateSQL = sprintf("UPDATE demo_tmplogo SET name=%s, type=%s, logotype=%s, logoname=%s, logoname_cn=%s, logoname_en=%s, logoname_jp=%s, logoname_kr=%s, logoname_sp=%s, logocolor=%s, logofontsize=%s, notes1=%s, lang=%s WHERE id=%s",
...
?>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
               <input name="logoname" type="text" required="" class="form-control" id="logoname" value="<?php echo $row_RecordTmpLogo['logoname']; ?>" maxlength="100" data-parsley-trigger="blur"/>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
               <input name="logoname_cn" type="text" required="" class="form-control" id="logoname_cn" value="<?php echo $row_RecordTmpLogo['logoname_cn']; ?>" maxlength="100" data-parsley-trigger="blur"/>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
               <input name="logoname_en" type="text" required="" class="form-control" id="logoname_en" value="<?php echo $row_RecordTmpLogo['logoname_en']; ?>" maxlength="100" data-parsley-trigger="blur"/>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
               <div class="col-md-10">
               <input name="logoname_jp" type="text" required="" class="form-control" id="logoname_jp" value="<?php echo $row_RecordTmpLogo['logoname_jp']; ?>" maxlength="100" data-parsley-trigger="blur"/>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
               <div class="col-md-10">
               <input name="logoname_jp" type="text" required="" class="form-control" id="logoname_kr" value="<?php echo $row_RecordTmpLogo['logoname_kr']; ?>" maxlength="100" data-parsley-trigger="blur"/>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
               <div class="col-md-10">
               <input name="logoname_sp" type="text" required="" class="form-control" id="logoname_sp" value="<?php echo $row_RecordTmpLogo['logoname_sp']; ?>" maxlength="100" data-parsley-trigger="blur"/>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
              <div class="input-group colorpicker-component colorpicker-element" id="colorpicker-prepend">
                   <input name="logocolor" type="text" required="" class="form-control colorpicker-element" id="logocolor" value="<?php echo $row_RecordTmpLogo['logocolor']; ?>" maxlength="100" data-parsley-errors-container="#error_colorpicker" data-parsley-trigger="blur"/>
