...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE demo_setting_fr SET Mobole_TopLine_Bg=%s WHERE userid=%s",
...
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpBackGroundSelect = "SELECT Mobole_TopLine_Bg FROM demo_setting_fr WHERE userid = $w_userid";
...
?>
    ...
    <tbody>
      ...
      <tr>    
	   ...
	   <div style="padding:5px; border: 1px dotted #CCC; margin-bottom:2px; width:115px; float:left; margin:5px; text-align:center;" class="<?php if($row_RecordTmpBackGroundSelect['Mobole_TopLine_Bg'] == ''){echo "bg_active";} ?> bg_board"><!--無圖片指定-->
       <div class="TmpBgSelectIcon" style="display:<?php if($row_RecordTmpBackGroundSelect['Mobole_TopLine_Bg'] != ''){echo "none";} ?>;"></div>
       ...
       <?php do { ?>
           <div style="padding:5px; border: 1px dotted #CCC; margin-bottom:2px; width:115px; float:left; margin:5px; text-align:center; position:relative;" class="<?php if($row_RecordTmpBackGroundSelect['Mobole_TopLine_Bg'] == $row_RecordTmpBackGround['id']){echo "bg_active";} ?> bg_board">
           <div class="TmpBgSelectIcon" style="display:<?php if($row_RecordTmpBackGroundSelect['Mobole_TopLine_Bg'] != $row_RecordTmpBackGround['id']){echo "none";} ?>;"></div>
