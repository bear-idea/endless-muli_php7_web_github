...
$tableConfig = [
    ...
    'ajaxUrl' => ADMINURL . '/sqldatatable/modules_view.php',
    'editUrl' => ADMINURL . '/sqledit/modules_jedit.php',
    'editListUrl' => ADMINURL . '/sqledit/modules_get_list.php?list_id=1',
    'deleteUrl' => ADMINURL . '/sqldatatable/modules_del.php',
    'deleteMutiUrl' => ADMINURL . '/sqldatatable/modules_del_muti.php',
    'columns' => [
        ...
        [ 'title' => '模組名稱', 'data' => 'name', 'orderable' => true, 'className' => 'ed_name', 'width' => '-1' ],
        [ 'title' => '型態', 'data' => 'type', 'orderable' => true, 'className' => 'ed_type', 'width' => '100px', 'inputclass' => 'form-select', 'sourceUrl' => "[{ value: 'System', text: '系統' }, { value: 'Backend', text: '後台' }, { value: 'Frontend', text: '前台' }]" ],
        [ 'title' => '圖示', 'data' => 'icon', 'orderable' => true, 'className' => 'ed_icon', 'width' => '100px' ],
        [ 'title' => '模組類別', 'data' => 'class', 'orderable' => true, 'className' => 'ed_class', 'width' => '200px' ],
        [ 'title' => '模組識別名', 'data' => 'uri', 'orderable' => true, 'className' => 'ed_uri', 'width' => '200px' ],
    ...
    <div class="panel-body">
        <div class="row justify-content-end">
            <div class="col-md-2 col-sm-12 m-b-10">
                <div class="input-group" data-column="2"> <span class="input-group-text"><i class="fas fa-search fa-fw"></i> 模組類別</span>
                    <select name="class" class="form-control form-select search_filter" id="filter-class">
