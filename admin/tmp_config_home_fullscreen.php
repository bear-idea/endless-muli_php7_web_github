...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Tmp")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET homefullscreenmenubackground=%s, homefullscreenfooterbackground=%s, homefullscreenmenuwordcolor=%s, homefullscreenfooterwordcolor=%s, homefullscreenmenuopacity=%s WHERE id=%s",
                       GetSQLValueString($_POST['homefullscreenmenubackground'], "text"),
                       GetSQLValueString($_POST['homefullscreenfooterbackground'], "text"),
                       GetSQLValueString($_POST['homefullscreenmenuwordcolor'], "text"),
                       GetSQLValueString($_POST['homefullscreenfooterwordcolor'], "text"),
                       GetSQLValueString($_POST['homefullscreenmenuopacity'], "text"),
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-heading">
    ...
    <div class="btn-group pull-right"><a href="tmp_config_homeboard021.php?lang=<?php echo $_SESSION['lang']; ?>&amp;id_edit=<?php echo $row_RecordTmp['id']; ?>" data-original-title="" data-toggle="tooltip" data-placement="top" class="btn btn-default btn-sm"><i class="fa fa-reply fa-fw"></i> 上一頁</a></div>
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post" id="form_Tmp" name="form_Tmp">
       <div class="form-group row">
        ...
        <div class="col-md-12"><span class="badge badge-primary"><i class="fa fa-paper-plane"></i> 設定</span></div>
      </div>
       
  	  <div class="form-group row">
          <label class="col-md-2 col-form-label">選單區塊<span class="text-red">*</span></label>
          <div class="col-md-10">
          		<div class="input-group colorpicker-component colorpicker-element">				
                   <input name="homefullscreenmenubackground" type="text" required class="form-control colorpicker-element" id="homefullscreenmenubackground" value="<?php echo $row_RecordTmp['homefullscreenmenubackground']; ?>" maxlength="20" data-parsley-errors-container="#error_homefullscreenmenubackground" data-parsley-trigger="blur"/>
                   <span class="input-group-addon"><i style="background-color: rgb(64, 18, 18);"></i></span>
              </div>
              <div id="error_homefullscreenmenubackground"></div>
                      
                 
          </div>
      </div>
      <div class="form-group row">
          <label class="col-md-2 col-form-label">選單區塊透明度<span class="text-red">*</span></label>
          <div class="col-md-10">
                      
                      <select name="homefullscreenmenuopacity" id="homefullscreenmenuopacity" class="form-control">
          <option value="0.1" <?php if (!(strcmp(0.1, $row_RecordTmp['homefullscreenmenuopacity']))) {echo "selected=\"selected\"";} ?>>10%</option>
          <option value="0.2" <?php if (!(strcmp(0.2, $row_RecordTmp['homefullscreenmenuopacity']))) {echo "selected=\"selected\"";} ?>>20%</option>
          <option value="0.3" <?php if (!(strcmp(0.3, $row_RecordTmp['homefullscreenmenuopacity']))) {echo "selected=\"selected\"";} ?>>30%</option>
          <option value="0.4" <?php if (!(strcmp(0.4, $row_RecordTmp['homefullscreenmenuopacity']))) {echo "selected=\"selected\"";} ?>>40%</option>
          <option value="0.5" <?php if (!(strcmp(0.5, $row_RecordTmp['homefullscreenmenuopacity']))) {echo "selected=\"selected\"";} ?>>50%</option>
          <option value="0.6" <?php if (!(strcmp(0.6, $row_RecordTmp['homefullscreenmenuopacity']))) {echo "selected=\"selected\"";} ?>>60%</option>
          <option value="0.7" <?php if (!(strcmp(0.7, $row_RecordTmp['homefullscreenmenuopacity']))) {echo "selected=\"selected\"";} ?>>70%</option>
          <option value="0.8" <?php if (!(strcmp(0.8, $row_RecordTmp['homefullscreenmenuopacity']))) {echo "selected=\"selected\"";} ?>>80%</option>
          <option value="0.9" <?php if (!(strcmp(0.9, $row_RecordTmp['homefullscreenmenuopacity']))) {echo "selected=\"selected\"";} ?>>90%</option>
          <option value="1.0" <?php if (!(strcmp(1.0, $row_RecordTmp['homefullscreenmenuopacity']))) {echo "selected=\"selected\"";} ?>>100%</option>
        </select>
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">選單文字<span class="text-red">*</span></label>
          <div class="col-md-10">
          		<div class="input-group colorpicker-component colorpicker-element">				
                   <input name="homefullscreenmenuwordcolor" type="text" required class="form-control colorpicker-element" id="homefullscreenmenuwordcolor" value="<?php echo $row_RecordTmp['homefullscreenmenuwordcolor']; ?>" maxlength="20" data-parsley-errors-container="#error_homefullscreenmenuwordcolor" data-parsley-trigger="blur"/>
                   <span class="input-group-addon"><i style="background-color: rgb(64, 18, 18);"></i></span>
              </div>
              <div id="error_homefullscreenmenuwordcolor"></div>
                      
                 
          </div>
      </div>
      <div class="form-group row">
          <label class="col-md-2 col-form-label">頁尾區塊<span class="text-red">*</span></label>
          <div class="col-md-10">
          		<div class="input-group colorpicker-component colorpicker-element">				
                   <input name="homefullscreenfooterbackground" type="text" required class="form-control colorpicker-element" id="homefullscreenfooterbackground" value="<?php echo $row_RecordTmp['homefullscreenfooterbackground']; ?>" maxlength="20" data-parsley-errors-container="#error_homefullscreenfooterbackground" data-parsley-trigger="blur"/>
                   <span class="input-group-addon"><i style="background-color: rgb(64, 18, 18);"></i></span>
              </div>
              <div id="error_homefullscreenfooterbackground"></div>
                      
                 
          </div>
      </div>
      <div class="form-group row">
          <label class="col-md-2 col-form-label">頁尾文字<span class="text-red">*</span></label>
          <div class="col-md-10">
          		<div class="input-group colorpicker-component colorpicker-element">				
                   <input name="homefullscreenfooterwordcolor" type="text" required class="form-control colorpicker-element" id="homefullscreenfooterwordcolor" value="<?php echo $row_RecordTmp['homefullscreenfooterwordcolor']; ?>" maxlength="20" data-parsley-errors-container="#error_homefullscreenfooterwordcolor" data-parsley-trigger="blur"/>
                   <span class="input-group-addon"><i style="background-color: rgb(64, 18, 18);"></i></span>
              </div>
              <div id="error_homefullscreenfooterwordcolor"></div>
