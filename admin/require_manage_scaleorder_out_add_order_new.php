...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="manage_scaleorder_out.php?wshop=<?php echo $wshop;?>&amp;Opt=outaddpage&amp;lang=<?php echo $_SESSION['lang']; ?>" method="POST" name="Form_Choose" id="Form_Choose" data-parsley-validate=""> 
    ...
    <button type="submit" class="btn btn btn-primary btn-block m-t-10">下一步 - 新增全新出貨單</button>
