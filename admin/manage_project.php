...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_project.php"); ?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include_once("require_manage_project_index.php");			
					break;
				case "addpage":
					include_once("require_manage_project_add.php");
					break;
				case "editpage":
					include_once("require_manage_project_edit.php"); 
					break;
				case "copypage":
					include_once("require_manage_project_copy.php"); 
					break;
				case "photoviewpage":
					include_once("require_manage_project_photo_index.php");			
					break;
				case "photoaddpage":
					include_once("require_manage_project_photo_multi_add.php");
					break;
				case "photoeditpage":
					include_once("require_manage_project_photo_edit.php"); 
					break;
				case "deletepage":
					include_once("require_manage_project_delete.php");
					break;
				case "listpage":
					include_once("require_manage_project_list.php");
					break;
				case "listitempage":
					include_once("require_manage_project_listitem.php");
					break;
				case "configpage":
					include_once("require_manage_project_config.php");
					break;
				default:
					include_once("require_manage_project_index.php");
					break;
