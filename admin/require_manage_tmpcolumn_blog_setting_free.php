...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_TmpColumn")) {
  $updateSQL = sprintf("UPDATE demo_tmpblogcolumn SET customname=%s, content=%s, sortid=%s, indicatewrp=%s, indicatetitle=%s, indicatemiddle=%s, lang=%s WHERE id=%s",
...
window.onload = function()
{
	...
	CKEDITOR.replace( 'content',{width : '350px', toolbar : 'Free'} );
};
</script>
...
<form action="require_manage_tmpcolumn_blog_setting_free.php" method="POST" enctype="multipart/form-data" name="form_TmpColumn" id="form_TmpColumn">
...
var sprytextarea1 = new Spry.Widget.ValidationTextarea("sprytextarea1", {validateOn:["blur"], maxChars:500});
