...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE demo_setting_fr SET SiteDecsHome=%s, SiteMail=%s, SiteAuthor=%s, SiteSName=%s, SitePhone=%s, SiteCell=%s, SiteFax=%s, SiteAddr=%s, SiteAddrX=%s, SiteAddrY=%s, contacttitle=%s, contacttitleindicate=%s, contactcontent=%s, googlemapindicate=%s, formindicate=%s WHERE id=%s",
  ...
  <form action="<?php echo $editFormAction;?>" id="form1" name="form1" class="form-horizontal form-bordered" data-parsley-validate="" method="post">
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="contacttitle" type="text" class="form-control" id="contacttitle" value="<?php echo $row_RecordSystemConfigFr['contacttitle']; ?>" maxlength="200" data-parsley-trigger="blur" required="" />
      ...
      <div class="form-group row" id="Step_Content">
          ...
          <div class="table-responsive">
                <textarea name="contactcontent" id="contactcontent" cols="100%" rows="35" class="form-control"><?php echo $row_RecordSystemConfigFr['contactcontent']; ?></textarea>  
          </div>
          </div>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SiteSName" type="text" class="form-control" id="SiteSName" value="<?php echo $row_RecordSystemConfigFr['SiteSName']; ?>" maxlength="100" data-parsley-trigger="blur" required="" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SiteDecsHome" type="text" class="form-control" id="SiteDecsHome" value="<?php echo $row_RecordSystemConfigFr['SiteDecsHome']; ?>" maxlength="200" data-parsley-trigger="blur" required="" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SitePhone" type="text" class="form-control" id="SitePhone" value="<?php echo $row_RecordSystemConfigFr['SitePhone']; ?>" maxlength="30" data-parsley-trigger="blur" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SiteCell" type="text" class="form-control" id="SiteCell" value="<?php echo $row_RecordSystemConfigFr['SiteCell']; ?>" maxlength="15" data-parsley-trigger="blur" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SiteFax" type="text" class="form-control" id="SiteFax" value="<?php echo $row_RecordSystemConfigFr['SiteFax']; ?>" maxlength="15" data-parsley-trigger="blur" />
      ...
      <div class="form-group row" id="Step_MapMove">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SiteAddr" type="text" class="form-control" id="SiteAddr" value="<?php echo $row_RecordSystemConfigFr['SiteAddr']; ?>" maxlength="250" data-parsley-trigger="blur" />
...
<div style="position:relative"><div id="out" style="position:absolute;"><div id="map_canvas"></div></div></div>
      ...
      <div class="form-group row" id="Step_Mail">
          ...
          <div class="col-md-10">
                      ...
                      <input name="sitemail" type="email" class="form-control" id="sitemail" value="<?php echo $row_RecordSystemConfigFr['SiteMail']; ?>" maxlength="150" data-parsley-trigger="blur" required="" />
      ...
      <div class="form-group row" id="Step_MailTitle">
          ...
          <div class="col-md-10">
                      ...
                      <input name="siteauthor" type="text" class="form-control" id="siteauthor" value="<?php echo $row_RecordSystemConfigFr['SiteAuthor']; ?>" maxlength="150" data-parsley-trigger="blur" required="" />
