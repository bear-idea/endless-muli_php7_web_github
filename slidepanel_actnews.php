...
$query_RecordActnewsMultiLeftMenu_l1 = sprintf("SELECT * FROM demo_actnewsitem WHERE list_id = 1 && lang = %s ORDER BY item_id DESC", GetSQLValueString($collang_RecordActnewsMultiLeftMenu_l1, "text"));
...
<ul class="list-group">
            <?php do { ?>
                ...
                <a href="<?php echo $SiteBaseUrl . url_rewrite("actnews",array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'viewpage'),'',$UrlWriteEnable);?><?php echo $key_params . urlencode($row_RecordActnewsMultiLeftMenu_l1['itemname']); ?>"><?php echo $row_RecordActnewsMultiLeftMenu_l1['itemname']; ?>
                </a>
                </li>
