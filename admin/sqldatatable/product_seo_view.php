...
<?php do { ?>
  ...
  <?php 
	...
	$link_edit = "manage_product.php?wshop=".$wshop."&amp;Opt=seoeditpage&amp;lang=".$_SESSION['lang']."&amp;id_edit=".$row_RecordProduct['id'];
	...
	$but_edit = "<a href='".$link_edit."' class='btn btn-xs btn-primary' style=text-align:center'><i class='fa fa-edit'></i> SEO優化關鍵字</a>";
  ...
  switch($row_RecordProduct['plot'])
	...
	$dvalue['action'] = "<div><div class='btn-group'>".$but_edit."</div>";
