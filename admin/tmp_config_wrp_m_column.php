...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Tmp")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmpmiddleminheight=%s, tmpmeger_t_m=%s, tmpmiddlepaddingtop=%s, tmpmiddlepaddingbttom=%s, tmpmiddlepaddingleft=%s, tmpmiddlepaddingright=%s, tmpmiddlefontcolor=%s WHERE id=%s",
