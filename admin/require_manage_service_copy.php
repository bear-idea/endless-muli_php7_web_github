...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_Service")) {
  $insertSQL = sprintf("INSERT INTO demo_service (title, author, type, content, postdate, indicate, sdescription, skeyword, skeywordindicate, pushtop, notes1, lang, userid) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 服務項目 <small>複增</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post">
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="title" type="text" class="form-control" id="title" value="<?php echo $row_RecordService['title']; ?>" maxlength="200" data-parsley-trigger="blur" required="" />
