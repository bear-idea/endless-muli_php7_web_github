  ...
  <?php 
    ...
    <?php if ($TmpWrpViewLineLocate == '2') { ?>               
        ...
        <section class="page-header page-header-xxs">
            <h1><!-- TemplateBeginEditable name="標題文字" --><?php echo $ModuleName[$Tp_Page]; ?><!-- TemplateEndEditable --></h1>
            <!-- TemplateBeginEditable name="導覽列" --><?php require('app/viewline/require_'.$Tp_MdName.'_viewline_mobile.php'); ?><!-- TemplateEndEditable -->
        </section>
