...
<div class="columns on-1">
		...
		<form action="<?php echo $SiteBaseUrl . url_rewrite('dealer',array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'pswfgt2'),'',$UrlWriteEnable);?>" method="post" name="LostPass" id="LostPass" onsubmit="YY_checkform('LostPass','mail','#S','2','<?php echo $Lang_Classify_Tip04; ?>');return document.MM_returnValue">
         <br />
