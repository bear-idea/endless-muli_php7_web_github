...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "TmpColumnFree")) {
  ...
  if($_POST['type'] == 'productlist' || $_POST['type'] == 'productactlist' || $_POST['type'] == 'producthotlist' || $_POST['type'] == 'productsalelist' || $_POST['type'] == 'productnewslist' || $_POST['type'] == 'modlink' || $_POST['type'] == 'frilink' || $_POST['type'] == 'articlelist' || $_POST['type'] == 'fbfan' || $_POST['type'] == 'alllist' || $_POST['type'] == 'newslist' || $_POST['type'] == 'blogplist' || $_POST['type'] == 'blogcalendar' || $_POST['type'] == 'siteviewcount' || $_POST['type'] == 'sitewhoscount' || $_POST['type'] == 'alltypelist' || $_POST['type'] == 'productsearch')
  {
	  ...
	  $updateSQLLock = sprintf("UPDATE demo_setting_fr SET %s=1 WHERE userid=%s",
	  					   GetSQLValueString($_POST['type'] . "Lock", "none"),
						   GetSQLValueString($_POST['userid'], "int"));
...
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordSettingLock = sprintf("SELECT productlistLock, productactlistLock, producthotlistLock, productsalelistLock, productnewslistLock, frilinkLock, modlinkLock, fbfanLock, articlelistLock, alllistLock, newslistLock, blogplistLock, blogcalendarLock, siteviewcountLock, sitewhoscountLock, alltypelistLock, productsearchLock FROM demo_setting_fr WHERE userid = %s", GetSQLValueString($coluserid_RecordSettingLock, "int"));
  ...
  <div class="panel-body">
    <div class="table-responsive">
        <table class="table table-hover m-b-0">
			...
			<?php do { ?>
            <?php if (
		  ($row_RecordTmpAddColumn['type'] == 'sitewhoscount' && ($row_RecordSettingLock['sitewhoscountLock'] == '1')) || 
		  ($row_RecordTmpAddColumn['type'] == 'siteviewcount' && ($row_RecordSettingLock['siteviewcountLock'] == '1')) || 
		  ($row_RecordTmpAddColumn['type'] == 'blogcalendar' && ($row_RecordSettingLock['blogcalendarLock'] == '1' OR $OptionBlogSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'blogplist' && ($row_RecordSettingLock['blogplistLock'] == '1' OR $OptionBlogSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'frilink' && ($row_RecordSettingLock['frilinkLock'] == '1' OR $OptionFrilinkSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'modlink' && ($row_RecordSettingLock['modlinkLock'] == '1')) || 
		  ($row_RecordTmpAddColumn['type'] == 'productlist' && ($row_RecordSettingLock['productlistLock'] == '1' OR $OptionProductSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'productactlist' && ($row_RecordSettingLock['productactlistLock'] == '1' OR $OptionProductSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'producthotlist' && ($row_RecordSettingLock['producthotlistLock'] == '1' OR $OptionProductSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'productsalelist' && ($row_RecordSettingLock['productsalelistLock'] == '1' OR $OptionProductSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'productnewslist' && ($row_RecordSettingLock['productnewslistLock'] == '1' OR $OptionProductSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'productsearch' && ($row_RecordSettingLock['productsearchLock'] == '1' OR $OptionProductSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'articlelist' && ($row_RecordSettingLock['articlelistLock'] == '1' OR $OptionArticleSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'alltypelist' && ($row_RecordSettingLock['alltypelistLock'] == '1')) || 
		  ($row_RecordTmpAddColumn['type'] == 'fbfan' && ($row_RecordSettingLock['fbfanLock'] == '1')) || 
		  ($row_RecordTmpAddColumn['type'] == 'alllist' && ($row_RecordSettingLock['alllistLock'] == '1')) || 
		  ($row_RecordTmpAddColumn['type'] == 'newslist' && ($row_RecordSettingLock['newslistLock'] == '1' OR $OptionNewsSelect == '0'))
		  ) { ?>
          <?php } else { ?>
