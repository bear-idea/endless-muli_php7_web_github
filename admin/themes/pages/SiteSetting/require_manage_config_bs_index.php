...
$updateSQL = sprintf("UPDATE demo_setting_fr SET SiteName=%s, SiteDecsHome=%s, SiteIndicate=%s, SiteIndicateDesc=%s, SiteCopyLock=%s, SiteAnimeCheck=%s, SiteType=%s, SiteFBFan=%s, SiteUrl=%s, SiteMail=%s, SiteAuthor=%s, SiteSName=%s, SitePhone=%s, SiteCell=%s, SiteFax=%s, SiteLINE=%s, SiteAddr=%s, SiteAddrX=%s, SiteAddrY=%s, SiteIndustryType1=%s, SiteIndustryType2=%s, SiteIndustryType3=%s, googlemaparea1=%s, googlemaparea2=%s, googlemaparea3=%s, SiteFontSize=%s, urlwriteenable=%s WHERE id=%s",
...
<div class="card bg-silver-lighter mb-10px" style="overflow:hidden">
  <div class="card-body">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 網站基本資料 <small>修改</small> <?php require($page_view_path_vendor."require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $request->getRequestUri(); ?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post">
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">網站標題名稱<span class="text-red">*</span> <i class="fa fa-info-circle text-orange" data-bs-original-title="網站標題的顯示名稱及FB顯示名稱，會影響搜尋引擎搜尋之標題。" data-bs-toggle="tooltip" data-bs-placement="top"></i></label>
          <div class="col-md-10">
                      
                      <input name="sitename" type="text" class="form-control" id="sitename" value="<?php echo $row_RecordSettingFr['SiteName']; ?>" maxlength="200" data-parsley-trigger="blur" required="" />
                      
                 
          </div>
      </div>
      <div class="form-group row">
          <label class="col-md-2 col-form-label">網站描述<span class="text-red">*</span> <i class="fa fa-info-circle text-orange" data-bs-original-title="網站基本描述，會影響搜尋引擎搜尋之摘要。" data-bs-toggle="tooltip" data-bs-placement="top"></i></label>
          <div class="col-md-10">
                      
                      <input name="SiteDecsHome" type="text" class="form-control" id="SiteDecsHome" value="<?php echo $row_RecordSettingFr['SiteDecsHome']; ?>" maxlength="300" data-parsley-trigger="blur" required="" />
                      
                 
          </div>
      </div>
      <div class="form-group row">
          <label class="col-md-2 col-form-label">網站狀態<span class="text-red">*</span> <i class="fa fa-info-circle text-orange" data-bs-original-title="會顯示提示訊息告知正在維修中。" data-bs-toggle="tooltip" data-bs-placement="top"></i></label>
          <div class="col-md-10">
          
            <div class="form-check form-check-inline">
                <input <?php if (!(strcmp($row_RecordSettingFr['SiteIndicate'],"1"))) {echo "checked=\"checked\"";} ?> class="form-check-input"  type="radio" name="SiteIndicate" id="SiteIndicate_1" value="1" />
                <label for="SiteIndicate_1">開啟</label>
            </div>
            <div class="form-check form-check-inline">
                <input <?php if (!(strcmp($row_RecordSettingFr['SiteIndicate'],"0"))) {echo "checked=\"checked\"";} ?> class="form-check-input"  type="radio" name="SiteIndicate" id="SiteIndicate_2" value="0" />
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">網站關閉狀態提示文字 <i class="fa fa-info-circle text-orange" data-bs-original-title="網站暫時關閉的提醒訊息。" data-bs-toggle="tooltip" data-bs-placement="top"></i></label>
          <div class="col-md-10">
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">網站複製與否<span class="text-red">*</span> <i class="fa fa-info-circle text-orange" data-bs-original-title="網站鎖定鍵盤和滑鼠。" data-bs-toggle="tooltip" data-bs-placement="top"></i></label>
          <div class="col-md-10">
          
            <div class="form-check form-check-inline">
                <input <?php if (!(strcmp($row_RecordSettingFr['SiteCopyLock'],"0"))) {echo "checked=\"checked\"";} ?> class="form-check-input"  type="radio" name="SiteCopyLock" id="SiteCopyLock_1" value="0" />
                <label for="SiteCopyLock_1">開啟</label>
            </div>
            <div class="form-check form-check-inline">
                <input <?php if (!(strcmp($row_RecordSettingFr['SiteCopyLock'],"1"))) {echo "checked=\"checked\"";} ?> class="form-check-input"  type="radio" name="SiteCopyLock" id="SiteCopyLock_2" value="1" />
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">網站動畫<span class="text-red">*</span> <i class="fa fa-info-circle text-orange" data-bs-original-title="網站的動畫效果。" data-bs-toggle="tooltip" data-bs-placement="top"></i></label>
          <div class="col-md-10">
          
            <div class="form-check form-check-inline">
                <input <?php if (!(strcmp($row_RecordSettingFr['SiteCopyLock'],"0"))) {echo "checked=\"checked\"";} ?> class="form-check-input"  type="radio" name="SiteAnimeCheck" id="SiteAnimeCheck_0" value="0" />
                <label for="SiteAnimeCheck_0">關閉</label>
            </div>
            <div class="form-check form-check-inline">
                <input <?php if (!(strcmp($row_RecordSettingFr['SiteCopyLock'],"1"))) {echo "checked=\"checked\"";} ?> class="form-check-input"  type="radio" name="SiteAnimeCheck" id="SiteAnimeCheck_1" value="1" />
                <label for="SiteAnimeCheck_1">隨時刷新動畫特效</label>
            </div>
            <div class="form-check form-check-inline">
                <input <?php if (!(strcmp($row_RecordSettingFr['SiteCopyLock'],"2"))) {echo "checked=\"checked\"";} ?> class="form-check-input"  type="radio" name="SiteAnimeCheck" id="SiteAnimeCheck_2" value="2" />
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">網址SEO<span class="text-red">*</span> <i class="fa fa-info-circle text-orange" data-bs-original-title="是否改變網址結構。" data-bs-toggle="tooltip" data-bs-placement="top"></i></label>
          <div class="col-md-10">
          
            <div class="form-check form-check-inline">
                <input <?php if (!(strcmp($row_RecordSettingFr['urlwriteenable'],"1"))) {echo "checked=\"checked\"";} ?> class="form-check-input"  type="radio" name="urlwriteenable" id="urlwriteenable_1" value="1" />
                <label for="urlwriteenable_1">使用</label>
            </div>
            <div class="form-check form-check-inline">
                <input <?php if (!(strcmp($row_RecordSettingFr['urlwriteenable'],"0"))) {echo "checked=\"checked\"";} ?> class="form-check-input"  type="radio" name="urlwriteenable" id="urlwriteenable_2" value="0" />
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label ">強制設定網站文字大小<span class="text-red">*</span> <i class="fa fa-info-circle text-orange" data-bs-original-title="網站整體的文字大小，強制指定時樣版設定文字大小的功能部分會失效。" data-bs-toggle="tooltip" data-bs-placement="top"></i></label>
          <div class="col-md-10">
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label ">全站分類<span class="text-red">*</span> <i class="fa fa-info-circle text-orange" data-bs-original-title="網站分類。" data-bs-toggle="tooltip" data-bs-placement="top"></i></label>
          <div class="col-md-10">
...
?>
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label ">行業別<span class="text-red">*</span> <i class="fa fa-info-circle text-orange" data-bs-original-title="設定您的行業分類。" data-bs-toggle="tooltip" data-bs-placement="top"></i></label>
          <div class="col-md-10">
          <div class="row p-10">
...
?>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SiteSName" type="text" class="form-control" id="SiteSName" value="<?php echo $row_RecordSettingFr['SiteSName']; ?>" maxlength="100" data-parsley-trigger="blur" required="" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SitePhone" type="text" id="SitePhone" value="<?php echo $row_RecordSettingFr['SitePhone']; ?>" maxlength="30" data-parsley-trigger="blur" class="form-control"/>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SiteCell" type="text" id="SitePhone" value="<?php echo $row_RecordSettingFr['SiteCell']; ?>" maxlength="15" data-parsley-trigger="blur" class="form-control"/>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SiteFax" type="text" id="SiteFax" value="<?php echo $row_RecordSettingFr['SiteFax']; ?>" maxlength="20" data-parsley-trigger="blur" class="form-control"/>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SiteAddr" type="text" id="SiteAddr" value="<?php echo $row_RecordSettingFr['SiteAddr']; ?>" size="50" maxlength="250" data-parsley-trigger="blur" class="form-control"/>
...
<div style="position:relative"><div class="" id="out" style="position:absolute;"><div id="map_canvas"></div></div></div>
      ...
      <div class="form-group row" id="Step_MapS">
          <label class="col-md-2 col-form-label">GPS座標 <i class="fa fa-info-circle text-orange" data-bs-original-title="若尚未輸入GoogleMapAPI KEY或欲更精準位置，請手動輸入。" data-bs-toggle="tooltip" data-bs-placement="top"></i></label>
          <div class="col-md-5">
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">寄送郵件Mail<span class="text-red">*</span> <i class="fa fa-info-circle text-orange" data-bs-original-title="寄送信件之顯示寄送Mail。" data-bs-toggle="tooltip" data-bs-placement="top"></i></label>
          <div class="col-md-10">
                      
                      <input name="sitemail" type="email" id="sitemail" value="<?php echo $row_RecordSettingFr['SiteMail']; ?>" size="50" maxlength="150" data-parsley-trigger="blur" class="form-control" required=""/>
                      
                 
          </div>
      </div>
      <div class="form-group row">
          <label class="col-md-2 col-form-label">寄送郵件名稱<span class="text-red">*</span> <i class="fa fa-info-circle text-orange" data-bs-original-title="寄送信件之顯示信件標題。" data-bs-toggle="tooltip" data-bs-placement="top"></i></label>
          <div class="col-md-10">
                      
                      <input name="siteauthor" type="text" id="siteauthor" value="<?php echo $row_RecordSettingFr['SiteAuthor']; ?>" size="50" maxlength="150"  data-parsley-trigger="blur" class="form-control" required=""/>
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">網站圖示 <i class="fa fa-info-circle text-orange" data-bs-original-title="FB發布後顯示的圖片以及您的網站代表圖片。" data-bs-toggle="tooltip" data-bs-placement="top"></i></label>
          <div class="col-md-10">      
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">網站小圖示 <i class="fa fa-info-circle text-orange" data-bs-original-title="顯示於網站頁簽的小圖示 附檔名為.ico。" data-bs-toggle="tooltip" data-bs-placement="top"></i></label>
          <div class="col-md-10">      
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">FB粉絲頁 <i class="fa fa-info-circle text-orange" data-bs-original-title="若您的網站有此功能則可輸入FB粉絲頁網址。" data-bs-toggle="tooltip" data-bs-placement="top"></i></label>
          <div class="col-md-10">
              <div class="input-group p-0">
