...
<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>sqldatatable/js/accounts_summonsreport_trialbalance_datatable.js"></script>
<!-- ================== END Datatables JS ================== -->
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 試算表 <small>總覽</small>
...
?>
	  ...
	  <div class="col-md-6 col-sm-12 m-b-10">
        <div class="input-group"> <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 時間</span></span>
          <input name="postdate" type="text" class="form-control search_filter" placeholder="" id="colpostdate_filter" autocomplete="off"/>
        </div>
      </div>
    ...
    <table id="data-table-default" class="table table-striped table-bordered table-hover table-condensed">
      <thead>
        <tr>
          <th width="16"></th>
          <th width="70" data-priority="1"><strong>會計項目</strong></th>
          <th width="-1" data-priority="1"><strong>項目名稱</strong></th>
          <th width="120"><strong>期初借方餘額</strong></th>
          <th width="120"><strong>期初貸方餘額</strong></th>
          <th width="120"><strong>本期借方金額</strong></th>
          <th width="120"><strong>本期借方餘額</strong></th>
          <th width="120"><strong>本期貸方金額</strong></th>
          <th width="120"><strong>本期貸方餘額</strong></th>
          <th width="120"><strong>期末借方餘額</strong></th>
          <th width="120"><strong>期末貸方餘額</strong></th>
        </tr>
      </thead>
      <tfoot>
        <tr>
