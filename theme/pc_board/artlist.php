...
<!--<script src="<?php //echo $SiteBaseUrl ?>includes/ice/ice.js" type="text/javascript"></script>-->
<!-- InstanceEndEditable -->
...
<div class="mdviewline ViewlineBoardStyle">
	...
	<div class="mdviewline_c g_p_hide">
			...
			<div class="mdviewline_c_c">
			    ...
			    <!--導覽列外框--> 
                <?php require("require_artlist_viewline.php"); ?>
                <!--導覽列外框-->
  				<!--</div>
...
<?php } ?>
        ...
        <?php
			...
			{
				case "viewpage":
					include_once("require_artlist.php");				
					break;
				case "detailed":
					include_once("require_artlist_detailed.php");				
					break;
				default:
					include_once("require_artlist.php");
					break;
