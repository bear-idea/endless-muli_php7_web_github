...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 綜合損益表 <small>選擇</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-body p-0">
    ...
    <?php //if ($totalRows_RecordYearend == 0) { // Show if recordset not empty ?>
     <form action="print_accounts_report.php?wshop=<?php echo $wshop;?>&amp;Opt=profitlosslistpage_print&amp;lang=<?php echo $_SESSION['lang']; ?>" method="post"  name="Yearend_Gen" target="_blank" class="form-horizontal form-bordered m-t-0" id="Yearend_Gen" data-parsley-validate="">
        ...
        <label class="col-md-2 col-form-label">選擇年份<span class="text-red">*</span></label>
          <div class="col-md-10">
              ...
              <div class="input-group input-daterange">
                  <input type="text" class="form-control"  name="startdate" id="startdate" value="<?php $dt = new DateTime(); echo $dt->format('Y-m-01'); ?>" data-parsley-trigger="blur" data-date-language="zh-TW" data-provide="datepicker" data-date-format="yyyy-mm-dd" autocomplete="off"/>
                  <span class="input-group-addon">to</span>
                  <input type="text" class="form-control" name="enddate" value="<?php $dt = new DateTime(); echo $dt->format('Y-m-t'); ?>" data-provide="datepicker" data-date-format="yyyy-mm-dd" id="enddate"  data-parsley-trigger="blur" data-date-language="zh-TW" autocomplete="off"/> 
              </div>
          </div>
      </div>
      ...
      <div class="form-group row">
        <label class="col-md-2 col-form-label">顯示方式<span class="text-red">*</span></label>
          <div class="col-md-10">
                    ...
                    <select name="show" id="show" class="form-control" data-parsley-trigger="blur" required="">
                		<option value="base" selected="selected">簡易</option>
                        <option value="complex">詳細</option>
        ...
        <label class="col-md-2 col-form-label">選擇紙張<span class="text-red">*</span></label>
          <div class="col-md-10">
                    ...
                    <select name="paper" id="paper" class="form-control" data-parsley-trigger="blur" required="">
                		...
                		<option value="A4-landscape" selected="selected">A4 - 橫式</option>
