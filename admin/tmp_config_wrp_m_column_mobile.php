...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Tmp")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmpmiddleminheight=%s, tmpmeger_t_m=%s, tmpmiddlepaddingtop=%s, tmpmiddlepaddingbttom=%s, tmpmiddlepaddingleft=%s, tmpmiddlepaddingright=%s, tmpmiddlefontcolor=%s, typemenubtnindicate=%s, typemenubtnbgcolor=%s, typemenubtnfontcolor=%s WHERE id=%s",
					   ...
					   GetSQLValueString($_POST['typemenubtnindicate'], "int"),
					   GetSQLValueString($_POST['typemenubtnbgcolor'], "text"),
					   GetSQLValueString($_POST['typemenubtnfontcolor'], "text"),
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post" id="form_Tmp" name="form_Tmp">
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">外框合併<span class="text-red">*</span><i class="fa fa-info-circle text-orange" data-original-title="此選項會將上方兩區塊作合併，合併時上下兩外框建議選擇同樣外觀，而此選項僅適用於由圖片組成的外框，若選擇的外框樣式是由Css所控制，即在新增區塊外框時，所新增的內容為主外框部分時，該部分的內容是不被此選項所支援的。" data-toggle="tooltip" data-placement="top"></i></label>                       	
          <div class="col-md-10">
          
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmpmeger_t_m'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpmeger_t_m" id="tmpmeger_t_m_2" value="0" />
                <label for="tmpmeger_t_m_2">不合併</label>
            </div>
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmpmeger_t_m'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpmeger_t_m" id="tmpmeger_t_m_1" value="1" />
                <label for="tmpmeger_t_m_1">合併</label>
            </div>
  	  ...
  	  <div class="form-group row">
          <label class="col-md-2 col-form-label">文字顏色<span class="text-red">*</span><i class="fa fa-info-circle text-orange" data-original-title="設為透明會沿用主框架文字顏色設定。" data-toggle="tooltip" data-placement="top"></i></label>
          <div class="col-md-9">
          ...
          <div class="col-md-1">
          	<button type="button" class="btn btn-default btn-block" id="TransparentButtom" name="TransparentButtom"><i class="fa fa-tint"></i> 設為透明</button>
          </div>
      </div>
      <div class="form-group row">
          <label class="col-md-2 col-form-label">最小高度</label>
          <div class="col-md-10">
                      <input name="tmpmiddleminheight" class="form-control" id="tmpmiddleminheight" value="<?php echo $row_RecordTmp['tmpmiddleminheight']; ?>" maxlength="5" data-parsley-min="0" data-parsley-max="9999" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">上</span></div>
                  <input name="tmpmiddlepaddingtop" class="form-control" id="tmpmiddlepaddingtop" value="<?php echo $row_RecordTmp['tmpmiddlepaddingtop']; ?>" maxlength="3" data-parsley-min="-50" data-parsley-max="50" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">下</span></div>
                  <input name="tmpmiddlepaddingbttom" class="form-control" id="tmpmiddlepaddingbttom" value="<?php echo $row_RecordTmp['tmpmiddlepaddingbttom']; ?>" maxlength="3" data-parsley-min="-50" data-parsley-max="50" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                     <div class="input-group-append"><span class="input-group-text">px</span></div>                 
              </div>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">左</span></div>
                  <input name="tmpmiddlepaddingleft" class="form-control" id="tmpmiddlepaddingleft" value="<?php echo $row_RecordTmp['tmpmiddlepaddingleft']; ?>" maxlength="3" data-parsley-min="-50" data-parsley-max="50" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                  <div class="input-group-append"><span class="input-group-text">px</span></div>                    
              </div>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">右</span></div>
                  <input name="tmpmiddlepaddingright" class="form-control" id="tmpmiddlepaddingright" value="<?php echo $row_RecordTmp['tmpmiddlepaddingright']; ?>" maxlength="3" data-parsley-min="-50" data-parsley-max="50" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                    <div class="input-group-append"><span class="input-group-text">px</span></div>                  
              </div>
       ...
       <div class="form-group row">
        <label class="col-md-12 col-form-label d-block d-sm-none"></label>
        <div class="col-md-12"><span class="badge badge-primary"><i class="fa fa-paper-plane"></i> 分類標籤</span></div>
      </div>
      <div class="form-group row">
          <label class="col-md-2 col-form-label">是否顯示<span class="text-red">*</span><i class="fa fa-info-circle text-orange" data-original-title="若有多層分類，標籤僅會顯示首層。" data-toggle="tooltip" data-placement="top"></i></label>                       	
          <div class="col-md-10">
          
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['typemenubtnindicate'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="typemenubtnindicate" id="typemenubtnindicate_2" value="0" />
                <label for="typemenubtnindicate_2">不顯示</label>
            </div>
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['typemenubtnindicate'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="typemenubtnindicate" id="typemenubtnindicate_1" value="1" />
                <label for="typemenubtnindicate_1">顯示</label>
            </div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
          		<div class="input-group colorpicker-component colorpicker-element">				
                   <input name="typemenubtnbgcolor" type="text" required class="form-control colorpicker-element" id="typemenubtnbgcolor" value="<?php echo $row_RecordTmp['typemenubtnbgcolor']; ?>" maxlength="20" data-parsley-errors-container="#error_typemenubtnbgcolor" data-parsley-trigger="blur"/>
                   <span class="input-group-addon"><i style="background-color: rgb(64, 18, 18);"></i></span>
              </div>
              <div id="error_typemenubtnbgcolor"></div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
          		<div class="input-group colorpicker-component colorpicker-element">				
                   <input name="typemenubtnfontcolor" type="text" required class="form-control colorpicker-element" id="typemenubtnfontcolor" value="<?php echo $row_RecordTmp['typemenubtnfontcolor']; ?>" maxlength="20" data-parsley-errors-container="#error_typemenubtnfontcolor" data-parsley-trigger="blur"/>
                   <span class="input-group-addon"><i style="background-color: rgb(64, 18, 18);"></i></span>
              </div>
              <div id="error_typemenubtnfontcolor"></div>
