...
<div style="padding:10px; margin:10px; position:relative;" id="wrapper_config">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="TB_General_style01">
    <tr>
      <td colspan="2"><i class="fa fa-chevron-right" style="color:#F00"></i> <strong><?php echo $ModuleName['Product']; ?>：</strong></td>
      </tr>
       <tr>
      ...
      <td><table width="600">
          <tr>
            ...
            <td width="65" style="border-bottom-width:0px;"><img src="images/col1.jpg" alt="" width="60" height="60" /></td>
            <td style="border-bottom-width:0px;">&nbsp;</td>
          </tr>
          <tr>
            <td style="border-bottom-width:0px;"><label>
              <input <?php if (!(strcmp($row_RecordTmp['tmpproductviewcolumn'],"4"))) {echo "checked=\"checked\"";} ?> name="tmpproductviewcolumn" type="radio" id="RadioGroup1_1" value="4" checked="checked" />
              風格1</label></td>
            <td style="border-bottom-width:0px;"><input <?php if (!(strcmp($row_RecordTmp['tmpproductviewcolumn'],"3"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpproductviewcolumn" value="3" id="RadioGroup1_2" />
風格2</td>
            <td style="border-bottom-width:0px;"><input <?php if (!(strcmp($row_RecordTmp['tmpproductviewcolumn'],"2"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpproductviewcolumn" value="2" id="RadioGroup1_3" />
風格3</td>
            <td style="border-bottom-width:0px;"><p>
              <input <?php if (!(strcmp($row_RecordTmp['tmpproductviewcolumn'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpproductviewcolumn" value="1" id="RadioGroup1_4" />
              風格4</p></td>
            <td style="border-bottom-width:0px;">&nbsp;</td>
          </tr>
        </table></td>
    ...
    <tr>
      ...
      <select name="tmpproductboard" id="tmpproductboard">
        <option value="none" <?php if (!(strcmp("none", $row_RecordTmp['tmpproductboard']))) {echo "selected=\"selected\"";} ?>>不使用</option>
    ...
    <tr>
     ...
     <tr>
      <td align="right">圖片顯示方式：</td>
      <td><table width="600">
          <tr>
            <td width="65" style="border-bottom-width:0px;"><img src="images/imgmd01.jpg" width="60" height="60" /></td>
            <td width="65" style="border-bottom-width:0px;"><img src="images/imgmd02.jpg" width="60" height="60" /></td>
          ...
          <tr>
            <td style="border-bottom-width:0px;"><label>
              <input <?php if (!(strcmp($row_RecordTmp['tmpproductimagemethods'],"resize"))) {echo "checked=\"checked\"";} ?> name="tmpproductimagemethods" type="radio" id="RadioGroup1_1" value="resize" checked="checked" />
              縮放</label></td>
            <td style="border-bottom-width:0px;"><input <?php if (!(strcmp($row_RecordTmp['tmpproductimagemethods'],"crop"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpproductimagemethods" value="crop" id="RadioGroup1_2" />
裁切</td>
            <td style="border-bottom-width:0px;">&nbsp;</td>
            <td style="border-bottom-width:0px;"><p>&nbsp;</p></td>
            <td style="border-bottom-width:0px;">&nbsp;</td>
          </tr>
        </table></td>
    </tr>
    <tr>
      <td align="right">圖片顯示外框：</td>
      <td><table width="600">
          <tr>
            <td width="65" style="border-bottom-width:0px;"><img src="images/img_board01.jpg" width="60" height="60" /></td>
            <td width="65" style="border-bottom-width:0px;"><img src="images/img_board02.jpg" width="60" height="60" /></td>
            <td width="65" style="border-bottom-width:0px;">&nbsp;</td>
            <td width="65" style="border-bottom-width:0px;">&nbsp;</td>
            <td style="border-bottom-width:0px;">&nbsp;</td>
          </tr>
          <tr>
            <td style="border-bottom-width:0px;"><label>
              <input <?php if (!(strcmp($row_RecordTmp['tmpproductimageboard'],"0"))) {echo "checked=\"checked\"";} ?> name="tmpproductimageboard" type="radio" id="RadioGroup1_1" value="0" checked="checked" />
              方型</label></td>
            <td style="border-bottom-width:0px;"><input <?php if (!(strcmp($row_RecordTmp['tmpproductimageboard'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpproductimageboard" value="1" id="RadioGroup1_2" />
矩形</td>
            <td style="border-bottom-width:0px;">&nbsp;</td>
            <td style="border-bottom-width:0px;"><p>&nbsp;</p></td>
            <td style="border-bottom-width:0px;">&nbsp;</td>
