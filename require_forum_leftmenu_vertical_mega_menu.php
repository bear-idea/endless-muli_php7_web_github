...
$query_RecordMultiLeftMenu_l1 = sprintf("SELECT * FROM demo_forumitem WHERE list_id = 1 && lang = %s && level = '0' && indicate = '1' && userid=%s ORDER BY sortid ASC, item_id DESC", GetSQLValueString($collang_RecordMultiLeftMenu_l1, "text"),GetSQLValueString($coluserid_RecordMultiLeftMenu_l1, "int"));
...
<div class="dcjq-vertical-mega-menu">
        ...
        <?php do { ?>
            ...
            <?php if ($row_RecordMultiLeftMenu_l1['endnode'] != 'child') { ?>
            	<a href="forum.php?Opt=maintypepage&lang=<?php echo $_SESSION['lang']; ?>&tp=Forum&level=<?php echo $row_RecordMultiLeftMenu_l1['level']; ?>&type1=<?php echo $row_RecordMultiLeftMenu_l1['item_id']; ?>&subitem_id=<?php echo $row_RecordMultiLeftMenu_l1['subitem_id']; ?>"><?php echo $row_RecordMultiLeftMenu_l1['itemname']; ?></a>
			<?php } else { ?>
                 <a href="forum.php?Opt=typepage&navi=<?php echo $_GET['navi']; ?>&lang=<?php echo $_SESSION['lang']; ?>&mtype=Forum&level=<?php echo $row_RecordMultiLeftMenu_l1['level']; ?>&type1=<?php echo $row_RecordMultiLeftMenu_l1['item_id']; ?>&subitem_id=<?php echo $row_RecordMultiLeftMenu_l1['subitem_id']; ?>"><?php echo $row_RecordMultiLeftMenu_l1['itemname']; ?></a>
            <?php }  ?>
...
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordMultiLeftMenu_l2 = sprintf("SELECT * FROM demo_forumitem WHERE list_id = 1 && lang = %s && level = '1' && subitem_id = %s && indicate = '1' && userid=%s ORDER BY sortid ASC, item_id DESC", GetSQLValueString($collang_RecordMultiLeftMenu_l2, "text"),GetSQLValueString($colsubitem_id_RecordMultiLeftMenu_l2, "int"),GetSQLValueString($coluserid_RecordMultiLeftMenu_l2, "int"));
...
$totalRows_RecordMultiLeftMenu_l2 = mysqli_num_rows($RecordMultiLeftMenu_l2);
                    ...
                    <?php if ($row_RecordMultiLeftMenu_l2['endnode'] != 'child') { ?>
                    	<a href="forum.php?Opt=maintypepage&lang=<?php echo $_SESSION['lang']; ?>&tp=Forum&level=<?php echo $row_RecordMultiLeftMenu_l2['level']; ?>&type1=<?php echo $row_RecordMultiLeftMenu_l1['item_id']; ?>&type2=<?php echo $row_RecordMultiLeftMenu_l2['item_id']; ?>&subitem_id=<?php echo $row_RecordMultiLeftMenu_l2['subitem_id']; ?>"><strong><?php echo $row_RecordMultiLeftMenu_l2['itemname']; ?></strong></a>
                    <?php } else { ?>
                    <a href="forum.php?Opt=typepage&lang=<?php echo $_SESSION['lang']; ?>&tp=Forum&level=<?php echo $row_RecordMultiLeftMenu_l2['level']; ?>&type1=<?php echo $row_RecordMultiLeftMenu_l1['item_id']; ?>&type2=<?php echo $row_RecordMultiLeftMenu_l2['item_id']; ?>&subitem_id=<?php echo $row_RecordMultiLeftMenu_l2['subitem_id']; ?>"><?php echo $row_RecordMultiLeftMenu_l2['itemname']; ?></a>
                    <?php } ?>
...
$totalRows_RecordMultiLeftMenu_l3 = mysqli_num_rows($RecordMultiLeftMenu_l3);
						...
						<?php do { ?>
                    	  ...
                    	  <?php } else { ?>
                            <a href="forum.php?Opt=typepage&lang=<?php echo $_SESSION['lang']; ?>&tp=Forum&level=<?php echo $row_RecordMultiLeftMenu_l3['level']; ?>&type1=<?php echo $row_RecordMultiLeftMenu_l1['item_id']; ?>&type2=<?php echo $row_RecordMultiLeftMenu_l2['item_id']; ?>&type3=<?php echo $row_RecordMultiLeftMenu_l3['item_id']; ?>&subitem_id=<?php echo $row_RecordMultiLeftMenu_l3['subitem_id']; ?>"><?php echo $row_RecordMultiLeftMenu_l3['itemname']; ?></a>
                            <?php } ?>
                          </li>
