...
#v_out_wrp_c{width:1200px; border:#CCC dashed 1px; margin-left:auto; margin-right:auto; color:#090}
#v_out_wrp{width:1200px; border:#CCC dashed 1px; margin-left:auto; margin-right:auto;}
...
#v_wrp{width:800px; margin-left:auto; margin-right:auto; margin-top:10px; border:#CCC dotted 1px; position:relative; padding-right:20px; padding-bottom:20px; padding-top:20px; padding-left:20px; background-position:center center; background-repeat:no-repeat}

#v_wrp:hover{border:1px dashed #C30}
#v_wrp_header{border:#CCC dotted 1px; margin:5px; position:relative; min-height:230px; margin-top:100px;}
...
#v_wrp_header_menu{color:#CCC; font-size:30px; font-weight:bolder; padding:10px; position:absolute; right:10px; top:5px; border:#CCC dashed 1px; width:430px; height:115px}
...
#v_wrp_r_column{border:#CCC dotted 1px; margin:5px; float:right; width:200px; position:relative; min-height:700px}
#v_wrp_r_column:hover{border:#C30 dotted 1px}
.v_wrp_r_column_board_style{border:1px #CCC dotted; position:relative; margin:5px}
#v_wrp_r_column_wrp_board_style:hover .v_wrp_l_column_board_style{border:#C30 dotted 1px}
#v_wrp_r_column_menu_style{border:1px #CCC dotted; position:relative; margin:5px; height:210px}
#v_wrp_r_column_menu_style:hover{border:#C30 dotted 1px}
#v_wrp_middle{border:#CCC dashed 1px; margin:5px; margin-left:215px; position:relative; min-height:700px; margin-right:215px;}
...
#v_wrp_md{width:800px; margin-left:auto; margin-right:auto; margin-top:10px; margin-bottom:100px; border:#CCC dashed 1px; position:relative; padding-right:20px; padding-bottom:20px; padding-top:5px; padding-left:20px; background-position:center center; background-repeat:no-repeat; min-height:250px}
    ...
    <tr>
      <td>
       ...
       <div id="v_out_wrp">
        ...
        <div id="v_wrp_header">
        <span style="position: absolute; top: -80px; left: -160px; border: #CCC dotted 1px; padding: 5px;"><img src="images/sty08.jpg" width="100" height="100" /><br />
        ...
        <a href="tmpheaderbackground_home.php?id=<?php echo $row_RecordTmp['id']; ?>&amp;type=拼貼材質" data-original-title="選擇您要更換的背景" data-toggle="tooltip" data-placement="right" class="btn btn-primary btn-xs btn-block">背景選擇</a>
       	...
       	<div id="v_wrp"><span style="position: absolute; top: 57px; right: -259px;">
        	<img src="images/z_line_e_f.png" width="276" height="123" /> 
        </span>
        <span style="margin-right: 5px; margin-top: 5px; padding: 5px; border: #CCC dotted 1px;  position: absolute; top: -5px; right: -327px;" id="Step_WrpBoard">
        <iframe src="tmp_config_board_view.php?id=<?php echo $row_RecordTmp['tmpwrpboard']  ?>" width="102" marginwidth="0" height="102" marginheight="0" scrolling="no" frameborder="0"></iframe><br />
        <a href="tmpwrpboard_home.php?id=<?php echo $row_RecordTmp['id']; ?>" data-original-title="選擇您要更換的外框" data-toggle="tooltip" data-placement="right" class="btn btn-primary btn-xs btn-block">外框選擇</a>
        </span>
        <!--獨立背景-->
        <span style="margin-right: 5px; margin-top: 150px; padding: 5px; border: #CCC dotted 1px;  position: absolute; top: -1px; right: -327px;">
        ...
        <a href="tmpwrpbackground_home.php?id=<?php echo $row_RecordTmp['id']; ?>&amp;type=拼貼材質" data-original-title="選擇您要更換的背景" data-toggle="tooltip" data-placement="right" class="btn btn-primary btn-xs btn-block">背景選擇</a>
            	...
            	<div style="color: #CCC; font-size: 30px; font-weight: bolder; padding: 10px; position: absolute; left: -36px; top: -41px;" id="Step_Wrp">主框架<span style="font-size:16px;"> <a href="tmp_config_wrp.php?id_edit=<?php echo $row_RecordTmp['id']; ?>" data-original-title="您可在此設定整體網站的文字顏色、超連結顏色、文字大小" data-toggle="tooltip" data-placement="right" class="btn btn-info btn-circle btn-xs" >更多設定 <i class="fa fa-chevron-circle-right"></i></a></span></div>
            	<div id="v_wrp_banner">
            	  <span style="position: absolute; top: 65px; left: -31px;">
            	    <img src="images/z_line_c.png" width="36" height="1" /> 
            	    </span>
            	  <span style="margin-left: 5px; margin-top: 5px; padding: 5px; border: #CCC dotted 1px; height: 125px; position: absolute; top: 3px; left: -150px;">
            	    <iframe src="tmp_config_board_view.php?id=<?php echo $row_RecordTmp['tmpbannerboard']  ?>" width="102" marginwidth="0" height="102" marginheight="0" scrolling="no" frameborder="0"></iframe><br />
                <a href="tmpbannerboard_home.php?id=<?php echo $row_RecordTmp['id']; ?>" data-original-title="選擇您要更換的外框，此外框可和內文區塊外框作合併，但合併時建議外框選擇同樣式" data-toggle="tooltip" data-placement="right" class="btn btn-primary btn-xs btn-block">外框選擇</a>
                </span>
        ...
        <a href="tmpleftbackground_home.php?id=<?php echo $row_RecordTmp['id']; ?>&amp;type=拼貼材質" data-original-title="選擇您要更換的背景" data-toggle="tooltip" data-placement="right" class="btn btn-primary btn-xs btn-block">背景選擇</a>
            ...
            <div id="v_wrp_r_column">
            <div id="v_wrp_r_column_wrp_board_style">
            <div class="v_wrp_r_column_board_style" style="height:280px;">
            <div id="v_wrp_r_column_menu_style">
            <!--獨立選單-->
            <span style="color: #CCC; font-size:30px; font-weight:bolder; padding:5px; position: absolute; right: 0px; bottom: 0px;">選單樣式</span>
            </div>
            <span style="color: #CCC; font-size:24px; font-weight:bolder; padding:5px; position: absolute; right: 0px; bottom: 0px;">側邊裝飾外框</span>
            ...
            <span style="position: absolute; top: 10px; right: -272px;">
        	<img src="images/z_line_c.png" width="282" height="1" /> 
        </span>
        <span style="margin-left: 5px; margin-top: 5px; padding: 5px; border: #CCC dotted 1px; position: absolute; top: -50px; right: -385px;" id="Step_ViewLine">
            ...
            <div id="v_wrp_middle_title">
            	<div id="v_wrp_middle_title_sicon"><span style="color: #CCC; font-size:20px; font-weight:bolder; padding:2px; position: absolute; right: 5px; top: 5px;">
            	  小圖示</span></div>
                <!--獨立背景-->
                <span style="margin-right: 5px; margin-top: 150px; padding: 5px; border: #CCC dotted 1px; position: absolute; top: 57px; right: -389px;">
        ...
        <a href="tmptitlebackground_home.php?id=<?php echo $row_RecordTmp['id']; ?>&amp;type=標題圖示" data-original-title="選擇您要更換的圖示" data-toggle="tooltip" data-placement="right" class="btn btn-primary btn-xs btn-block">圖示選擇</a>
            	...
            	<!--獨立外框-->
                 <span style="position: absolute; top: 104px; right: -190px;">
        	<img src="images/z_line_c.png" width="200" height="1" /> 
        </span>
                <span style="position: absolute; top: 115px; right: -320px;">
        	<img src="images/z_line_f.png" width="130" height="123" /> 
        </span>
                <span style="margin-left: 5px; margin-top: 5px; padding: 5px; border: #CCC dotted 1px;  position: absolute; top: 53px; right: -385px;" id="Step_Title">
            ...
            <div id="v_wrp_middle_content">
            	...
            	<span style="color: #CCC; font-size:30px; font-weight:bolder; padding:10px; position: absolute; right: 5px; bottom: 5px; text-align:right;" id="Step_ContentOther"><span style="font-size:16px;"> <a href="tmp_config_wrp_m_column.php?id_edit=<?php echo $row_RecordTmp['id']; ?>" data-original-title="您可在此設定此區塊內之兩區塊是否合併、區塊最小高度" data-toggle="tooltip" data-placement="right" class="btn btn-info btn-circle btn-xs">更多設定 <i class="fa fa-chevron-circle-right"></i></a></span><br />
            	中央區塊</span>
                <!--獨立背景-->
        <span style="margin-left: 5px; margin-top: 80px; padding: 5px; border: #CCC dashed 1px;  position: absolute; bottom: 5px;">
