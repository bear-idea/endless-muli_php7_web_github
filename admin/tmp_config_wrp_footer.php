...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Tmp")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmpfooterminheight=%s, tmpfooterpaddingtop=%s, tmpfooterpaddingbttom=%s, tmpfooterpaddingleft=%s, tmpfooterpaddingright=%s, tmpfooterfontcolor=%s WHERE id=%s",
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post" id="form_Tmp" name="form_Tmp">
      <div class="form-group row">
        ...
        <div class="col-md-12"><span class="badge badge-primary"><i class="fa fa-paper-plane"></i> 頁尾區塊</span></div>
      </div>
  	  <div class="form-group row">
          ...
          <div class="col-md-10">
          		<div class="input-group colorpicker-component colorpicker-element">				
                   <input name="tmpfooterfontcolor" type="text" required class="form-control colorpicker-element" id="tmpfooterfontcolor" value="<?php echo $row_RecordTmp['tmpfooterfontcolor']; ?>" maxlength="20" data-parsley-errors-container="#error_tmpfooterfontcolor" data-parsley-trigger="blur"/>
                   <span class="input-group-addon"><i style="background-color: rgb(64, 18, 18);"></i></span>
              </div>
              <div id="error_tmpfooterfontcolor"></div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      <input name="tmpfooterminheight" class="form-control" id="tmpfooterminheight" value="<?php echo $row_RecordTmp['tmpfooterminheight']; ?>" maxlength="5" data-parsley-min="0" data-parsley-max="9999999" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">上</span></div>
                  <input name="tmpfooterpaddingtop" class="form-control" id="tmpfooterpaddingtop" value="<?php echo $row_RecordTmp['tmpfooterpaddingtop']; ?>" maxlength="3" data-parsley-min="-50" data-parsley-max="50" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">下</span></div>
                  <input name="tmpfooterpaddingbttom" class="form-control" id="tmpfooterpaddingbttom" value="<?php echo $row_RecordTmp['tmpfooterpaddingbttom']; ?>" maxlength="3" data-parsley-min="-50" data-parsley-max="50" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                     <div class="input-group-append"><span class="input-group-text">px</span></div>                 
              </div>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">左</span></div>
                  <input name="tmpfooterpaddingleft" class="form-control" id="tmpfooterpaddingleft" value="<?php echo $row_RecordTmp['tmpfooterpaddingleft']; ?>" maxlength="3" data-parsley-min="-50" data-parsley-max="50" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                  <div class="input-group-append"><span class="input-group-text">px</span></div>                    
              </div>
          ...
          <div class="col-md-2">
            <div class="input-group p-0">
              ...
              <div class="input-group-prepend"><span class="input-group-text">右</span></div>
                  <input name="tmpfooterpaddingright" class="form-control" id="tmpfooterpaddingright" value="<?php echo $row_RecordTmp['tmpfooterpaddingright']; ?>" maxlength="3" data-parsley-min="-50" data-parsley-max="50" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1"/>
                    <div class="input-group-append"><span class="input-group-text">px</span></div>                  
              </div>
