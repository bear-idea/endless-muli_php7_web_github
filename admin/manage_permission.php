...
<link href="<?php if($SiteBaseUrlOuter != "") { echo $SiteBaseUrlOuter . $SiteBaseAdminPath; } else { echo $SiteBaseUrl . $SiteBaseAdminPath; } ?>assets/plugins/sumoselect/sumoselect.min.css" rel="stylesheet" />
<script src="<?php if($SiteBaseUrlOuter != "") { echo $SiteBaseUrlOuter . $SiteBaseAdminPath; } else { echo $SiteBaseUrl . $SiteBaseAdminPath; } ?>assets/plugins/sumoselect/jquery.sumoselect.min.js"></script>
<!-- InstanceEndEditable -->
</head>
<body>
...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require("require_leftmainmenu_permission.php");?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include("require_manage_permission_index.php");			
					break;
				case "rulepage":
					include("require_manage_permission_rule.php");			
					break;
				case "addpage":
					include("require_manage_permission_add.php");
					break;
				case "editpage":
					include("require_manage_permission_edit.php"); 
					break;
				case "addpage_rule":
					include("require_manage_permission_add_rule.php");
					break;
				case "editpage_rule":
					include("require_manage_permission_edit_rule.php"); 
					break;
				case "listpage":
					include("require_manage_permission_list.php");
					break;
				case "listitempage":
					include("require_manage_permission_listitem.php");
					break;
				case "listitempage_group":
					include("require_manage_permission_listitem_group.php");
					break;
				default:
					include("require_manage_permission_index.php");
					break;
