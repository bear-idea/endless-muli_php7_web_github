...
橫幅區塊</span>
            ...
            <div id="v_wrp_middle">
              <div class="v_md"><img src="images/mt_026.png" width="60" height="60" /><br />
          		<a href="#" data-original-title="" data-toggle="tooltip" data-placement="right" class="btn btn-white btn-xs btn-block disabled"><?php echo $ModuleName['Partner']; ?></a></div><span style="color: #CCC; font-size:30px; font-weight:bolder; padding:10px; position: absolute; right: 5px; bottom: 5px;"><br />
            	模組區塊</span>
                <!--獨立背景-->
            </div>
