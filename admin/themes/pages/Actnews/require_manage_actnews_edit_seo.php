...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Actnews")) {
  ...
  $updateSQL = sprintf("UPDATE demo_actnews SET title=%s, sdescription=%s, skeyword=%s, ogtitle=%s, ogtype=%s, ogurl=%s, ogimage=%s, ogdescription=%s, notes1=%s, lang=%s WHERE id=%s",
  ...
  $updateGoTo = "manage_actnews.php?Opt=seo&lang=" . $_POST['lang'];
  /*if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <form action="<?php echo $request->getRequestUri(); ?><?php echo '&amp;GP_upload=true'; ?>" class="form-horizontal form-bordered" data-parsley-validate="" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="ogtitle" type="text" class="form-control" id="ogtitle" value="<?php echo $row_RecordActnews['ogtitle']; ?>" maxlength="200" data-parsley-trigger="blur" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="ogtype" type="text" class="form-control" id="ogtype" value="<?php echo $row_RecordActnews['ogtype']; ?>" maxlength="200" data-parsley-trigger="blur" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="ogurl" type="url" class="form-control" id="ogurl" value="<?php echo $row_RecordActnews['ogurl']; ?>" maxlength="200" data-parsley-trigger="blur" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                 <input name="ogdescription" type="text" class="form-control" id="ogdescription" value="<?php echo $row_RecordActnews['ogdescription']; ?>" size="100" maxlength="150"/> 
          </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-10">
          <button type="submit" class="btn btn btn-primary w-100 btn-block">送出</button>
            ...
            <input name="oldpic" type="hidden" id="oldpic" value="<?php echo $row_RecordActnews['ogimage']; ?>" />
          </div>
      </div>
...
$(document).ready(function() {
	$("#ogimage").fileinput({
		...
		<?php if($row_RecordActnews['ogimage'] != "") { ?>
		initialPreview: [<?php echo "'" . $SiteImgUrlAdmin . $wshop ."/image/seo/" . $row_RecordActnews['ogimage'] .  "'"; ?>],
		initialPreviewConfig: [<?php echo "{url: 'sqldatatable/actnews_seophoto_del.php?id_del=".$row_RecordActnews['id']."', key: ".$row_RecordActnews['id'].", extra: {id:".$row_RecordActnews['id']."} }"; ?>],
		<?php } ?>
