...
<div class="panel panel-inverse bg-white-transparent-9">
    <div class="panel-heading">
        ...
        <div class="btn-group float-end mr-10px"><a href="<?php echo ADMINURL . generateUrl('/'.toSpinalCase($useModuleUri).'/list', $parameters); ?>" data-bs-original-title="" data-bs-toggle="tooltip" data-bs-placement="top" class="text-nowrap btn btn-default btn-sm"><i class="fa fa-reply fa-fw"></i> 清單設定</a></div>
        <?php require($page_view_path_vendor . "require_panel_heading_btn.php"); ?>
    </div>
    <div class="panel-body">
        <?php if ($RecordListItemMenu->count() > 0) { // Show if recordset not empty ?>
            <form id="form_ListItemMenuEdit" name="form_ListItemMenuEdit" method="POST" action="<?php echo $request->getRequestUri(); ?>" class="form-horizontal form-bordered" data-parsley-validate>
                <div id="card_sortable">
                    <?php foreach ($RecordListItemMenu as $row_RecordListItemMenu) { ?>
                        <div class="widget-card bg-cyan-transparent-1"
                             data-post-id="<?php echo $row_RecordListItemMenu['id']; ?>">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group row">
                                            <div class="input-group px-0 py-5px">
                                                ...
                                                <input name="itemname[]" type="text" value="<?php echo $row_RecordListItemMenu['itemname']; ?>" class="form-control" data-parsley-trigger="blur" required/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group row">
                                            <div class="input-group px-0 py-5px">
                                                ...
                                                <input name="sortid[]" type="number" value="<?php echo $row_RecordListItemMenu['sortid']; ?>" class="form-control" maxlength="10" data-parsley-trigger="blur" required/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group row">
                                            <div class="input-group px-0 py-5px">
                                                ...
                                                <select class="form-control form-select" name="indicate[]">
                                                    <option <?php if ($row_RecordListItemMenu['indicate'] == 1) {echo 'selected';} ?> value="1">顯示</option>
                                                    <option <?php if ($row_RecordListItemMenu['indicate'] == 0) {echo 'selected';} ?> value="0">隱藏</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="input-group px-0 py-5px">
                                                <div class="checkbox checkbox-css">
                                                    <input name="delId[]" class="form-check-input" type="checkbox" id="delId_<?php echo $row_RecordListItemMenu['id']; ?>" value="<?php echo $row_RecordListItemMenu['id']; ?>"/>
                                                    <label class="form-check-label" for="delId_<?php echo $row_RecordListItemMenu['id']; ?>">是否刪除</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group row">
                                            <div class="input-group px-0 py-5px">
                                                ...
                                                <input name="id[]" type="hidden" value="<?php echo $row_RecordListItemMenu['id']; ?>"/>
                                                <input name="list_id[]" type="hidden" value="<?php echo $row_RecordListItemMenu['list_id']; ?>"/>
                                                <input name="lang[]" type="hidden" value="<?php echo $row_RecordListItemMenu['lang']; ?>"/>
