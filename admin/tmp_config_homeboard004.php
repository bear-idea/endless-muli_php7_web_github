       ...
       <div id="v_out_wrp">
        ...
        <div id="v_wrp"><!--獨立外框--><!--獨立背景--><!--獨立背景-->
          <div style="color: #CCC; font-size: 30px; font-weight: bolder; padding: 10px; position: absolute; left: -36px; top: -41px;">主框架</div>
            ...
            <div id="v_wrp_banner">
            	<span style="color: #CCC; font-size:30px; font-weight:bolder; padding:10px; position: absolute; right: 5px; bottom: 5px;"><br />
            	<span style="font-size:16px;"><a href="tmp_config_homeboard_banner.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>" data-original-title="您可在此設定橫幅的類型" data-toggle="tooltip" data-placement="right">(更多設定)</a></span><br />
橫幅區塊</span>
            </div>
            <div style="position:relative; float:right; width:100%; margin-left:-215px; margin-right:0px;">
              <div id="v_wrp_middle">
                <div class="v_md"><img src="images/mt_060.png" width="60" height="60" /><br />
          		<a href="#" data-toggle="tooltip" data-placement="right">功能區塊</a>
                <div style="position: absolute; top: 64px; left: 81px;">
                <?php if ($LangChooseEN == '1') { ?>
                <span class = "InnerPage"><a href="tmp_config_homeboard004_block_en.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=en"  data-original-title="英文設定" data-toggle="tooltip" data-placement="top"><i class="fa fa-tachometer"></i>英</a></span>
                <?php } ?>
                <?php if ($LangChooseZHCN == '1') { ?>
                <span class = "InnerPage"><a href="tmp_config_homeboard004_block_cn.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=zh-cn"  data-original-title="簡體設定" data-toggle="tooltip" data-placement="top"><i class="fa fa-tachometer"></i>簡</a></span>
                <?php } ?>
                <span class = "InnerPage"><a href="tmp_config_homeboard004_block.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=zh-tw"  data-original-title="繁體設定" data-toggle="tooltip" data-placement="top"><i class="fa fa-tachometer"></i>繁</a></span>
                </div>
