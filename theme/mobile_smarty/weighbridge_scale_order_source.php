<script language="javascript" src="/admin/js/tableExport.js"></script>
<!--標題外框-->
<div style="position:relative;">
  ...
  <!--標題外框--> 
        ...
        <div class="ct_title">
          <h1 style="font-size:large"><?php if($TmpTitleBgImage != ''){ ?><span class="titlesicon" data-scroll-reveal="enter top"><img src="<?php if($SiteBaseUrlOuter != "" && $TmpTitleBgWebName == 'playweb') { echo $SiteImgUrlOuter; } else { echo $SiteImgUrl; } ?><?php echo $TmpTitleBgWebName; ?>/image/tmpbackground/<?php echo $TmpTitleBgImage; ?>" /></span><?php } ?> <span class="titlesicon" data-scroll-reveal="enter right">現有庫存查詢</span></h1>
                </div>
...
<form id="form_Scaleorder" name="form_Scaleorder" method="post" action="<?php echo $SiteBaseUrl . url_rewrite('weighbridge',array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'order_source'),'',$UrlWriteEnable);?>">
 ...
 <div class="row">
	...
	<input name="startdate" type="text" class="form-control datepicker" id="postdate" value="" data-format="yyyy-mm-dd" data-from="<?php echo date("Y")?>-01-01" data-to="<?php echo date("Y")?>-12-31" data-lang="zh" data-RTL="false" placeholder="開始日期">
    ...
    <input name="enddate" type="text" class="form-control datepicker" id="postdate" value="" data-format="yyyy-mm-dd" data-from="<?php echo date("Y")?>-01-01" data-to="<?php echo date("Y")?>-12-31" data-lang="zh" data-RTL="false" placeholder="結束日期">
	...
	<!-- range picker -->
                ...
                <input name="Opt" type="hidden" id="Opt" value="order_source" />
...
foreach ($_POST['scale_bk'] as $value) {
	...
	$query_RecordScaleGet = sprintf("SELECT * FROM erp_scalesource WHERE code = %s && userid=%s", GetSQLValueString($value, "text"),GetSQLValueString($_SESSION['userid'], "int"));
...
<?php } ?>
                      ...
                      <td valign="top"><?php echo $row_RecordScale['warehouse']; ?></td>
                      ...
                      <td valign="top"><?php echo $row_RecordScale['num']; ?></td>
