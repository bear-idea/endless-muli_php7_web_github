...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> <?php echo $ModuleName['Product']; ?> <small>複增</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                    ...
                    <select name="type1" id="type1" class="form-control col-md-4" style="display:inline-block" data-parsley-trigger="blur" required="">
                      <option value="" <?php if (!(strcmp(-1, $row_RecordProduct['type1']))) {echo "selected=\"selected\"";} ?>>-- 選擇分類 --</option>
                      <?php
do {  
?>
                      <option value="<?php echo $row_RecordProductListType['item_id']?>"<?php if (!(strcmp($row_RecordProductListType['item_id'], $row_RecordProduct['type1']))) {echo "selected=\"selected\"";} ?>><?php echo $row_RecordProductListType['itemname']?></option>
                      <?php
...
?>
                    ...
                    <select name="type2" id="type2" class="form-control col-md-4" style="display:inline-block">
                      <option value="-1" <?php if (!(strcmp(-1, $row_RecordProductListType['item_id']))) {echo "selected=\"selected\"";} ?>>-- 選擇分類2 --</option>
                      <?php
do {  
?>
                      <option value="<?php echo $row_RecordProductListType['item_id']?>"<?php if (!(strcmp($row_RecordProductListType['item_id'], $row_RecordProductListType['item_id']))) {echo "selected=\"selected\"";} ?>><?php echo $row_RecordProductListType['itemname']?></option>
<?php
} while ($row_RecordProductListType = mysqli_fetch_assoc($RecordProductListType));
  $rows = mysqli_num_rows($RecordProductListType);
  if($rows > 0) {
...
?>
                    ...
                    <select name="type3" id="type3" class="form-control col-md-4" style="display:inline-block">
                      <option value="-1" <?php if (!(strcmp(-1, $row_RecordProductListType['item_id']))) {echo "selected=\"selected\"";} ?>>-- 選擇分類3 --</option>
                      <?php
do {  
?>
                      <option value="<?php echo $row_RecordProductListType['item_id']?>"<?php if (!(strcmp($row_RecordProductListType['item_id'], $row_RecordProductListType['item_id']))) {echo "selected=\"selected\"";} ?>><?php echo $row_RecordProductListType['itemname']?></option>
