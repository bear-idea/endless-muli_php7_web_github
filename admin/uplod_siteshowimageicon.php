...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_SiteShowImage")) {
  $updateSQL = sprintf("UPDATE demo_setting_fr SET SiteIcon=IFNULL(%s,SiteIcon) WHERE id=%s",
  ...
  $updateGoTo = "uplod_siteshowimageicon.php";
  if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <form action="<?php echo $editFormAction;?>" class="form-horizontal form-bordered" data-parsley-validate="" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
            ...
            <input name="oldpic" type="hidden" id="oldpic" value="<?php echo $row_RecordSiteShowImage['SiteIcon']; ?>" />
...
$(document).ready(function() {
	$("#pic").fileinput({
		...
		maxFileSize: 500,  
		<?php if ($row_RecordSiteShowImage['SiteIcon'] != "") { ?>
		initialPreview: ["<?php echo $SiteImgUrlAdmin; ?><?php echo $wshop; ?>/image/<?php echo $row_RecordSiteShowImage['SiteIcon']; ?>"],
		<?php } ?>
