...
<ul class="xbreadcrumbs" id="breadcrumbs-1" data-scroll-reveal='enter top after 0.8s'>
    ...
    <li class="current"><i class="fa fa-angle-double-right"></i> <a href="member.php?wshop=<?php echo $_GET['wshop'];?>&amp;Opt=viewpage&amp;tp=Member&amp;lang=<?php echo $_SESSION['lang'] ?>">會員登入</a></li>
</ul>
