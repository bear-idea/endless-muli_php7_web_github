...
// 導覽
if($.cookie("intro_modlink") == null){
	jQuery(window).load(function() {startIntro();})
	$.cookie('intro_modlink', '1', { path:'/', expires: 365 });
}
</script>
<!-- InstanceEndEditable -->
</head>
...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_modlink.php"); ?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include_once("require_manage_modlink_index.php");			
					break;
				case "addpage_s":
					include_once("require_manage_modlink_add_select.php");
					break;
				case "addpage_d":
					include_once("require_manage_modlink_add_default.php");
					break;
				case "addpage_c":
					include_once("require_manage_modlink_add_custom.php");
					break;
				case "copypage_d":
					include_once("require_manage_modlink_copy_default.php"); 
					break;
				case "copypage_c":
					include_once("require_manage_modlink_copy_custom.php"); 
					break;
				case "editpage_d":
					include_once("require_manage_modlink_edit_default.php"); 
					break;
				case "editpage_c":
					include_once("require_manage_modlink_edit_custom.php"); 
					break;
				case "listpage":
					include_once("require_manage_modlink_list.php");
					break;
				case "listitempage":
					include_once("require_manage_modlink_listitem.php");
					break;
				case "configpage":
					include_once("require_manage_modlink_config.php");
					break;
				case "tmp_step_map":
					include_once("require_manage_modlink_step_map.php");
					break;
				default:
					include_once("require_manage_modlink_index.php");
					break;
