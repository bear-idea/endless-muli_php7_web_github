...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_Modlink")) {
  $insertSQL = sprintf("INSERT INTO demo_modlink (name, type, typemenu, sdescription, modselect, picname, indicate, notes1, lang, userid) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                     ...
                     <div class="row">
                         <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6 pull-left">
                             <div class="card">
                                  ...
                                  <div class="card-block">
                                      <div class="radio radio-css radio-inline">
                                            <input <?php if (!(strcmp($row_RecordModlink['picname'],"fri_mod01.jpg"))) {echo "checked=\"checked\"";} ?>type="radio" name="picname" value="fri_mod01.jpg" id="picname_01" />
                          ...
                          <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6 pull-left">
                             <div class="card">
                                  ...
                                  <div class="card-block">
                                      <div class="radio radio-css radio-inline">
                                            <input <?php if (!(strcmp($row_RecordModlink['picname'],"fri_mod0$i.jpg"))) {echo "checked=\"checked\"";} ?> type="radio" name="picname" value="fri_mod0<?php echo $i; ?>.jpg" id="picname_0<?php echo $i; ?>" />
                          ...
                          <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6 pull-left">
                             <div class="card">
                                  ...
                                  <div class="card-block">
                                      <div class="radio radio-css radio-inline">
                                            <input <?php if (!(strcmp($row_RecordModlink['picname'],"fri_mod$i.jpg"))) {echo "checked=\"checked\"";} ?>type="radio" name="picname" value="fri_mod<?php echo $i; ?>.jpg" id="picname_<?php echo $i; ?>" />
