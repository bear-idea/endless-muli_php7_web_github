  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="TB_General_style01">
    ...
    <tr>
      ...
      <td><span id="TmpColumnName">
        ...
        <span class="textfieldRequiredMsg">欄位不可為空。</span></span><span class="Form_Caption_Word">(此名稱您可至<a href="manage_tmp.php?wshop=<?php echo $wshop;?>&amp;Opt_Tmp=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>" target="_blank">版型設計</a>畫面中設定是否顯示)</span></td>
    </tr>
    <tr>
