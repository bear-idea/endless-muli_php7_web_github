...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-body p-0">
    ...
    <?php //if ($totalRows_RecordYearend == 0) { // Show if recordset not empty ?>
     <form action="manage_scaleorder_source_cartransport_print_month.php" method="post"  name="Yearend_Gen" target="_blank" class="form-horizontal form-bordered m-t-0" id="Yearend_Gen" data-parsley-validate="">
