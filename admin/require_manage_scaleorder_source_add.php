...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_Scaleorder_source")) {
  ...
  $insertSQL = sprintf("INSERT INTO erp_scaleordersourcedetail (title, code, num, author, warehouse, Totalweight, Minweight, Oriweight, carnumber, postdate, notes1, lang, userid) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "manage_scaleorder_source.php?Opt=viewpage&lang=" . $_POST['lang'];
  /*if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 貨源庫存 <small>新增</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post">
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      <input name="num" type="text" class="form-control" id="num" maxlength="200" data-parsley-trigger="blur" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
              <input name="postdate" type="text" class="form-control" id="postdate" value="<?php $dt = new DateTime(); echo $dt->format('Y-m-d H:i:s'); ?>" maxlength="20" data-provide="datetimepicker" data-date-format="yyyy-mm-dd h:i:s" data-parsley-trigger="blur" data-date-language="zh-TW" required=""/> 
