...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE demo_setting_fr SET SiteName_kr=%s, SitePrivate=%s, SiteKeyWord_kr=%s, SiteDesc_kr=%s WHERE id=%s",
...
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordSettingFr = sprintf("SELECT id, SiteName_kr, SitePrivate, SiteKeyWord_kr, SiteDesc_kr FROM demo_setting_fr WHERE userid=%s", GetSQLValueString($coluserid_RecordSettingFr, "int"));
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post">
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SiteName" type="text" class="form-control" id="SiteName" value="<?php echo $row_RecordSettingFr['SiteName_kr']; ?>" maxlength="100" data-parsley-trigger="blur" required="" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
            ...
            <input name="SiteKeyWord" type="text" class="form-control" id="SiteKeyWord" value="<?php echo $row_RecordSettingFr['SiteKeyWord_kr']; ?>" maxlength="300" data-role="tagsinput" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
            <textarea name="SiteDesc" cols="100" class="form-control" id="SiteDesc"><?php echo $row_RecordSettingFr['SiteDesc_kr']; ?></textarea> 
          </div>
      </div>
