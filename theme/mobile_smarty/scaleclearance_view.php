...
<div style="position:relative;">
  ...
  <!--標題外框--> 
        ...
        <div class="ct_title">
          <h1 style="font-size:large"><?php if($TmpTitleBgImage != ''){ ?><span class="titlesicon" data-scroll-reveal="enter top"><img src="<?php echo $SiteImgUrl; ?><?php echo $TmpTitleBgWebName; ?>/image/tmpbackground/<?php echo $TmpTitleBgImage; ?>" /></span><?php } ?> <span class="titlesicon" data-scroll-reveal="enter right"><?php echo $ModuleName['Member']; // 標題文字 ?></span></h1>
                </div>
                        ...
                        <div class="box-image text-center" style="margin:10px 0; background-color:#FFF;">
							...
							<div class="box-icon">
								<a class="box-icon-title" href="<?php echo $SiteBaseUrl . url_rewrite('scaleclearance',array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'order'),'',$UrlWriteEnable);?>">
									...
									<h3><i class="fa fa-address-book" aria-hidden="true"></i> 查詢清運明細</h3>
								</a>
								<p class="text-muted"></p>
							</div>
