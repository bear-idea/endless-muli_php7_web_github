...
<?php $pan_ct=0; ?>
        ...
        <?php do { ?>
          ...
          <a data-toggle="collapse" data-parent="#sidebar-nav" href="#collapse-product-<?php echo $pan_ct; ?>" class="collapsed"><i class="ico-dd icon-angle-down"></i><?php echo $row_RecordProductMultiLeftMenu_l1['itemname']; ?></a>
          <?php } else { ?>
          ...
          <ul id="collapse-product-<?php echo $pan_ct; ?>" class="list-unstyled collapse" style="margin-left:10px;">
            <?php
