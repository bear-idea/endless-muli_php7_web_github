...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-without-sidebar p-0">
  ...
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 超商店舖資訊 <small>更新</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="alert alert-warning"><i class="fa fa-info-circle"></i> <b>商店代號已填入，請關閉目前視窗</b></div>
  
<form name="childForm"> 
<table width="100%" class="table m-b-0">
  <tr>
    <td width="150">超商店舖編號</td>
    <td><input name="CVSStoreID" type="text" class="text form-control" id="CVSStoreID" value="<?php echo $_POST['CVSStoreID']; ?>" readonly></td>
  </tr>
  <tr>
    <td width="150">超商店舖名稱</td>
    <td><input name="CVSStoreName" type="text" class="text form-control" id="CVSStoreName" value="<?php echo $_POST['CVSStoreName']; ?>" readonly="readonly"></td>
  </tr>
  <tr>
    <td>超商店鋪地址</td>
    <td><input name="CVSAddress" type="text" class="text form-control" id="CVSAddress" value="<?php echo $_POST['CVSAddress']; ?>" readonly="readonly"></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<a href="javascript:window.close();window.opener=null" class="btn btn-danger btn-block">關閉視窗</a>
