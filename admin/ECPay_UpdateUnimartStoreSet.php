...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-without-sidebar p-0">
  ...
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 取件門市更新 <small>更新</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="ECPay_UpdateUnimartStore.php?Serial=<?php echo $row_RecordCart['oserial']; ?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post" id="form1" name="form1">
  　　<div class="form-group row">
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label ">物流交易編號<span class="text-red">*</span></label>
          <div class="col-md-10"><?php echo $row_RecordCart['ocAllPayLogisticsID']; ?></div>
      </div>
      <div class="form-group row">
          <label class="col-md-2 col-form-label ">寄貨編號<span class="text-red">*</span></label>
          <div class="col-md-10"><?php echo $row_RecordCart['ocCVSPaymentNo']; ?></div>
      </div>
      <div class="form-group row">
          <label class="col-md-2 col-form-label">驗證碼<span class="text-red">*</span></label>
          <div class="col-md-10"><?php echo $row_RecordCart['ocCVSValidationNo']; ?></div>
      </div>
      <div class="form-group row">
          <label class="col-md-2 col-form-label ">門市類型<span class="text-red">*</span></label>
          <div class="col-md-10">
              <select name="StoreType" id="StoreType" class="form-control">
             	  <option value="01">取件門市更新</option>
              　　　<!--<option value="02">退件門市更新</option>-->
              </select>     
          </div>
      </div>
      
      <div class="form-group row">
          <label class="col-md-2 col-form-label">物流訂單取貨門市<span class="text-red">*</span></label>
          <div class="col-md-8">
                      
                      <input name="ocCVSStoreID" type="text" class="form-control" id="ocCVSStoreID" maxlength="100" data-parsley-trigger="blur" required="" />
          ...
          <div class="col-md-2">
                      ...
                      <?php if ($row_RecordCart['ocfreightselect'] == "sevenshop" || $row_RecordCart['ocfreightselect'] == "sevenshopnopay") { ?>
                          <?php if($row_RecordSystemConfigOtr['allshopuseC2C'] == "1") { ?>
                          <?php $StoreType = "UNIMART"; ?>
                          <?php } else { ?>
                          <?php $StoreType = "UNIMART"; ?>
                          <?php } ?>
                      <?php } ?>
                      
                      <button type="button" class="btn btn-danger btn-block" onClick="javascript:window.open('allshop_CvsMap.php?wshop=<?php echo $_GET['wshop']; ?>&Type=<?php echo $StoreType; ?><?php if($row_RecordSystemConfigOtr['allshopuseC2C'] == "1") { echo "C2C";} ?>&Col=<?php if($row_RecordCart['ocfreightselect'] == "sevenshop" || $row_RecordCart['ocfreightselect'] == "familyshop") {echo "YES";}else{echo "NO";} ?>&Serial=<?php echo $row_RecordCart['oserial']; ?>','mywindow','width=800,height=800')">取得超商門市資訊</button>
