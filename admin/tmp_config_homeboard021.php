...
#v_wrp{width:980px; margin-left:auto; margin-right:auto; margin-top:10px; border:#CCC dashed 1px; position:relative; padding-right:20px; padding-bottom:20px; padding-top:20px; padding-left:20px; background-position:center center; background-repeat:no-repeat}
#v_wrp:hover{border:1px dashed #C30}
#v_wrp_header{border:#CCC dashed 1px; margin:5px; position:relative; min-height:80px}
...
#v_wrp_banner{border:#CCC dashed 1px; margin:5px; position:relative; min-height:500px}
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="TB_General_style00">
    <tr>
      <td>
       ...
       <div id="v_out_wrp">
       	<span class="v_out_wrp_font" style="display:none">外框架</span>
        <!--獨立背景--><!--獨立背景--><!--獨立背景-->
        <div id="v_wrp">
          <!--獨立外框-->
        <!--獨立背景-->
        <!--獨立背景-->
          <div style="color: #CCC; font-size: 30px; font-weight: bolder; padding: 10px; position: absolute; left: -36px; top: -41px;">主框架<span style="font-size:16px;"><a href="tmp_config_home_fullscreen.php?id_edit=<?php echo $row_RecordTmp['id']; ?>" data-original-title="您可在此設定選單背景、頁尾背景、文字顏色" data-toggle="tooltip" data-placement="right" class="btn btn-info btn-circle btn-xs">更多設定 <i class="fa fa-chevron-circle-right"></i></a></span></div>
        	<div id="v_wrp_header">
            <!--獨立背景-->
            ...
            <div id="v_wrp_banner">
            	<span style="color: #CCC; font-size:30px; font-weight:bolder; padding:10px; position: absolute; right: 5px; bottom: 5px;"><br />
            	<span style="font-size:16px;"><a href="manage_ads_home_image.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>&amp;board=<?php echo $_GET['board']; ?>" target="_top" class="btn btn-info btn-circle btn-xs" data-original-title="設定您的橫幅所要上傳的圖片，位於《輪播系統》中的《首頁橫幅》" data-toggle="tooltip" data-placement="right">橫幅圖片上傳 <i class="fa fa-chevron-circle-right"></i></a></span><br />
橫幅區塊</span>
            </div>
            <div id="v_wrp_footer">
            <div id="v_wrp_header_logo" style="z-index:100"><span style="font-size:16px;"><a href="tmp_config_home_logo.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>" data-original-title="您可在此設定Logo的位置及選擇您要放置的Logo樣式。" data-toggle="tooltip" data-placement="right" class="btn btn-info btn-circle btn-xs">更多設定 <i class="fa fa-chevron-circle-right"></i></a></span><br>
Logo</div>
              <!--獨立背景-->
              <span style="color: #CCC; font-size:30px; font-weight:bolder; padding:10px;position: absolute; right: 5px; bottom: 5px;"><br />
            	頁尾區塊</span>
