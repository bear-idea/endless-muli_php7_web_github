  ...
  <div id="content_full" class="content" style="padding:15px">
    ...
    <div class="col-lg-12">
      ...
      <?php
			...
			{
				case "pricelist":
					include_once("require_manage_scale_pricelist_index.php");
					break;
				case "pricelistadd":
					include_once("require_manage_scale_pricelist_add.php");
					break;
				case "pricelistedit":
					include_once("require_manage_scale_pricelist_edit.php");
					break;
				default:
					break;
			}
