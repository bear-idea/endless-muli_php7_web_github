...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Service")) {
  ...
  $updateSQL = sprintf("UPDATE demo_service SET name=%s, sdescription=%s, skeyword=%s, ogtitle=%s, ogtype=%s, ogurl=%s, ogimage=%s, ogdescription=%s, notes1=%s, lang=%s WHERE id=%s",
  ...
  $updateGoTo = "manage_service.php?Opt=seo&lang=" . $_POST['lang'];
  /*if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <form action="<?php echo $editFormAction;?><?php echo '&amp;GP_upload=true'; ?>" class="form-horizontal form-bordered" data-parsley-validate="" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="name" type="text" class="form-control" id="name" value="<?php echo $row_RecordService['name']; ?>" maxlength="200" data-parsley-trigger="blur" required="" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="ogtitle" type="text" class="form-control" id="ogtitle" value="<?php echo $row_RecordService['ogtitle']; ?>" maxlength="200" data-parsley-trigger="blur" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="ogtype" type="text" class="form-control" id="ogtype" value="<?php echo $row_RecordService['ogtype']; ?>" maxlength="200" data-parsley-trigger="blur" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="ogurl" type="url" class="form-control" id="ogurl" value="<?php echo $row_RecordService['ogurl']; ?>" maxlength="200" data-parsley-trigger="blur" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                 <input name="ogdescription" type="text" class="form-control" id="ogdescription" value="<?php echo $row_RecordService['ogdescription']; ?>" size="100" maxlength="150"/> 
          </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-10">
          <button type="submit" class="btn btn btn-primary btn-block">送出</button>
            ...
            <input name="oldpic" type="hidden" id="oldpic" value="<?php echo $row_RecordService['ogimage']; ?>" />
          </div>
      </div>
...
$(document).ready(function() {
	$("#ogimage").fileinput({
		...
		<?php if($row_RecordService['ogimage'] != "") { ?>
		initialPreview: [<?php echo "'" . $SiteImgUrlAdmin . $wshop ."/image/seo/" . $row_RecordService['ogimage'] .  "'"; ?>],
		initialPreviewConfig: [<?php echo "{url: 'sqldatatable/service_seophoto_del.php?id_del=".$row_RecordService['id']."', key: ".$row_RecordService['id'].", extra: {id:".$row_RecordService['id']."} }"; ?>],
		<?php } ?>
