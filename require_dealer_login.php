...
if (isset($_POST['account'])) {
  ...
  $MM_redirectLoginSuccess = $SiteBaseUrl . url_rewrite('dealer',array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'viewpage'),'',$UrlWriteEnable);
  ...
  $LoginRS__query=sprintf("SELECT account, psw, level, auth FROM demo_dealer WHERE account=%s AND psw=%s",
...
<?php include($TplPath . "/dealer_login.php"); ?>
<?php } ?>