...
//echo $_POST['type'] = explode(',',$_POST['type']);

//var_dump(implode(",", $_POST['type']));

if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_Product")) {
  $insertSQL = sprintf("INSERT INTO demo_product (name, type, type1, type2, type3, pdseries, model, price, spprice, pricecheck, pic, skeyword, sdescription, skeywordindicate, content, postdate, indicate, plot, homeshow, notes1, lang, userid) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
do {  
?>
                      <option value="<?php echo $row_RecordProductListType['itemname']?>"><?php echo $row_RecordProductListType['itemname']?></option>
