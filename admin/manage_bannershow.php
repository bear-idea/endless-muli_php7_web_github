...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require("require_leftmainmenu_bannershow.php");?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include("require_manage_bannershow_index.php");			
					break;
				case "addpage":
					include("require_manage_bannershow_add.php");
					break;
				case "editpage":
					include("require_manage_bannershow_edit.php"); 
					break;
				case "deletepage":
					include("require_manage_bannershow_delete.php");
					break;
				case "listpage":
					include("require_manage_bannershow_list.php");
					break;
				case "listitempage":
					include("require_manage_bannershow_listitem.php");
					break;
				case "configpage":
					include_once("require_manage_bannershow_config.php");
					break;
				default:
					include("require_manage_bannershow_index.php");
					break;
