<?php if ($totalRows_RecordDfPageMultiTopMenu_l1 > 0) { // Show if recordset not empty ?>    	
	<ul class="dropdown-menu <?php if (((int)$totalRows_RecordDfPageMultiTopMenu_l1 - (int)$Count_TypeMultiTopMenu) < 2) { ?>pull-right<?php } ?>"> 
        <?php do { ?>
            <li class="<?php if(isset($row_RecordDfPageMultiTopMenu_l1['endnode'])) { echo $row_RecordDfPageMultiTopMenu_l1['endnode']; } ?> <?php if ($row_RecordDfPageMultiTopMenu_l1['endnode'] != 'child') { echo "dropdown-submenu"; }  ?>">
            <?php if ($row_RecordDfPageMultiTopMenu_l1['endnode'] != 'child') { // 目前無第三層 ?>
            <a href="#" class="dropdown-item"><?php echo $row_RecordDfPageMultiTopMenu_l1['itemname']; ?></a>
            <?php } else { ?>
            ...
            <a href="<?php echo $SiteBaseUrl . url_rewrite(strtolower($row_RecordDfPageMultiTopMenu_l1['typemenu']),array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'subpage','aid'=>$row_RecordDfTypeMultiTopMenu_l1['id'],'type1'=>$row_RecordDfPageMultiTopMenu_l1['item_id']),'',$UrlWriteEnable);?>" class="dropdown-item"><?php echo $row_RecordDfPageMultiTopMenu_l1['itemname']; ?></a>
            <?php } else { ?>
            <a href="<?php echo $SiteBaseUrl . url_rewrite(strtolower($row_RecordDfPageMultiTopMenu_l1['typemenu']),array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'viewpage'),'',$UrlWriteEnable);?>" class="dropdown-item"><?php echo $row_RecordDfPageMultiTopMenu_l1['itemname']; ?></a>
            <?php } ?>
...
$totalRows_RecordDfPageMultiTopMenu_l2 = mysqli_num_rows($RecordDfPageMultiTopMenu_l2);
					?>
              <?php do { ?>
                <li class="<?php if(isset($row_RecordDfPageMultiTopMenu_l2['endnode'])) { echo $row_RecordDfPageMultiTopMenu_l2['endnode']; } ?> <?php if ($row_RecordDfPageMultiTopMenu_l2['endnode'] != 'child') { echo "dropdown-submenu"; }  ?>">
                  ...
                  <?php  /* 判斷模組是否為dfpage Start */ ?>
				  <?php if ($row_RecordDfPageMultiTopMenu_l1['typemenu'] == 'dfpage' || $row_RecordDfPageMultiTopMenu_l1['typemenu'] == 'dftype') { ?>
                  <a href="<?php echo strtolower($row_RecordDfPageMultiTopMenu_l2['typemenu']) ?>.php?wshop=<?php echo $_GET['wshop'];?>&amp;Opt=subpage&lang=<?php echo $_SESSION['lang']; ?>&tp=<?php echo $row_RecordDfPageMultiTopMenu_l2['typemenu']; ?>&level=<?php echo $row_RecordDfPageMultiTopMenu_l2['level']; ?>&type1=<?php echo $row_RecordDfPageMultiTopMenu_l1['item_id']; ?>&type2=<?php echo $row_RecordDfPageMultiTopMenu_l2['item_id']; ?>&subitem_id=<?php echo $row_RecordDfPageMultiTopMenu_l2['subitem_id']; ?>&amp;aid=<?php echo $row_RecordDfPageMultiTopMenu_l2['aid']; ?>" class="dropdown-item"><?php echo $row_RecordDfPageMultiTopMenu_l2['itemname']; ?></a>
                  <?php } else { ?>
                  <a href="<?php echo strtolower($row_RecordDfPageMultiTopMenu_l2['typemenu']) ?>.php?wshop=<?php echo $_GET['wshop'];?>&amp;Opt=subpage&lang=<?php echo $_SESSION['lang']; ?>&tp=<?php echo $row_RecordDfPageMultiTopMenu_l2['typemenu']; ?>&amp;aid=<?php echo $row_RecordDfPageMultiTopMenu_l2['aid']; ?>" class="dropdown-item"><?php echo $row_RecordDfPageMultiTopMenu_l2['itemname']; ?></a>
                  <?php } ?>
                  <?php  /* 判斷模組是否為dfpage End*/ ?>
                  <?php } ?>
