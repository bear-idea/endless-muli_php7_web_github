...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE demo_setting_fr SET TmpLogoID=%s WHERE userid=%s",
...
$coluserid_RecordTmpLogoStyle = "-1";
if (isset($w_userid)) {
  $coluserid_RecordTmpLogoStyle = $w_userid;
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpLogoStyle = sprintf("SELECT TmpLogoID FROM demo_setting_fr WHERE userid=%s", GetSQLValueString($coluserid_RecordTmpLogoStyle, "int"));
