...
.mdhome_t_l,.mdhome_t_r{position:absolute;top:0;font-size:1px;overflow:hidden}
.mdhome_t_l{left:0}
...
.mdhome_c{position:relative;overflow:hidden}
.mdhome_c .mdhome_m_t,.mdhome_c .mdhome_m_c,.mdhome_c .mdhome_m_b{padding:0}
...
.mdhome_b_l{left:0}
.mdhome_b_r{right:0}
#wrapper #Left_column{width:0;float:left;display:none}
#wrapper #Left_column #context{margin:0;display:none}
#wrapper #Content_containter{float:right;width:100%;margin-left:0;margin-right:0}
#wrapper #Content_containter #Main_content #context{min-height:inherit;margin:0}
</style>
<!-- InstanceEndEditable -->
...
<!-- InstanceEndEditable -->
        ...
        <?php 
		// 側邊欄位寬度
		$TmpWebColumnUseWidth = (($TmpWebWidth-$Tmp_Middle_L_M_Width-$Tmp_Middle_R_M_Width)/4);
		?>
        <?php
			switch($Tp_Page)
			{
				case "Home":
					  ...
					  {
						  case "homeboard014":
						  	  include_once("require_main_mod_news_product.php");
							  break;
						  case "homeboard015":
						  	  include_once("require_main_mod_news_project.php");
							  break;
						  case "homeboard016":
						  	  include_once("require_main_mod_news_activities.php");
							  break;
						  case "homeboard017":
						  	  include_once("require_main_mod_news_sponsor.php");
							  break;
						  case "homeboard018":
						  	  include_once("require_main_mod_news_video.php");
							  break;
						  case "homeboard019":
						  	  include_once("require_main_mod_product_sponsor.php");
							  break;
						  case "homeboard020":
						  	  include_once("require_main_mod_project_video.php");
							  break;
					  }	 	
				default:
					break;
