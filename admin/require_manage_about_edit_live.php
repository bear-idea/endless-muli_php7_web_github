...
/* 取得類別列表 */
$colname_RecordAboutListType = "zh-tw";
if (isset($_GET['lang'])) {
  $colname_RecordAboutListType = $_GET['lang'];
}
$coluserid_RecordAboutListType = "-1";
if (isset($w_userid)) {
  $coluserid_RecordAboutListType = $w_userid;
}
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordAboutListType = sprintf("SELECT * FROM demo_aboutitem WHERE list_id = 1 && lang=%s && level='0' && userid=%s ORDER BY subitem_id", GetSQLValueString($colname_RecordAboutListType, "text"),GetSQLValueString($coluserid_RecordAboutListType, "int"));
$RecordAboutListType = mysqli_query($DB_Conn, $query_RecordAboutListType) or die(mysqli_error($DB_Conn));
$row_RecordAboutListType = mysqli_fetch_assoc($RecordAboutListType);
$totalRows_RecordAboutListType = mysqli_num_rows($RecordAboutListType);

$colname_RecordAbout = "-1";
if (isset($_GET['id_edit'])) {
  $colname_RecordAbout = $_GET['id_edit'];
}
...
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordAbout = sprintf("SELECT * FROM demo_about WHERE id = %s && userid=%s", GetSQLValueString($colname_RecordAbout, "int"),GetSQLValueString($coluserid_RecordAbout, "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_About") && $_POST['sdescription'] == "") { 
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_About")) {
  $updateSQL = sprintf("UPDATE demo_about SET title=%s, type1=%s, type2=%s, type3=%s, content=%s, indicate=%s, skeyword=%s, sdescription=%s, skeywordindicate=%s, notes1=%s, lang=%s, userid=%s WHERE id=%s",
					   ...
					   GetSQLValueString($_POST['skeywordindicate'], "text"),
...
<script src="dist/grapesjs-plugin-ckeditor.min.js"></script>
...
<div id="gjs">
      <?php echo $row_RecordAbout['content']; ?>
</div>

<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> <?php echo $ModuleName['About']; ?> <small>修改</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                    ...
                    <select name="type1" id="type1" class="form-control col-md-4" style="display:inline-block">
                      <option value="-1" <?php if (!(strcmp(-1, $row_RecordAbout['type1']))) {echo "selected=\"selected\"";} ?>>-- 選擇分類 --</option>
                      <?php
do {  
?>
                      <option value="<?php echo $row_RecordAboutListType['item_id']?>"<?php if (!(strcmp($row_RecordAboutListType['item_id'], $row_RecordAbout['type1']))) {echo "selected=\"selected\"";} ?>><?php echo $row_RecordAboutListType['itemname']?></option>
                      <?php
} while ($row_RecordAboutListType = mysqli_fetch_assoc($RecordAboutListType));
  $rows = mysqli_num_rows($RecordAboutListType);
  if($rows > 0) {
      mysqli_data_seek($RecordAboutListType, 0);
	  $row_RecordAboutListType = mysqli_fetch_assoc($RecordAboutListType);
  }
?>
                    </select>
                    ...
                    <select name="type2" id="type2" class="form-control col-md-4" style="display:inline-block">
                      <option value="-1" <?php if (!(strcmp(-1, $row_RecordAboutListType['item_id']))) {echo "selected=\"selected\"";} ?>>-- 選擇分類2 --</option>
                      <?php
do {  
?>
                      <option value="<?php echo $row_RecordAboutListType['item_id']?>"<?php if (!(strcmp($row_RecordAboutListType['item_id'], $row_RecordAboutListType['item_id']))) {echo "selected=\"selected\"";} ?>><?php echo $row_RecordAboutListType['itemname']?></option>
<?php
} while ($row_RecordAboutListType = mysqli_fetch_assoc($RecordAboutListType));
  $rows = mysqli_num_rows($RecordAboutListType);
  if($rows > 0) {
...
?>
                    ...
                    <select name="type3" id="type3" class="form-control col-4" style="display:inline-block">
                      <option value="-1" <?php if (!(strcmp(-1, $row_RecordAboutListType['item_id']))) {echo "selected=\"selected\"";} ?>>-- 選擇分類3 --</option>
                      <?php
do {  
?>
                      <option value="<?php echo $row_RecordAboutListType['item_id']?>"<?php if (!(strcmp($row_RecordAboutListType['item_id'], $row_RecordAboutListType['item_id']))) {echo "selected=\"selected\"";} ?>><?php echo $row_RecordAboutListType['itemname']?></option>
...
?>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
            ...
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordAbout['indicate'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="indicate" id="indicate_1" value="1" />
                <label for="indicate_1">公佈</label>
            </div>
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordAbout['indicate'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="indicate" id="indicate_2" value="0" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordAbout['skeywordindicate'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="skeywordindicate" id="skeywordindicate_1" value="1" />
                <label for="skeywordindicate_1">顯示</label>
            </div>
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordAbout['skeywordindicate'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="skeywordindicate" id="skeywordindicate_2" value="0" />
      ...
      <div class="form-group row">
          ...
          <div class="table-responsive">
                <textarea name="content" id="content" cols="100%" rows="35" class="form-control"><?php echo $row_RecordAbout['content']; ?></textarea>  
          </div>
          </div>
      </div>
      <div class="form-group row">
...
$(function () {
    ...
    $('#type1').change(function () {
        ...
        $('#type2').removeOption(/.?/).ajaxAddOption(
            'selectbox_action/about_add.php?&<?php echo time();?>', 
            { 'id': $(this).val(), 'lv': 1 }, 
...
<?php
mysqli_free_result($RecordAboutListType);
