...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmpnewstopbackground=%s WHERE id=%s",
...
?>
    ...
    <tbody>
      ...
      <tr>    
	   ...
	   <div style="padding:5px; border: 1px dotted #CCC; margin-bottom:2px; width:115px; float:left; margin:5px; text-align:center;" class="<?php if($row_RecordTmpBackGroundSelect['tmpnewstopbackground'] == ''){echo "bg_active";} ?> bg_board"><!--無圖片指定-->
       <div class="TmpBgSelectIcon" style="display:<?php if($row_RecordTmpBackGroundSelect['tmpnewstopbackground'] != ''){echo "none";} ?>;"></div>
       ...
       <?php do { ?>
           <div style="padding:5px; border: 1px dotted #CCC; margin-bottom:2px; width:115px; float:left; margin:5px; text-align:center; position:relative;" class="<?php if($row_RecordTmpBackGroundSelect['tmpnewstopbackground'] == $row_RecordTmpBackGround['id']){echo "bg_active";} ?> bg_board">
           <div class="TmpBgSelectIcon" style="display:<?php if($row_RecordTmpBackGroundSelect['tmpnewstopbackground'] != $row_RecordTmpBackGround['id']){echo "none";} ?>;"></div>
