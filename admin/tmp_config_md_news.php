...
<div style="padding:10px; margin:10px; position:relative;" id="wrapper_config">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="TB_General_style01">
    <tr>
      <td colspan="2"><i class="fa fa-chevron-right" style="color:#F00"></i> <strong><?php echo $ModuleName['News']; ?>：</strong></td>
      </tr>
    <tr>
      ...
      <td><iframe src="tmp_config_background_view.php?id=<?php echo $row_RecordTmp['tmpnewsevenbackground']  ?>" width="52" marginwidth="0" height="52" marginheight="0" scrolling="no" frameborder="0"></iframe>
        <br />
        <a href="tmpnewsevenbackground_home.php?id=<?php echo $row_RecordTmp['id']; ?>" data-original-title="背景選擇">背景指定</a><br /></td>
    </tr>
    <tr>
      <td align="right">偶數列背景：</td>
      <td><iframe src="tmp_config_background_view.php?id=<?php echo $row_RecordTmp['tmpnewsoddbackground']  ?>" width="52" marginwidth="0" height="52" marginheight="0" scrolling="no" frameborder="0"></iframe>
        <br />
        <a href="tmpnewsoddbackground_home.php?id=<?php echo $row_RecordTmp['id']; ?>" data-original-title="背景選擇">背景指定</a></td>
    </tr>
    <tr>
      <td align="right">&nbsp;</td>
      <td>&nbsp;</td>
