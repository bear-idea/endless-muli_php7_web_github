...
<?php if ($row_RecordTmpConfig['tmpfootermodselect'] == '0') { ?>
...
switch($_SESSION['lang'])
	{
		case "zh-tw":
		    echo $row_RecordSystemConfigOtr['tmpfootercontext'];
			break;
		case "zh-cn":
		    echo $row_RecordSystemConfigOtr['tmpfootercontext_cn'];
			break;
		case "en":
		    echo $row_RecordSystemConfigOtr['tmpfootercontext_en'];
			break;	
		case "jp":
		    echo $row_RecordSystemConfigOtr['tmpfootercontext_jp'];
			break;
		case "kr":
		    echo $row_RecordSystemConfigOtr['tmpfootercontext_kr'];
			break;
		case "sp":
		    echo $row_RecordSystemConfigOtr['tmpfootercontext_sp'];
			break;	
		default:
		    break;
	}
