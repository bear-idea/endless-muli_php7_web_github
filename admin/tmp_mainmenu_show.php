...
$query_RecordTmpMainMenu = sprintf("SELECT * FROM demo_tmpmainmenu WHERE id=%s", GetSQLValueString($colid_RecordTmpMainMenu, "int"));
...
#navcss3 li{line-height:<?php echo $row_RecordTmpMainMenu['tmp_mainmenupic_height']; ?>px; font-size:<?php echo $row_RecordTmpMainMenu['tmp_mainmenu_font_size']; ?>; font-weight:<?php echo $row_RecordTmpMainMenu['tmp_mainmenu_font_style']; ?>}
#navcss3 a{color:<?php echo $row_RecordTmpMainMenu['tmp_mainmenu_color']; ?>; background-image:url(<?php echo $SiteImgUrlAdmin; ?><?php echo $row_RecordTmpMainMenu['webname']; ?>/image/tmpmainmenu/<?php echo $row_RecordTmpMainMenu['tmp_mainmenu_img']; ?>); width:<?php echo $row_RecordTmpMainMenu['tmp_mainmenu_width']; ?>px}
#navcss3 .mactive{color:<?php echo $row_RecordTmpMainMenu['tmp_mainmenu_hovercolor']; ?>; background-image:url(<?php echo $SiteImgUrlAdmin; ?><?php echo $row_RecordTmpMainMenu['webname']; ?>/image/tmpmainmenu/<?php echo $row_RecordTmpMainMenu['tmp_mainmenu_hover_img']; ?>)}
#navcss3 a:hover{color:<?php echo $row_RecordTmpMainMenu['tmp_mainmenu_hovercolor']; ?>; background-image:url(<?php echo $SiteImgUrlAdmin; ?><?php echo $row_RecordTmpMainMenu['webname']; ?>/image/tmpmainmenu/<?php echo $row_RecordTmpMainMenu['tmp_mainmenu_hover_img']; ?>)}
#apDiv_outmenu {
	height: <?php echo $row_RecordTmpMainMenu['tmp_mainmenupic_height']; ?>px;
	width: 100%;
	<?php if ($row_RecordTmpMainMenu['tmp_mainmenu_location'] == '0') { // 當自定選單採用100%寬度時採用?>
	position: absolute;
	<?php } ?>
	background-image: url(<?php echo $SiteImgUrlAdmin; ?><?php echo $row_RecordTmpMainMenu['webname']; ?>/image/tmpmainmenu/<?php echo $row_RecordTmpMainMenu['tmp_mainmenu_o_img']; ?>);
...
<div style="padding:10px; margin:10px; position:relative;" id="wrapper_config">
  <div style="background-color:#FFFFFF; padding:5px; border: 1px solid #CCC; min-height:400px; background-color:#F3F3F3;">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="TB_General_style02">
          <tr>
            <td><h5><strong><font color="#756b5b">主選單預覽 [<?php echo $langname; ?>編輯介面]</font></strong>(主選單)</h4></td>
            <td align="right">&nbsp;</td>
      </tr>
    </table>
    ...
    <div id="v_out_wrp_c" style=" margin-top:10px; padding:10px;">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td>主選單的實際位置會依您的版型設定而有所變動，您可以在 <span style="color:#F60;">版型編輯畫面中 選單的更多設定</span> 調整您的選單位置。</td>
          </tr>
          <tr>
    ...
    <div id="v_wrp">
      ...
      <!--獨立背景-->
        <div style="color: #CCC; font-size: 30px; font-weight: bolder; padding: 10px; position: absolute; left: -36px; top: -41px;">主框架</div>
            ...
            <div id="v_wrp_header_logo">Logo</div>
                <div id="v_wrp_header_menu" style="background-image:url(images/ap_p_u.jpg);">
                <!--獨立選單-->
                <div>
                    <link rel="stylesheet" href="../css/css3menu.css" type="text/css" />
                    <div style="width:960px;">
                    <div id="apDiv_outmenu"><ul id="navcss3" style=" margin-right:10px; float:right;"><?php if ($row_RecordTmpMainMenu['tmp_mainmenu_l_img'] != '') { ?><span class="topmainmenu_l"><img src="<?php echo $SiteImgUrlAdmin; ?><?php echo $row_RecordTmpMainMenu['webname']; ?>/image/tmpmainmenu/<?php echo $row_RecordTmpMainMenu['tmp_mainmenu_l_img']; ?>"/></span><?php } ?><li><a href="#" class="mactive">關於我們</a></li><li><a href="#" >最新訊息</a></li><li><a href="#" >商品櫥窗</a></li><li><a href="#" >常見問答</a></li><li><a href="#" >聯絡我們</a></li><?php if ($row_RecordTmpMainMenu['tmp_mainmenu_r_img'] != '') { ?><li class="topmainmenu_r"><img src="<?php echo $SiteImgUrlAdmin; ?><?php echo $row_RecordTmpMainMenu['webname']; ?>/image/tmpmainmenu/<?php echo $row_RecordTmpMainMenu['tmp_mainmenu_r_img']; ?>"/></li><?php } ?></ul></div>
                    </div>
                </div>
                <!--獨立選單-->
                選單</div>
            ...
            <div id="v_wrp_menu_full" style="background-image:url(images/ap_p_u.jpg);">
            	<span style="color: #CCC; font-size:30px; font-weight:bolder; padding:10px; position: absolute; right: 5px; bottom: 5px;">
                <!--獨立選單-->
                <div>
                    <link rel="stylesheet" href="../css/css3menu.css" type="text/css" />
                    <div style="width:948px; margin-right:-15px;">
                    <div id="apDiv_outmenu"><ul id="navcss3" style=" margin-right:10px; float:right;"><?php if ($row_RecordTmpMainMenu['tmp_mainmenu_l_img'] != '') { ?><span class="topmainmenu_l"><img src="<?php echo $SiteImgUrlAdmin; ?><?php echo $row_RecordTmpMainMenu['webname']; ?>/image/tmpmainmenu/<?php echo $row_RecordTmpMainMenu['tmp_mainmenu_l_img']; ?>"/></span><?php } ?><li><a href="#" class="mactive">關於我們</a></li><li><a href="#" >最新訊息</a></li><li><a href="#" >商品櫥窗</a></li><li><a href="#" >常見問答</a></li><li><a href="#" >聯絡我們</a></li><?php if ($row_RecordTmpMainMenu['tmp_mainmenu_r_img'] != '') { ?><li class="topmainmenu_r"><img src="<?php echo $SiteImgUrlAdmin; ?><?php echo $row_RecordTmpMainMenu['webname']; ?>/image/tmpmainmenu/<?php echo $row_RecordTmpMainMenu['tmp_mainmenu_r_img']; ?>"/></li><?php } ?></ul></div>
                    </div>
                </div>
                選單<!--獨立選單-->
      ...
      <div id="v_wrp_banner">
            ...
            <div class="v_wrp_l_column_board_style" style="height:280px;">
