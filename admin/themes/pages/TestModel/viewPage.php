...
//dd(route('admin.admin.news.index'));
$useModuleUri = $request->input('useModuleUri');

// 定義 tableConfig 的 PHP 版本
$tableConfig = [
    'tableId' => 'data-table-default',
    'ajaxUrl' => ADMINURL . '/sqldatatable/'.toSpinalCase($useModuleUri).'_view.php',
    'editUrl' => ADMINURL . '/sqledit/'.toSpinalCase($useModuleUri).'_jedit.php',
    'editListUrl' => ADMINURL . '/sqledit/'.toSpinalCase($useModuleUri).'_get_list.php?list_id=1',
    ...
    'columns' => [
        ...
        ['title' => '標題', 'data' => 'title', 'orderable' => true, 'className' => 'ed_title', 'width' => '-1'],
        ['title' => '類別', 'data' => 'type', 'orderable' => true, 'className' => 'ed_type', 'inputclass' => 'form-select', 'sourceUrl' => ADMINURL . '/sqledit/news_get_list.php?list_id=1', 'width' => '100px'],
            ...
            <div class="col-md-2 col-sm-12 m-b-10">
                <div class="input-group" data-column="2"> <span class="input-group-text"><i class="fas fa-search fa-fw"></i> 類別</span>
                    <select name="type" class="form-control form-select search_filter" id="filter-type">
                        ...
                        <?php foreach($RecordListItemMenuType as $row_RecordListItemMenuType) { ?>
                            <option value="<?php echo $row_RecordListItemMenuType['itemname']?>"><?php echo $row_RecordListItemMenuType['itemname']?></option>
                        <?php }  ?>
                    </select>
                </div>
            </div>
