...
<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>sqldatatable/js/health_datatable.js?<?php echo time(); ?>"></script>
<!-- ================== END Datatables JS ================== -->
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 健保費表 <small>總覽</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
    ...
    <table id="data-table-default" class="table table-striped table-bordered table-hover table-condensed">
      <thead>
        <tr>
          ...
          <th width="-1" data-priority="1"><strong>投保等級</strong></th>
          <th width="-1" data-priority="1"><strong>類別</strong></th>
          <th width="100" data-priority="1"><strong>投保金額</strong></th>
          <th width="100" data-priority="1"><strong>本人</strong></th>
          <th width="100" data-priority="1"><strong>本人+1眷口</strong></th>
          <th width="100" data-priority="1"><strong>本人+2眷口</strong></th>
          <th width="100" data-priority="1"><strong>本人+3眷口</strong></th>
          <th width="100" data-priority="1"><strong>單位負擔</strong></th>
        </tr>
      </thead>
      <tfoot>
        <tr>
