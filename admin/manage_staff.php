...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require("require_leftmainmenu_staff.php");?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include("require_manage_staff_index.php");			
					break;
				case "addpage":
					include("require_manage_staff_add.php");
					break;
				case "editpage":
					include("require_manage_staff_edit.php"); 
					break;
				case "capital":
					include("require_manage_staff_capital.php"); 
					break;
				case "yearend":
					include("require_manage_staff_yearend.php"); 
					break;
				case "listpage":
					include("require_manage_staff_list.php");
					break;
				case "listitempage":
					include("require_manage_staff_listitem.php");
					break;
				default:
					include("require_manage_staff_index.php");
					break;
