...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require("require_leftmainmenu_webuser.php");?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include("require_manage_webuser_index.php");			
					break;
				case "viewpage_now":
					include("require_manage_webuser_now_index.php");			
					break;
				case "viewpage_done":
					include("require_manage_webuser_done_index.php");			
					break;
				case "qrcode":
					include("require_manage_webuser_qrcode.php");			
					break;
				case "searchpage":
					include("require_manage_webuser_index_search.php");			
					break;
				case "enablepage":
					include("require_manage_webuser_enable.php");			
					break;
				case "statepage":
					include("require_manage_webuser_state.php");			
					break;
				case "changeaccount":
				    include("require_manage_webuser_change.php");			
					break;
				case "addpage":
					include("require_manage_webuser_add.php");
					break;
				case "modaddpage":
					include("require_manage_webuser_modadd.php");
					break;
				case "modselectpage":
					include("require_manage_webuser_modselect.php");
					break;
				case "editpage":
					include("require_manage_webuser_edit.php"); 
					break;
				case "editfontpage":
					include("require_manage_systemconfig_fr_webuser.php"); 
					break;
				case "editmspage":
					include("require_manage_systemconfig_ms_webuser.php"); 
					break;
				case "editbackpage":
					include("require_manage_systemconfig_webuser.php"); 
					break;
				default:
					include("require_manage_webuser_index.php");
					break;
