...
$updateSQL = sprintf("UPDATE demo_setting_fr SET SiteName_kr=%s, SiteDecsHome_kr=%s, SiteIndicate=%s, SiteIndicateDesc=%s, SiteCopyLock=%s, SiteAnimeCheck=%s, SiteType=%s, SiteFBFan=%s, SiteUrl=%s, SiteMail_kr=%s, SiteAuthor_kr=%s, SiteSName_kr=%s, SitePhone_kr=%s, SiteCell_kr=%s, SiteFax_kr=%s, SiteLINE=%s, SiteAddr_kr=%s, SiteAddrX_kr=%s, SiteAddrY_kr=%s, SiteIndustryType1=%s, SiteIndustryType2=%s, SiteIndustryType3=%s, googlemaparea1=%s, googlemaparea2=%s, googlemaparea3=%s, SiteFontSize=%s, urlwriteenable=%s WHERE id=%s",
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post">
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="sitename" type="text" class="form-control" id="sitename" value="<?php echo $row_RecordSettingFr['SiteName_kr']; ?>" maxlength="200" data-parsley-trigger="blur" required="" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SiteDecsHome" type="text" class="form-control" id="SiteDecsHome" value="<?php echo $row_RecordSettingFr['SiteDecsHome_kr']; ?>" maxlength="300" data-parsley-trigger="blur" required="" />
...
?>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SiteSName" type="text" class="form-control" id="SiteSName" value="<?php echo $row_RecordSettingFr['SiteSName_kr']; ?>" maxlength="100" data-parsley-trigger="blur" required="" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SitePhone" type="text" id="SitePhone" value="<?php echo $row_RecordSettingFr['SitePhone_kr']; ?>" maxlength="30" data-parsley-trigger="blur" class="form-control"/>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SiteCell" type="text" id="SitePhone" value="<?php echo $row_RecordSettingFr['SiteCell_kr']; ?>" maxlength="15" data-parsley-trigger="blur" class="form-control"/>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SiteFax" type="text" id="SiteFax" value="<?php echo $row_RecordSettingFr['SiteFax_kr']; ?>" maxlength="20" data-parsley-trigger="blur" class="form-control"/>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="SiteAddr" type="text" id="SiteAddr" value="<?php echo $row_RecordSettingFr['SiteAddr_kr']; ?>" size="50" maxlength="250" data-parsley-trigger="blur" class="form-control"/>
...
<div style="position:relative"><div class="" id="out" style="position:absolute;"><div id="map_canvas"></div></div></div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="sitemail" type="email" id="sitemail" value="<?php echo $row_RecordSettingFr['SiteMail_kr']; ?>" size="50" maxlength="150" data-parsley-trigger="blur" class="form-control" required=""/>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="siteauthor" type="text" id="siteauthor" value="<?php echo $row_RecordSettingFr['SiteAuthor_kr']; ?>" size="50" maxlength="150"  data-parsley-trigger="blur" class="form-control" required=""/>
