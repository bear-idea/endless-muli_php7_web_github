...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_picasa.php"); ?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include_once("require_manage_picasa_index.php");			
					break;
				case "detailed":
					include_once("require_manage_picasa_detailed.php");			
					break;
				case "install":
					include_once("require_manage_picasa_install.php");			
					break;
				default:
					include_once("require_manage_picasa_index.php");
					break;
