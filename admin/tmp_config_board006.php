...
#v_wrp_middle{border:#CCC dotted 1px; margin:5px; margin-left:0px; position:relative; min-height:700px}
    ...
    <tr>
      <td>
       ...
       <div id="v_out_wrp">
        ...
        <div id="v_wrp_header">
        <span style="position: absolute; top: -80px; left: -160px; border: #CCC dotted 1px; padding: 5px;"><img src="images/sty06.jpg" width="100" height="100" /><br />
