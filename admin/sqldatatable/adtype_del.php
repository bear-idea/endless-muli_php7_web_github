...
if ((isset($_GET['id_del'])) && ($_GET['id_del'] != "")) {
  ...
  $deleteSQL = sprintf("DELETE FROM demo_adtype WHERE userid=%s && act_id=%s",
...
if ((isset($_GET['id_del'])) && ($_GET['id_del'] != "")) {
  ...
  if (isset($_GET['id_del'])) {
	$colname_RecordAdsPhotoGet = $_GET['id_del'];
  }
  //mysqli_select_db($database_DB_Conn, $DB_Conn);
  $query_RecordAdsPhotoGet = sprintf("SELECT * FROM demo_productphoto WHERE act_id = %s", GetSQLValueString($colname_RecordAdsPhotoGet, "int"));
  ...
  $deleteSQL = sprintf("DELETE FROM demo_productphoto WHERE userid=%s && act_id=%s",
                       GetSQLValueString($w_userid, "int"),
                       GetSQLValueString($_GET['id_del'], "int"));
