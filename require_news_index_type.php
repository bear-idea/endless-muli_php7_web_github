...
$colname_RecordNewsTab = "-1";
if (isset($_GET['type'])) {
  $colname_RecordNewsTab = $_GET['type'];
}
...
$query_RecordNewsTab = sprintf("SELECT * FROM demo_news WHERE type = %s && lang=%s && indicate=1 && userid=%s", GetSQLValueString($colname_RecordNewsTab, "text"),GetSQLValueString($collang_RecordNewsTab, "text"),GetSQLValueString($coluserid_RecordNewsTab, "int"));
