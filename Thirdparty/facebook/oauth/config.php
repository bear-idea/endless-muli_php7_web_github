...
$query_RecordThirdparty = sprintf("SELECT FacebookLoginAppID, FacebookLoginSecret FROM demo_setting_fr WHERE userid = %s", GetSQLValueString($colname_RecordThirdparty, "int"));
...
if($row_RecordThirdparty['FacebookLoginAppID'] != "" && $row_RecordThirdparty['FacebookLoginSecret'] != ""){
	$fb_app_id = $row_RecordThirdparty['FacebookLoginAppID'];
	$fb_app_secret = $row_RecordThirdparty['FacebookLoginSecret'];
}
