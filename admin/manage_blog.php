...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_blog.php"); ?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "areapage":
					include_once("require_manage_blog_area_index.php");			
					break;
				case "viewpage":
					include_once("require_manage_blog_index.php");			
					break;
				case "viewpage_sub":
					include_once("require_manage_blog_index_sub.php");			
					break;
				case "searchpage":
					include_once("require_manage_blog_index_search.php");			
					break;
				case "viewpage_sl1":
					include_once("require_manage_blog_index_sl1.php");			
					break;
				case "viewpage_sl2":
					include_once("require_manage_blog_index_sl2.php");			
					break;
				case "viewpage_sl3":
					include_once("require_manage_blog_index_sl3.php");			
					break;
				case "addpage":
					include_once("require_manage_blog_add.php");
					break;
				case "editpage":
					include_once("require_manage_blog_edit.php"); 
					break;
				case "deletepage":
					include_once("require_manage_blog_delete.php");
					break;
				case "listpage":
					include_once("require_manage_blog_list.php");
					break;
				case "listitempage":
					include_once("require_manage_blog_listitem.php");
					break;
				case "mulilistitempage":
					include_once("require_manage_blog_mulilistitem.php");
					break;
				case "sub_mulilistitempage":
					include_once("require_manage_blog_mulilistitem_sub.php");
					break;
				case "postpage":
					include_once("require_manage_blog_post_index.php");			
					break;
				case "postaddpage":
					include_once("require_manage_blog_post_add.php");			
					break;
				case "posteditpage":
					include_once("require_manage_blog_post_edit.php");			
					break;
				case "replypage":
					include_once("require_manage_blog_reply_index.php");			
					break;
				case "replyaddpage":
					include_once("require_manage_blog_reply_add.php");			
					break;
				case "replyeditpage":
					include_once("require_manage_blog_reply_edit.php");			
					break;
				case "configpage":
					include_once("require_manage_blog_config.php");
					break;
				default:
					include_once("require_manage_blog_index.php");
					break;
