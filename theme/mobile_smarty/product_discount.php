...
#
# 在此判斷式之內放置要顯示之內容
if ($totalRows_RecordDiscount > 0) { // Show if recordset not empty 
?> 
<!--外框-->
<div style="position:relative;">
  ...
  <?php if ($totalRows_RecordDiscount > 0) { ?>
  <?php echo $row_RecordDiscount['content']; ?>
  <?php } ?>
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<div class="row">
                    ...
                    <a href="#" class="btn btn-3d btn-red btn-lg" onclick="AddtoCart('<?php echo $row_RecordProduct['id']; ?>','<?php if(isset($fmtpid)) { echo $fmtpid; } ?>','1')" style="width:100%;"><?php echo $Lang_Classify_Context_Mail_Send_Pay; ?></a>
                    </div>
                </div> <!--\row-->
			</div>
