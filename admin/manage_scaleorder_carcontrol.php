...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_scaleorder_carcontrol.php"); ?>
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include("require_manage_scaleorder_out_index_carcontrol.php");			
					break;
				case "listitempage":
					include_once("require_manage_scaleorder_out_index_listitem.php");
					break;
				case "print_cartransport_select":
					include("require_manage_scaleorder_out_index_carcontrol_print_cartransport_select.php"); 
					break;
				default:
					include("require_manage_scaleorder_out_index_carcontrol.php");
					break;
