  ...
  <?php 
    ...
    <?php if ($TmpWrpViewLineLocate == '2') { ?>               
        ...
        <section class="page-header page-header-xxs">
            <h1><!-- InstanceBeginEditable name="標題文字" --> <?php echo $ModuleName['Room']; ?> <!-- InstanceEndEditable --></h1>
            <!-- InstanceBeginEditable name="導覽列" -->
                                    <?php if ($_GET['Opt'] == 'cartdetailed') { ?>
										  <?php require("require_roomcart_viewline_mobile.php"); ?>
                                          <?php } else { ?>
                                          <?php require("require_room_viewline_mobile.php"); ?>
                                          <?php } ?>
                    <!-- InstanceEndEditable -->
        </section>
          ...
          <?php
			switch($_GET['Opt'])
			{
				case "viewpage":
					...
					{	
						/*case '0':
							include_once("require_room_ela.php");
							break;
						case '1':
							include_once("require_room_4col.php");
							break;
						case '2':
							include_once("require_room_3col.php");
							break;
						case '3':
							include_once("require_room_2col.php");
							break;
						case '4':
							include_once("require_room_1col.php");
							break;*/
						default:
							include_once("require_room.php");	
							break;
					}
					break;	
                case "reserve":
                    include_once("require_room_reserve.php");
					break;
				case "roomlist":
					include_once("require_room_reserve_list_show_date.php");				
					break;
				case "showpage":
					include_once("require_room_reserve_cart_show.php");				
					break;
				case "addpage":
					include_once("require_room_reserve_cart_add.php");				
					break;
				case "checkpage":
					include_once("require_room_reserve_cart_check.php");				
					break;
				case "purchasepage":
					include_once("require_room_reserve_cart_purchase.php");				
					break;
				case "purchasecheckpage":
					include_once("require_room_reserve_cart_purchase_check.php");				
					break;
				case "clearpage":
					include_once("require_room_reserve_cart_clear.php");				
					break;
				case "sendpage":
					include_once("require_room_reserve_cart_ordersend.php");				
					break;
				case "typepage":
					switch($MSRoom)
					{	
						/*case '0':
							include_once("require_room_type_ela.php");	
							break;
						case '1':
							include_once("require_room_type_4col.php");	
							break;
						case '2':
							include_once("require_room_type_3col.php");	
							break;
						case '3':
							include_once("require_room_type_2col.php");	
							break;
						case '4':
							include_once("require_room_type_1col.php");	
							break;*/
						default:
							include_once("require_room.php");	
							break;
				...
				case "maintypepage":
					...
					{	
						/*case '0':
							include_once("require_room_type_main_ela.php");	
							break;
						case '1':
							include_once("require_room_type_main_4col.php");	
							break;
						case '2':
							include_once("require_room_type_main_3col.php");	
							break;
						case '3':
							include_once("require_room_type_main_2col.php");		
							break;
						case '4':
							include_once("require_room_type_main_1col.php");	
							break;*/
						default:
							include_once("require_room.php");	
							break;
					...
					break;		
				case "detailed":
					switch($MSRoomContent)
					{	
						/*case '0':
							include_once("require_room_detailed_ela_base.php");
							break;
						case '1':
							include_once("require_room_detailed_ela.php");
							break;*/
						default:
							include_once("require_room_detailed_ela.php");
							break;
				...
				case "cartdetailed":
					...
					break;	
				case "search":
					include_once("require_room_search.php");				
					break;
				default:
					include_once("require_room.php");
					break;
