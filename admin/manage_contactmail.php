...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_contactmail.php"); ?>
    	<!-- InstanceEndEditable -->
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			switch($_GET['Opt'])
			{
				case "viewpage":
				    if($_SESSION['lang'] == 'en') {
						include_once("require_manage_contactmail_index_en.php");	
					}else if($_SESSION['lang'] == 'zh-cn') {
						include_once("require_manage_contactmail_index_cn.php");
					}else if($_SESSION['lang'] == 'jp') {
						include_once("require_manage_contactmail_index_jp.php");	
					}else if($_SESSION['lang'] == 'kr') {
						include_once("require_manage_contactmail_index_kr.php");	
					}else if($_SESSION['lang'] == 'sp') {
						include_once("require_manage_contactmail_index_sp.php");	
					} else {
						include_once("require_manage_contactmail_index.php");	
					}
					break;
				case "listpage":
					include_once("require_manage_contactmail_list.php");
					break;
				case "listitempage":
				...
				case "sub_mulilistitempage":
					...
					break;
				case "gapi":
					include_once("require_manage_googlemapapi.php");
					break;
				case "captcha":
					include_once("require_manage_captcha.php");
					break;	
				default:
					if($_SESSION['lang'] == 'en') {
						include_once("require_manage_contactmail_index_en.php");	
