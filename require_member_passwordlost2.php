...
$query_RecordSendMail = sprintf("SELECT * FROM demo_member WHERE mail = %s", GetSQLValueString($colname_RecordSendMail, "text"));
...
if (isset($_POST['account'])) {
  ...
  $LoginRS__query=sprintf("SELECT account, psw, level FROM demo_member WHERE account=%s AND psw=%s",
...
<?php } else { ?>
<?php include($TplPath . "/member_passwordlost2.php"); ?>
<?php } ?>
<?php
