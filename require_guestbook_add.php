...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_Guestbook")) {
  ...
  $insertGoTo = $SiteBaseUrl . url_rewrite('guestbook',array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'viewpage'),'',$UrlWriteEnable) . $operate_params . "addSuccess";
  /*if (isset($_SERVER['QUERY_STRING'])) {
    $insertGoTo .= (strpos($insertGoTo, '?')) ? "&" : "?";
    $insertGoTo .= $_SERVER['QUERY_STRING'];
  }*/
  ...
  exit;
		...
		$insertGoTo = $SiteBaseUrl . url_rewrite('guestbook',array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'viewpage'),'',$UrlWriteEnable) . $operate_params . "TimeOut";
  //if (isset($_SERVER['QUERY_STRING'])) {
    //$insertGoTo .= (strpos($insertGoTo, '?')) ? "&" : "?";
    //$insertGoTo .= $_SERVER['QUERY_STRING'];
	header(sprintf("Location: %s", $insertGoTo));
...
<?php } else { ?>
<?php include($TplPath . "/guestbook_add.php"); ?>
<?php } ?>
