...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_Catalog")) {
  $insertSQL = sprintf("INSERT INTO demo_catalog (title, author, type, pic, sdescription, postdate, indicate, auth, menutype, notes1, lang, userid) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
