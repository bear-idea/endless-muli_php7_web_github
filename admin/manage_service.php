...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require("require_leftmainmenu_service.php");?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include("require_manage_service_index.php");			
					break;
				case "seo":
					include("require_manage_service_index_seo.php");			
					break;
				case "addpage":
					include("require_manage_service_add.php");
					break;
				case "editpage":
					include("require_manage_service_edit.php"); 
					break;
				case "seoeditpage":
					include("require_manage_service_edit_seo.php"); 
					break;
				case "copypage":
					include("require_manage_service_copy.php"); 
					break;
				case "searchpage":
					include_once("require_manage_service_post_search.php");			
					break;
				case "postpage":
					include_once("require_manage_service_post_index.php");			
					break;
				case "postaddpage":
					include_once("require_manage_service_post_add.php");			
					break;
				case "posteditpage":
					include_once("require_manage_service_post_edit.php");			
					break;
				case "replypage":
					include_once("require_manage_service_reply_index.php");			
					break;
				case "replyaddpage":
					include_once("require_manage_service_reply_add.php");			
					break;
				case "replyeditpage":
					include_once("require_manage_service_reply_edit.php");			
					break;
				case "listpage":
					include("require_manage_service_list.php");
					break;
				case "listitempage":
					include("require_manage_service_listitem.php");
					break;
				default:
					include("require_manage_service_index.php");
					break;
