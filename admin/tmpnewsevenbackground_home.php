...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmpnewsevenbackground=%s WHERE id=%s",
...
?>
    ...
    <div style="width:100%"><span class="Type_Sum"><a href="tmpnewsevenbackground_home.php?id=<?php echo $_GET['id']; ?>" <?php if($_GET['type'] == "") { ?>class="active"<?php } ?>>全部</a></span>
    <?php do { ?>
      <span class="Type_Sum"><a href="tmpnewsevenbackground_home.php?id=<?php echo $_GET['id']; ?>&amp;type=<?php echo $row_RecordTmpBackGroundListType['itemname']; ?>" <?php if($_GET['type'] == $row_RecordTmpBackGroundListType['itemname']) { ?>class="active"<?php } ?>><?php echo $row_RecordTmpBackGroundListType['itemname']; ?></a></span>
...
<div style="height:10px; clear:both;"></div></div>
    ...
    <tbody>
      ...
      <tr>    
	   ...
	   <div style="padding:5px; border: 1px dotted #CCC; margin-bottom:2px; width:115px; float:left; margin:5px; text-align:center;" class="<?php if($row_RecordTmpBackGroundSelect['tmpnewsevenbackground'] == ''){echo "bg_active";} ?> bg_board"><!--無圖片指定-->
       <div class="TmpBgSelectIcon" style="display:<?php if($row_RecordTmpBackGroundSelect['tmpnewsevenbackground'] != ''){echo "none";} ?>;"></div>
  ...
  <?php do { ?>
    <div style="padding:5px; border: 1px dotted #CCC; margin-bottom:2px; width:115px; float:left; margin:5px; text-align:center; position:relative;" class="<?php if($row_RecordTmpBackGroundSelect['tmpnewsevenbackground'] == $row_RecordTmpBackGround['id']){echo "bg_active";} ?> bg_board">
      <div class="TmpBgSelectIcon" style="display:<?php if($row_RecordTmpBackGroundSelect['tmpnewsevenbackground'] != $row_RecordTmpBackGround['id']){echo "none";} ?>;"></div>
