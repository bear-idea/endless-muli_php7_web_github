...
<script type="text/javascript">
	...
	$(function() {
		...
		$('#ignore_refer_word').tagsInput({
			width:'auto',
			defaultText:'加入'
		});
		$('#ignore_visit_url').tagsInput({
			width:'auto',
			defaultText:'加入'
		});
		$('#ignore_visit_page').tagsInput({
			width:'auto',
			defaultText:'加入'
		});
		$('#ignore_visit_word').tagsInput({
			width:'auto',
			defaultText:'加入'
		});
		$('#ignore_refer_url').tagsInput({
			width:'auto',
			defaultText:'加入'
		});
		$('#ignore_refer_page').tagsInput({
			width:'auto',
			defaultText:'加入'
		});
...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_analysis.php"); ?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include_once("require_manage_analysis_index.php");			
					break;
				case "settingpage":
					include_once("require_manage_analysis_setting.php");			
					break;			
			}
		?>
		<!-- InstanceEndEditable -->
