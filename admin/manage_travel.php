...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_travel.php"); ?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "areapage":
					include_once("require_manage_travel_area_index.php");			
					break;
				case "viewpage":
					include_once("require_manage_travel_index.php");			
					break;
				case "viewpage_sub":
					include_once("require_manage_travel_index_sub.php");			
					break;
				case "searchpage":
					include_once("require_manage_travel_index_search.php");			
					break;
				case "viewpage_sl1":
					include_once("require_manage_travel_index_sl1.php");			
					break;
				case "viewpage_sl2":
					include_once("require_manage_travel_index_sl2.php");			
					break;
				case "viewpage_sl3":
					include_once("require_manage_travel_index_sl3.php");			
					break;
				case "multiaddpage":
					include_once("require_manage_travel_multiadd.php");
					break;
				case "addpage":
					include_once("require_manage_travel_add.php");
					break;
				case "editpage":
					include_once("require_manage_travel_edit.php"); 
					break;
				case "deletepage":
					include_once("require_manage_travel_delete.php");
					break;
				case "listpage":
					include_once("require_manage_travel_list.php");
					break;
				case "listitempage":
					include_once("require_manage_travel_listitem.php");
					break;
				case "mulilistitempage":
					include_once("require_manage_travel_mulilistitem.php");
					break;
				case "sub_mulilistitempage":
					include_once("require_manage_travel_mulilistitem_sub.php");
					break;
				case "configpage":
					include_once("require_manage_travel_config.php");
					break;
				default:
					include_once("require_manage_travel_index.php");
					break;
