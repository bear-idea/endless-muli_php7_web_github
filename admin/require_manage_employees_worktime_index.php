...
<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>sqldatatable/js/employees_datatable_worktime.js"></script>
<!-- ================== END Datatables JS ================== -->
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 基本排班 <small>總覽</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-heading">
    ...
    <div class="btn-group pull-right"><a href="inner_employees.php?wshop=<?php echo $wshop; ?>&amp;Opt=worktimeaddpage&amp;lang=<?php echo $_SESSION['lang']; ?>&amp;aid=<?php echo $_GET['aid']; ?>" class="btn btn-default btn-sm"><i class="fa fa-plus"></i> 新增</a></div>
    <h4 class="panel-title"><i class="fa fa-database"></i> 基本排班一覽</h4>
  </div>
  <!-- end panel-heading --> 
  <!-- begin panel-body -->
  <div class="panel-body">
  
  <div class="alert alert-warning m-t-0 m-b-5"><i class="fa fa-info-circle"></i> <b>若未設定該星期日程，系統會自行判斷為休假日。</b></div>
  <div class="alert alert-warning m-t-5 m-b-10"><i class="fa fa-info-circle"></i> <b>當狀態設定為休假日時，將忽略工作時間及休息時間。</b></div>
      ...
      <div class="col-md-2 m-b-10">
        <div class="input-group" data-column="3"> <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 狀態</span></span>
            <select name="indicate" class="form-control search_filter" id="col3_filter">
              ...
              <option value="上班日">上班日</option>
              <option value="休假日">休假日</option>
            </select>
        </div>
      </div>
      <!--<div class="col-md-5 m-b-10">
        <div class="input-group"> <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 描述</span></span>
    ...
    <table id="data-table-default" class="table table-striped table-bordered" style="width:100%">
      <thead>
        <tr>
          ...
          <th width="120" data-priority="1">星期</th>
          <th><strong>工作時間</strong></th>
          <th><strong>休息時間</strong></th>
