...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_accounts_summons.php"); ?>
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include("require_manage_accounts_summons_order.php");		
					break;
				case "addpage":
					include("require_manage_accounts_summons_add.php");
					break;
				case "orderaddpage":
					include("require_manage_accounts_summons_order_add.php");
					break;
				case "editpage":
					include("require_manage_accounts_summons_edit.php"); 
					break;
				case "ordereditpage":
					include("require_manage_accounts_summons_order_edit.php"); 
					break;
				case "ordercopypage":
					include("require_manage_accounts_summons_order_copy.php"); 
					break;
				case "listpage":
					include_once("require_manage_accounts_summons_list.php");
					break;
				case "listitempage":
					include_once("require_manage_accounts_summons_listitem.php");
					break;
				case "mulilistitempage":
					include_once("require_manage_accounts_summons_mulilistitem.php");
					break;
				case "mulilistitempage_adv":
					include_once("require_manage_accounts_summons_mulilistitem_adv.php");
					break;
				case "advlistitempage":
					include_once("require_manage_accounts_summons_advlilistitem.php");
					break;
				case "adminlistitempage":
					include_once("require_manage_accounts_summons_adminlilistitem.php");
					break;
				case "sub_mulilistitempage":
					include_once("require_manage_accounts_summons_mulilistitem_sub.php");
					break;
				case "sub_mulilistitempage_adv":
					include_once("require_manage_accounts_summons_mulilistitem_sub_adv.php");
					break;
				default:
					include("require_manage_accounts_summons_order.php");
					break;
