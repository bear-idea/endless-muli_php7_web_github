...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 商品折扣 <small>取消</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
?>
    ...
    <button type="submit" class="btn btn btn-danger btn-block m-t-10"><i class='fa fa-minus-circle'></i> 取消所選取指定商品</button>
