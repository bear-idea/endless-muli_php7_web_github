...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Tmp")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmptotopmode=%s, tmptotopimgwidth=%s, tmptotopimgheight=%s WHERE id=%s",
                       GetSQLValueString($_POST['tmptotopmode'], "text"),
					   GetSQLValueString($_POST['tmptotopimgwidth'], "text"),
					   GetSQLValueString($_POST['tmptotopimgheight'], "text"),
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post" id="form_Tmp" name="form_Tmp">
       <div class="form-group row">
        ...
        <div class="col-md-12"><span class="badge badge-primary"><i class="fa fa-paper-plane"></i> ToTop</span></div>
      </div>
      <div class="form-group row">
          ...
          <div class="col-md-10">
            ...
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmptotopmode'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmptotopmode" id="tmptotopmode_0" value="0" />
                <label for="tmptotopmode_0">預設</label>
            </div>
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordTmp['tmptotopmode'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmptotopmode" id="tmptotopmode_1" value="1" />
                <label for="tmptotopmode_1">自訂圖示</label>
            </div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                 <a href="uplod_tmptotopimg.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;lang=<?php echo $_GET['lang']; ?>" class="btn btn-warning colorbox_iframe"><i class="fa fa-image"></i> 圖片修改</a>
          </div>
      </div>
      <div class="form-group row">
          <label class="col-md-2 col-form-label">圖片寬度<span class="text-red">*</span></label>
          <div class="col-md-10">
                      <input name="tmptotopimgwidth" type="number" required class="form-control" id="tmptotopimgwidth" value="<?php echo $row_RecordTmp['tmptotopimgwidth']; ?>" maxlength="3" data-parsley-min="0" data-parsley-type="number" data-parsley-trigger="blur"/>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      <input name="tmptotopimgheight" type="number" required class="form-control" id="tmptotopimgheight" value="<?php echo $row_RecordTmp['tmptotopimgheight']; ?>" maxlength="3" data-parsley-min="0" data-parsley-type="number" data-parsley-trigger="blur"/>
