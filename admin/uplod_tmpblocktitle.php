...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Tmp")) {
  $updateSQL = sprintf("UPDATE demo_tmpblock SET tmp_title_pic=IFNULL(%s,tmp_title_pic) WHERE id=%s",
  ...
  $updateGoTo = "uplod_tmpblocktitle.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$(document).ready(function() {
	$("#pic").fileinput({
		...
		initialPreview: ["<?php echo $SiteImgUrlAdmin; ?><?php echo $wshop; ?>/image/tmpblock/<?php echo $row_RecordTmp['tmp_title_pic']; ?>"],
		<?php } ?>
