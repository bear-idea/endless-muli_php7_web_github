    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "areapage":
					include_once("require_manage_template_area_index.php");			
					break;
				case "viewpage":
					include_once("require_manage_template_index.php");			
					break;
				case "selectpage":
					include_once("require_manage_template_select.php");			
					break;
				case "viewpage_sub":
					include_once("require_manage_template_index_sub.php");			
					break;
				case "searchpage":
					include_once("require_manage_template_index_search.php");			
					break;
				case "viewpage_sl1":
					include_once("require_manage_template_index_sl1.php");			
					break;
				case "viewpage_sl2":
					include_once("require_manage_template_index_sl2.php");			
					break;
				case "viewpage_sl3":
					include_once("require_manage_template_index_sl3.php");			
					break;
				case "addpage":
					include_once("require_manage_template_add.php");
					break;
				case "editpage":
					include_once("require_manage_template_edit.php"); 
					break;
				case "deletepage":
					include_once("require_manage_template_delete.php");
					break;
				case "listpage":
					include_once("require_manage_template_list.php");
					break;
				case "listitempage":
					include_once("require_manage_template_listitem.php");
					break;
				case "nvlistitempage":
					include_once("require_manage_template_nvlistitem.php");
					break;
				case "mulilistitempage":
					include_once("require_manage_template_mulilistitem.php");
					break;
				case "sub_mulilistitempage":
					include_once("require_manage_template_mulilistitem_sub.php");
					break;
				case "configpage":
					include_once("require_manage_template_config.php");
					break;
				default:
					include_once("require_manage_template_index.php");
					break;
