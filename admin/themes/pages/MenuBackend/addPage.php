...
// 定義表單字段
$formFields = [
    'title' => ['label' => '選單標題', 'type' => 'text', 'maxlength' => 100, 'required' => true],
    'subtitle' => ['label' => '子選單標題', 'type' => 'text', 'maxlength' => 100, 'required' => true],
    'route_name' => ['label' => '路由名稱', 'type' => 'text', 'maxlength' => 100, 'required' => true],
