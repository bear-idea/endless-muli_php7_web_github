...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Discount")) {
  $updateSQL = sprintf("UPDATE demo_productdiscount SET name=%s, discountFullamount=%s, discountNowfold=%s, startdate=%s, enddate=%s, limitdate=%s, skeyword=%s, sdescription=%s, content=%s, menuname=%s, menuindicate=%s, indicate=%s, notes1=%s, lang=%s WHERE id=%s",
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 滿額減價(-) <small>修改</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
