...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_Bills_receivable")) {
	
	
	foreach ( $_POST['clientele'] as $key => $value ){
		$colcode_RecordClientele = "-1";
		if (isset($w_userid)) {
		  $coluserid_RecordClientele = $w_userid;
		}
		$colid_RecordClientele = "-1";
		if (isset($_POST['clientele'][$key])) {
		  $colid_RecordClientele = $_POST['clientele'][$key];
		}
		//mysqli_select_db($database_DB_Conn, $DB_Conn);
	  ...
	  $insertSQL = sprintf("INSERT INTO invoicing_bills_receivabledetail (company, clientele, clientelecode, chequenumber, amountr, collectionaccountid, postdate, indicate, state, notes1, lang, userid) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
						   ...
						   GetSQLValueString($_POST['collectionaccountid'][$key], "text"),
  ...
  $insertGoTo = "manage_bills_receivable.php?Opt=viewpage&lang=" . $_POST['lang'];
  /*if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 應收票據 <small>新增</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post">
	  ...
	  <div class="form-group row">
          <label class="col-md-2 col-form-label">收票日<span class="text-red">*</span></label>
          <div class="col-md-10">
          ...
          <div class="col-md-10">
                    <select name="clientele[]" id="clientele[]" class="form-control" data-parsley-trigger="blur" required="">
                      ...
                      <?php
						do {  
						?>
											  <option value="<?php echo $row_RecordClientele['code']?>"><?php echo $row_RecordClientele['code']?> <?php echo $row_RecordClientele['name']?></option>
											  <?php
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
              <input name="chequenumber" type="text" id="chequenumber" value="" size="50" maxlength="50" class="form-control" required=""/>    
          </div>
      </div>
	  <div class="form-group row">
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
              <input name="expirydate" type="text" class="form-control date-picker expirydate" id="expirydate" value="<?php $dt = new DateTime(); echo $dt->format('Y-m-d'); ?>" maxlength="10" data-provide="datepicker" data-date-format="yyyy-mm-dd" data-parsley-trigger="blur" data-date-language="zh-TW" required="" autocomplete="off"/> 
          ...
          <div class="col-md-10">
                    <select name="collectionaccountid[]" id="collectionaccountid[]" class="form-control" data-parsley-trigger="blur" required="">
                      ...
                      <?php
						do {  
						?>
											  <option value="<?php echo $row_RecordBank['bankaccount']?>"><?php echo $row_RecordBank['swiftcode']?> <?php echo $row_RecordBank['bankaccount']?> <?php echo $row_RecordBank['name']?></option>
											  <?php
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
              <input name="payee" type="text" id="payee" size="50" maxlength="50" class="form-control"/>    
          </div>
      </div>
      ...
      <input type="hidden" name="MM_insert" value="form_Bills_receivable" />
  </form>
  </div>
  <!-- end panel-body --> 
</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		$('.postdate, .expirydate').datepicker() 
