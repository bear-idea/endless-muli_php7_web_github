...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="alert alert-warning m-10"><i class="fa fa-info-circle"></i> <b>獲得Facebook的個人網址，點選此連結會導向您的Facebook頁面。<a href="https://www.facebook.com/me" target="_blank" class="btn btn-primary btn-xs" data-original-title="前往個人頁面" data-toggle="tooltip" data-placement="top"><i class="fa fa-chevron-right"></i> Facebook Id</a></b></div>

    <div class="alert alert-warning m-10"><i class="fa fa-info-circle"></i> <b>您的Facebook個人資料網址是您點擊Facebook主頁左上角的姓名時獲得的網址。看起來應該是這樣的。<br />https://www.facebook.com/您的FacebookID<br />https://m.facebook.com/您的FacebookID<br />https://www.facebook.com/profile.php?id=您的FacebookID</b></div>
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post">
      ...
      <div class="form-group row">
          <label class="col-md-2 col-form-label">Facebook ID<span class="text-red">*</span></label>
          <div class="col-md-10">
          
                      <input name="socialnameid" type="text" required="" class="form-control" id="socialnameid" value="<?php echo $row_RecordSocialchat['socialnameid']; ?>" maxlength="200" data-parsley-trigger="blur"/>
