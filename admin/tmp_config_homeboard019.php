...
橫幅區塊</span>
            ...
            <div id="v_wrp_middle">
              <div class="v_md"><img src="images/mt_002.png" width="60" height="60" /><br />
          		<a href="#" data-original-title="" data-toggle="tooltip" data-placement="right" class="btn btn-white btn-xs btn-block disabled"><?php echo $ModuleName['Product']; ?></a></div><span style="color: #CCC; font-size:30px; font-weight:bolder; padding:10px; position: absolute; right: 5px; bottom: 5px;"><a href="tmp_config_md_product_home_block.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&board=<?php echo $_GET['board']; ?>&lang=<?php echo $_GET['lang']; ?>" data-original-title="可在此選擇為自訂顯示(需至各別商品指定)或隨機顯示" data-toggle="tooltip" data-placement="right" class="btn btn-info btn-circle btn-xs">更多設定 <i class="fa fa-chevron-circle-right"></i></a><br />
            	模組區塊</span>
                <!--獨立背景-->
            </div>
            ...
            <div id="v_wrp_l_column">
              <div class="v_md"><img src="images/mt_054.png" width="60" height="60" /><br />
          		<a href="#" data-original-title="您可在此加入您要的內容，例如：圖片、Youtube影片、文字等等。" data-toggle="tooltip" data-placement="right" class="btn btn-white btn-xs btn-block disabled">自訂內容</a>
                <?php if ($LangChooseEN == '1' || $defaultlang == "en") { ?>
                <a href="tmp_config_home_content_small2.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=en" class="btn btn-primary btn-xs" data-original-title="英文設定" data-toggle="tooltip" data-placement="top">英</a>
                <?php } ?>
                <?php if ($LangChooseZHCN == '1' || $defaultlang == "zh-cn") { ?>
                <a href="tmp_config_home_content_small2.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=zh-cn" class="btn btn-primary btn-xs" data-original-title="簡體設定" data-toggle="tooltip" data-placement="top">簡</a>
                <?php } ?>
                <?php if ($LangChooseZHTW == '1' || $defaultlang == "zh-tw") { ?>
                <a href="tmp_config_home_content_small2.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=zh-tw" class="btn btn-primary btn-xs" data-original-title="繁體設定" data-toggle="tooltip" data-placement="top">繁</a>
                <?php } ?>
                <?php if ($LangChooseJP == '1' || $defaultlang == "jp") { ?>
                <a href="tmp_config_home_content_small2.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=jp" class="btn btn-primary btn-xs" data-original-title="日文設定" data-toggle="tooltip" data-placement="top">日</a>
                <?php } ?>
                <?php if ($LangChooseKR == '1' || $defaultlang == "kr") { ?>
                <a href="tmp_config_home_content_small2.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=kr" class="btn btn-primary btn-xs" data-original-title="韓文設定" data-toggle="tooltip" data-placement="top">韓</a>
                <?php } ?>
                <?php if ($LangChooseSP == '1' || $defaultlang == "sp") { ?>
                <a href="tmp_config_home_content_small2.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=sp" class="btn btn-primary btn-xs" data-original-title="西班牙語設定" data-toggle="tooltip" data-placement="top">西</a>
                <?php } ?>
              </div><!--獨立背景-->
            <span style="color: #CCC; font-size:30px; font-weight:bolder; padding:10px; position: absolute; right: 0px; bottom: 5px;">
            	內容區塊</span>
            </div>
            <div id="v_wrp_middle">
              <div class="v_md"><img src="images/mt_011.png" width="60" height="60" /><br />
          		<a href="#" data-original-title="" data-toggle="tooltip" data-placement="right" class="btn btn-white btn-xs btn-block disabled"><?php echo $ModuleName['Sponsor']; ?></a></div><span style="color: #CCC; font-size:30px; font-weight:bolder; padding:10px; position: absolute; right: 5px; bottom: 5px;"><br />
            	模組區塊</span>
                <!--獨立背景-->
            </div>
            </div>
