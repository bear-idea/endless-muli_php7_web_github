...
div .sponsor_inner_board{margin:5px}
div .photoFram_Block_glossy,.div_table-cell{overflow:hidden;height:100px;width:150px}
...
div .sponsor_inner_board_context{text-align:left}
</style>
<!--標題外框-->
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td valign="middle">
                        ...
                        <span style="color:#666"><?php echo $row_RecordSponsor['sdescription']; ?></span>
                    </td>
                  </tr>
                </table>
