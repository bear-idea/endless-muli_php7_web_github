...
#v_wrp_header_image{color:#CCC; font-size:30px; font-weight:bolder; padding:10px; position:absolute; left:5px; top:105px; border:#CCC dotted 1px; width:556px;;}
#v_wrp_header_image:hover{border:#C30 dotted 1px}
#v_wrp_header_enter{color:#CCC; font-size:30px; font-weight:bolder; padding:10px; position:absolute; right:5px; bottom:5px; border:#CCC dotted 1px}
        ...
        <!--獨立背景--><!--獨立背景-->
          ...
          <div style="position:relative; float:right; width:100%; margin-left:-215px; margin-right:0px;">
            <div id="v_wrp_middle"><span style="color: #CCC; font-size:30px; font-weight:bolder; padding:10px; position: absolute; left: 5px; bottom: 5px; "><br />
            	...
            	中央區塊</span>
                <!--獨立背景-->
             <div id="v_wrp_header_logo"><span style="font-size:16px;"> <a href="tmp_config_home_logo.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>" data-original-title="您可在此設定Logo的位置及選擇您要放置的Logo樣式。" data-toggle="tooltip" data-placement="right">(更多設定)</a></span><br />
            	  Logo</div>
             <div id="v_wrp_header_image"><span style="font-size:16px;"> <a href="manage_ads_home_image.php?wshop=<?php echo $wshop;?>&amp;Opt_Ads=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>&amp;board=<?php echo $_GET['board']; ?>" data-original-title="設定您的橫幅所要上傳的圖片，位於《輪播系統》中的《首頁橫幅》，請注意您的橫幅長寬必須為960px、300px。" target="_blank" data-toggle="tooltip" data-placement="right">(圖片上傳)</a></span><br />
            	  Image Banner(960x300px)</div>
