...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmpwrpboard=%s WHERE id=%s",
...
if (isset($row_RecordTmpBoardStyle['tmpwrpboard'])) {
  $colid_RecordTmpBoard = $row_RecordTmpBoardStyle['tmpwrpboard'];
}
  ...
  <div class="row">
      <div class="col-md-12">
        <div class="card bg-grey-transparent-1">
          <div class="card-block">
            <?php if($row_RecordTmpBoardStyle['tmpwrpboard'] != "") { ?>
