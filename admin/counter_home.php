...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE demo_setting_fr SET SiteStartCounter=%s WHERE id=%s",
                       GetSQLValueString($_POST['SiteStartCounter'], "int"),
...
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordSettingFr = "SELECT id,SiteStartCounter FROM demo_setting_fr WHERE userid = $w_userid";
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post" id="form_Tmp" name="form_Tmp">
       <div class="form-group row">
        ...
        <div class="col-md-12"><span class="badge badge-primary"><i class="fa fa-paper-plane"></i> 起始人數</span></div>
      </div>
      <div class="form-group row">
          <label class="col-md-2 col-form-label">初始值 <i class="fa fa-info-circle text-orange" data-original-title="人次統計的初始值。" data-toggle="tooltip" data-placement="top"></i></label>
          <div class="col-md-10">
              
             
                  <input name="SiteStartCounter" id="SiteStartCounter" value="<?php echo $row_RecordSettingFr['SiteStartCounter']; ?>" size="20" maxlength="100" class="form-control" data-parsley-min="0" data-parsley-max="9999999" type="number" data-parsley-type="number" data-parsley-trigger="blur" step="1" required=""/>
