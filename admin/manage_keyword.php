...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_keyword.php"); ?>
    	<!-- InstanceEndEditable -->
        ...
        <?php
			switch($_GET['Opt'])
			{
				...
				if($_SESSION['lang'] == 'zh-tw') {
					include_once("require_manage_config_ky_index.php");	
				}else if($_SESSION['lang'] == 'zh-cn') {
					include_once("require_manage_config_ky_index_cn.php");	
				}else if($_SESSION['lang'] == 'en') {
					include_once("require_manage_config_ky_index_en.php");	
				}else if($_SESSION['lang'] == 'kr') {
					include_once("require_manage_config_ky_index_kr.php");	
				}else if($_SESSION['lang'] == 'sp') {
					include_once("require_manage_config_ky_index_sp.php");	
				}
					break;
				default:
					if($_SESSION['lang'] == ''){
