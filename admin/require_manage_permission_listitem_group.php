...
if ((isset($_POST['deltype'])) && ($_POST['deltype'] != "")) {
  $deleteSQL2 = sprintf("DELETE FROM demo_permissiongrouptype WHERE itemid in (%s)", implode(",", $_POST['deltype']));
...
/*$colname_RecordPermissionListType = "zh-tw";
if (isset($_GET['lang'])) {
  $colname_RecordPermissionListType = $_GET['lang'];
}*/
              ...
              <div class="form-group row">
                  <!--<div class="col-md-6" style="border:0">-->
                      <div class="input-group p-0">
                            ...
                            <input name="itemname[]" type="text" id="itemname[]" value="<?php echo $row_RecordPermissionListItem['itemname']; ?>" class="form-control" <?php if ($row_RecordPermissionListItem['userid'] != $w_userid) { ?>readonly="readonly"<?php } ?> data-parsley-trigger="blur" required=""/>
