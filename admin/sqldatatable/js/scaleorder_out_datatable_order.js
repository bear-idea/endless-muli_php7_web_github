var handleDataTableDefault = function() {
    ...
    if ($('#data-table-default').length !== 0) {
		...
		//"dom":"lBfrtip",buttons:[{extend:"copy",className:"btn-sm"},{extend:"csv",className:"btn-sm"},{extend:"excel",className:"btn-sm"},{extend:"pdf",className:"btn-sm"},{extend:"print",className:"btn-sm"},{extend:"colvis",className:"btn-sm"}],
            ...
            "autoWidth": false,
            "ajax": {
                "url": "sqldatatable/scaleorder_out_view_order.php",
                "type": "post",
				"data": function ( d ) {
					...
					d.search_people = $('#col8_filter').val();
					d.search_author = $('#col10_filter').val();
					d.search_oserial = $('#col3_filter').val();
					
					d.search_postdate = $('#col11_filter').val();
            ...
            "fnDrawCallback": function(oSettings) {
				...
				$('#data-table-default').editable({
                    ...
                    url: 'sqledit/scaleorder_out_jedit_order.php',
                    name: "type",
                    source: "sqledit/scaleorder_out_get_list.php?list_id=1",
                    validate: function(value) {
                        if ($.trim(value) == '') {
                            return '值不能為空';
                        }
