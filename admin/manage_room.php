...
{
   $('.tip_img_r1').qtip({
      content: '<img src="images/tip/tip011.jpg" width="200" height="210" />'
   });
   $('.tip_img_r2').qtip({
      content: '<img src="images/tip/tip012.jpg" width="200" height="210" />'
   });
   $('.tip_img_r3').qtip({
      content: '<img src="images/tip/tip013.jpg" width="200" height="210" />'
   });
});
</script>
<!-- InstanceEndEditable -->
...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_room.php"); ?>
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include_once("require_manage_room_index.php");			
					break;
				case "viewpage_sub":
					include_once("require_manage_room_index_sub.php");			
					break;
				case "searchpage":
					include_once("require_manage_room_index_search.php");			
					break;
				case "photoviewpage":
					include_once("require_manage_room_photo_index.php");			
					break;
				case "photoaddpage":
					include_once("require_manage_room_photo_multi_add.php");			
					break;
				case "photoeditpage":
					include_once("require_manage_room_photo_edit.php");			
					break;
				case "postpage":
					include_once("require_manage_room_post_index.php");			
					break;
				case "postaddpage":
					include_once("require_manage_room_post_add.php");			
					break;
				case "posteditpage":
					include_once("require_manage_room_post_edit.php");			
					break;
				case "replypage":
					include_once("require_manage_room_reply_index.php");			
					break;
				case "replyaddpage":
					include_once("require_manage_room_reply_add.php");			
					break;
				case "replyeditpage":
					include_once("require_manage_room_reply_edit.php");			
					break;
				case "pluspage":
					include_once("require_manage_room_plus_index.php");			
					break;
				case "plusaddpage":
					include_once("require_manage_room_plus_add.php");			
					break;
				case "pluseditpage":
					include_once("require_manage_room_plus_edit.php");			
					break;
				case "postsearchpage":
					include_once("require_manage_room_post_search.php");			
					break;
				case "addpage":
					include_once("require_manage_room_add.php");
					break;
				case "editpage":
					include_once("require_manage_room_edit.php"); 
					break;
				case "edittabpage":
					include_once("require_manage_room_tab_edit.php"); 
					break;
				case "listpage":
					include_once("require_manage_room_list.php");
					break;
				case "listitempage":
					include_once("require_manage_room_listitem.php");
					break;
				case "mulilistitempage":
					include_once("require_manage_room_mulilistitem.php");
					break;
				case "advlistitempage":
					include_once("require_manage_room_advlilistitem.php");
					break;
				case "adminlistitempage":
					include_once("require_manage_room_adminlilistitem.php");
					break;
				case "sub_mulilistitempage":
					include_once("require_manage_room_mulilistitem_sub.php");
					break;
				case "configpage":
					include_once("require_manage_room_config.php");
					break;
				default:
					include_once("require_manage_room_index.php");
					break;
