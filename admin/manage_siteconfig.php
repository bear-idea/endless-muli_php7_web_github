...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_siteconfig.php"); ?>
    	<!-- InstanceEndEditable -->
			...
			switch($_GET['Opt'])
			{
				...
				case "viewpage":
					if($_SESSION['lang'] == 'en') {
						...
						include_once("require_manage_config_bs_index_jp.php");
                    }else if($_SESSION['lang'] == 'sp') {
                        include_once("require_manage_config_bs_index_sp.php");
                    }else {
