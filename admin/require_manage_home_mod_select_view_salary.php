...
<a href="manage_staff.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td height="20" align="center">員工名冊</td>
    </tr>
  </table>
</div>
</a>
<a href="manage_worksheet.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
    ...
    <tr>
      <td height="20" align="center">日排班表</td>
    </tr>
  </table>
</div>
</a>
<a href="manage_weeksheet.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_123.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">周排班表</td>
    </tr>
  </table>
</div>
</a>
<a href="manage_labor.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_114.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">勞保費表</td>
    </tr>
  </table>
</div>
</a>
<a href="manage_health.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_115.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">健保費表</td>
    </tr>
  </table>
</div>
</a>
<a href="manage_overtimepay.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_116.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">加班費表</td>
    </tr>
  </table>
</div>
</a>
<a href="manage_absence.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_117.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">缺勤扣款</td>
    </tr>
  </table>
</div>
</a>
<a href="manage_payroll.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_118.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">薪資項目</td>
    </tr>
  </table>
</div>
</a>
<div class="Menu_ListView_Icon_Board cl_blue4" style="background-image:url(images/mt_color_010.png); color:#4d5258; font-weight:bolder;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="100" align="center">行事<br/>年曆
        </td>
    </tr>
  </table>
</div>
<a href="manage_hoilday.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_121.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">例假維護</td>
    </tr>
  </table>
</div>
</a>
<a href="manage_calendar.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_122.png" width="60" height="60" /></td>
    </tr>
    <tr>
...
<div class="Menu_ListView_Icon_Board cl_blue4" style="background-image:url(images/mt_color_010.png); color:#4d5258; font-weight:bolder;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="100" align="center">資料<br/>登錄
        </td>
    </tr>
  </table>
</div>
<a href="manage_staff_worksheet.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_124.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">排班設置</td>
    </tr>
  </table>
</div>
</a>
<a href="manage_salaryform.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_120.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">薪資列表</td>
    </tr>
  </table>
</div>
</a>
<a href="manage_attendance.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_119.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">出勤紀錄</td>
    </tr>
  </table>
</div>
</a>
<div class="Menu_ListView_Icon_Board cl_blue4" style="background-image:url(images/mt_color_010.png); color:#4d5258; font-weight:bolder;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="100" align="center">報表<br/>管理
        </td>
    </tr>
  </table>
</div>
<a href="manage_yearend.php?wshop=<?php echo $wshop;?>&amp;Opt=viewpage&amp;lang=<?php echo $_SESSION['lang']; ?>">
<div class="Menu_ListView_Icon_Board cl_blue4">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="80" align="center"><img src="images/mt_106.png" width="60" height="60" /></td>
    </tr>
    <tr>
      <td height="20" align="center">年終獎金</td>
    </tr>
  </table>
</div>
</a>
