...
<script src="<?php if($SiteBaseUrlOuter != "") { echo $SiteBaseUrlOuter . $SiteBaseAdminPath; } else { echo $SiteBaseUrl . $SiteBaseAdminPath; } ?>assets/plugins/Highcharts/js/highcharts.js"></script>
<script src="<?php if($SiteBaseUrlOuter != "") { echo $SiteBaseUrlOuter . $SiteBaseAdminPath; } else { echo $SiteBaseUrl . $SiteBaseAdminPath; } ?>assets/plugins/Highcharts/js/modules/exporting.js"></script>
<script src="<?php if($SiteBaseUrlOuter != "") { echo $SiteBaseUrlOuter . $SiteBaseAdminPath; } else { echo $SiteBaseUrl . $SiteBaseAdminPath; } ?>assets/plugins/Highcharts/js/highcharts-3d.js"></script>
<!-- InstanceEndEditable -->
</head>
<body>
...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require("require_leftmainmenu_cart.php");?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include("require_manage_cart_index.php");			
					break;
				case "addpage":
					include("require_manage_cart_add.php");
					break;
				case "editpage":
					include("require_manage_cart_edit.php"); 
					break;
				case "notes":
					include("require_manage_cart_notes.php"); 
					break;
				case "odpage":
					include("require_manage_cart_setting.php"); 
					break;
				case "ivcpage":
					include("require_manage_cart_inventory_correction.php"); 
					break;
				case "deletepage":
					include("require_manage_cart_delete.php");
					break;
				case "listpage":
					include("require_manage_cart_list.php");
					break;
				case "listitempage":
					include("require_manage_cart_listitem.php");
					break;
				case "mulilistitempage":
					include_once("require_manage_cart_mulilistitem.php");
					break;
				case "sub_mulilistitempage":
					include_once("require_manage_cart_mulilistitem_sub.php");
					break;
				case "nvitempage":
					include_once("require_manage_cart_nvlistitem.php");
					break;
				case "transititempage":
					include_once("require_manage_cart_transitlistitem.php");
					break;
				case "transitset":
					include_once("require_manage_cart_transitlistitem_set.php");
					break;
				case "paymentitempage":
					include_once("require_manage_cart_paymentlistitem.php");
					break;
				case "paymentset":
					include_once("require_manage_cart_paymentlistitem_set.php");
					break;
				case "paymentdefault":
					include_once("require_manage_cart_paymentlistitem_default.php");
					break;
				case "configpage":
					include_once("require_manage_cart_config.php");
					break;
				case "setpage":
					include_once("require_manage_cart_set.php");
					break;
				case "exprice":
					include_once("require_manage_cart_exprice.php");
					break;
				case "freeprice":
					include_once("require_manage_cart_freeprice.php");
					break;
				case "invoice":
					include_once("require_manage_cart_invoice.php");
					break;
				case "export":
					include_once("require_manage_cart_export.php");
					break;
				case "anypdsell":
					include_once("require_manage_cart_analysis_product_sell.php");
					break;
				case "anyusbuy":
					include_once("require_manage_cart_analysis_user_buy.php");
					break;
				case "anypdhot":
					include_once("require_manage_cart_analysis_product_hot.php");
					break;
				case "paytip":
					include_once("require_manage_cart_paytip.php");
					break;
				case "FAQ":
					include_once("require_manage_cart_faq.php");
					break;
				case "discount":
					include_once("require_manage_cart_discount_index.php");
					break;
				case "discount_designated":
					include_once("require_manage_cart_discount_designated.php");
					break;
                case "discount_designated_cancel":
					include_once("require_manage_cart_discount_designated_cancel.php");
					break;
				case "discount_page":
					include_once("require_manage_cart_discount_page.php");
					break;
				case "discount_page_add":
					include_once("require_manage_cart_discount_page_add.php");
					break;
				case "discount_page_edit":
					include_once("require_manage_cart_discount_page_edit.php");
					break;
			    case "gift":
					include_once("require_manage_cart_discount_gift.php");
					break;
				case "gift_add":
					include_once("require_manage_cart_discount_gift_add.php");
					break;
				case "gift_edit":
					include_once("require_manage_cart_discount_gift_edit.php");
					break;
				case "discount_add":
					include_once("require_manage_cart_discount_add_select.php");
					break;
				case "discount_add_1":
					include_once("require_manage_cart_discount_add_type1.php");
					break;
				case "discount_add_2":
					include_once("require_manage_cart_discount_add_type2.php");
					break;
				case "discount_add_3":
					include_once("require_manage_cart_discount_add_type3.php");
					break;
				case "discount_add_4":
					include_once("require_manage_cart_discount_add_type4.php");
					break;
				case "discount_add_5":
					include_once("require_manage_cart_discount_add_type5.php");
					break;
				case "discount_add_6":
					include_once("require_manage_cart_discount_add_type6.php");
					break;
				case "discount_add_7":
					include_once("require_manage_cart_discount_add_type7.php");
					break;
				case "discount_add_8":
					include_once("require_manage_cart_discount_add_type8.php");
					break;
				case "discount_add_9":
					include_once("require_manage_cart_discount_add_type9.php");
					break;
				case "discount_edit_1":
					include_once("require_manage_cart_discount_edit_type1.php");
					break;
				case "discount_edit_2":
					include_once("require_manage_cart_discount_edit_type2.php");
					break;
				case "discount_edit_3":
					include_once("require_manage_cart_discount_edit_type3.php");
					break;
				case "discount_edit_4":
					include_once("require_manage_cart_discount_edit_type4.php");
					break;
				case "discount_edit_5":
					include_once("require_manage_cart_discount_edit_type5.php");
					break;
				case "discount_edit_6":
					include_once("require_manage_cart_discount_edit_type6.php");
					break;
				case "discount_edit_7":
					include_once("require_manage_cart_discount_edit_type7.php");
					break;
				case "discount_edit_8":
					include_once("require_manage_cart_discount_edit_type8.php");
					break;
				case "discount_edit_9":
					include_once("require_manage_cart_discount_edit_type9.php");
					break;
				default:
					include("require_manage_cart_index.php");
					break;
