...
div#abgne_marquee ul li a{display:block; overflow:hidden; font-size:12px; height:25px; line-height:25px; padding-left:0px; text-decoration:none}
...
<div id="abgne_marquee">
		<div class="marquee_btn" id="marquee_next_btn"><img src="<?php echo $SiteBaseUrl ?>images/marquee_next_btn.png" width="18" height="25" /></div>
		<ul>
			<?php do { ?>
		  ...
		  #
		  # 判斷是否顯示分類項目
 		  if($row_RecordPublishMarquee['type'] != "") { 
		  ?>
          <span class="TipTypeStyle">[<?php echo $row_RecordPublishMarquee['type']; ?>]</span> 
     	  <?php 
		  } 
		  #
		  # ============== [/if] ============== #
		...
		<div class="marquee_btn" id="marquee_prev_btn"><img src="<?php echo $SiteBaseUrl ?>images/marquee_prev_btn.png" /></div>
	</div>
