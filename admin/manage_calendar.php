...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require("require_leftmainmenu_calendar.php");?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include("require_manage_calendar_index.php");			
					break;
				case "addpage":
					include("require_manage_calendar_add.php");
					break;
				case "editpage":
					include("require_manage_calendar_edit.php"); 
					break;
				case "genpage":
					include("require_manage_calendar_gen.php"); 
					break;
				case "listpage":
					include("require_manage_calendar_list.php");
					break;
				case "listitempage":
					include("require_manage_calendar_listitem.php");
					break;
				default:
					include("require_manage_calendar_index.php");
					break;
