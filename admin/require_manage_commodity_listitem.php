...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_CommodityItemAdd")) {
  $insertSQL = sprintf("INSERT INTO invoicing_commodityitem (list_id, itemname, lang, userid) VALUES (%s, %s, %s, %s)",
...
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordCommodityListItem = sprintf("SELECT invoicing_commodityitem.item_id, invoicing_commodityitem.userid, invoicing_commoditylist.list_id, invoicing_commoditylist.listname, invoicing_commodityitem.itemname, invoicing_commodityitem.sortid, invoicing_commodityitem.indicate, invoicing_commodityitem.lang FROM invoicing_commoditylist LEFT OUTER JOIN invoicing_commodityitem ON invoicing_commoditylist.list_id = invoicing_commodityitem.list_id WHERE invoicing_commoditylist.list_id = %s && invoicing_commodityitem.lang=%s && invoicing_commodityitem.userid=%s ORDER BY invoicing_commodityitem.sortid ASC, invoicing_commodityitem.item_id DESC", GetSQLValueString($collistid_RecordCommodityListItem, "int"),GetSQLValueString($collang_RecordCommodityListItem, "text"),GetSQLValueString($coluserid_RecordCommodityListItem, "int"));
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-body">
    ...
    <form id="form_CommodityItemEdit" name="form_CommodityItemEdit" method="POST" action="<?php echo $editFormAction; ?>" class="form-horizontal form-bordered" data-parsley-validate="">
    <?php do { ?>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <!-- begin panel-body -->
  <div class="panel-body">
      <form id="form_CommodityItemAdd" name="form_CommodityItemAdd" method="POST" action="<?php echo $editFormAction; ?>" class="form-horizontal form-bordered" data-parsley-validate="">
      <div class="card bg-aqua-transparent-1">
          <div class="card-block">
              <div class="row">
