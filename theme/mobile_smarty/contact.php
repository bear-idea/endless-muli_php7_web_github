  ...
  <?php 
    ...
    <?php if ($TmpWrpViewLineLocate == '2') { ?>               
        ...
        <section class="page-header page-header-xxs">
			...
			<?php echo $ModuleName['Contact']; ?>
			<!-- InstanceEndEditable --></h1>
            <!-- InstanceBeginEditable name="導覽列" -->
                                    <?php require("require_contact_viewline_mobile.php"); ?>
                    <!-- InstanceEndEditable -->
        </section>
	...
	<?php } ?>
      ...
      <div class="row">      
        ...
        <?php
			...
			{
				case "viewpage":
					include_once("require_contact_mail.php");				
					break;
				/*
				case "typepage":
					include_once("require_contact_type.php");				
					break;
				case "maintypepage":
					include_once("require_contact_type.php");				
					break;
				case "detailed":
					include_once("require_contact_detailed.php");				
					break;
				*/
				default:   
					include_once("require_contact_mail.php");	
