...
if (isset($_GET['id'])) {
  $colname_RecordClientele = $_GET['id'];
}
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-body p-0 bg-white" id="jq_print">
      ...
      <tbody>
                        ...
                        <tr>
                          <td width="150" class="title_bg">客戶代號</td>
                          <td><?php echo $row_RecordClientele['code']; ?></td>
                          <td width="150" class="title_bg">公司名稱</td>
                          <td><?php echo $row_RecordClientele['name']; ?></td>
                        </tr>
                        <td class="title_bg">簡稱</td>
                          <td width="380"><?php echo $row_RecordClientele['sname']; ?></td>
                          <td width="150" class="title_bg">負責人</td>
                          <td width="380"><?php echo $row_RecordClientele['leader']; ?></td>
                        </tr>
                        <tr>
                          <td class="title_bg">統一編號</td>
                          <td><?php echo $row_RecordClientele['VATnumber']; ?></td>
                          <td class="title_bg">廠商編號</td>
                          <td><?php echo $row_RecordClientele['vendornumber']; ?></td>
                        </tr>
                    <tr>
                ...
                <tr>
                          ...
                          <td><?php echo $row_RecordClientele['tel']; ?></td>
                          <td width="150" class="title_bg">電話</td>
                          <td><?php echo $row_RecordClientele['tel2']; ?></td>
                        </tr>
                        <td class="title_bg">行動</td>
                          <td width="380"><?php echo $row_RecordClientele['cellphone']; ?></td>
                          <td width="150" class="title_bg">傳真</td>
                          <td width="380"><?php echo $row_RecordClientele['fax']; ?></td>
                        </tr>
                          <td class="title_bg">電子郵件</td>
                          <td width="380"><?php echo $row_RecordClientele['mail']; ?></td>
                          <td width="150" class="title_bg">&nbsp;</td>
                          <td width="380">&nbsp;</td>
                        </tr>
                          <td class="title_bg">營業地址</td>
                          <td colspan="3"><?php echo $row_RecordClientele['companyaddr']; ?></td>
                          </tr>
                          <td class="title_bg">送貨地址</td>
                          <td colspan="3"><?php echo $row_RecordClientele['shipmentsaddr']; ?></td>
                          </tr>
                        <td class="title_bg">聯絡人</td>
                          <td width="380"><?php echo $row_RecordClientele['contactperson']; ?></td>
                          <td width="150" class="title_bg">業務人員</td>
                          <td width="380"><?php echo $row_RecordClientele['sales']; ?></td>
                        </tr>
                        <tr>
                          <td colspan="4" class="title_bg"><i class="fa fa-chevron-circle-right" aria-hidden="true"></i> 帳務資訊</td>
                </tr>  
                          <td class="title_bg">每月結帳日</td>
                          <td width="380"><?php echo $row_RecordClientele['monthcloseday']; ?></td>
                          <td width="150" class="title_bg">交易額度</td>
                          <td width="380"><?php echo $row_RecordClientele['transactionlimit']; ?></td>
                        </tr>
                        <td class="title_bg">發票抬頭</td>
                          <td width="380"><?php echo $row_RecordClientele['invoicetittle']; ?></td>
                          <td width="150" class="title_bg">&nbsp;</td>
                          <td width="380">&nbsp;</td>
                        </tr>
                        <td class="title_bg">發票地址</td>
                          <td colspan="3"><?php echo $row_RecordClientele['invoiceaddr']; ?></td>
                          </tr>
                        <tr>
