...
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordSettingLock = sprintf("SELECT productlistLock_cn, frilinkLock_cn, fbfanLock_cn, articlelistLock_cn, alllistLock_cn, newslistLock_cn, blogplistLock_cn, blogcalendarLock_cn, blogrlistLock_cn, bloglistLock_cn, blogviewcountLock_cn, blogwhoscountLock_cn FROM demo_setting_fr WHERE userid = %s", GetSQLValueString($coluserid_RecordSettingLock, "int"));
...
<div>
  ...
  <td width="100" align="right"><?php echo $row_RecordTmpColumn['dftname']; ?></td>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-left:10px; margin-right:10px;border:solid 1px #CCCCCC;" class="TB_General_style01">
		  ...
		  <?php do { ?>
          <?php if (
		  ($row_RecordTmpAddColumn['type'] == 'blogwhoscount' && ($row_RecordSettingLock['blogwhoscountLock_cn'] == '1')) || 
		  ($row_RecordTmpAddColumn['type'] == 'blogviewcount' && ($row_RecordSettingLock['blogviewcountLock_cn'] == '1')) || 
		  ($row_RecordTmpAddColumn['type'] == 'blogrlist' && ($row_RecordSettingLock['blogrlistLock_cn'] == '1')) || 
		  ($row_RecordTmpAddColumn['type'] == 'bloglist' && ($row_RecordSettingLock['bloglistLock_cn'] == '1')) || 
		  ($row_RecordTmpAddColumn['type'] == 'blogcalendar' && ($row_RecordSettingLock['blogcalendarLock_cn'] == '1')) || 
		  ($row_RecordTmpAddColumn['type'] == 'blogplist' && ($row_RecordSettingLock['blogplistLock_cn'] == '1')) || 
