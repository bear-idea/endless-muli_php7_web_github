<div class="card bg-silver-lighter mb-10px" style="overflow:hidden">
  <div class="card-body">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 選擇網站方案 <small>選擇</small> <?php require($page_view_path_vendor."require_lang_show.php"); ?></h4>
  </div>
</div>
  ...
  <form action="manage_webuser.php?wshop=<?php echo $wshop;?>&amp;Opt=modaddpage&amp;lang=<?php echo $_SESSION['lang']; ?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post">
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                             ...
                             <div class="card pull-left m-5px">
                                  <div class="imgLiquidFill" style="width: 120px; height: 120px;"><img src="images/shop3500.png" width="130"/></div>
                                  <div class="card-body">
                                      <div class="form-check form-check-inline">
                                            <input name="modselect" class="form-check-input"  type="radio" id="modselect_1" value="1" checked="checked"  />
                             ...
                             <div class="card pull-left m-5px">
                                  ...
                                  <div class="card-body">
                                      <div class="form-check form-check-inline">
                                            <input class="form-check-input"  type="radio" name="modselect" value="2" id="modselect_2"  />
                              ...
                              <div class="card pull-left m-5px">
                                  ...
                                  <div class="card-body">
                                      <div class="form-check form-check-inline">
                                            <input class="form-check-input"  type="radio" name="modselect" value="3" id="modselect_3"  />
                              ...
                              <div class="card pull-left m-5px">
                                  ...
                                  <div class="card-body">
                                      <div class="form-check form-check-inline">
                                            <input class="form-check-input"  type="radio" name="modselect" value="4" id="modselect_4"  />
