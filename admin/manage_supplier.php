...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_supplier.php"); ?>
        <?php //require_once("require_leftmainmenu_supplier_list.php"); ?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include_once("require_manage_supplier_index.php");			
					break;
				case "seo":
					include_once("require_manage_supplier_index_seo.php");			
					break;
				case "export":
					include_once("require_manage_supplier_export.php");			
					break;
				case "copypage":
					include_once("require_manage_supplier_copy.php");			
					break;
				case "inventory":
					include_once("require_manage_supplier_inventory.php");			
					break;
				case "viewpage_sub":
					include_once("require_manage_supplier_index_sub.php");			
					break;
				case "searchpage":
					include_once("require_manage_supplier_index_search.php");			
					break;
				case "photoviewpage":
					include_once("require_manage_supplier_photo_index.php");			
					break;
				case "photoaddpage":
					include_once("require_manage_supplier_photo_multi_add.php");			
					break;
				case "photoeditpage":
					include_once("require_manage_supplier_photo_edit.php");			
					break;
				case "postpage":
					include_once("require_manage_supplier_post_index.php");			
					break;
				case "postaddpage":
					include_once("require_manage_supplier_post_add.php");			
					break;
				case "posteditpage":
					include_once("require_manage_supplier_post_edit.php");			
					break;
				case "replypage":
					include_once("require_manage_supplier_reply_index.php");			
					break;
				case "replyaddpage":
					include_once("require_manage_supplier_reply_add.php");			
					break;
				case "replyeditpage":
					include_once("require_manage_supplier_reply_edit.php");			
					break;
				case "pluspage":
					include_once("require_manage_supplier_plus_index.php");			
					break;
				case "plusaddpage":
					include_once("require_manage_supplier_plus_add.php");			
					break;
				case "pluseditpage":
					include_once("require_manage_supplier_plus_edit.php");			
					break;
				case "formatpage":
					include_once("require_manage_supplier_formatlistitem.php");
					break;
				case "spformatpage":
					include_once("require_manage_supplier_spformatlistitem.php");
					break;
				case "postsearchpage":
					include_once("require_manage_supplier_post_search.php");			
					break;
				case "addpage":
					include_once("require_manage_supplier_add.php");
					break;
				case "editpage":
					include_once("require_manage_supplier_edit.php"); 
					break;
				case "edittabpage":
					include_once("require_manage_supplier_tab_edit.php"); 
					break;
				case "listpage":
					include_once("require_manage_supplier_list.php");
					break;
				case "listitempage":
					include_once("require_manage_supplier_listitem.php");
					break;
				case "mulilistitempage":
					include_once("require_manage_supplier_mulilistitem.php");
					break;
				case "advlistitempage":
					include_once("require_manage_supplier_advlilistitem.php");
					break;
				case "adminlistitempage":
					include_once("require_manage_supplier_adminlilistitem.php");
					break;
				case "sub_mulilistitempage":
					include_once("require_manage_supplier_mulilistitem_sub.php");
					break;
				case "configpage":
					include_once("require_manage_supplier_config.php");
					break;
				case "pricecheck":
					include_once("require_manage_supplier_pricecheck.php");
					break;
				case "pricecheck_st":
					include_once("require_manage_supplier_pricecheck_config.php");
					break;
				case "editpricecheck":
					include_once("require_manage_supplier_pricecheck_edit.php");
					break;
				case "editinventory":
					include_once("require_manage_supplier_inventory_edit.php");			
					break;
				case "datachange":
					include_once("require_manage_supplier_datachange.php");
					break;
				default:
					include_once("require_manage_supplier_index.php");
					break;
