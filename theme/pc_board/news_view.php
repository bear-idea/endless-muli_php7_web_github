...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  class="TB_General_style00">
  <tr>
    <td width="20%"><?php echo $Lang_Content_Count_Display; // 顯示 ?> <?php echo ($startRow_RecordNews + 1) ?> - <?php echo min($startRow_RecordNews + $maxRows_RecordNews, $totalRows_RecordNews) ?> <?php echo $Lang_Content_Count_Lots; //筆 ?> <?php echo $Lang_Content_Count_Total; // 共計?> <?php echo $totalRows_RecordNews ?> <?php echo $Lang_Content_Count_Lots; //筆 ?></td>
    <td width="80%" align="right"><?php if ($NewsSearchSelect == "1") { ?>
      ...
      ?>
          ...
          ?>
                    <tr class= "<?php echo $chahgecolorcount; ?>">
                      <td align="center" valign="top" width="20"><?php if ($row_RecordNews['pushtop'] == '1') { ?><img src="<?php echo $TplImagePath; ?>/sicon/icon_newslist_top.gif" alt="icon" width="18" height="18" /><?php } else { ?><img src="<?php echo $TplImagePath; ?>/sicon/icon_newslist.gif" width="18" height="18" /><?php } ?></td>
                      <td valign="top"><?php 
              #
              # ============== [if] ============== #
			  #
