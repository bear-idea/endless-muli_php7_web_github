...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Tmp")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmpmodlinkboard=%s, tmpmodlinkboardicon=%s WHERE id=%s",
                       GetSQLValueString($_POST['tmpmodlinkboard'], "text"),
                       GetSQLValueString($_POST['tmpmodlinkboardicon'], "text"),
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post" id="form_Tmp" name="form_Tmp">
       <div class="form-group row">
        ...
        <div class="col-md-12"><span class="badge badge-primary"><i class="fa fa-paper-plane"></i> <?php echo $ModuleName['Modlink']; ?></span></div>
      </div>
       <div class="form-group row">
          <label class="col-md-2 col-form-label">相片外框<span class="text-red">*</span></label>                       	
          <div class="col-md-10">
          
      <select name="tmpmodlinkboard" id="tmpmodlinkboard" class="form-control" data-parsley-trigger="blur" required="">
        <option value="none" <?php if (!(strcmp("none", $row_RecordTmp['tmpmodlinkboard']))) {echo "selected=\"selected\"";} ?>>無外框</option>
        <option value="base" <?php if (!(strcmp("base", $row_RecordTmp['tmpmodlinkboard']))) {echo "selected=\"selected\"";} ?>>基本</option>
        <option value="corner" <?php if (!(strcmp("corner", $row_RecordTmp['tmpmodlinkboard']))) {echo "selected=\"selected\"";} ?>>圓角</option>
        <option value="glass01" <?php if (!(strcmp("glass01", $row_RecordTmp['tmpmodlinkboard']))) {echo "selected=\"selected\"";} ?>>玻璃圓角</option>
        <option value="glass02" <?php if (!(strcmp("glass02", $row_RecordTmp['tmpmodlinkboard']))) {echo "selected=\"selected\"";} ?>>玻璃方角</option>
        <option value="pick" <?php if (!(strcmp("pick", $row_RecordTmp['tmpmodlinkboard']))) {echo "selected=\"selected\"";} ?>>切角</option>
        <option value="stamp" <?php if (!(strcmp("stamp", $row_RecordTmp['tmpmodlinkboard']))) {echo "selected=\"selected\"";} ?>>郵票</option>
        <option value="photographic" <?php if (!(strcmp("photographic", $row_RecordTmp['tmpmodlinkboard']))) {echo "selected=\"selected\"";} ?>>相紙A</option>
        <option value="photographic01" <?php if (!(strcmp("photographic01", $row_RecordTmp['tmpmodlinkboard']))) {echo "selected=\"selected\"";} ?>>相紙B</option>
        <option value="photographic02" <?php if (!(strcmp("photographic02", $row_RecordTmp['tmpmodlinkboard']))) {echo "selected=\"selected\"";} ?>>相紙C</option>
        <option value="photographic03" <?php if (!(strcmp("photographic03", $row_RecordTmp['tmpmodlinkboard']))) {echo "selected=\"selected\"";} ?>>相紙D</option>
        <option value="photographic04" <?php if (!(strcmp("photographic04", $row_RecordTmp['tmpmodlinkboard']))) {echo "selected=\"selected\"";} ?>>相紙E</option>
        <option value="photographic05" <?php if (!(strcmp("photographic05", $row_RecordTmp['tmpmodlinkboard']))) {echo "selected=\"selected\"";} ?>>相紙F</option>
        <option value="photographic06" <?php if (!(strcmp("photographic06", $row_RecordTmp['tmpmodlinkboard']))) {echo "selected=\"selected\"";} ?>>相紙G</option>
        <option value="photographic07" <?php if (!(strcmp("photographic07", $row_RecordTmp['tmpmodlinkboard']))) {echo "selected=\"selected\"";} ?>>相紙H</option>
        <option value="photographic08" <?php if (!(strcmp("photographic08", $row_RecordTmp['tmpmodlinkboard']))) {echo "selected=\"selected\"";} ?>>相紙I</option>
        <option value="photographic09" <?php if (!(strcmp("photographic09", $row_RecordTmp['tmpmodlinkboard']))) {echo "selected=\"selected\"";} ?>>相紙J</option>
        <option value="baseline01" <?php if (!(strcmp("baseline01", $row_RecordTmp['tmpmodlinkboard']))) {echo "selected=\"selected\"";} ?>>基本線條A</option>
        <option value="baseline02" <?php if (!(strcmp("baseline02", $row_RecordTmp['tmpmodlinkboard']))) {echo "selected=\"selected\"";} ?>>基本線條B</option>
        <option value="baseline03" <?php if (!(strcmp("baseline03", $row_RecordTmp['tmpmodlinkboard']))) {echo "selected=\"selected\"";} ?>>基本線條C</option>
        <option value="baseline04" <?php if (!(strcmp("baseline04", $row_RecordTmp['tmpmodlinkboard']))) {echo "selected=\"selected\"";} ?>>基本線條D</option>
        <option value="baseline05" <?php if (!(strcmp("baseline05", $row_RecordTmp['tmpmodlinkboard']))) {echo "selected=\"selected\"";} ?>>基本線條E</option>
      </select>
      ...
      <select name="tmpmodlinkboardicon" id="tmpmodlinkboardicon" class="form-control" data-parsley-trigger="blur" >
        <option value="" <?php if (!(strcmp("", $row_RecordTmp['tmpmodlinkboardicon']))) {echo "selected=\"selected\"";} ?>>-- 選擇圖示 --</option>
        <option value="photoFram_Block_glossy" <?php if (!(strcmp("photoFram_Block_glossy", $row_RecordTmp['tmpmodlinkboardicon']))) {echo "selected=\"selected\"";} ?>>仿玻璃</option>
        <option value="photoFram_Block_floral-corner" <?php if (!(strcmp("photoFram_Block_floral-corner", $row_RecordTmp['tmpmodlinkboardicon']))) {echo "selected=\"selected\"";} ?>>花紋A</option>
        <option value="photoFram_Block_heraldry" <?php if (!(strcmp("photoFram_Block_heraldry", $row_RecordTmp['tmpmodlinkboardicon']))) {echo "selected=\"selected\"";} ?>>花紋B</option>
        <option value="photoFram_Block_paper-clip" <?php if (!(strcmp("photoFram_Block_paper-clip", $row_RecordTmp['tmpmodlinkboardicon']))) {echo "selected=\"selected\"";} ?>>迴紋針</option>
        <option value="photoFram_Block_pin" <?php if (!(strcmp("photoFram_Block_pin", $row_RecordTmp['tmpmodlinkboardicon']))) {echo "selected=\"selected\"";} ?>>圖釘</option>
        <option value="photoFram_Block_tape" <?php if (!(strcmp("photoFram_Block_tape", $row_RecordTmp['tmpmodlinkboardicon']))) {echo "selected=\"selected\"";} ?>>膠帶</option>
        <option value="photoFram_Block_flower" <?php if (!(strcmp("photoFram_Block_flower", $row_RecordTmp['tmpmodlinkboardicon']))) {echo "selected=\"selected\"";} ?>>花和蝴蝶</option>
        <option value="photoFram_Block_leaf" <?php if (!(strcmp("photoFram_Block_leaf", $row_RecordTmp['tmpmodlinkboardicon']))) {echo "selected=\"selected\"";} ?>>葉子</option>
        <option value="photoFram_Block_clip" <?php if (!(strcmp("photoFram_Block_clip", $row_RecordTmp['tmpmodlinkboardicon']))) {echo "selected=\"selected\"";} ?>>夾子</option>
      </select>
