var handleDataTableDefault = function() {
    ...
    if ($('#data-table-default').length !== 0) {
        var otable = $('#data-table-default').DataTable({       //"dom":"lBfrtip",buttons:[{extend:"copy",className:"btn-sm"},{extend:"csv",className:"btn-sm"},{extend:"excel",className:"btn-sm"},{extend:"pdf",className:"btn-sm"},{extend:"print",className:"btn-sm"},{extend:"colvis",className:"btn-sm"}],
            ...
            "autoWidth": false,
            "ajax": {
                "url": "sqldatatable/dftype_view.php",
                "type": "post",
				"data": function ( d ) {
    ...
    swal({
        ...
        preConfirm: function() {
            return new Promise(function(resolve) {
                ...
                $.ajax({
                    url: "sqldatatable/dftype_del.php?id_del=" + id,
                    type: "GET"
...
function delete_datatables_page(id,e) {
    ...
    swal({
        title: '確定删除?',
        text: "刪除後將會由主選單移除此模組連結,並一併刪除此頁面下的所有文章內容和分類",
        type: 'warning',
        showCancelButton: true,
        cancelButtonText: '取消',
        confirmButtonText: '確定',
        ...
        swal({
            ...
            preConfirm: function() {
                return new Promise(function(resolve) {
                    ...
                    $.ajax({
                        url: "sqldatatable/dftype_del_muti.php",
                        data: {
                            id: list_id
                        },
                        type: "POST"
