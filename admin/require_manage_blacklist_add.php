...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_Blacklist")) {
  ...
  $insertGoTo = "manage_blacklist.php?Opt=viewpage&lang=" . $_POST['lang'];
  /*if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 黑名單 <small>新增</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post">
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="title" type="email" id="title" maxlength="200" class="form-control" data-parsley-trigger="blur" required=""/>
      ...
      <div class="form-group row">
        <label class="col-md-2 col-form-label">分類<span class="text-red">*</span></label>
          <div class="col-md-10">
				...
				do {  
				?>
								<option value="<?php echo $row_RecordBlacklistListType['itemname']?>"><?php echo $row_RecordBlacklistListType['itemname']?></option>
								<?php
      ...
      <input type="hidden" name="MM_insert" value="form_Blacklist" />
  </form>
  </div>
  <!-- end panel-body --> 
</div>
