...
#v_wrp_middle{border:#CCC dashed 1px; margin:5px; position:relative; min-height:700px}
      ...
      <td>
       ...
       <div id="v_out_wrp">
        ...
        <a href="tmpbodybackground_home.php?id=<?php echo $row_RecordTmp['id']; ?>&amp;type=拼貼材質" data-original-title="選擇您要更換的背景" data-toggle="tooltip" data-placement="right" class="btn btn-primary btn-xs btn-block">底層背景</a>
       	...
       	<div id="v_wrp">
        <span style="position: absolute; top: -80px; left: -160px; border: #CCC dashed 1px; padding: 5px;"><img src="images/sty03.jpg" width="100" height="100" /><br />
        ...
        <iframe src="tmp_config_background_view.php?id=<?php echo $row_RecordTmp['tmpwrpbackground']  ?>" width="52" marginwidth="0" height="52" marginheight="0" scrolling="no" frameborder="0"></iframe><br />
        ...
        <a href="tmpheaderbackground_home.php?id=<?php echo $row_RecordTmp['id']; ?>&amp;type=拼貼材質" data-original-title="選擇您要更換的背景" data-toggle="tooltip" data-placement="right" class="btn btn-primary btn-xs btn-block">背景選擇</a>
            ...
            <span style="margin-left: 5px; margin-top: 5px; padding: 5px; border: #CCC dotted 1px; position: absolute; top: 3px; left: -150px;">
