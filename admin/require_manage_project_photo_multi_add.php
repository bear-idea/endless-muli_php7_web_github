...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_Project")) {
  for($i=0; $i<6; $i++)
	{
		if($_POST['pic' . $i] != "")
		{
			  $insertSQL = sprintf("INSERT INTO demo_projectalbumphoto (act_id, sdescription, pic, lang, userid) VALUES (%s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "inner_project.php?Opt=photoviewpage&lang=" . $_POST['lang'] . "&act_id=" . $_POST['act_id'] ;
  /*if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> <?php echo $ModuleName['Project']; ?> <small>新增</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
