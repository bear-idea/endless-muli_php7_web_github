  ...
  <?php 
    ...
    <?php if ($TmpWrpViewLineLocate == '2') { ?>               
        ...
        <section class="page-header page-header-xxs">
			...
			<?php echo $ModuleName['Dealer']; ?>
			<!-- InstanceEndEditable --></h1>
            <!-- InstanceBeginEditable name="導覽列" -->
                                    <?php require("require_dealer_viewline_mobile.php"); ?>
                    <!-- InstanceEndEditable -->
        </section>
	...
	<?php } ?>
      ...
      <div class="row">      
        ...
        <?php
			...
			{
				case "viewpage":
				    if ($_SESSION['MM_UserGroup_' . $_GET['wshop']] == 'Wshop_Dealer') {
						include_once("require_dealer.php");			
					}else{
						include_once("require_dealer_login.php");	
					}
					break;
				case "editpage":
					include_once("require_dealer_edit.php");				
					break;
				case "accountpage":
					include_once("require_dealer_account.php");				
					break;
				case "reg":
					include_once("require_dealer_reg.php");				
					break;
				case "log":
					include_once("require_dealer_login.php");				
					break;
				case "pswfgt":
					include_once("require_dealer_passwordlost.php");				
					break;
				case "pswfgt2":
					include_once("require_dealer_passwordlost2.php");				
					break;
				default:
					if ($_SESSION['MM_UserGroup_' . $_GET['wshop']] == 'Wshop_Dealer') {
						include_once("require_dealer.php");			
