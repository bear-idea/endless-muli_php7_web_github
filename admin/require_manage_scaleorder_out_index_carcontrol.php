...
<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>sqldatatable/js/scaleorder_out_datatable_carcontrol.js"></script>
<!-- ================== END Datatables JS ================== -->
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 車輛管制表 <small>總覽</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
    ...
    <div class="row justify-content-end">
      <div class="col-md-3 col-sm-12 m-b-10">
          <div class="input-group" data-column="0">
              ...
              <input name="postdate" type="text" class="form-control search_filter" placeholder="" id="col0_filter" autocomplete="off"/>		
          </div>
      </div>
      <div class="col-md-2 col-sm-12 m-b-10">
        <div class="input-group" data-column="2"> <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 車號</span></span>
            <select name="carnumber" class="form-control search_filter" id="col2_filter">
...
?>
      ...
      <div class="col-md-3 m-b-10">
        <div class="input-group"> <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 放行單號</span></span>
    ...
    <table id="data-table-default" class="table table-striped table-bordered table-hover table-condensed">
      <thead>
        <tr>
          ...
          <th width="100" data-priority="1"><strong>時間</strong></th>
          <th width="100" data-priority="1"><strong>車號</strong></th>
          <th width="100" data-priority="1"><strong>磅單</strong></th>
          <th width="" data-priority="1"><strong>品項及放行編號</strong></th>
          <th width="200" data-priority="1"><strong>主要載運品項</strong></th>
          <th width="100"><strong>照片</strong></th>
        </tr>
      </thead>
      <tfoot>
        <tr>
