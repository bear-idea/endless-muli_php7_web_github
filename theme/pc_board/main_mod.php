        ...
        <?php
			switch($Tp_Page)
			{
				case "Home":
					  ...
					  {
						  case "homeboard007":
						  	  include_once("require_main_mod_news.php");
							  break;
						  case "homeboard008":
							  include_once("require_main_mod_product.php");
							  break;
						  case "homeboard009":
							  include_once("require_main_mod_project.php");
							  break;
						  case "homeboard010":
							  include_once("require_main_mod_activities.php");
							  break;
						  case "homeboard011":
							  include_once("require_main_mod_sponsor.php");
							  break;
						  case "homeboard012":
							  include_once("require_main_mod_video.php");
							  break;
						  case "homeboard013":
							  include_once("require_main_mod_partner.php");
							  break;
					  }	 	
				default:
					break;
