...
<link href="<?php //if($SiteBaseUrlOuter != "") { echo $SiteBaseUrlOuter . $SiteBaseAdminPath; } else { echo $SiteBaseUrl . $SiteBaseAdminPath; } ?>assets/plugins/fullcalendar/dist/fullcalendar.print.css" rel="stylesheet" media='print'/>
<link href="<?php //if($SiteBaseUrlOuter != "") { echo $SiteBaseUrlOuter . $SiteBaseAdminPath; } else { echo $SiteBaseUrl . $SiteBaseAdminPath; } ?>assets/plugins/fullcalendar/dist/fullcalendar.min.css" rel="stylesheet" />
<script src="<?php //if($SiteBaseUrlOuter != "") { echo $SiteBaseUrlOuter . $SiteBaseAdminPath; } else { echo $SiteBaseUrl . $SiteBaseAdminPath; } ?>assets/plugins/fullcalendar/dist/fullcalendar.min.js"></script>
<script src="<?php //if($SiteBaseUrlOuter != "") { echo $SiteBaseUrlOuter . $SiteBaseAdminPath; } else { echo $SiteBaseUrl . $SiteBaseAdminPath; } ?>assets/plugins/fullcalendar/dist/locale/zh-tw.js"></script>
  ...
  <div id="content_full" class="content" style="padding:15px">
    ...
    <div class="col-lg-12">
      ...
      <?php
			switch($_GET['Opt'])
			{
				case "worktimeviewpage":
					include_once("require_manage_employees_worktime_index.php");			
					break;
			    case "worktimeaddpage":
					include_once("require_manage_employees_worktime_add.php");			
					break;
				case "worktimeeditpage":
					include_once("require_manage_employees_worktime_edit.php");			
					break;
				case "hoildayviewpage":
					include_once("require_manage_employees_hoilday_index.php");	
					break;
				default:
					break;
			}
