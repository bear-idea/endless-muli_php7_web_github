...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE demo_setting_fr SET MSTmpSelectRwd=%s WHERE userid=%s",
...
$colname_RecordTmp1 = "board009";
$colname_RecordTmp2 = "board010";

//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmp = sprintf("SELECT * FROM demo_tmp WHERE (userid=%s || userid=1) && (name=%s || name=%s) ORDER BY sortid ASC, id DESC", GetSQLValueString($coluserid_RecordTmp, "int"), GetSQLValueString($colname_RecordTmp1, "text"), GetSQLValueString($colname_RecordTmp2, "text"));
...
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpSelect = sprintf("SELECT MSTmpSelectRwd FROM demo_setting_fr WHERE userid=%s", GetSQLValueString($coluserid_RecordTmpSelect, "int"));
...
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordTmpShowSlect = sprintf("SELECT * FROM demo_tmp WHERE id = (SELECT MSTmpSelectRwd FROM demo_setting_fr WHERE userid=%s)", GetSQLValueString($coluserid_RecordTmpShowSlect, "int"));
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-body">
    ...
    <div class="alert alert-warning"><i class="fa fa-info-circle"></i> <b>此頁面版型套用後即為您網站於 <span class="label label-warning">平板 / 手機</span> 的外觀。</b></div>
    ...
    <table id="data-table-default" class="table table-bordered table-hover cards" style="width:100%">
      <thead>
        <tr>
          ...
          <th data-priority="1"><strong>可選擇版型
