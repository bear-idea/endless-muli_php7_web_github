...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Tmplogo")) {
  echo $updateSQL = sprintf("UPDATE demo_tmplogo SET logoimage_jp=IFNULL(%s,logoimage_jp), width=%s, height=%s WHERE id=%s",
  ...
  <form action="<?php echo $editFormAction;?>" class="form-horizontal form-bordered" data-parsley-validate="" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <div class="alert alert-warning m-t-5 m-b-0"><i class="fa fa-info-circle"></i> <b>目前寬度以圖片<?php if($defaultlang == "zh-tw") {echo "【繁體】";}elseif($defaultlang == "jp"){echo "【简体】";}elseif($defaultlang == "jp"){echo "【English】";}elseif($defaultlang == "jp"){echo "【日本語】";} ?>為準。</b></div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <div class="alert alert-warning m-t-5 m-b-0"><i class="fa fa-info-circle"></i> <b>目前高度以圖片<?php if($defaultlang == "zh-tw") {echo "【繁體】";}elseif($defaultlang == "jp"){echo "【简体】";}elseif($defaultlang == "jp"){echo "【English】";}elseif($defaultlang == "jp"){echo "【日本語】";} ?>為準。</b></div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
            ...
            <input name="oldpic" type="hidden" id="oldpic" value="<?php echo $row_RecordTmplogo['logoimage_jp']; ?>" />
...
$(document).ready(function() {
	$("#logoimage").fileinput({
		...
		maxFileSize: 2000,  
		<?php if ($row_RecordTmplogo['logoimage_jp'] != "") { ?>
		initialPreview: ["<?php echo $SiteImgUrlAdmin; ?><?php echo $wshop; ?>/logo/<?php echo $row_RecordTmplogo['logoimage_jp']; ?>"],
		<?php } ?>
