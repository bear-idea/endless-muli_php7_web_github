...
.sponsor_outer_board { width:<?php echo floor(floor(((1170/12)*9)/6)+40); ?>px; float:left;}
	
@media (max-width: 500px){
	.sponsor_outer_board { float:none;}
}
</style>
<!--標題外框-->
                    ...
                    <div class="photoFrame_base">
                      <div class="imgLiquid" data-fill="<?php echo 'resize'; /* resize or crop */ ?>" data-board="<?php echo '1'; /* 方型 or 矩形 */ ?>">
                       <?php if ($row_RecordSponsor['pic'] != "") { ?>	 
                            <a href="<?php echo $row_RecordSponsor['link']; ?>" target="_blank"><img src="<?php echo $SiteImgUrl; ?><?php echo $_GET['wshop']; ?>/image/sponsor/<?php echo  GetFileThumbExtend($row_RecordSponsor['pic']);?>" alt="<?php echo $row_RecordSponsor['sdescription']; ?>" /><span></span></a>
                      <?php } else { ?>      
