...
if ((isset($_POST["MM_Gen"])) && ($_POST["MM_Gen"] == "form_Banner_Gen")) {
	$insertSQLBanner = sprintf("INSERT INTO demo_adtype (title, type, sdescription, bwight, lang, userid) VALUES (%s, %s, %s, %s, %s, %s)",
					   ...
					   GetSQLValueString("contentbannerimage", "text"),
...
$insertGoTo = "manage_ads_content_image.php?wshop=" . $_GET['wshop']. "&Opt=viewpage&lang=" . $_SESSION['lang'];
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include_once("require_manage_ads_contentimage_index.php");			
					break;
				case "addpage":
				...
				case "ads_set":
					...
					break;
				case "photoviewpage":
					include_once("require_manage_ads_contentimage_photo_index.php");			
					break;
				case "photoaddpage":
					include_once("require_manage_ads_contentimage_photo_add.php");
					break;
				case "photoeditpage":
					include_once("require_manage_ads_contentimage_photo_edit.php"); 
					break;
				case "deletepage":
