<ul class="xbreadcrumbs" id="breadcrumbs-1" data-scroll-reveal='enter top after 0.8s'>
    ...
    <li class="<?php if ($_GET['Opt']!='detailed') {echo 'current';} ?>"><i class="fa fa-angle-double-right"></i> <a href="<?php echo $SiteBaseUrl . url_rewrite("faq",array('wshop'=>$_GET['wshop'],'lang'=>$_SESSION['lang'],'Opt'=>'viewpage'),'',$UrlWriteEnable);?>"><?php echo $ModuleName['Faq']; //最新訊息 ?></a></li>
    ...
    <li class="current"><i class="fa fa-angle-double-right"></i> <a><?php echo $row_RecordFaqKeyWord['title']; ?></a></li>
    <?php } ?>
