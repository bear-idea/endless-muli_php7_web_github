...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_Activities")) {
  for($i=0; $i<6; $i++)
	{
		if($_POST['pic' . $i] != "")
		{
			  $insertSQL = sprintf("INSERT INTO demo_actalbumphoto (act_id, sdescription, pic, lang, userid) VALUES (%s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "inner_activities.php?Opt=photoviewpage&lang=" . $_POST['lang'] . "&act_id=" . $_POST['act_id'] ;
  /*if (isset($_SERVER['QUERY_STRING'])) {
