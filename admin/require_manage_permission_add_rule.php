...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_Permission")) {
  $insertSQL = sprintf("INSERT INTO demo_permission (title, type, module, opt, link, postdate, enable, notes1, lang, userid) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $lastId = mysqli_insert_id($DB_Conn); // 取得最後新增(insert)資料的索引值。
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 權限規則 <small>新增</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-heading">
    ...
    <h4 class="panel-title"><i class="fa fa-plus"></i> 新增權限規則</h4>
  </div>
  <!-- end panel-heading --> 
  <!-- begin panel-body -->
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post">
      ...
      <div class="form-group row">
        <label class="col-md-2 col-form-label">模組類別群組<span class="text-red">*</span></label>
          <div class="col-md-10">
				...
				do {  
				?>
								<option value="<?php echo $row_RecordPermissionListType['itemvalue']?>"><?php echo $row_RecordPermissionListType['itemname']?> - <?php echo $row_RecordPermissionListType['itemvalue']?></option>
								<?php
      ...
      <div class="form-group row">
        <label class="col-md-2 col-form-label">群組<span class="text-red">*</span></label>
          <div class="col-md-10">
				...
				do {  
				?>
								<option value="<?php echo $row_RecordPermissionListAuthor['itemvalue']?>" <?php if (!(strcmp($row_RecordPermissionListType['itemvalue'], $row_RecordPermission['type']))) {echo "selected=\"selected\"";} ?>><?php echo $row_RecordPermissionListAuthor['itemname']?> - <?php echo $row_RecordPermissionListAuthor['itemvalue']?></option>
								<?php
      ...
      <div class="form-group row">
         ...
         <div class="radio radio-css radio-inline">
              <input  type="radio" name="module" value="<?php echo $row_RecordModList['itemvalue'] ?>" id="module_<?php echo $i ?>" />
        ...
        <?php if ($OptionDfPageSelect == '1') {?>
         ...
         <div class="mod_text">
         <div class="radio radio-css radio-inline">
              <input  type="radio" name="module" value="<?php echo $row_RecordModList['itemvalue'] ?>" id="module_<?php echo $i ?>" checked="checked"/>
              <label for="module_<?php echo $i ?>"><?php echo $row_RecordModList['customname']; ?></label>
         </div>
         </div>
         </div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="opt" type="text" id="opt" maxlength="100" class="form-control" data-parsley-trigger="blur" required="" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="link" type="text" id="link" maxlength="100" class="form-control" data-parsley-trigger="blur"  />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
            ...
            <div class="radio radio-css radio-inline">
                <input type="radio" name="enable" id="enable_1" value="1" checked />
                <label for="enable_1">啟用</label>
            </div>
            <div class="radio radio-css radio-inline">
                <input type="radio" name="enable" id="enable_2" value="0" />
      ...
      <input type="hidden" name="MM_insert" value="form_Permission" />
  </form>
  </div>
  <!-- end panel-body --> 
</div>
