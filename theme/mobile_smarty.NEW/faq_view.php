...
<script src="<?php if($SiteBaseUrlOuter != "") { echo $SiteJsUrlOuter; } else { echo $SiteJsUrl; } ?>paper-collapse.min.js"></script>
	...
	<?php do { ?>
<div class="collapse-card <?php if ($TmpFaqState == '1') { echo "active"; } ?>">
  <div class="collapse-card__heading">
    <div class="collapse-card__title">
      <div style="font-size:<?php echo $TmpFaqTitleFontSize; ?>; color:<?php echo $TmpFaqTitleFontColor; ?>; line-height:<?php echo $TmpFaqTitleFontSize; ?>;"><?php if($row_RecordFaq['type'] != "") { ?>&nbsp;【<?php echo $row_RecordFaq['type']; ?>】<?php } ?>&nbsp;<?php echo $row_RecordFaq['title']; ?></div>
    </div>
  </div>
  <div class="collapse-card__body" style="display:<?php if ($TmpFaqState == '1') { echo "block"; } ?>; margin:0px 10px;">
