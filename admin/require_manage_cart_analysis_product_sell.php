...
<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>sqldatatable/js/cart_datatable_analysis_product_sell.js"></script>
<!-- ================== END Datatables JS ================== -->
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 商品銷售 <small>統計</small> 
    ...
    <div class="row justify-content-end">
      <div class="col-md-3 col-sm-12 m-b-10">
          <div class="input-group" data-column="3">
              <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 售出日期</span></span>
      ...
      <div class="col-md-3 m-b-10">
        <div class="input-group"> <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 商品</span></span>
    ...
    <table id="data-table-default" class="table table-striped table-bordered table-hover table-condensed">
      <thead>
        <tr>
          ...
          <th width="-1" data-priority="1"><strong>商品</strong></th>
          <th width="150" data-priority="1"><strong>售出時間</strong></th>
          <th width="100" data-priority="1"><strong>售出總金額</strong></th>
          <th width="50" data-priority="1"><strong>售出數量</strong></th>
        </tr>
      </thead>
      <tfoot>
        <tr>
