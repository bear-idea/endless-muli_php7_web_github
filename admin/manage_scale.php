...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_scale.php"); ?>
        <?php //require_once("require_leftmainmenu_scale_list.php"); ?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include_once("require_manage_scale_index.php");			
					break;
				case "seo":
					include_once("require_manage_scale_index_seo.php");			
					break;
				case "export":
					include_once("require_manage_scale_export.php");			
					break;
				/*case "maintain":
					include_once("require_manage_scale_maintain.php");
					break;*/
				case "copypage":
					include_once("require_manage_scale_copy.php");			
					break;
				case "inventory":
					include_once("require_manage_scale_inventory.php");			
					break;
				case "viewpage_sub":
					include_once("require_manage_scale_index_sub.php");			
					break;
				case "searchpage":
					include_once("require_manage_scale_index_search.php");			
					break;
				case "photoviewpage":
					include_once("require_manage_scale_photo_index.php");			
					break;
				case "photoaddpage":
					include_once("require_manage_scale_photo_multi_add.php");			
					break;
				case "photoeditpage":
					include_once("require_manage_scale_photo_edit.php");			
					break;
				case "postpage":
					include_once("require_manage_scale_post_index.php");			
					break;
				case "postaddpage":
					include_once("require_manage_scale_post_add.php");			
					break;
				case "posteditpage":
					include_once("require_manage_scale_post_edit.php");			
					break;
				case "replypage":
					include_once("require_manage_scale_reply_index.php");			
					break;
				case "replyaddpage":
					include_once("require_manage_scale_reply_add.php");			
					break;
				case "replyeditpage":
					include_once("require_manage_scale_reply_edit.php");			
					break;
				case "pluspage":
					include_once("require_manage_scale_plus_index.php");			
					break;
				case "plusaddpage":
					include_once("require_manage_scale_plus_add.php");			
					break;
				case "pluseditpage":
					include_once("require_manage_scale_plus_edit.php");			
					break;
				case "formatpage":
					include_once("require_manage_scale_formatlistitem.php");
					break;
				case "spformatpage":
					include_once("require_manage_scale_spformatlistitem.php");
					break;
				case "postsearchpage":
					include_once("require_manage_scale_post_search.php");			
					break;
				case "addpage":
					include_once("require_manage_scale_add.php");
					break;
				case "editpage":
					include_once("require_manage_scale_edit.php"); 
					break;
				case "edittabpage":
					include_once("require_manage_scale_tab_edit.php"); 
					break;
				case "listpage":
					include_once("require_manage_scale_list.php");
					break;
				case "listitempage":
					include_once("require_manage_scale_listitem.php");
					break;
				case "mulilistitempage":
					include_once("require_manage_scale_mulilistitem.php");
					break;
				case "advlistitempage":
					include_once("require_manage_scale_advlilistitem.php");
					break;
				case "adminlistitempage":
					include_once("require_manage_scale_adminlilistitem.php");
					break;
				case "sub_mulilistitempage":
					include_once("require_manage_scale_mulilistitem_sub.php");
					break;
				case "configpage":
					include_once("require_manage_scale_config.php");
					break;
				case "pricecheck":
					include_once("require_manage_scale_pricecheck.php");
					break;
				case "pricecheck_st":
					include_once("require_manage_scale_pricecheck_config.php");
					break;
				case "editpricecheck":
					include_once("require_manage_scale_pricecheck_edit.php");
					break;
				case "editinventory":
					include_once("require_manage_scale_inventory_edit.php");			
					break;
				case "datachange":
					include_once("require_manage_scale_datachange.php");
					break;
				default:
					include_once("require_manage_scale_index.php");
					break;
