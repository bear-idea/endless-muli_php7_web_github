...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmpselectbannerid=%s WHERE id=%s",
...
$coltplid_RecordBannerShowSlect = "-1";
if (isset($_GET['id_edit'])) {
  $coltplid_RecordBannerShowSlect = $_GET['id_edit'];
}

//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordBannerShowSlect = sprintf("SELECT * FROM demo_bannershow WHERE id = (SELECT tmpselectbannerid FROM demo_tmp WHERE id=%s)", GetSQLValueString($coltplid_RecordBannerShowSlect, "int"));
$RecordBannerShowSlect = mysqli_query($DB_Conn, $query_RecordBannerShowSlect) or die(mysqli_error($DB_Conn));
$row_RecordBannerShowSlect = mysqli_fetch_assoc($RecordBannerShowSlect);
$totalRows_RecordBannerShowSlect = mysqli_num_rows($RecordBannerShowSlect);
?>
<!DOCTYPE html>
<html lang="zh-TW">
<!--<![endif]-->
...
<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>sqldatatable/js/tmpbanner_datatable_get.js"></script>
<!-- ================== END Datatables JS ================== -->
...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-without-sidebar p-0">
  ...
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 橫幅圖片 <small>選擇</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-heading">
    ...
    <div class="btn-group pull-right"><a href="tmp_config_wrp_banner.php?lang=<?php echo $_SESSION['lang']; ?>&amp;id_edit=<?php echo $_GET['id_edit']; ?>" data-original-title="" data-toggle="tooltip" data-placement="top" class="btn btn-default btn-sm"><i class="fa fa-reply fa-fw"></i> 上一頁</a></div>
  ...
  <div class="row">
      <div class="col-md-12">
        <div class="card bg-grey-transparent-1">
          <div class="card-block">
            <?php if($totalRows_RecordBannerShowSlect > 0) { ?>
            
            <div class="pull-left m-r-10" style="width:160px">
              <span class="label label-purple" data-original-title="目前套用背景編號" data-toggle="tooltip" data-placement="right">#No.<?php echo $row_RecordBannerShowSlect['id']; ?></span>
              <div class="img-thumbnail m-b-5 m-t-5">
              <div class="imgLiquidFill" style="width:100%; height:100px;">
              	<?php if ($row_RecordBannerShowSlect['pic'] != "") { ?>
					<?php if ($SiteBaseUrlOuter != '' && $row_RecordBannerShowSlect['userid'] == '1') {  ?>
                    <img src="<?php echo $SiteImgUrlOuter; ?><?php echo $row_RecordBannerShowSlect['webname']; ?>/image/bannershow/<?php echo $row_RecordBannerShowSlect['pic']; ?>"/>
                    <?php } else {  ?>
                    <img src="<?php echo $SiteImgUrlAdmin; ?><?php echo $row_RecordBannerShowSlect['webname']; ?>/image/bannershow/<?php echo $row_RecordBannerShowSlect['pic']; ?>"/>
                    <?php } ?>
                <?php } else { ?> 
                <img src="images/100x100_tmp.jpg" width="100" height="100"  alumb="true" _w="200" _h="100"/>
                <?php } ?> 
              </div>
              </div>
  ...
  <form action="<?php echo $editFormAction; ?>" method="POST" name="Form_Choose" id="Form_Choose" data-parsley-validate=""> 
    ...
    <div class="row justify-content-end">
      ...
      <div class="col-md-5 m-b-10">
        <div class="input-group"> <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 編號</span></span>
    ...
    <table id="data-table-default" class="table table-bordered table-hover cards" style="width:100%">
      <thead>
        <tr>
          ...
          <th data-priority="1"><strong>可選擇橫幅圖片
              <div id="error_action"></div></strong></th>
        </tr>
      </thead>
      <tfoot>
        <tr>
...
<script>
	$(document).ready(function() {
	  ...
	  $("#TransparentButtom1").click(function(){
		...
		<?php if ($row_RecordTmpBanner['tmpleftfontcolor'] == "transparent") { ?>
			$("#tmpleftfontcolor").val("transparent");
		<?php } ?>
		...
		<?php if ($row_RecordTmpBanner['tmpmiddlefontcolor'] == "transparent") { ?>
			$("#tmpmiddlefontcolor").val("transparent");
		<?php } ?>
	});
</script>
...
mysqli_free_result($RecordBannerShowSlect);
