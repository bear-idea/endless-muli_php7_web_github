...
<!--<link href="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>assets/css/layout-datatables.css" rel="stylesheet" type="text/css" />-->

<link href="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>css/styleless.css" rel="stylesheet" type="text/css" />
<link href="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>css/obj-style.css" rel="stylesheet" type="text/css" />
...
<script>
	if (!window.jQuery) {
		document.write('<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>assets/plugins/jquery/jquery-3.2.1.min.js"><\/script>');
	}
</script>
...
<script>
	if (!window.jQuery.ui) {
		document.write('<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>assets/plugins/jquery/jquery-ui.min.js"><\/script>');
	}
</script>
<script type="text/javascript" src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>assets/js/app.js"></script> 
<script type="text/javascript" src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>assets/plugins/jquery/jquery-ui.min.js"></script>
...
<!--<script language="javascript" src="../js/jquery.jeditable.js" type="text/javascript">/*原地編輯*/</script>-->
<script language="javascript" src="js/jquery.qtip-1.0.0-rc3.min.js" type="text/javascript">/*Tip*/</script>
<script language="javascript" src="js/intro.min.js" type="text/javascript"></script>
<script language="javascript" src="js/jquery.tipsy.js" type="text/javascript">/*Tip*/</script>
...
<script language="javascript" src="js/address.js" type="text/javascript"></script><!--引入郵遞區號.js檔案-->
...
<body style="background-image:url(images/h_bk.png); background-repeat:repeat-x; background-color:#FFF">

<div id="wrapper" class="clearfix">

<aside id="aside" style="top:110px; z-index:100; background: -webkit-gradient(linear,left top,right top,color-stop(93%,#EEE),color-stop(100%,#DDD)); border-right:solid 1px #DDD;">		
...
<!-- TemplateEndEditable -->				
    ...
    <section id="middle" style="padding:5px 0px 0px 0px;">
...
<script language="javascript" type="text/javascript">jQuery(document).ready(function(){fontResizer("80%","90%","100%");jQuery("div#fontdisplay").css("display","block")});</script>
</html>