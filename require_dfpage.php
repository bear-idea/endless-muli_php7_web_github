...
if(isset($HomeTypeID)) { $colaid_RecordDfPage = $HomeTypeID; }
if (isset($_GET['aid'])) {
...
$query_RecordDfPage = sprintf("SELECT * FROM demo_dfpage WHERE lang = %s && home = 1  && indicate = 1 && userid=%s && aid=%s", GetSQLValueString($colnamelang_RecordDfPage, "text"),GetSQLValueString($coluserid_RecordDfPage, "int"),GetSQLValueString($colaid_RecordDfPage, "int"));
...
<?php } else { ?>
<?php include($TplPath . "/dfpage_view.php"); ?>
<?php } ?>
<?php
