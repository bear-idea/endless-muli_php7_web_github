...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_Accounts_receivable")) {
	...
	foreach ( $_POST['clientele'] as $key => $value ){
	  ...
	  $insertSQL = sprintf("INSERT INTO invoicing_accounts_receivabledetail (company, clientele, clientelecode, amountr, amountp, amountmin, amountreal, postdate, indicate, state, notes1, lang, userid) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "manage_accounts_receivable.php?Opt=viewpage&lang=" . $_POST['lang'];
  /*if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 應收帳款 <small>新增</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post">
      ...
      <input type="hidden" name="MM_insert" value="form_Accounts_receivable" />
  </form>
  </div>
  <!-- end panel-body --> 
</div>
