 ...
 <?php do { ?> 
                           <li class="col-md-4 col-sm-6 col-xs-6"><!-- item -->
                                ...
                                <div class="imgLiquid" data-fill="<?php echo $TmpProjectImageMethods; /* resize or crop */ ?>" data-board="<?php echo $TmpProjectImageBoard; /* 方型 or 矩形 */ ?>">
										...
										<a class="ico-rounded" href="<?php echo $SiteImgUrl; ?><?php echo $_GET['wshop']; ?>/image/project/<?php echo $row_RecordProject['pic']; ?>"><img src="<?php echo $SiteImgUrl; ?><?php echo $_GET['wshop']; ?>/image/project/thumb/small_<?php echo GetFileThumbExtend($row_RecordProject['pic']); ?>" alt=""></a>
                                        <?php } else { ?>
