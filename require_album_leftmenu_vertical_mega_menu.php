...
$query_RecordMultiLeftMenu_l1 = sprintf("SELECT * FROM demo_albumitem WHERE list_id = 1 && lang = %s && userid=%s ORDER BY item_id DESC", GetSQLValueString($collang_RecordMultiLeftMenu_l1, "text"),GetSQLValueString($coluserid_RecordMultiLeftMenu_l1, "int"));
...
<div class="dcjq-vertical-mega-menu">
        ...
        <?php do { ?>
             <li class="child">
            <a href="album.php?Opt=viewpage&lang=<?php echo $_SESSION['lang']; ?>&tp=Album&type=<?php echo urlencode($row_RecordMultiLeftMenu_l1['itemname']); ?>"><?php echo $row_RecordMultiLeftMenu_l1['itemname']; ?>
            </a>
            </li>
