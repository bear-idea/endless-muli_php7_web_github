...
#v_wrp_middle{border:#CCC dashed 1px; margin:5px; margin-left:5px; position:relative; min-height:700px}
...
橫幅區塊</span>
            ...
            <div id="v_wrp_middle">
              <div class="v_md"><img src="images/mt_060.png" width="60" height="60" /><br />
                ...
                <a href="tmp_config_homeboard002_block_en.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=en" class="btn btn-primary btn-xs" data-original-title="英文設定" data-toggle="tooltip" data-placement="top">英</a>
                <?php } ?>
                <?php if ($LangChooseZHCN == '1' || $defaultlang == "zh-cn") { ?>
                <a href="tmp_config_homeboard002_block_cn.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=zh-cn" class="btn btn-primary btn-xs" data-original-title="簡體設定" data-toggle="tooltip" data-placement="top">簡</a>
                <?php } ?>
                <?php if ($LangChooseZHTW == '1' || $defaultlang == "zh-tw") { ?>
                <a href="tmp_config_homeboard002_block.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=zh-tw" class="btn btn-primary btn-xs" data-original-title="繁體設定" data-toggle="tooltip" data-placement="top">繁</a>
                <?php } ?>
                <?php if ($LangChooseJP == '1' || $defaultlang == "jp") { ?>
                <a href="tmp_config_homeboard002_block_jp.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=jp" class="btn btn-primary btn-xs" data-original-title="日文設定" data-toggle="tooltip" data-placement="top">日</a>
                <?php } ?>
                <?php if ($LangChooseKR == '1' || $defaultlang == "kr") { ?>
                <a href="tmp_config_homeboard002_block_kr.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=kr" class="btn btn-primary btn-xs" data-original-title="韓文設定" data-toggle="tooltip" data-placement="top">韓</a>
                <?php } ?>
                <?php if ($LangChooseSP == '1' || $defaultlang == "sp") { ?>
                <a href="tmp_config_homeboard002_block_sp.php?id_edit=<?php echo $row_RecordTmp['id']; ?>&amp;board=<?php echo $_GET['board']; ?>&amp;lang=sp" class="btn btn-primary btn-xs" data-original-title="西班牙語設定" data-toggle="tooltip" data-placement="top">西</a>
                <?php } ?>
            </div>
