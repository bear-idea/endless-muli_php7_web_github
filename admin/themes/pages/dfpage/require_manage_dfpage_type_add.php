...
<div class="card bg-silver-lighter mb-10px" style="overflow:hidden">
  <div class="card-body">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> <?php echo $ModuleName['DfType']; ?> <small>新增</small> <?php require($page_view_path_vendor."require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9">
  ...
  <form action="<?php echo $request->getRequestUri(); ?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post" id="form1">
      ...
      <div class="form-group row">
          ...
          <div class="mod_board col-md-2 col-sm-3 col-xs-4"><div class="mod_pic"><img src="images/mt_019.png" width="60" height="60" /></div>
             ...
             <div class="form-check form-check-inline">
                  <input  class="form-check-input"  type="radio" name="typemenu" value="Home" id="typemenu_Home" />
           ...
           <?php } while ($row_RecordModList = mysqli_fetch_assoc($RecordModList)); ?>
             ...
             <div class="mod_text">
             <div class="form-check form-check-inline">
                  <input  class="form-check-input"  type="radio" name="typemenu" value="Link" id="typemenu_Link"/>
                  <label for="typemenu_Link">它網連結 <i class="fa fa-info-circle text-orange" data-bs-original-title="此模組會內連到外部網站並開新視窗，選擇此項目後在《網址》輸入網址即可。" data-bs-toggle="tooltip" data-bs-placement="top"></i></label>
             </div>
             </div>
             </div>
             ...
             <div class="mod_text">
             <div class="form-check form-check-inline">
                  <input  class="form-check-input"  type="radio" name="typemenu" value="LinkPage" id="typemenu_LinkPage" />
                  <label for="typemenu_LinkPage">頁面連結 <i class="fa fa-info-circle text-orange" data-bs-original-title="此模組會內連到內部網站，選擇此項目後在《網址》輸入網址即可。" data-bs-toggle="tooltip" data-bs-placement="top"></i></label>
             </div>
             </div>
             </div>
             <?php //} ?>
             ...
             <div class="mod_text">
             <div class="form-check form-check-inline">
                  <input  class="form-check-input"  type="radio" name="typemenu" value="AnchorPoint" id="typemenu_AnchorPoint" />
                  <label for="typemenu_AnchorPoint">錨點 <i class="fa fa-info-circle text-orange" data-bs-original-title="此模組可設定可以快速的定位到指定元素，並將元素置於頁面最頂端。" data-bs-toggle="tooltip" data-bs-placement="top"></i></label>
             </div>
             </div>
             </div>
             ...
             <div class="mod_text">
             <div class="form-check form-check-inline">
                  <input  class="form-check-input"  type="radio" name="typemenu" value="Cart_Pay" id="typemenu_Cart_Pay"/>
             ...
             <div class="mod_text">
             <div class="form-check form-check-inline">
                  <input  class="form-check-input"  type="radio" name="typemenu" value="Cart_Note" id="typemenu_Cart_Note"/>
             ...
             <div class="mod_text">
             <div class="form-check form-check-inline">
                  <input  class="form-check-input"  type="radio" name="typemenu" value="Scalesource" id="typemenu_Scalesource" />
             ...
             <div class="mod_text">
             <div class="form-check form-check-inline">
                  <input  class="form-check-input"  type="radio" name="typemenu" value="ScaleClearance" id="typemenu_ScaleClearance" />
             ...
             <div class="mod_text">
             <div class="form-check form-check-inline">
                  <input  class="form-check-input"  type="radio" name="typemenu" value="Splitorder" id="typemenu_Splitorder" />
             ...
             <div class="mod_text">
             <div class="form-check form-check-inline">
                  <input  class="form-check-input"  type="radio" name="typemenu" value="Booking" id="typemenu_Booking" />
