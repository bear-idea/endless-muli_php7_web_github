...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require_once("require_leftmainmenu_accounts_book.php"); ?>
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "diarypage":
					include("require_manage_accounts_book_diary.php");		
					break;
				case "cashpage":
					include("require_manage_accounts_book_cash.php");		
					break;
				case "generalledgerpage":
					include("require_manage_accounts_book_generalledger.php");		
					break;
				case "detailledgerpage":
					include("require_manage_accounts_book_detailledger.php");		
					break;
				case "settingpage":
					include("require_manage_accounts_book_setting.php");		
					break;
				default:
					include("require_manage_accounts_book_diary.php");
					break;
