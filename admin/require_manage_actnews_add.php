...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_Actnews")) {
  $insertSQL = sprintf("INSERT INTO demo_actnews (title, author, type, pic, content, postdate, indicate, sdescription, skeyword, skeywordindicate, pushtop, notes1, lang, userid) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> <?php echo $ModuleName['Actnews']; ?> <small>新增</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
          ...
          <div class="col-md-10">
                    <select name="author" id="author" class="form-control" data-parsley-trigger="blur" required="">
                      ...
                      <?php
						do {  
						?>
											  <option value="<?php echo $row_RecordActnewsListAuthor['itemname']?>"><?php echo $row_RecordActnewsListAuthor['itemname']?></option>
											  <?php
