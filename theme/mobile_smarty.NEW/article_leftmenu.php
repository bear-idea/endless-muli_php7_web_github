<ul class="list-group list-group-bordered list-group-noicon uppercase">
        <?php do { ?>
            ...
            <li class="<?php echo $row_RecordMultiLeftMenu_l1['endnode']; ?> list-group-item">
            <?php if ($row_RecordMultiLeftMenu_l1['endnode'] != 'child') { ?>
            <a href="#" class="dropdown-toggle"><?php echo $row_RecordMultiLeftMenu_l1['itemname']; ?></a>
            <?php } else { ?>
            ...
            <ul>
              <?php
					...
					?>
              <?php do { ?>
                <li class="<?php echo $row_RecordMultiLeftMenu_l2['endnode']; ?> list-group-item">
                  <?php if ($row_RecordMultiLeftMenu_l2['endnode'] != 'child') { ?>
                  <a href="#" class="dropdown-toggle"><strong><?php echo $row_RecordMultiLeftMenu_l2['itemname']; ?></strong></a>
                  <?php } else { ?>
                  ...
                  <ul>
                    <?php
                        ...
                        ?>
                    <?php do { ?>
                      <li class="<?php echo $row_RecordMultiLeftMenu_l3['endnode']; ?> list-group-item">
