...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Actnews")) {
  $updateSQL = sprintf("UPDATE demo_actnews SET title=%s, author=%s, type=%s, content=%s, postdate=%s, indicate=%s, sdescription=%s, skeyword=%s, skeywordindicate=%s, pushtop=%s, notes1=%s, lang=%s WHERE id=%s",
  ...
  $updateGoTo = "manage_actnews.php?Opt=viewpage&lang=" . $_POST['lang'];
  /*if (isset($_SERVER['QUERY_STRING'])) {
...
/* 取得類別資料 */
$colname_RecordActnewsListType = "zh-tw";
if (isset($_GET["lang"])) {
...
/* 取得作者資料 */
$colname_RecordActnewsListAuthor = "zh-tw";
if (isset($_GET['lang'])) {
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> <?php echo $ModuleName['Actnews']; ?> <small>修改</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
?>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">      
          <a href="uplod_actnews.php?id_edit=<?php echo $row_RecordActnews['id']; ?>&amp;lang=<?php echo $_GET['lang']; ?>" class="btn btn-warning colorbox_iframe_cd"><i class="fa fa-image"></i> 圖片修改</a>                    
        </div>
      </div>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
            ...
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordActnews['indicate'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="indicate" id="indicate_1" value="1" />
                <label for="indicate_1">公佈</label>
            </div>
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordActnews['indicate'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="indicate" id="indicate_2" value="0" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordActnews['skeywordindicate'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="skeywordindicate" id="skeywordindicate_1" value="1" />
                <label for="skeywordindicate_1">顯示</label>
            </div>
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordActnews['skeywordindicate'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="skeywordindicate" id="skeywordindicate_2" value="0" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordActnews['pushtop'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="pushtop" id="pushtop_1" value="1" />
                <label for="pushtop_1">是</label>
            </div>
            <div class="radio radio-css radio-inline">
                <input <?php if (!(strcmp($row_RecordActnews['pushtop'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="pushtop" id="pushtop_2" value="0" />
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
              <input name="postdate" type="text" class="form-control" id="postdate" value="<?php $dt = new DateTime($row_RecordActnews['postdate']); echo $dt->format('Y-m-d'); ?>" maxlength="10" data-provide="datepicker" data-date-format="yyyy-mm-dd" data-date-language="zh-TW" data-parsley-trigger="blur" required="" autocomplete="off"/> 
