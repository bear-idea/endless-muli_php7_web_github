...
$query_RecordMultiLeftMenu_l1 = sprintf("SELECT * FROM invoicing_accounts_summonsitem WHERE list_id = 1 && itemvalue = %s && lang = %s && level = '1' && indicate = '1' && userid=%s ORDER BY itemvalue ASC, item_id DESC", GetSQLValueString($colitemvalue_RecordMultiLeftMenu_l1, "text"), GetSQLValueString($collang_RecordMultiLeftMenu_l1, "text"),GetSQLValueString($coluserid_RecordMultiLeftMenu_l1, "int"));
...
$CurrentYear = $row_RecordAccounts_summonssetting['CurrentYear'] . '-01-01';
        ...
        <?php do { ?>
          ...
          <ul>
            <?php
					...
					//mysqli_select_db($database_DB_Conn, $DB_Conn);
					$query_RecordMultiLeftMenu_l2 = sprintf("SELECT * FROM invoicing_accounts_summonsitem WHERE list_id = 1 && lang = %s && level = '2' && subitem_id = %s && indicate = '1' ORDER BY itemvalue ASC, item_id DESC", GetSQLValueString($collang_RecordMultiLeftMenu_l2, "text"),GetSQLValueString($colsubitem_id_RecordMultiLeftMenu_l2, "int"));
            ...
            <?php do { ?>
              <li><?php echo $row_RecordMultiLeftMenu_l2['itemvalue']; ?> <?php echo $row_RecordMultiLeftMenu_l2['itemname']; ?>
                  ...
                  <?php 
                      $row_RecordAccounts_summonsListType['itemvalue'] = $row_RecordMultiLeftMenu_l2['itemvalue']; 
                      $row_RecordAccounts_summonsListType['state'] = $row_RecordMultiLeftMenu_l2['state']; 
                      $row_RecordAccounts_summonsListType['level0'] = $row_RecordMultiLeftMenu_l1['itemvalue'];
                      require("require_manage_accounts_report_balancesheet_print_get_trialbalance.php"); 
                ...
                <ul>
                  <?php
                        ...
                        //mysqli_select_db($database_DB_Conn, $DB_Conn);
                        $query_RecordMultiLeftMenu_l3 = sprintf("SELECT * FROM invoicing_accounts_summonsitem WHERE list_id = 1 && lang = %s && level = '3' && subitem_id = %s && indicate = '1' ORDER BY itemvalue ASC, item_id DESC", GetSQLValueString($collang_RecordMultiLeftMenu_l3, "text"),GetSQLValueString($colsubitem_id_RecordMultiLeftMenu_l3, "int"));
                        ...
                        ?>
                  <?php do { ?>
                    <li><?php echo $row_RecordMultiLeftMenu_l3['itemvalue']; ?> <?php echo $row_RecordMultiLeftMenu_l3['itemname']; // 第四層 ?>
						...
						<ul>
						  <?php
								...
								//mysqli_select_db($database_DB_Conn, $DB_Conn);
								$query_RecordMultiLeftMenu_l4 = sprintf("SELECT * FROM invoicing_accounts_summonsitem WHERE list_id = 1 && lang = %s && level = '4' && subitem_id = %s && indicate = '1' ORDER BY itemvalue ASC, item_id DESC", GetSQLValueString($collang_RecordMultiLeftMenu_l4, "text"),GetSQLValueString($colsubitem_id_RecordMultiLeftMenu_l4, "int"));
								...
								?>
						  <?php do { ?>
							<li><?php echo $row_RecordMultiLeftMenu_l4['itemvalue']; ?> <?php echo $row_RecordMultiLeftMenu_l4['itemname']; ?>
								...
								<ul>
								  <?php
										...
										?>
								  <?php do { ?>
									<li><?php echo $row_RecordMultiLeftMenu_l5['itemvalue']; ?> <?php echo $row_RecordMultiLeftMenu_l5['itemname']; ?>
