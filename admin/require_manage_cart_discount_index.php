...
<script src="<?php echo $SiteBaseUrl . $SiteBaseAdminPath; ?>sqldatatable/js/cart_datatable_discount.js"></script>
<!-- ================== END Datatables JS ================== -->
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 折扣活動 <small>總覽</small> 
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="alert alert-warning"><i class="fa fa-info-circle"></i> <b>注意!! 設定優惠活動將會忽略商品原先所設定的特價，皆會以原價來做計算。</b></div>
    ...
    <div class="row justify-content-end">
      ...
      <div class="col-md-2 col-sm-12 m-b-10">
        <div class="input-group" data-column="6"> <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 狀態</span></span>
            <select name="state" class="form-control search_filter" id="col6_filter">
      ...
      <div class="col-md-3 m-b-10">
        <div class="input-group"> <span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-search fa-fw"></i> 標題 / 描述</span></span>
    ...
    <table id="data-table-default" class="table table-striped table-bordered table-hover table-condensed">
      <thead>
        <tr>
          ...
          <th width="150" data-priority="1"><strong>折扣方式</strong></th>
          <th width="70" data-priority="1"><strong>分類</strong></th>
          <th width="70" data-priority="1"><strong>選單顯示</strong></th>
          <th width="150" data-priority="1"><strong>選單名稱</strong></th>
          <th width="70" data-priority="1"><strong>狀態</strong></th>
          <th width="160"><strong>限制</strong></th>
