...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 資產負債表 <small>選擇</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-body p-0">
    ...
    <?php //if ($totalRows_RecordYearend == 0) { // Show if recordset not empty ?>
     <form action="print_accounts_report.php?wshop=<?php echo $wshop;?>&amp;Opt=balancesheetpage_print&amp;lang=<?php echo $_SESSION['lang']; ?>" method="post"  name="Yearend_Gen" target="_blank" class="form-horizontal form-bordered m-t-0" id="Yearend_Gen" data-parsley-validate="">
     
     <div class="form-group row">
        <label class="col-md-2 col-form-label">選擇日期<span class="text-red">*</span></label>
          <div class="col-md-10">
