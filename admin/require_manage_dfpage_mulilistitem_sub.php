          ...
          <tr>
            ...
            <td width="300"><label for="sortid[]"></label>
              <input name="itemname[]" type="text" id="itemname[]" value="<?php echo $row_RecordDfPageListItem['itemname']; ?>" maxlength="30" /><span class = "InnerPage">&nbsp;&nbsp;&nbsp;
                <?php if ($_GET['level'] == '') { ?>
                <a href="manage_dfpage.php?wshop=<?php echo $wshop;?>&amp;Opt=sub_mulilistitempage&amp;lang=<?php echo $_SESSION['lang']; ?>&amp;item_id=<?php echo $_GET['item_id']; ?>&amp;level=1&amp;aid=<?php echo $_GET['aid']; ?>&amp;tpt=<?php echo $row_RecordTpt['title']; ?>" onfocus="undefined" data-original-title="點選查看下層的分類項目" data-toggle="tooltip" data-placement="right"><i class="fa fa-folder-open-o"></i> 子分類</a>
                <?php } ?>
                <?php if ($_GET['level'] == '1') { ?>
                <a href="manage_dfpage.php?wshop=<?php echo $wshop;?>&amp;Opt=sub_mulilistitempage&amp;lang=<?php echo $_SESSION['lang']; ?>&amp;item_id=<?php echo $row_RecordDfPageListItem['item_id']; ?>&amp;subitem_id=<?php echo $row_RecordDfPageListItem['subitem_id']; ?>&amp;level=2&amp;aid=<?php echo $_GET['aid']; ?>&amp;tpt=<?php echo $row_RecordTpt['title']; ?>" onfocus="undefined" data-original-title="點選查看下層的分類項目" data-toggle="tooltip" data-placement="right"><i class="fa fa-folder-open-o"></i> 子分類</a>
                <?php } ?>
                <?php if ($_GET['level'] == '2') { ?>
                <!--<a href="manage_dfpage.php?wshop=<?php echo $wshop;?>&amp;Opt=sub_mulilistitempage&amp;lang=<?php echo $_SESSION['lang']; ?>&amp;item_id=<?php echo $row_RecordDfPageListItem['item_id']; ?>&amp;level=3&amp;aid=<?php echo $_GET['aid']; ?>" onfocus="undefined" data-original-title="點選查看下層的分類項目" data-toggle="tooltip" data-placement="right"><i class="fa fa-folder-open-o"></i> 子分類</a>-->
                <?php } ?>
                </span>
            ...
            <td>刪除：
              <input name="deltype[]" type="checkbox" id="deltype[]" value="<?php echo $row_RecordDfPageListItem['item_id']; ?>" />
              <label for="deltype[]">
