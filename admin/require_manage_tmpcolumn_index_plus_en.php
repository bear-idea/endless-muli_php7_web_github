...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "TmpColumnFree")) {
  $insertSQL = sprintf("INSERT INTO demo_tmpcolumn (type, style, dftname, customname, location, lang, userid) VALUES (%s, %s, %s, %s, %s, %s, %s)",
					   ...
					   GetSQLValueString($_POST['dftname_en'], "text"),
...
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordSettingLock = sprintf("SELECT productlistLock_en, productactlistLock_en, producthotlistLock_en, productsalelistLock_en, productnewslistLock_en, frilinkLock_en, modlinkLock_en, fbfanLock_en, articlelistLock_en, alllistLock_en, newslistLock_en, blogplistLock_en, blogcalendarLock_en, siteviewcountLock_en, sitewhoscountLock_en, alltypelistLock_en, productsearchLock_en FROM demo_setting_fr WHERE userid = %s", GetSQLValueString($coluserid_RecordSettingLock, "int"));
  ...
  <div class="panel-body">
    <div class="table-responsive">
        <table class="table table-hover m-b-0">
			...
			<?php do { ?>
            <?php if (
		  ($row_RecordTmpAddColumn['type'] == 'sitewhoscount' && ($row_RecordSettingLock['sitewhoscountLock_en'] == '1')) || 
		  ($row_RecordTmpAddColumn['type'] == 'siteviewcount' && ($row_RecordSettingLock['siteviewcountLock_en'] == '1')) || 
		  ($row_RecordTmpAddColumn['type'] == 'blogcalendar' && ($row_RecordSettingLock['blogcalendarLock_en'] == '1' OR $OptionBlogSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'blogplist' && ($row_RecordSettingLock['blogplistLock_en'] == '1' OR $OptionBlogSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'frilink' && ($row_RecordSettingLock['frilinkLock_en'] == '1' OR $OptionFrilinkSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'modlink' && ($row_RecordSettingLock['modlinkLock_en'] == '1')) || 
		  ($row_RecordTmpAddColumn['type'] == 'productlist' && ($row_RecordSettingLock['productlistLock_en'] == '1' OR $OptionProductSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'productactlist' && ($row_RecordSettingLock['productactlistLock_en'] == '1' OR $OptionProductSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'producthotlist' && ($row_RecordSettingLock['producthotlistLock_en'] == '1' OR $OptionProductSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'productsalelist' && ($row_RecordSettingLock['productsalelistLock_en'] == '1' OR $OptionProductSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'productnewslist' && ($row_RecordSettingLock['productnewslistLock_en'] == '1' OR $OptionProductSelect == '0')) ||
		  ($row_RecordTmpAddColumn['type'] == 'productsearch' && ($row_RecordSettingLock['productsearchLock_en'] == '1' OR $OptionProductSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'articlelist' && ($row_RecordSettingLock['articlelistLock_en'] == '1' OR $OptionArticleSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'alltypelist' && ($row_RecordSettingLock['alltypelistLock_en'] == '1')) || 
          ...
          <form name="TmpColumn" action="<?php echo $editFormAction; ?>" method="POST" id="TmpColumn<?php echo $row_RecordTmpAddColumn['type']; ?>">
             ...
             <input name="dftname_en" type="hidden" id="dftname_en" value="<?php echo $row_RecordTmpAddColumn['dftname_en']; ?>" />
