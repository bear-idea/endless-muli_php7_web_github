...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require("require_leftmainmenu_labor.php");?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include("require_manage_labor_index.php");			
					break;
				case "genpage":
					include("require_manage_labor_gen.php");
					break;
				case "genpage_staff":
					include("require_manage_labor_gen_staff.php");
					break;
				case "listpage":
					include("require_manage_labor_list.php");
					break;
				case "listitempage":
					include("require_manage_labor_listitem.php");
					break;
				default:
					include("require_manage_labor_index.php");
					break;
