...
/* 取得類別資料 */
$colname_RecordNewsListType = "zh_TW";
if (isset($_GET['lang'])) {
...
/* 取得發佈者資料 */
$colname_RecordNewsListAuthor = "zh_TW";
if (isset($_GET['lang'])) {
...
<script src="<?php echo $SiteAdminPath; ?>sqldatatable/js/news_datatable_seo.js"></script>


<div class="card bg-silver-lighter mb-10px" style="overflow:hidden">
  <div class="card-body">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> <?php echo $ModuleName['News']; ?> <small>總覽</small> <?php require($page_view_path_vendor."require_lang_show.php"); ?></h4>
  </div>
</div>
...
do {
?>
                  <option value="<?php echo $row_RecordNewsListType['itemname']?>"><?php echo $row_RecordNewsListType['itemname']?></option>
                  <?php
