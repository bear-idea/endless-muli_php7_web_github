...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require("require_leftmainmenu_epaper.php");?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include("require_manage_epaper_index.php");			
					break;
				case "mailpage":
					include("require_manage_epapermail_index.php");			
					break;
				case "addpage":
					include("require_manage_epaper_add.php");
					break;
				case "editpage":
					include("require_manage_epaper_edit.php"); 
					break;
				case "addmailpage":
					include("require_manage_epapermail_add.php");
					break;
				case "editmailpage":
					include("require_manage_epapermail_edit.php"); 
					break;
				case "deletepage":
					include("require_manage_epaper_delete.php");
					break;
				case "listpage":
					include("require_manage_epaper_list.php");
					break;
				case "listitempage":
					include("require_manage_epaper_listitem.php");
					break;
				case "configpage":
					include("require_manage_epaper_config.php");
					break;
				default:
					include("require_manage_epaper_index.php");
					break;
