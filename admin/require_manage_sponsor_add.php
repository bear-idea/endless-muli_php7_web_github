...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_Sponsor")) {
  $insertSQL = sprintf("INSERT INTO demo_sponsor (name, type, link, pic, sdescription, indicate, notes1, lang, userid) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "manage_sponsor.php?Opt=viewpage&lang=" . $_POST['lang'];
  /*if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> <?php echo $ModuleName['Sponsor']; ?> <small>新增</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?><?php echo '&amp;GP_upload=true'; ?>" class="form-horizontal form-bordered" data-parsley-validate="" method="post" enctype="multipart/form-data">
      ...
      <input type="hidden" name="MM_insert" value="form_Sponsor" />
  </form>
  </div>
  <!-- end panel-body --> 
</div>
