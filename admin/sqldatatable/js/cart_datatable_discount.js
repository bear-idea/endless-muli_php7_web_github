var handleDataTableDefault = function() {
    ...
    if ($('#data-table-default').length !== 0) {
		...
		//"dom":"lBfrtip",buttons:[{extend:"copy",className:"btn-sm"},{extend:"csv",className:"btn-sm"},{extend:"excel",className:"btn-sm"},{extend:"pdf",className:"btn-sm"},{extend:"print",className:"btn-sm"},{extend:"colvis",className:"btn-sm"}],
            ...
            "autoWidth": false,
            "ajax": {
                "url": "sqldatatable/cart_view_discount.php",
                "type": "post",
				"data": function ( d ) {
					...
					d.search_postdate = $('#col14_filter').val();
            ...
            "fnDrawCallback": function(oSettings) {
                ...
                $('#data-table-default').editable({
                    selector: ".ed_name",
                    url: 'sqledit/cart_discount_jedit.php',
                    type: 'text',
                    name: 'name',
                    //title: '輸入標題',
    ...
    swal({
        ...
        preConfirm: function() {
            return new Promise(function(resolve) {
                ...
                $.ajax({
                    url: "sqldatatable/cart_discount_del.php?id_del=" + id,
                    type: "GET"
        ...
        swal({
            ...
            preConfirm: function() {
                return new Promise(function(resolve) {
                    ...
                    $.ajax({
                        url: "sqldatatable/cart_discount_del_muti.php",
                        data: {
                            id: list_id
                        },
						//dataType: text,
