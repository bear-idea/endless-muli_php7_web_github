...
$query_RecordContact = sprintf("SELECT * FROM demo_contact WHERE lang = %s && home = 1  && indicate = 1 && userid=%s", GetSQLValueString($colnamelang_RecordContact, "text"),GetSQLValueString($coluserid_RecordContact, "int"));
...
?>
<?php } else { ?>
<?php include($TplPath . "/contact_view.php"); ?>
<?php } ?>
<?php
