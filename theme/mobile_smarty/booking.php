  ...
  <?php 
    ...
    <?php if ($TmpWrpViewLineLocate == '2') { ?>               
        ...
        <section class="page-header page-header-xxs">
			...
			<?php echo $ModuleName['Booking']; ?>
			<!-- InstanceEndEditable --></h1>
            <!-- InstanceBeginEditable name="導覽列" -->
                    <?php require("require_booking_viewline_mobile.php"); ?>
                    <!-- InstanceEndEditable -->
        </section>
		...
		<!-- InstanceBeginEditable name="主內容" -->
        	...
        	<?php } ?>
						<?php
							...
							{
								case "viewpage":
									include_once("require_booking.php");				
									break;
								case "typepage":
								case "maintypepage":
								case "detailed":
									include_once("require_booking_detailed.php");				
									break;
								case "search":
									include_once("require_booking_search.php");				
                  break;
                case "purchase":
									include_once("require_booking_purchase.php");				
                  break;
								default:   
									include_once("require_booking.php");	
									break;  
