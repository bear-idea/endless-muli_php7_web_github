...
if ((isset($_GET['id_del'])) && ($_GET['id_del'] != "") && $_GET['userid'] == $w_userid) {
  ...
  if($_GET['type'] == 'productlist' || $_GET['type'] == 'productactlist' || $_GET['type'] == 'producthotlist' || $_GET['type'] == 'productsalelist' || $_GET['type'] == 'productnewslist' || $_GET['type'] == 'modlink' || $_GET['type'] == 'frilink' || $_GET['type'] == 'articlelist' || $_GET['type'] == 'fbfan' || $_GET['type'] == 'alllist' || $_GET['type'] == 'newslist' || $_GET['type'] == 'blogplist' || $_GET['type'] == 'blogcalendar' || $_GET['type'] == 'siteviewcount' || $_GET['type'] == 'sitewhoscount' || $_GET['type'] == 'alltypelist' || $_GET['type'] == 'productsearch')
  {
	  ...
	  $updateSQLLock = sprintf("UPDATE demo_setting_fr SET %s=0 WHERE userid=%s",
	                       GetSQLValueString($_GET['type'] . "Lock_cn", "none"),
  ...
  $deleteGoTo = "manage_tmp.php?wshop=" . $wshop . "&Opt=tmpcolumn_plus&lang=" . $_SESSION['lang'];
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "TmpColumnFree")) {
  $insertSQL = sprintf("INSERT INTO demo_tmpcolumn (type, style, dftname, customname, location, lang, userid) VALUES (%s, %s, %s, %s, %s, %s, %s)",
					   ...
					   GetSQLValueString($_POST['dftname_cn'], "text"),
  ...
  if($_POST['type'] == 'productlist' || $_POST['type'] == 'productactlist' || $_POST['type'] == 'producthotlist' || $_POST['type'] == 'productsalelist' || $_POST['type'] == 'productnewslist' || $_POST['type'] == 'modlink' || $_POST['type'] == 'frilink' || $_POST['type'] == 'articlelist' || $_POST['type'] == 'fbfan' || $_POST['type'] == 'alllist' || $_POST['type'] == 'newslist' || $_POST['type'] == 'blogplist' || $_POST['type'] == 'blogcalendar' || $_POST['type'] == 'siteviewcount' || $_POST['type'] == 'sitewhoscount' || $_POST['type'] == 'alltypelist' || $_POST['type'] == 'productsearch')
  {
	  ...
	  $updateSQLLock = sprintf("UPDATE demo_setting_fr SET %s=1 WHERE userid=%s",
	  					   GetSQLValueString($_POST['type'] . "Lock_cn", "none"),
						   GetSQLValueString($_POST['userid'], "int"));
...
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordSettingLock = sprintf("SELECT productlistLock_cn, productactlistLock_cn, producthotlistLock_cn, productsalelistLock_cn, productnewslistLock_cn, frilinkLock_cn, modlinkLock_cn, fbfanLock_cn, articlelistLock_cn, alllistLock_cn, newslistLock_cn, blogplistLock_cn, blogcalendarLock_cn, siteviewcountLock_cn, sitewhoscountLock_cn, alltypelistLock_cn, productsearchLock_cn FROM demo_setting_fr WHERE userid = %s", GetSQLValueString($coluserid_RecordSettingLock, "int"));
  ...
  <div class="panel-body">
    <div class="table-responsive">
        <table class="table table-hover m-b-0">
			...
			<?php do { ?>
            <?php if (
		  ($row_RecordTmpAddColumn['type'] == 'sitewhoscount' && ($row_RecordSettingLock['sitewhoscountLock_cn'] == '1')) || 
		  ($row_RecordTmpAddColumn['type'] == 'siteviewcount' && ($row_RecordSettingLock['siteviewcountLock_cn'] == '1')) || 
		  ($row_RecordTmpAddColumn['type'] == 'blogcalendar' && ($row_RecordSettingLock['blogcalendarLock_cn'] == '1' OR $OptionBlogSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'blogplist' && ($row_RecordSettingLock['blogplistLock_cn'] == '1' OR $OptionBlogSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'frilink' && ($row_RecordSettingLock['frilinkLock_cn'] == '1' OR $OptionFrilinkSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'modlink' && ($row_RecordSettingLock['modlinkLock_cn'] == '1')) || 
		  ($row_RecordTmpAddColumn['type'] == 'productlist' && ($row_RecordSettingLock['productlistLock_cn'] == '1' OR $OptionProductSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'productactlist' && ($row_RecordSettingLock['productactlistLock_cn'] == '1' OR $OptionProductSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'producthotlist' && ($row_RecordSettingLock['producthotlistLock_cn'] == '1' OR $OptionProductSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'productsalelist' && ($row_RecordSettingLock['productsalelistLock_cn'] == '1' OR $OptionProductSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'productnewslist' && ($row_RecordSettingLock['productnewslistLock_cn'] == '1' OR $OptionProductSelect == '0')) ||
		  ($row_RecordTmpAddColumn['type'] == 'productsearch' && ($row_RecordSettingLock['productsearchLock_cn'] == '1' OR $OptionProductSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'articlelist' && ($row_RecordSettingLock['articlelistLock_cn'] == '1' OR $OptionArticleSelect == '0')) || 
		  ($row_RecordTmpAddColumn['type'] == 'alltypelist' && ($row_RecordSettingLock['alltypelistLock_cn'] == '1')) || 
		  ($row_RecordTmpAddColumn['type'] == 'fbfan' && ($row_RecordSettingLock['fbfanLock_cn'] == '1')) || 
		  ($row_RecordTmpAddColumn['type'] == 'alllist' && ($row_RecordSettingLock['alllistLock_cn'] == '1')) || 
		  ($row_RecordTmpAddColumn['type'] == 'newslist' && ($row_RecordSettingLock['newslistLock_cn'] == '1' OR $OptionNewsSelect == '0'))
		  ) { ?>
          <?php } else { ?>
          <form name="TmpColumn" action="<?php echo $editFormAction; ?>" method="POST" id="TmpColumn<?php echo $row_RecordTmpAddColumn['type']; ?>">
             ...
             <input name="dftname_cn" type="hidden" id="dftname_cn" value="<?php echo $row_RecordTmpAddColumn['dftname_cn']; ?>" />
