...
<?php if ($totalRows_RecordAboutCMenu > 1 ) { // Show if recordset not empty ?>
<div class="nav-wrap">
  <ul class="group" id="sm-one">
    <?php $menu_act=1; // 選單啟用 ?>
    <?php do { ?>
      <?php if (isset($_GET['Opt']) && $_GET['Opt']=='detailed') { ?> 
      <li class="<?php if ($row_RecordAboutCMenu['id'] == $_GET['id']){echo "current_page_item";} ?>"><a href="about.php?wshop=<?php echo $_GET['wshop'];?>&amp;Opt=detailed&amp;lang=<?php echo $_SESSION['lang']; ?>&amp;tp=About&amp;level=<?php echo $level; ?>&amp;type1=<?php echo $row_RecordAboutCMenu['type1']; ?>&amp;type2=<?php echo $row_RecordAboutCMenu['type2']; ?>&amp;type3=<?php echo $row_RecordAboutCMenu['type3']; ?>&amp;subitem_id=<?php echo $_GET['subitem_id']; ?>&amp;id=<?php echo $row_RecordAboutCMenu['id']; ?>"><?php echo $row_RecordAboutCMenu['title']; ?></a></li>
      <?php } else { ?>
      <li class="<?php if ($menu_act == '1') {echo "current_page_item";}?>"><a href="about.php?wshop=<?php echo $_GET['wshop'];?>&amp;Opt=detailed&amp;lang=<?php echo $_SESSION['lang']; ?>&amp;tp=About&amp;level=<?php echo $level; ?>&amp;type1=<?php echo $row_RecordAboutCMenu['type1']; ?>&amp;type2=<?php echo $row_RecordAboutCMenu['type2']; ?>&amp;type3=<?php echo $row_RecordAboutCMenu['type3']; ?>&amp;subitem_id=<?php echo $_GET['subitem_id']; ?>&amp;id=<?php echo $row_RecordAboutCMenu['id']; ?>"><?php echo $row_RecordAboutCMenu['title']; ?></a></li>
       <?php $menu_act = 0;?>
      <?php } ?>   
...
<![endif]-->
<?php } else { ?>
<?php include($TplPath . "/about_cmenu.php"); ?>
<?php } ?>
<?php
