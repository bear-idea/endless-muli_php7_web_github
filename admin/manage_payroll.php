...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require("require_leftmainmenu_payroll.php");?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include("require_manage_payroll_index.php");			
					break;
				case "genpage":
					include("require_manage_payroll_gen.php");			
					break;
				case "addpage":
					include("require_manage_payroll_add.php");
					break;
				case "editpage":
					include("require_manage_payroll_edit.php"); 
					break;
				case "listpage":
					include("require_manage_payroll_list.php");
					break;
				case "listitempage":
					include("require_manage_payroll_listitem.php");
					break;
				default:
					include("require_manage_payroll_index.php");
					break;
