...
if (isset($_POST[$MM_flag])) {
  $MM_dupKeyRedirect="dealer.php?Opt_Dealer=regpage&RegMsg=error&lang=" . $_POST['lang'];
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_Dealer")) {
  $insertSQL = sprintf("INSERT INTO demo_dealer (account, psw, name, nickname, sex, birthday, mail, tel, cellphone, addr1, fax, serviceunits, web, job, indicate, notes1, lang, auth) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "login_dealer.php?Operate=regSuccess&lang=" . $_POST['lang'];
  if (isset($_SERVER['QUERY_STRING'])) {
