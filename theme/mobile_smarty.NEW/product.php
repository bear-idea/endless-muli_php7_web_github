  ...
  <?php 
    ...
    <?php if ($TmpWrpViewLineLocate == '2') { ?>               
        ...
        <section class="page-header page-header-xxs">
			...
			<?php echo $ModuleName['Product']; ?>
			<!-- InstanceEndEditable --></h1>
            <!-- InstanceBeginEditable name="導覽列" -->
                                    <?php if ($_GET['Opt'] == 'cartdetailed') { ?>
                <?php require("require_productcart_viewline_mobile.php"); ?>
                <?php } else { ?>
                <?php require("require_product_viewline_mobile.php"); ?>
                <?php } ?>
                    <!-- InstanceEndEditable -->
        </section>
		...
		<!-- InstanceBeginEditable name="主內容" -->
	    	<?php if ($TmpWrpViewLineLocate == '1') { ?>               
            	...
            	<section class="page-header page-header-xxs">
					...
					<?php if ($_GET['Opt'] == 'cartdetailed') { ?>
						<?php require('app/viewline/require_productcart_viewline_mobile.php'); ?>
					<?php } else { ?>
        ...
        <?php
			switch($_GET['Opt'])
			{
				...
				case "cartdetailed":
					...
					break;	
				case "search":
					include_once("require_product_search.php");				
					break;
				case "discount":
					include_once("require_product_discount.php");				
					break;
				default:
					include_once("require_product.php");
					break;
