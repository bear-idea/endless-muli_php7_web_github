...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require("require_leftmainmenu_org.php"); ?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include("require_manage_org_index.php");			
					break;
				case "addpage":
					include("require_manage_org_add.php");
					break;
				case "editpage":
					include("require_manage_org_edit.php"); 
					break;
				case "deletepage":
					include("require_manage_org_delete.php");
					break;
				case "listpage":
					include("require_manage_org_list.php");
					break;
				case "listitempage":
					include("require_manage_org_listitem.php");
					break;
				case "configpage":
					include_once("require_manage_org_config.php");
					break;
				default:
					include("require_manage_org_index.php");
					break;
