...
<?php require_once("inc_dfpage.php"); // 取得頁面名稱?>
<!DOCTYPE html>
  ...
  <!-- begin #sidebar -->
        ...
        <?php
			switch($_GET['Opt'])
			{
				...
				case "startpage_sub":
					require_once("require_leftmainmenu_dfpage.php");
					break;
				default:
					require_once("require_leftmainmenu_dftype.php");
					break;
			}
		?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "areapage":
					include_once("require_manage_dfpage_area_index.php");			
					break;
				case "viewpage":
					include_once("require_manage_dfpage_index.php");			
					break;
				case "typepage":
					include_once("require_manage_dfpage_type.php");			
					break;
				case "startpage":
					include_once("require_manage_dfpage_start.php"); 
					break;
				case "startpage_sub":
					include_once("require_manage_dfpage_start_sub.php"); 
					break;
				case "typeaddpage":
					include_once("require_manage_dfpage_type_add.php");			
					break;
				case "typeeditpage":
					include_once("require_manage_dfpage_type_edit.php");			
					break;
				case "typelinkeditpage":
					include_once("require_manage_dfpage_type_link_edit.php");			
					break;
				case "typeanchorpointeditpage":
					include_once("require_manage_dfpage_type_anchorpoint_edit.php");			
					break;
				case "viewpage_sub":
					include_once("require_manage_dfpage_index_sub.php");			
					break;
				case "searchallpage":
					include_once("require_manage_dfpage_index_all_search.php");			
					break;
				case "searchpage":
					include_once("require_manage_dfpage_index_search.php");					
					break;
				case "viewpage_sl1":
					include_once("require_manage_dfpage_index_sl1.php");			
					break;
				case "viewpage_sl2":
					include_once("require_manage_dfpage_index_sl2.php");			
					break;
				case "viewpage_sl3":
					include_once("require_manage_dfpage_index_sl3.php");			
					break;
				case "addpage":
					include_once("require_manage_dfpage_add.php");
					break;
				case "editpage":
					include_once("require_manage_dfpage_edit.php"); 
					break;
				case "deletepage":
					include_once("require_manage_dfpage_delete.php");
					break;
				case "listpage":
					include_once("require_manage_dfpage_list.php");
					break;
				case "listitempage":
					include_once("require_manage_dfpage_listitem.php");
					break;
				case "mulilistitempage":
					include_once("require_manage_dfpage_mulilistitem.php");
					break;
				case "sub_mulilistitempage":
					include_once("require_manage_dfpage_mulilistitem_sub.php");
					break;
				case "configpage":
					include_once("require_manage_dfpage_config.php");
					break;
				case "tmp_step_type_map":
					include_once("require_manage_dfpage_step_type_map.php");
					break;
				default:
					include_once("require_manage_dfpage_type.php");
					break;
