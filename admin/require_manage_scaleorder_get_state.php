...
if (isset($row_RecordCartDetailed['code'])) {
  $colname_RecordScale = $row_RecordCartDetailed['code'];
}
...
echo $query_RecordScale = sprintf("SELECT * FROM erp_scale WHERE code = %s && userid=%s", GetSQLValueString($colname_RecordScale, "text"),GetSQLValueString($coluserid_RecordScale, "int"));
