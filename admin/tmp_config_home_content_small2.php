...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Tmp")) {
  if($_POST['lang'] == 'zh-tw') {
  $updateSQL = sprintf("UPDATE demo_setting_fr SET homecontenttwsmall2=%s WHERE userid=%s",
                       GetSQLValueString($_POST['homecontent'], "text"),
                       GetSQLValueString($w_userid, "int"));
  }
  if($_POST['lang'] == 'cn') {
  $updateSQL = sprintf("UPDATE demo_setting_fr SET homecontentcnsmall2=%s WHERE userid=%s",
                       GetSQLValueString($_POST['homecontent'], "text"),
                       GetSQLValueString($w_userid, "int"));
  }
  if($_POST['lang'] == 'en') {
  $updateSQL = sprintf("UPDATE demo_setting_fr SET homecontentensmall2=%s WHERE userid=%s",
                       GetSQLValueString($_POST['homecontent'], "text"),
                       GetSQLValueString($w_userid, "int"));
  }
  if($_POST['lang'] == 'kr') {
  $updateSQL = sprintf("UPDATE demo_setting_fr SET homecontentkrsmall2=%s WHERE userid=%s",
                       GetSQLValueString($_POST['homecontent'], "text"),
                       GetSQLValueString($w_userid, "int"));
  }
  if($_POST['lang'] == 'sp') {
  $updateSQL = sprintf("UPDATE demo_setting_fr SET homecontentspsmall2=%s WHERE userid=%s",
                       GetSQLValueString($_POST['homecontent'], "text"),
                       GetSQLValueString($w_userid, "int"));
  }
...
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordSystemSetting = sprintf("SELECT homecontenttwsmall2, homecontentcnsmall2, homecontentensmall2, homecontentkrsmall2, homecontentspsmall2 FROM demo_setting_fr WHERE userid=%s", GetSQLValueString($coluserid_RecordSystemSetting, "int"));
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post" id="form_TmpColumn" name="form_TmpColumn">
      ...
      <div class="form-group row">
          ...
          <div class="table-responsive">
                <textarea name="homecontent" id="homecontent" cols="100%" rows="35" class="form-control"><?php if ($_SESSION['lang'] == 'zh-cn') { ?><?php echo $row_RecordSystemSetting['homecontentcnsmall2']; ?><?php } else if ($_SESSION['lang'] == 'en') { ?><?php echo $row_RecordSystemSetting['homecontentensmall2']; ?><?php } else if ($_SESSION['lang'] == 'kr') { ?><?php echo $row_RecordSystemSetting['homecontentkrsmall2']; ?><?php } else if ($_SESSION['lang'] == 'sp') { ?><?php echo $row_RecordSystemSetting['homecontentspsmall2']; ?><?php } else { ?><?php echo $row_RecordSystemSetting['homecontenttwsmall2']; ?><?php } ?></textarea>  
          </div>
          </div>
      </div>
