var handleDataTableDefault = function() {
    ...
    if ($('#data-table-default').length !== 0) {
        var otable = $('#data-table-default').DataTable({       //"dom":"lBfrtip",buttons:[{extend:"copy",className:"btn-sm"},{extend:"csv",className:"btn-sm"},{extend:"excel",className:"btn-sm"},{extend:"pdf",className:"btn-sm"},{extend:"print",className:"btn-sm"},{extend:"colvis",className:"btn-sm"}],
            ...
            "autoWidth": false,
            "ajax": {
                "url": "sqldatatable/health_view.php",
                "type": "post",
				"data": function ( d ) {
			...
			{
                "data": "HealthSharingAdd1",
                "orderable": true
            },
			{
                "data": "HealthSharingAdd2",
                "orderable": true
            },
			{
                "data": "HealthSharingAdd3",
                "orderable": true
            },
			{
                "data": "EmployerSharing",
                "orderable": true
            }],
            "lengthMenu": [[10, 30, 60, -1], [10, 30, 60, "All"] // change per page values here
            ],
            "language": //把文本變為中文
            {
                "sProcessing": "處理中...",
            ...
            "fnDrawCallback": function(oSettings) {
				...
				$('#data-table-default').editable({
                    ...
                    url: 'sqledit/health_jedit.php',
                    name: "type",
                    source: "sqledit/health_get_list.php?list_id=1",
                    validate: function(value) {
                        if ($.trim(value) == '') {
                            return '值不能為空';
                        }
    ...
    swal({
        ...
        preConfirm: function() {
            return new Promise(function(resolve) {
                ...
                $.ajax({
                    url: "sqldatatable/health_del.php?id_del=" + id,
                    type: "GET"
        ...
        swal({
            ...
            preConfirm: function() {
                return new Promise(function(resolve) {
                    ...
                    $.ajax({
                        url: "sqldatatable/health_del_muti.php",
                        data: {
                            id: list_id
                        },
                        type: "POST"
