...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Scaleorder")) {
  $updateSQL = sprintf("UPDATE erp_scaleorderout SET pic8=IFNULL(%s,pic8) WHERE oid=%s",
                       GetSQLValueString($_POST['pic8'], "text"),
  ...
  $updateGoTo = "uplod_scalesnumber8.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?>" class="form-horizontal form-bordered" data-parsley-validate="" method="post" enctype="multipart/form-data">
      <div class="form-group row">
          ...
          <div class="col-md-10">
               <input id="pic8" name="pic8" type="file" size="50" maxlength="50" class="file" data-parsley-trigger="blur" data-parsley-errors-container="#error_pic" required/>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
            ...
            <input name="oldpic" type="hidden" id="oldpic" value="<?php echo $row_RecordScaleorder['pic8']; ?>" />
...
$(document).ready(function() {
	$("#pic8").fileinput({
		...
		<?php if ($row_RecordScaleorder['pic8'] != "") { ?>
		initialPreview: ["<?php echo $SiteImgUrlAdmin; ?><?php echo $wshop; ?>/image/scaleorder/thumb/small_<?php echo $row_RecordScaleorder['pic8']; ?>"],
		initialPreviewConfig: [<?php echo "{url: 'sqldatatable/scaleorder_scalesnumber8_photo_del.php?id_del=".$row_RecordScaleorder['oid']."', key: ".$row_RecordScaleorder['oid'].", extra: {id:".$row_RecordScaleorder['oid']."} }"; ?>],
		<?php } ?>
