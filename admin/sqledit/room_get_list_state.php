...
$query_RecordRoomListItem = sprintf("SELECT demo_roomitem.item_id, demo_roomlist.list_id, demo_roomlist.listname, demo_roomitem.itemname, demo_roomitem.itemvalue, demo_roomitem.lang FROM demo_roomlist LEFT OUTER JOIN demo_roomitem ON demo_roomlist.list_id = demo_roomitem.list_id WHERE demo_roomlist.list_id = %s && demo_roomitem.lang=%s  && demo_roomitem.userid=%s ORDER BY demo_roomitem. sortid ASC", GetSQLValueString($collistid_RecordRoomListItem, "int"),GetSQLValueString($collang_RecordRoomListItem, "text"),GetSQLValueString($coluserid_RecordRoomListItem, "int"));
...
<?php do { ?>
  <?php $data[$row_RecordRoomListItem['itemvalue']] = $row_RecordRoomListItem['itemname']; ?>
