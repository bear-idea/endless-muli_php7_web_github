...
if (isset($_GET['id'])) {
  $colname_RecordSupplier = $_GET['id'];
}
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <div class="panel-body p-0 bg-white" id="jq_print">
      ...
      <tbody>
                        ...
                        <tr>
                          <td width="150" class="title_bg">廠商代號</td>
                          <td><?php echo $row_RecordSupplier['code']; ?></td>
                          <td width="150" class="title_bg">公司名稱</td>
                          <td><?php echo $row_RecordSupplier['name']; ?></td>
                        </tr>
                        <td class="title_bg">簡稱</td>
                          <td width="380"><?php echo $row_RecordSupplier['sname']; ?></td>
                          <td width="150" class="title_bg">負責人</td>
                          <td width="380"><?php echo $row_RecordSupplier['leader']; ?></td>
                        </tr>
                        <tr>
                          <td class="title_bg">統一編號</td>
                          <td><?php echo $row_RecordSupplier['VATnumber']; ?></td>
                          <td class="title_bg">廠商編號</td>
                          <td><?php echo $row_RecordSupplier['vendornumber']; ?></td>
                        </tr>
                    <tr>
                          <td colspan="4" class="title_bg"><i class="fa fa-chevron-circle-right" aria-hidden="true"></i> 聯絡資訊</td>
                </tr>    
                <tr>
                          <td width="150" class="title_bg">電話</td>
                          <td><?php echo $row_RecordSupplier['tel']; ?></td>
                          <td width="150" class="title_bg">電話</td>
                          <td><?php echo $row_RecordSupplier['tel2']; ?></td>
                        </tr>
                        <td class="title_bg">行動</td>
                          <td width="380"><?php echo $row_RecordSupplier['cellphone']; ?></td>
                          <td width="150" class="title_bg">傳真</td>
                          <td width="380"><?php echo $row_RecordSupplier['fax']; ?></td>
                        </tr>
                          <td class="title_bg">電子郵件</td>
                          <td width="380"><?php echo $row_RecordSupplier['mail']; ?></td>
                          <td width="150" class="title_bg">&nbsp;</td>
                          <td width="380">&nbsp;</td>
                        </tr>
                          <td class="title_bg">營業地址</td>
                          <td colspan="3"><?php echo $row_RecordSupplier['companyaddr']; ?></td>
                          </tr>
                          <td class="title_bg">發貨地址</td>
                          <td colspan="3"><?php echo $row_RecordSupplier['shipmentsaddr']; ?></td>
                          </tr>
                        <td class="title_bg">聯絡人</td>
                          <td width="380"><?php echo $row_RecordSupplier['contactperson']; ?></td>
                          <td width="150" class="title_bg">業務人員</td>
                          <td width="380"><?php echo $row_RecordSupplier['sales']; ?></td>
                        </tr>
                        <tr>
                          <td colspan="4" class="title_bg"><i class="fa fa-chevron-circle-right" aria-hidden="true"></i> 帳務資訊</td>
                </tr>  
                          <td class="title_bg">每月結帳日</td>
                          <td width="380"><?php echo $row_RecordSupplier['monthcloseday']; ?></td>
                          <td width="150" class="title_bg">交易額度</td>
                          <td width="380"><?php echo $row_RecordSupplier['transactionlimit']; ?></td>
                        </tr>
                        <td class="title_bg">發票抬頭</td>
                          <td width="380"><?php echo $row_RecordSupplier['invoicetittle']; ?></td>
                          <td width="150" class="title_bg">&nbsp;</td>
                          <td width="380">&nbsp;</td>
                        </tr>
                        <td class="title_bg">發票地址</td>
                          <td colspan="3"><?php echo $row_RecordSupplier['invoiceaddr']; ?></td>
                          </tr>
                        <tr>
