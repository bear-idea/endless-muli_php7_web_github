...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Tmp")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmpprojectboard=%s, tmpprojectboardicon=%s, tmpprojectimagemethods=%s, tmpprojectimageboard=%s WHERE id=%s",
                       GetSQLValueString($_POST['tmpprojectboard'], "text"),
                       GetSQLValueString($_POST['tmpprojectboardicon'], "text"),
					   GetSQLValueString($_POST['tmpprojectimagemethods'], "text"),
					   GetSQLValueString($_POST['tmpprojectimageboard'], "int"),
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post" id="form_Tmp" name="form_Tmp">
       <div class="form-group row">
        ...
        <div class="col-md-12"><span class="badge badge-primary"><i class="fa fa-paper-plane"></i> <?php echo $ModuleName['Project']; ?></span></div>
      </div>
       <div class="form-group row">
          <label class="col-md-2 col-form-label">相片外框<span class="text-red">*</span></label>                       	
          <div class="col-md-10">
          
      <select name="tmpprojectboard" id="tmpprojectboard" class="form-control" data-parsley-trigger="blur" required="">
        <option value="none" <?php if (!(strcmp("none", $row_RecordTmp['tmpprojectboard']))) {echo "selected=\"selected\"";} ?>>無外框</option>
        ...
        <option value="baseline01" <?php if (!(strcmp("baseline01", $row_RecordTmp['tmpprojectboard']))) {echo "selected=\"selected\"";} ?>>基本線條A</option>
        <option value="baseline02" <?php if (!(strcmp("baseline02", $row_RecordTmp['tmpprojectboard']))) {echo "selected=\"selected\"";} ?>>基本線條B</option>
        <option value="baseline03" <?php if (!(strcmp("baseline03", $row_RecordTmp['tmpprojectboard']))) {echo "selected=\"selected\"";} ?>>基本線條C</option>
        <option value="baseline04" <?php if (!(strcmp("baseline04", $row_RecordTmp['tmpprojectboard']))) {echo "selected=\"selected\"";} ?>>基本線條D</option>
        <option value="baseline05" <?php if (!(strcmp("baseline05", $row_RecordTmp['tmpprojectboard']))) {echo "selected=\"selected\"";} ?>>基本線條E</option>
      </select>
      ...
      <select name="tmpprojectboardicon" id="tmpprojectboardicon" class="form-control" data-parsley-trigger="blur" >
  	  ...
  	  <div class="form-group row">
          ...
          <div class="col-md-10">
                             ...
                             <div class="card pull-left m-5">
                                  ...
                                  <div class="card-block">
                                      <div class="radio radio-css radio-inline">
                                            <input <?php if (!(strcmp($row_RecordTmp['tmpprojectimagemethods'],"resize"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpprojectimagemethods" value="resize" id="tmpprojectimagemethods_0"  />
                                            <label for="tmpprojectimagemethods_0">縮放</label>
                                      </div>
                                  </div>
                              </div> 
                             ...
                             <div class="card pull-left m-5">
                                  ...
                                  <div class="card-block">
                                      <div class="radio radio-css radio-inline">
                                            <input <?php if (!(strcmp($row_RecordTmp['tmpprojectimagemethods'],"crop"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpprojectimagemethods" value="crop" id="tmpprojectimagemethods_1"  />
                                            <label for="tmpprojectimagemethods_1">裁切</label>
                                      </div>
                                  </div>
                              </div> 
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                             ...
                             <div class="card pull-left m-5">
                                  ...
                                  <div class="card-block">
                                    <div class="radio radio-css radio-inline">
                                            <input <?php if (!(strcmp($row_RecordTmp['tmpprojectimageboard'],"0"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpprojectimageboard" value="0" id="tmpprojectimageboard_0"  />
                                            <label for="tmpprojectimageboard_0">方型</label>
                                      </div>
                                  </div>
                              </div> 
                             ...
                             <div class="card pull-left m-5">
                                  ...
                                  <div class="card-block">
                                      <div class="radio radio-css radio-inline">
                                            <input <?php if (!(strcmp($row_RecordTmp['tmpprojectimageboard'],"1"))) {echo "checked=\"checked\"";} ?> type="radio" name="tmpprojectimageboard" value="1" id="tmpprojectimageboard_1"  />
                                            <label for="tmpprojectimageboard_1">矩形</label>
                                      </div>
                                  </div>
                              </div> 
