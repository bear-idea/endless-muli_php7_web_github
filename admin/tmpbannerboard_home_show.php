...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE demo_tmp SET tmpbannerboard=%s WHERE id=%s",
...
.mdbanner_show{min-height:1px; _height:1px}
.mdbanner_show_t{position:relative; font-size:12px}
.mdbanner_show_t_l, .mdbanner_show_t_r{position:absolute; top:0px; font-size:1px; overflow:hidden}
.mdbanner_show_t_l{left:0}
.mdbanner_show_t_r{right:0; float:right}
.mdbanner_show_t_m{position:absolute; text-align:left; height:20px; line-height:20px}
.mdbanner_show_t_m h3{font-size:14px; width:120px}
.mdbanner_show_t_c{position:relative; text-align:left; overflow:hidden}
.mdbanner_show_t_c span.a_a{text-decoration:none}
.mdbanner_show_c{position:relative; overflow:hidden}
.mdbanner_show_c .mdbanner_show_m_t, .mdbanner_show_c .mdbanner_show_m_c, .mdbanner_show_c .mdbanner_show_m_b{padding:0 2px}
.mdbanner_show_c .mdbanner_show_m_t, .mdbanner_show_c .mdbanner_show_m_b{text-align:left}
.mdbanner_show_c_l, .mdbanner_show_c_r{position:absolute; top:0; font-size:1px}
.mdbanner_show_c_l{left:0}
.mdbanner_show_c_r{right:0}
.mdbanner_show_c_c{position:relative; zoom:1}
.mdbanner_show_b{position:relative; overflow:hidden}
.mdbanner_show_b_l, .mdbanner_show_b_r{position:absolute; top:0; font-size:1px}
.mdbanner_show_b_l{left:0}
.mdbanner_show_b_r{right:0}
  ...
  <div style="background-color:#FFFFFF; padding:5px; border: 1px solid #CCC; overflow-y:scroll; height:800px;">
    ...
    <tbody>
      ...
      <tr>    
	   ...
	   <div style="padding:5px; border: 1px dotted #CCC; margin-bottom:2px; width:350px;; float:left; margin:5px; text-align:center;" class="<?php if($row_RecordTmpBoardShowSelect['tmpbannerboard'] == ''){echo "bg_active";} ?> bg_board"><!--無圖片指定--><a><img src="images/no_bg.jpg" alt="" width="50" height="50" alumb="true" _w="50" _h="50"/></a>
...
$("#chang_tmp_none").click(function(){     
	$(".BannerBoardStyle").css({"background-image":"none", "background-color":"transparent"});
	$(".mdbanner_t_l").css({"background-image":"none", "background-color":"transparent"});
	$(".mdbanner_t_r").css({"background-image":"none", "background-color":"transparent"});
	$(".mdbanner_t_c").css({"background-image":"none", "background-color":"transparent"});
	$(".mdbanner_c_l").css({"background-image":"none", "background-color":"transparent"});
	$(".mdbanner_c_r").css({"background-image":"none", "background-color":"transparent"});
	$(".mdbanner_c_c").css({"background-image":"none", "background-color":"transparent"});
	$(".mdbanner_b_l").css({"background-image":"none", "background-color":"transparent"});
	$(".mdbanner_b_r").css({"background-image":"none", "background-color":"transparent"});
	$(".mdbanner_b_c").css({"background-image":"none", "background-color":"transparent"});
});
$("#use_tmp_none").click(function(){     
$.ajax({
		type: "POST",
		url: "sqlgettmp/tmpbannerboard_get.php?id=none&Operate=M_Update&tmpid=<?php echo $row_RecordTmp['id']; ?>&<?php echo time();?>",
		success: function(data){
			$(".BannerBoardStyle").css({"background-image":"none", "background-color":"transparent"});
			$(".mdbanner_t_l").css({"background-image":"none", "background-color":"transparent", "height":"0px", "width":"0px"});
			$(".mdbanner_t_r").css({"background-image":"none", "background-color":"transparent", "height":"0px", "width":"0px"});
			$(".mdbanner_t_c").css({"background-image":"none", "background-color":"transparent", "height":"0px", "width":"0px"});
			$(".mdbanner_c_l").css({"background-image":"none", "background-color":"transparent", "width":"0px"});
			$(".mdbanner_c_r").css({"background-image":"none", "background-color":"transparent", "width":"0px"});
			$(".mdbanner_c_c").css({"background-image":"none", "background-color":"transparent", });
			$(".mdbanner_b_l").css({"background-image":"none", "background-color":"transparent", "height":"0px", "width":"0px"});
			$(".mdbanner_b_r").css({"background-image":"none", "background-color":"transparent", "height":"0px", "width":"0px"});
			$(".mdbanner_b_c").css({"background-image":"none", "background-color":"transparent", "height":"0px"});
