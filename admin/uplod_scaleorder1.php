...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_Scaleorder")) {
  $updateSQL = sprintf("UPDATE erp_scaleorderindetail SET pic1=IFNULL(%s,pic1) WHERE id=%s",
  ...
  $updateGoTo = "uplod_scaleorder1.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
//mysqli_select_db($database_DB_Conn, $DB_Conn);
$query_RecordScaleorder = sprintf("SELECT * FROM erp_scaleorderindetail WHERE id = %s", GetSQLValueString($colname_RecordScaleorder, "int"));
...
$(document).ready(function() {
	$("#pic1").fileinput({
		...
		initialPreviewConfig: [<?php echo "{url: 'sqldatatable/scaleorder_scaleorder1_photo_del.php?id_del=".$row_RecordScaleorder['id']."', key: ".$row_RecordScaleorder['id'].", extra: {id:".$row_RecordScaleorder['id']."} }"; ?>],
		<?php } ?>
