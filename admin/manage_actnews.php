...
<div id="page-container" class="page-header-fixed page-sidebar-fixed page-with-wide-sidebar"> 
  ...
  <!-- begin #sidebar -->
    	...
    	<?php require("require_leftmainmenu_actnews.php");?>
    	<!-- InstanceEndEditable -->
    ...
    <div class="col-lg-12">
      ...
      <!-- InstanceBeginEditable name="主內容" -->
        <?php
			...
			{
				case "viewpage":
					include("require_manage_actnews_index.php");			
					break;
				case "seo":
					include("require_manage_actnews_index_seo.php");			
					break;
				case "addpage":
					include("require_manage_actnews_add.php");
					break;
				case "editpage":
					include("require_manage_actnews_edit.php"); 
					break;
				case "seoeditpage":
					include("require_manage_actnews_edit_seo.php"); 
					break;
				case "copypage":
					include("require_manage_actnews_copy.php"); 
					break;
				case "searchpage":
					include_once("require_manage_actnews_post_search.php");			
					break;
				case "postpage":
					include_once("require_manage_actnews_post_index.php");			
					break;
				case "postaddpage":
					include_once("require_manage_actnews_post_add.php");			
					break;
				case "posteditpage":
					include_once("require_manage_actnews_post_edit.php");			
					break;
				case "replypage":
					include_once("require_manage_actnews_reply_index.php");			
					break;
				case "replyaddpage":
					include_once("require_manage_actnews_reply_add.php");			
					break;
				case "replyeditpage":
					include_once("require_manage_actnews_reply_edit.php");			
					break;
				case "listpage":
					include("require_manage_actnews_list.php");
					break;
				case "listitempage":
					include("require_manage_actnews_listitem.php");
					break;
				default:
					include("require_manage_actnews_index.php");
					break;
