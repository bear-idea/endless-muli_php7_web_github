...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form_Scaleorder_source")) {
	
	if($_POST['erpcompanyordernum'] != "")
	{
		$_POST['snumber'] = $_POST['erpcompanyordernum'] . "-" . $_POST['snumber'];
	}
	
	/* 解析 title */
	list($pdname, $pdcode) = explode('_', $_POST['title']);
	
  $insertSQL = sprintf("INSERT INTO erp_scaleorderclearancedetail (title, code, snumber, carnumber, author, manufacturer, Totalweight, Minweight, Oriweight, postdate, notes1, lang, userid) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "manage_scaleorder_clearance.php?Opt=viewpage&lang=" . $_POST['lang'];
  /*if (isset($_SERVER['QUERY_STRING'])) {
...
<div class="card bg-silver-lighter" style="overflow:hidden">
  <div class="card-block">
    <h4 class="card-title m-0"><i class="far fa-bookmark"></i> 清運明細 <small>新增</small> <?php require("require_lang_show.php"); ?></h4>
  </div>
</div>
...
<div class="panel panel-inverse bg-white-transparent-9"> 
  ...
  <form action="<?php echo $editFormAction;?>"  class="form-horizontal form-bordered" data-parsley-validate="" method="post">
      ...
      <div class="form-group row">
          ...
          <input name="snumber" type="text" class="form-control" id="snumber" value="<?php echo $row_RecordSystemConfigOtr['erpcompanyordernum']; ?>-<?php echo $row_RecordScaleorder['snumber'] ?>" size="50" maxlength="50" />
          <?php } else { ?>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
                      ...
                      <input name="Minweight" type="number" required="" class="form-control" id="Minweight" step="0.1" value="0" maxlength="20" data-parsley-min="0" data-parsley-type="number" data-parsley-trigger="blur"/>
      ...
      <div class="form-group row">
          ...
          <div class="col-md-10">
            ...
            <input name="erpcompanyordernum" type="hidden" id="erpcompanyordernum" value="<?php echo $row_RecordSystemConfigOtr['erpcompanyordernum']; ?>" />
          </div>
      </div>
      <input type="hidden" name="MM_insert" value="form_Scaleorder_source" />
  </form>
  </div>
  <!-- end panel-body --> 
</div>
